...
> [!NOTE]
> **即時索引** · 上次同步: `2026-09-21T23:42:10+08:00` (UTC+8)
> · 條目: **737** · 本輪新增: **115** · 實作語言: **25**
...
- [Agent 工具鏈：MCP、鉤子、閘門與編碼 Agent](#agent-工具鏈mcp鉤子閘門與編碼-agent) — **192**
- [路由、護欄與核准](#路由護欄與核准) — **78**
- [評估、校準與基準測試](#評估校準與基準測試) — **77**
- [開放重現、權重與架構研究](#開放重現權重與架構研究) — **40**
- [應用程式、遊戲、機器人與互動示範](#應用程式遊戲機器人與互動示範) — **41**
...
- [BeatAPI/awesome-jev](https://github.com/BeatAPI/awesome-jev) - 我們只策展經原始碼審查、與 JEV 相關且擁有 100+ GitHub stars 的專案——整合、工具、開放模型與實驗.
...
- [gudcks0305/jev-java](https://github.com/gudcks0305/jev-java) - 非官方 Java SDK，用於 TypeSafe Jev 與 Vercel AI Gateway，支援 Spring Boot 和 WebClient。
...
<details>
<summary><b>本分類更多項目</b> <sub>· 170</sub></summary>
...
- [Prophetlab/JevPokerBench](https://github.com/Prophetlab/JevPokerBench) - ProphetLab 的 Texas Hold。
- [Nyarlathoteppppp/pi-jev-context](https://github.com/Nyarlathoteppppp/pi-jev-context) - 由 TypeSafe Jev 驅動、對快取中立的 pi coding agent 情境修剪：在長篇工具輸出進入情境前，先將其裁切為逐字關鍵行，並可無損回憶.
...
<details>
<summary><b>本分類更多項目</b> <sub>· 21</sub></summary>
...
- [zhengxuyu/litjev](https://github.com/zhengxuyu/litjev) - 將任何現成的 LLM 轉換為類似 Jev 的決策層。
...
<sub>產生工具 · `render.py` · 2026-09-21T23:42:10+08:00</sub>
