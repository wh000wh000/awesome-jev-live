...
> [!NOTE]
> **即時索引** · 上次同步: `2026-09-26T18:44:26+08:00` (UTC+8)
> · 條目: **806** · 本輪新增: **98** · 實作語言: **25**
...
- [topherchris420/james_library](https://github.com/topherchris420/james_library) - R.A.I.N. Lab 是一種實驗性科學代理架構，將快速的本地判斷、獨立的機率評估、多代理協議、證據與授權分離為不同的計算層.
...
- [6Mikao9/jev-native-agent-with-extended-options](https://github.com/6Mikao9/jev-native-agent-with-extended-options) - 一個以 Jev 為原生支援的代理系統研究設計：透過虛擬化與分頁提供比 jev 更多的選項，整合工具、由外部輔助程式提供 logits Top-k 建議並以…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/123skywalker/Neriv/main/demo.gif" width="100%" alt="123skywalker/Neriv animation"><br><sub>動態錄影</sub></td>
</tr></table>
...
- [shengjidaguai-china/goutoujunshi-jev-chat](https://github.com/shengjidaguai-china/goutoujunshi-jev-chat) - 狗头军师 Chat：Mac 微信讀屏、關係分析與回覆草稿懸浮窗。
...
- [HITsz-TMG/JevEmbed](https://github.com/HITsz-TMG/JevEmbed) - 認識 JevEmbed — 將嵌入轉化為決策。使用你選擇的嵌入模型進行選擇、評分與判斷.
...
<sub>產生工具 · `render.py` · 2026-09-26T18:44:26+08:00</sub>
