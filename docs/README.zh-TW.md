...
> [!NOTE]
> **即時索引** · 上次同步: `2026-09-23T07:10:14+08:00` (UTC+8)
> · 條目: **756** · 本輪新增: **71** · 實作語言: **25**
...
<sub>為你所有機器人準備的一個 offboard CLI。連接它們、指揮它們，並讓它們協同工作，每個都以 LLM 作為大腦，並以決策 LLM 實現更便宜且更快速的步驟。Microduck、Open Duck Mini、LeRobot、XLeRobot、AlohaMini、ToddlerBot 或任何 ROS…</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
<sub>🔧 於程式碼中發現使用: `docs/adr/0043-decision-llms-are-a-wire-format-and-a-data-row.md`</sub>
...
R.A.I.N. Lab 是一種實驗性科學代理架構，將快速本地判斷、獨立機率評估、多代理協商、證據與授權分隔為不同的計算層。🐙（早於 Karpathy 的 AutoResearch）
...
- [keltokhy/jlink](https://github.com/keltokhy/jlink) - 給經濟學家的記錄連結：用純英文撰寫匹配規則，取得每對的機率、稽核它、引用它。Python、CLI、Stata 和 R.
...
<details>
<summary><b>本分類更多項目</b> <sub>· 218</sub></summary>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/hfnissum-byte--hunkpick/21c4c5bad7854d6e.gif" width="100%" alt="hfnissum-byte/Hunkpick animation"><br><sub>動態錄影</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/surbhit20/jev-plays-snake/main/jev-plays-snake.gif" width="100%" alt="surbhit20/jev-plays-snake animation"><br><sub>動態錄影</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/yinsongxu--llm2jev/9b0b042b0dfa87b7.gif" width="100%" alt="Yinsongxu/LLM2Jev animation"><br><sub>動態錄影 · <a href="https://raw.githubusercontent.com/Yinsongxu/LLM2Jev/main/assets/mujoco.mp4">開啟影片</a></sub></td>
</tr></table>
...
- [phyous/tsai-sc](https://github.com/phyous/tsai-sc) - TypeSafe Jev 透過鍵盤和滑鼠，使用記錄的動作機率控制原版 StarCraft 共享軟體.
...
<sub>產生工具 · `render.py` · 2026-09-23T07:10:14+08:00</sub>
