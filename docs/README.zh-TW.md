...
> [!NOTE]
> **即時索引** · 上次同步: `2026-09-23T15:10:28+08:00` (UTC+8)
> · 條目: **704** · 本輪新增: **47** · 實作語言: **22**
...
- [Agent 工具鏈：MCP、鉤子、閘門與編碼 Agent](#agent-工具鏈mcp鉤子閘門與編碼-agent) — **224**
- [路由、護欄與核准](#路由護欄與核准) — **54**
- [評估、校準與基準測試](#評估校準與基準測試) — **70**
...
- [d-date/swift-jev](https://github.com/d-date/swift-jev) - 適用於 TypeSafe AI 的 Jev 的 Swift 用戶端——具型別的判斷，而非文字。
...
<details>
<summary><b>本分類更多項目</b> <sub>· 202</sub></summary>
...
- [Bodila51/muse-jev-playbook](https://github.com/Bodila51/muse-jev-playbook) - Muse 的 Jev 決策層：在昂貴的代理工作之前提供快速、低成本的 TypeSafe AI 閘門——信心度政策、配方、參考路由器、誠實的測量.
...
- [heyjunpenn/awesome-jev](https://github.com/heyjunpenn/awesome-jev) - 一份經驗證、由社群維護，使用 Jev 建構的 657 個開源專案目錄.
...
- [Nisaka520/JevBystander](https://github.com/Nisaka520/JevBystander) - Android 無障礙版微信判讀：只讀取螢幕、只彈出 3 條 Toast（意圖／情緒／著急／建議），不生成回覆文案、不傳送 · 零第三方依賴，APK 861…
...
<sub>產生工具 · `render.py` · 2026-09-23T15:10:28+08:00</sub>
