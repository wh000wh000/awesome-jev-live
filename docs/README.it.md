...
> [!NOTE]
> **Indice live** · Ultima sincronizzazione: `2026-09-25T18:10:37+08:00` (UTC+8)
> · Voci: **799** · Nuove in questo ciclo: **298** · Linguaggi di implementazione: **24**
...
<sub>Swift SDK per eseguire modelli di chat, visione e voce su iPhone e Mac con Core AI di Apple. Download e caching dei modelli, integrazione con FoundationModels ed…</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
- [Strumenti per agenti: MCP, hook, gate e agenti di coding](#strumenti-per-agenti-mcp-hook-gate-e-agenti-di-coding) — **249**
- [Instradamento, guardrail e approvazioni](#instradamento-guardrail-e-approvazioni) — **58**
- [Valutazione, calibrazione e benchmark](#valutazione-calibrazione-e-benchmark) — **81**
- [Riproduzioni aperte, pesi e ricerca sull'architettura](#riproduzioni-aperte-pesi-e-ricerca-sullarchitettura) — **38**
- [Applicazioni, giochi, robotica e demo interattive](#applicazioni-giochi-robotica-e-demo-interattive) — **54**
- [Articoli, discussioni e liste affini](#articoli-discussioni-e-liste-affini) — **102**
- [Altri progetti](#altri-progetti) — **82**
...
<sub>🔧 Trovato in uso nel codice: `src/typesafe_sdk/__init__.py`</sub>
...
<sub>🔧 Trovato in uso nel codice: `Sources/CoreAIOps/CoreAI+SystemOne.swift`</sub>
...
Framework Agentic GraphRAG indipendente dal database, che utilizza modelli System One sostituibili (Laya locale / Jev cloud). Un livello di intelligenza plug-and-play con una pipeline completa in 4 fasi e un attraversamento A* personalizzato per qualsiasi database a grafo.
...
Oltre 200 ricette Jev plug-and-play: decisioni AI piccole e calibrate che instradano, valutano, controllano, confrontano ed etichettano testi per agenti, RAG, assistenza, revisione del codice e musica. Importa da JavaScript o TypeScript, oppure chiama CLI con JSON da qualsiasi linguaggio.
...
Java SDK della community per Jev, il modello System One di TypeSafe: domande tipizzate in ingresso, risposte tipizzate con probabilità calibrate in uscita. Java 17+, starter Spring Boot (non ufficiale)
...
Un unico CLI per tutti i tuoi robot. Collegali, impartisci loro comandi e lascia che lavorino insieme, ciascuno con un LLM come cervello (Claude, OpenAI, Gemini, Grok o locale tramite Ollama o vLLM) e un LLM decisionale per la scelta multipla (Jev, Laya, Kev). Controlla Microduck, Open Duck Mini, LeRobot, XLeRobot, AlohaMini, ToddlerBot o qualsiasi base ROS 2 da un laptop, senza computer a bordo.
...
CLI che sceglie Cursor, Claude Code, Codex o OpenCode + modello/sforzo per un’attività, quindi lo avvia. Alimentato da Jev e Herdr
...
<details>
<summary><b>Altro in questa categoria</b> <sub>· 111</sub></summary>
...
- [chengyongru/fastjev](https://github.com/chengyongru/fastjev) - Fork di SemIf gestito indipendentemente e orientato prima di tutto a SDK, per…
- [Ray-Hughes/jevalyn](https://github.com/Ray-Hughes/jevalyn) - Il livello decisionale per la tua app Rails.
- [CheshiAI/Cheshi](https://github.com/CheshiAI/Cheshi) - Memoria delle conversazioni alimentata da Jev: trova sessioni passate e rivedi…
...
- [utk2103/jev-studio](https://github.com/utk2103/jev-studio) - se stai sperimentando con jev, da qui sarà più semplice.
...
Sperimentazione sui motori di ricerca con le collezioni TREC. Attualmente focalizzata sulle implementazioni di reranking zero-shot con il modello JEV di typesafe.ai
...
Alternativa locale open source a Jev: decisioni di agenti browser con Laya (modello System One) sulla propria macchina. Nessun cloud, nessuna chiave API. Compatibile con Playwright/CDP e MCP.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/mansicer--jev-plays/c4f1ec41afcb4ae9.gif" width="100%" alt="mansicer/jev-plays animation"><br><sub>registrazione animata</sub></td>
</tr></table>
...
- [supercorp-ai/supercov](https://github.com/supercorp-ai/supercov) - Copertura, sicurezza e qualità del codice per agenti di programmazione.
...
- [angel291592/Intent-Router](https://github.com/angel291592/Intent-Router) - Compilatore d.
- [socai-io/jev-social](https://github.com/socai-io/jev-social) - Agent Skill open-source e demo locale: Jev × socai per la ricerca su Instagram…
...
- [OmniJev/PlayJev](https://github.com/OmniJev/PlayJev) - 🚀🚀 Un modello multimodale da 0.8B simile a JEV che gioca ai giochi GUI…
...
- [PyModel/jev-judge-mcp](https://github.com/PyModel/jev-judge-mcp) - Strumenti di giudizio tipizzato per agenti MCP.
...
- [khordoo/jev-reflex-autonomy-lab](https://github.com/khordoo/jev-reflex-autonomy-lab) - Simulazione dell.
...
- [bgivenb/flick-computer-use](https://github.com/bgivenb/flick-computer-use) - Browser veloce e utilizzo del computer macOS per agenti MCP.
...
- [24601/Augustus](https://github.com/24601/Augustus) - Skill per agenti per trovare, costruire, valutare e migliorare sistemi di…
...
- [inso1337/revl](https://github.com/inso1337/revl) - Un linguaggio per la composibilità spaziotemporale sicura e universale…
- [AskTheWay/dsh-jev-interceptor](https://github.com/AskTheWay/dsh-jev-interceptor) - ⚡ Giudizio System-1 in millisecondi per ogni chiamata agli strumenti in…
...
Gateway di triage del rischio in tempo reale per depositi e prelievi dagli exchange — Jev (TypeSafe System One) gestisce solo il triage; l’adjudication resta nel codice deterministico.
...
Controllo degli accessi basato su giudizi tipizzati al margine del traffico: filtro a tre livelli contro prompt injection e abuso per nginx/OpenResty, alimentato da TypeSafe Jev. Fail-open, con cache e hot reload.
...
Disegna su una tela tldraw con la tua voce e un dito che indica. Jev (TypeSafe System One) decide l'azione, il bersaglio e il luogo in ~350 ms per parola pronunciata.
...
JevK5: alternativa open-weight a TypeSafe Jev. Decisioni tipizzate con probabilità in un’unica passata forward; pesi e codice Apache-2.0.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/allebee--jevk5/1f9cd6cb325d4bd4.gif" width="100%" alt="allebee/jevk5 animation"><br><sub>registrazione animata · <a href="https://raw.githubusercontent.com/allebee/jevk5/main/docs/demo/jevk5-nvidia-demo.mp4">Apri il video</a></sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/weitianxin--jevany/711125367b6758ff.gif" width="100%" alt="weitianxin/JevAny animation"><br><sub>registrazione animata</sub></td>
</tr></table>
...
Un minuscolo modello simile a jev che risponde a domande Choice, Score e Noul in un’unica passata forward e restituisce probabilità calibrate. MLX o PyTorch, completamente offline, compatibile con System One.
...
Decisioni tipizzate da stato non strutturato: una sola passata forward, zero testo generato. Locale, deterministico, compatibile con Jev. Non affiliato a typesafe.ai.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/antonellof--laya-vs-dijkstra/b61bc3a8e3d368be.gif" width="100%" alt="antonellof/laya-vs-dijkstra animation"><br><sub>registrazione animata</sub></td>
</tr></table>
...
Semantic ifs da modelli open, su una 3090 a casa. Indipendente; non affiliato a Jev o TypeSafe.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/theoleecj--semif-openjev/0504149cd9ef3cad.gif" width="100%" alt="TheoLeeCJ/SemIf-OpenJev animation"><br><sub>registrazione animata</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/zadescoxp--jev-trades/2abea899d779de55.gif" width="100%" alt="zadescoxp/Jev-Trades animation"><br><sub>registrazione animata</sub></td>
</tr></table>
...
<details>
<summary><b>Altro in questa categoria</b> <sub>· 36</sub></summary>
...
- [heyjunpenn/awesome-jev](https://github.com/heyjunpenn/awesome-jev) - Catalogo verificato e mantenuto dalla community di 916 progetti open-source…
...
<details>
<summary>📰 <b><a href="https://typesafe.ai/team">TypeSafe aggiunge la pagina Team + nella navigazione viene aggiunto l&#x27;ingresso `Enterprise` (segnale di productization/commercializzazione)</a></b> · ✅ official · 6 天</summary>
...
Famiglia di modelli decisionali simili a Jev, costruiti sopra Qwen3.5/3.8, che puoi addestrare ed eseguire autonomamente
...
Addestra autonomamente un modello multimodale simile a Jev. System One Model, ora con visione.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/liuziyu77--valen/d4fa3bf5c399a28d.gif" width="100%" alt="Liuziyu77/Valen animation"><br><sub>registrazione animata</sub></td>
</tr></table>
...
Un sostituto locale compatibile con API per Jev, il modello System One di TypeSafe
...
JevChat-Windows: assistente alla risposta affiancato alla finestra di chat. Screenshot della finestra + OCR offline locale legge i messaggi dell’interlocutore → Jev determina l’intento → 3 risposte candidate inserite con un clic; l’invio è sempre manuale
...
<sub>Generato da · `render.py` · 2026-09-25T18:10:37+08:00</sub>
