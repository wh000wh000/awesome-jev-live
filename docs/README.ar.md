...
> [!NOTE]
> **فهرس مباشر** · آخر مزامنة: `2026-09-23T09:31:07+08:00` (UTC+8)
> · المدخلات: **766** · جديد في هذه الدورة: **61** · لغات التنفيذ: **26**
...
<sub>نظام خارجي واحد CLI لجميع روبوتاتك. صِلها، وأصدر الأوامر إليها، ودعها تعمل معًا، بحيث يمتلك كل منها LLM كعقل وLLM لاتخاذ القرارات من أجل خطوات أرخص وأسرع. Microduck،…</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
- [التوجيه وضوابط الحماية والموافقات](#التوجيه-وضوابط-الحماية-والموافقات) — **54**
...
<sub>🔧 وُجد مستخدمًا في الشيفرة: `docs/adr/0043-decision-llms-are-a-wire-format-and-a-data-row.md`</sub>
...
- [keltokhy/jlink](https://github.com/keltokhy/jlink) - ربط السجلات للاقتصاديين: اكتب قاعدة المطابقة بالإنجليزية البسيطة، واحصل على…
...
<details>
<summary><b>المزيد في هذه الفئة</b> <sub>· 221</sub></summary>
...
- [ronadin2002/jev-cua](https://github.com/ronadin2002/jev-cua) - التحكم الصوتي والنصي في macOS. شريط عائم واحد، واختيار حي لإجراءات واجهة UI…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/hfnissum-byte--hunkpick/21c4c5bad7854d6e.gif" width="100%" alt="hfnissum-byte/Hunkpick animation"><br><sub>تسجيل متحرك</sub></td>
</tr></table>
...
- [backmeupplz/jev_antispam_bot](https://github.com/backmeupplz/jev_antispam_bot) - روبوت Telegram بسيط لمكافحة الرسائل المزعجة باستخدام grammY، مدعوم بـ TypeSafe…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/yinsongxu--llm2jev/9b0b042b0dfa87b7.gif" width="100%" alt="Yinsongxu/LLM2Jev animation"><br><sub>تسجيل متحرك · <a href="https://raw.githubusercontent.com/Yinsongxu/LLM2Jev/main/assets/mujoco.mp4">افتح الفيديو</a></sub></td>
</tr></table>
...
- [yushen100/wechat-jev-assistant](https://github.com/yushen100/wechat-jev-assistant) - مساعد تحليل محادثات 微信 من Windows: قراءة محلية، وإزالة البيانات الحساسة، وأحكام…
...
- [phyous/tsai-sc](https://github.com/phyous/tsai-sc) - يتحكم TypeSafe Jev في نسخة StarCraft shareware الأصلية عبر لوحة المفاتيح…
...
<sub>أُنشئ بواسطة · `render.py` · 2026-09-23T09:31:07+08:00</sub>
