...
> [!NOTE]
> **فهرس مباشر** · آخر مزامنة: `2026-09-22T18:35:35+08:00` (UTC+8)
> · المدخلات: **743** · جديد في هذه الدورة: **95** · لغات التنفيذ: **23**
...
- [عملاء وSDK ومحوّلات من المجتمع](#عملاء-وsdk-ومحولات-من-المجتمع) — **115**
- [أدوات الوكلاء: MCP والخطافات والبوابات ووكلاء البرمجة](#أدوات-الوكلاء-mcp-والخطافات-والبوابات-ووكلاء-البرمجة) — **222**
- [التوجيه وضوابط الحماية والموافقات](#التوجيه-وضوابط-الحماية-والموافقات) — **66**
- [التقييم والمعايرة والمقاييس المرجعية](#التقييم-والمعايرة-والمقاييس-المرجعية) — **71**
- [إعادة إنتاج مفتوحة وأوزان وبحوث في البنية](#إعادة-إنتاج-مفتوحة-وأوزان-وبحوث-في-البنية) — **39**
- [تطبيقات وألعاب وروبوتات وعروض تفاعلية](#تطبيقات-وألعاب-وروبوتات-وعروض-تفاعلية) — **47**
- [كتابات ونقاشات وقوائم مجاورة](#كتابات-ونقاشات-وقوائم-مجاورة) — **88**
- [مشاريع أخرى](#مشاريع-أخرى) — **88**
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/chenycl--jev-browser-skill/6f1223bb1aa99b1b.gif" width="100%" alt="ChenYCL/jev-browser-skill animation"><br><sub>تسجيل متحرك · <a href="https://raw.githubusercontent.com/ChenYCL/jev-browser-skill/main/assets/demo-wikipedia.mp4">افتح الفيديو</a></sub></td>
</tr></table>
...
<details>
<summary><b>المزيد في هذه الفئة</b> <sub>· 93</sub></summary>
...
- [BeatAPI/awesome-jev](https://github.com/BeatAPI/awesome-jev) - معرض خضعت مشاريعه المتعلقة بـ JEV لمراجعة المصادر، ويضم أكثر من 50 نجمة GitHub…
...
- [Nasrallah-AL/jev-cli](https://github.com/Nasrallah-AL/jev-cli) - أداة لسطر الأوامر لنموذج AI الخاص بـ TypeSafe Jev.
...
- [nylon-memory/NylonME](https://github.com/nylon-memory/NylonME) - محرك ذاكرة لوكلاء AI، يمكن أن يؤدي العمل مع Jev إلى دقة أعلى في اتخاذ القرارات.
...
- [doronp/jevc](https://github.com/doronp/jevc) - حوّل نثر سياسة الوكيل إلى برامج أحكام حتمية: أسئلة أدلة ضيقة للنموذج، والحكم…
...
<details>
<summary><b>المزيد في هذه الفئة</b> <sub>· 200</sub></summary>
...
- [chy4pro/jev-for-chrome](https://github.com/chy4pro/jev-for-chrome) - Jev لـ Chrome: يتحكم في علامة التبويب التي تنظر إليها باستخدام TypeSafe Jev،…
...
- [kavehmz/typesafe-playground](https://github.com/kavehmz/typesafe-playground) - تجارب تفاعلية باستخدام TypeSafe Jev، بدءًا من توجيه الدعم ووصولًا إلى محاكاة…
...
- [nibzard/decision-model-benchmark](https://github.com/nibzard/decision-model-benchmark) - اختبار معياري مستقل وقابل لإعادة الإنتاج: نموذج قرار (jev)، وثمانية LLMs…
...
بيئة تشغيل أصلية لـ MLX لنماذج القرار المكتوبة بنظام Laya — قرارات قصيرة خلال 7–14 مللي ثانية على M3 Max. لا يوجد توليد نصوص أو PyTorch أو API سحابي.
...
<details>
<summary><b>المزيد في هذه الفئة</b> <sub>· 17</sub></summary>
...
- [vtavakkoli/simple-jev](https://github.com/vtavakkoli/simple-jev) - حوّل أي نموذج مفتوح إلى مصنّف/نقطة نهاية jev.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/beingcognitive--jev-songwriter/0ed98beb60e70743.gif" width="100%" alt="beingcognitive/jev-songwriter animation"><br><sub>تسجيل متحرك</sub></td>
</tr></table>
...
- [nssmd/jev-bot](https://github.com/nssmd/jev-bot) - منضدة عمل مستضافة ذاتيًا لاتخاذ القرارات باستخدام Jev وروبوت Feishu: اختيارات…
...
- [tanxarx/awesome-jev](https://github.com/tanxarx/awesome-jev) - كل ما هو رائع والمتعلق بـ Jev.
...
ترجمة عربية لوثائق الاستخدام الرسمية لنموذج Jev (TypeSafe AI) | ترجمة صينية غير رسمية لوثائق Jev (TypeSafe AI) الرسمية — https://docs.typesafe.ai
...
<details>
<summary><b>المزيد في هذه الفئة</b> <sub>· 66</sub></summary>
...
<sub>أُنشئ بواسطة · `render.py` · 2026-09-22T18:35:35+08:00</sub>
