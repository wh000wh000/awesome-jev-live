...
> [!NOTE]
> **فهرس مباشر** · آخر مزامنة: `2026-09-25T18:10:37+08:00` (UTC+8)
> · المدخلات: **799** · جديد في هذه الدورة: **298** · لغات التنفيذ: **24**
...
- [التوجيه وضوابط الحماية والموافقات](#التوجيه-وضوابط-الحماية-والموافقات) — **58**
- [التقييم والمعايرة والمقاييس المرجعية](#التقييم-والمعايرة-والمقاييس-المرجعية) — **81**
- [إعادة إنتاج مفتوحة وأوزان وبحوث في البنية](#إعادة-إنتاج-مفتوحة-وأوزان-وبحوث-في-البنية) — **38**
- [تطبيقات وألعاب وروبوتات وعروض تفاعلية](#تطبيقات-وألعاب-وروبوتات-وعروض-تفاعلية) — **54**
- [كتابات ونقاشات وقوائم مجاورة](#كتابات-ونقاشات-وقوائم-مجاورة) — **102**
...
<sub>🔧 وُجد مستخدمًا في الشيفرة: `src/typesafe_sdk/__init__.py`</sub>
...
إطار عمل Agentic GraphRAG مستقل عن قاعدة البيانات، يستخدم نماذج System One قابلة للتبديل (Laya محلي / Jev سحابي). طبقة ذكاء قابلة للتوصيل والتشغيل، تتميز بخط أنابيب كامل من 4 مراحل واجتياز A* مخصص لأي قاعدة بيانات رسوم بيانية.
...
أكثر من 200 وصفة Jev قابلة للتوصيل والتشغيل: قرارات ذكاء اصطناعي صغيرة ومُعايرة لتوجيه النصوص وتقييمها ووضع بوابات لها ومقارنتها وتصنيفها للوكلاء وRAG والدعم ومراجعة التعليمات البرمجية والموسيقى. استورد من JavaScript أو TypeScript، أو استدعِ CLI باستخدام JSON من أي لغة.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/agencyenterprise--jev-recipes/0f08086836b893d8.gif" width="100%" alt="agencyenterprise/jev-recipes animation"><br><sub>تسجيل متحرك</sub></td>
</tr></table>
...
Java SDK مجتمعي لـ Jev، نموذج System One الخاص بـ TypeSafe: أسئلة مكتوبة الأنواع ومدخلات، وإجابات مكتوبة الأنواع مع احتمالات مُعايرة كمخرجات. Java 17+، وبدء تشغيل Spring Boot (غير رسمي)
...
CLI واحد لجميع روبوتاتك. صِلها، وأصدر أوامرك إليها، ودعها تعمل معًا، بحيث يمتلك كل منها LLM كدماغ (Claude أو OpenAI أو Gemini أو Grok أو محليًا عبر Ollama أو vLLM) وLLM قرار للاختيار من متعدد (Jev أو Laya أو Kev). يشغّل Microduck وOpen Duck Mini وLeRobot وXLeRobot وAlohaMini وToddlerBot أو أي قاعدة ROS 2، من حاسوب محمول، خارج اللوحة.
...
CLI يختار Cursor أو Claude Code أو Codex أو OpenCode + النموذج/الجهد لمهمة ما، ثم يطلقه. يعمل بدعم من Jev وHerdr
...
<details>
<summary><b>المزيد في هذه الفئة</b> <sub>· 111</sub></summary>
...
- [keltokhy/jsort](https://github.com/keltokhy/jsort) - الفرز حسب المعنى: رتّب الأسطر على بُعد مكتوب بالإنجليزية البسيطة، انطلاقًا من…
- [chengyongru/fastjev](https://github.com/chengyongru/fastjev) - شوكة SemIf مستقلة الصيانة، تضع SDK أولًا، لاتخاذ قرارات دلالية سريعة ومستضافة…
- [Ray-Hughes/jevalyn](https://github.com/Ray-Hughes/jevalyn) - طبقة اتخاذ القرار لتطبيق Rails الخاص بك.
- [CheshiAI/Cheshi](https://github.com/CheshiAI/Cheshi) - ذاكرة محادثات مدعومة بـ Jev: اعثر على الجلسات السابقة وأعد زيارة القرارات مع…
- [evoke-build/evoke](https://github.com/evoke-build/evoke) - البرمجيات، بالانعكاس. قلها، وسيعمل البرنامج الصغير المناسب: يختاره مصنف مُعاير،…
- [utk2103/jev-studio](https://github.com/utk2103/jev-studio) - إذا كنت تجرّب jev فسيكون الأمر أسهل من هنا.
...
تجارب محرك البحث على مجموعات TREC. يركّز حاليًا على تطبيقات إعادة الترتيب دون أمثلة باستخدام نموذج JEV الخاص بـ typesafe.ai
...
بديل محلي مفتوح المصدر لـ Jev: قرارات وكيل المتصفح باستخدام Laya (نموذج System One) على جهازك. لا سحابة ولا مفتاح API. متوافق مع Playwright/CDP وMCP.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/mansicer--jev-plays/c4f1ec41afcb4ae9.gif" width="100%" alt="mansicer/jev-plays animation"><br><sub>تسجيل متحرك</sub></td>
</tr></table>
...
- [browser-use/jev-ultrafast](https://github.com/browser-use/jev-ultrafast) - وكيل ويب هو الأسرع والأرخص.
...
- [kydlikebtc/awesome-jev](https://github.com/kydlikebtc/awesome-jev) - 1207 موردًا عامًا لـ Jev، ونموذج قرار System One الخاص بـ TypeSafe AI، مفهرسة…
...
- [walidboulanouar/awesome-jev-use-cases](https://github.com/walidboulanouar/awesome-jev-use-cases) - قائمة رائعة بحالات استخدام TypeSafe AI Jev: 74 عرضًا تجريبيًا مرتبة حسب…
...
- [supercorp-ai/supercov](https://github.com/supercorp-ai/supercov) - التغطية والأمان وجودة التعليمات البرمجية لوكلاء البرمجة.
...
- [angel291592/Intent-Router](https://github.com/angel291592/Intent-Router) - مترجم النوايا لوكلاء الذكاء الاصطناعي — يحوّل الطلبات الغامضة إلى عقود…
- [socai-io/jev-social](https://github.com/socai-io/jev-social) - مهارة وكيل مفتوحة المصدر وعرض تجريبي محلي: Jev × socai لأبحاث Instagram وTikTok…
...
- [OmniJev/PlayJev](https://github.com/OmniJev/PlayJev) - 🚀🚀 نموذج متعدد الوسائط شبيه بـ JEV بحجم 0.8B، يشغّل ألعاب GUI مباشرة من وحدات…
- [jonathanavis96/jev-kit](https://github.com/jonathanavis96/jev-kit) - كل ما تحتاجه لتشغيل Jev الخاص بـ TypeSafe باستخدام Claude Code: حارس استدعاءات…
- [PyModel/jev-judge-mcp](https://github.com/PyModel/jev-judge-mcp) - أدوات أحكام مكتوبة الأنواع لوكلاء MCP.
...
- [khordoo/jev-reflex-autonomy-lab](https://github.com/khordoo/jev-reflex-autonomy-lab) - محاكاة لاستقلالية سرب طائرات مسيّرة آنية باستخدام Jev لاتخاذ قرارات انعكاسية…
...
- [bgivenb/flick-computer-use](https://github.com/bgivenb/flick-computer-use) - استخدام سريع للمتصفح والحاسوب عبر macOS لوكلاء MCP.
...
- [24601/Augustus](https://github.com/24601/Augustus) - مهارة وكيل للعثور على أنظمة نماذج القرار وبنائها وتقييمها وتحسينها.
...
- [inso1337/revl](https://github.com/inso1337/revl) - لغة للتركيب الآمن والعالمي المكاني-الزماني (نموذج Cordis) والتنسيق.
- [AskTheWay/dsh-jev-interceptor](https://github.com/AskTheWay/dsh-jev-interceptor) - ⚡ حكم النظام 1 في غضون ميلي ثانية لكل استدعاء أداة في DeepSeek Harness — تصنيف…
...
بوابة فرز مخاطر آنية لإيداعات وسحوبات منصات التداول — يتولى Jev (TypeSafe System One) الفرز فقط؛ بينما يبقى الفصل في التعليمات البرمجية الحتمية.
...
تحكم في قبول الأحكام المكتوبة الأنواع عند حافة حركة المرور: مرشح من ثلاث طبقات لحقن التعليمات وإساءة الاستخدام في nginx/OpenResty، مدعوم بـ TypeSafe Jev. يفشل بالفتح، ومخزّن مؤقتًا، وقابل لإعادة التحميل الفوري.
...
ارسم على لوحة tldraw باستخدام صوتك وإصبع يشير. Jev (TypeSafe System One) يحدد الإجراء والهدف والمكان في ~350 ms لكل كلمة منطوقة.
...
- [Trystan-SA/laya-candle](https://github.com/Trystan-SA/laya-candle) - منفذ شبيه بـ JEV لـRust باستخدام Laya، محلي 100%، من دون Python.
...
JevK5: بديل ذو أوزان مفتوحة لـ TypeSafe Jev. قرارات مكتوبة الأنواع مع احتمالات في تمريرة أمامية واحدة؛ أوزان وتعليمات برمجية Apache-2.0.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/allebee--jevk5/1f9cd6cb325d4bd4.gif" width="100%" alt="allebee/jevk5 animation"><br><sub>تسجيل متحرك · <a href="https://raw.githubusercontent.com/allebee/jevk5/main/docs/demo/jevk5-nvidia-demo.mp4">افتح الفيديو</a></sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/weitianxin--jevany/711125367b6758ff.gif" width="100%" alt="weitianxin/JevAny animation"><br><sub>تسجيل متحرك</sub></td>
</tr></table>
...
نموذج صغير شبيه بـ jev يجيب عن أسئلة Choice وScore وNoul في تمريرة أمامية واحدة ويعيد احتمالات مُعايرة. MLX أو PyTorch، يعمل بالكامل دون اتصال، ومتوافق مع System One.
...
<details>
<summary><b>المزيد في هذه الفئة</b> <sub>· 63</sub></summary>
...
- [Eliot5566/JEV-Paper-Radar](https://github.com/Eliot5566/JEV-Paper-Radar) - دع Jev يقرأ كل ورقة جديدة على arXiv كل صباح ويعرض لك القليل الذي ينبغي أن…
...
- [fstandhartinger/jevbench](https://github.com/fstandhartinger/jevbench) - JevBench v1 - معيار قياس لنماذج القرار المtypated من فئة Jev: ذكية، رخيصة،…
...
قرارات مكتوبة الأنواع من حالة غير منظمة: تمريرة أمامية واحدة، ومن دون نص مُولّد. محلي وحتمي ومتوافق مع Jev. غير تابع لـ typesafe.ai.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/antonellof--laya-vs-dijkstra/b61bc3a8e3d368be.gif" width="100%" alt="antonellof/laya-vs-dijkstra animation"><br><sub>تسجيل متحرك</sub></td>
</tr></table>
...
Semantic ifs من نماذج مفتوحة، على جهاز 3090 في المنزل. مستقل؛ وغير تابع لـ Jev أو TypeSafe.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/theoleecj--semif-openjev/0504149cd9ef3cad.gif" width="100%" alt="TheoLeeCJ/SemIf-OpenJev animation"><br><sub>تسجيل متحرك</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/zadescoxp--jev-trades/2abea899d779de55.gif" width="100%" alt="zadescoxp/Jev-Trades animation"><br><sub>تسجيل متحرك</sub></td>
</tr></table>
...
- [heyjunpenn/awesome-jev](https://github.com/heyjunpenn/awesome-jev) - دليل موثّق تديره المجتمعات يضم 916 مشروعًا مفتوح المصدر مبنيًا باستخدام Jev.
...
- [NanmiCoder/jev-arena](https://github.com/NanmiCoder/jev-arena) - مقدمة واختبار فعلي لنموذج Jev: تحويل اللغة الطبيعية عبر Choice / Score / Noul…
...
عائلة نماذج قرارات شبيهة بـ Jev مبنية على Qwen3.5/3.8، يمكنك تدريبها وتشغيلها بنفسك
...
درّب نموذجًا متعدد الوسائط شبيهًا بـ Jev بنفسك. System One Model، الآن مع الرؤية.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/liuziyu77--valen/d4fa3bf5c399a28d.gif" width="100%" alt="Liuziyu77/Valen animation"><br><sub>تسجيل متحرك</sub></td>
</tr></table>
...
System One Model مفتوح المصدر وعالي الأداء لاتخاذ قرارات مُنَمَّطة بمرور واحد، مع بيئة تشغيل C قابلة للتضمين ودعم WebAssembly.
...
بديل محلي متوافق مع API لـ Jev، نموذج System One الخاص بـ TypeSafe
...
TypeLLM: LLMs مع توليد آمن من ناحية الأنواع
...
- [alvarobartt/sys1](https://github.com/alvarobartt/sys1) - API متوافق مع System One لنماذج القرارات المفتوحة، مكتوب بلغة Rust.
...
- [HITsz-TMG/JevEmbed](https://github.com/HITsz-TMG/JevEmbed) - تعرّف إلى JevEmbed — حوّل التضمينات إلى قرارات.
...
<sub>أُنشئ بواسطة · `render.py` · 2026-09-25T18:10:37+08:00</sub>
