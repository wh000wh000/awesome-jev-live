...
> [!NOTE]
> **Indeks langsung** · Sinkronisasi terakhir: `2026-09-20T12:04:41+08:00` (UTC+8)
> · Entri: **592** · Baru pada siklus ini: **69** · Bahasa implementasi: **22**
...
- [Klien, SDK, dan adapter komunitas](#klien-sdk-dan-adapter-komunitas) — **94**
- [Perkakas agen: MCP, hook, gate, dan agen pengkodean](#perkakas-agen-mcp-hook-gate-dan-agen-pengkodean) — **176**
- [Perutean, guardrail, dan persetujuan](#perutean-guardrail-dan-persetujuan) — **70**
- [Evaluasi, kalibrasi, dan benchmark](#evaluasi-kalibrasi-dan-benchmark) — **55**
...
- [heyman333/jev-router](https://github.com/heyman333/jev-router) - 프롬프트를 jev로 판단해 알맞은 모델을 고르는 Claude Code / Codex 스킬. 의존성 0개, 능력치는 공개 벤치마크 출처 명시.
...
- [maraichr/jev-triage](https://github.com/maraichr/jev-triage) - Cross-border B2B case triage prototype using TypeSafe Jev via OpenRouter.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/Chunky83/jev-workbench/main/docs/assets/jev-welcome.gif" width="100%" alt="Chunky83/jev-workbench animation"><br><sub>rekaman bergerak</sub></td>
</tr></table>
...
OpenAPI compatibility checks powered by TypeSafe AI’s System One model, JEV—combining structural diffing with semantic contract analysis.
...
Analisis kritis dan rencana penerapan Jev dalam keputusan terstruktur
...
- [inematds/jev-curso](https://github.com/inematds/jev-curso) - Rencana pedagogis kursus Jev: tiga jalur, dua belas modul, dan tiga puluh enam.
...
<sub>Dibuat oleh · `render.py` · 2026-09-20T12:04:41+08:00</sub>
