...
> [!NOTE]
> **Canlı dizin** · Son eşitleme: `2026-09-27T01:21:54+08:00` (UTC+8)
> · Kayıt: **811** · Bu turda yeni: **103** · Uygulama dilleri: **25**
...
- [Topluluk istemcileri, SDK'lar ve bağdaştırıcılar](#topluluk-istemcileri-sdklar-ve-bağdaştırıcılar) — **134**
...
TypeSafe Jev tarafından desteklenen ücretsiz Rust SEO ve GEO araç seti: 58 kural denetimi, site taramaları, AI alıntı kontrolleri, sıralama değişimleri, CI kapıları, 15 araçlı MCP. Maliyeti sıfır.
...
- [nexibeo/jev-cookbook](https://github.com/nexibeo/jev-cookbook) - OpenRouter üzerindeki TypeSafe.
...
- [9pings/notjev](https://github.com/9pings/notjev) - Jev gibi süper hızlı sunucu; modelden bağımsız, herhangi bir OpenAI uyumlu uç…
...
- [wojciechwiesner/jit-context](https://github.com/wojciechwiesner/jit-context) - Mimari Hendek: JIT-JEV Context OS — AI aracıları için epistemik çalışma zamanı…
...
Herhangi bir LLM öğesini Jev tarzı bir karar modeline dönüştürün: tür belirtilmiş kararlar, gerçek olasılıklar, eğitim yok. (güncellemeleri sürdürün, her türlü issue ve PR talebine açığız)
...
- [AIAnytime/jev-crash-course](https://github.com/AIAnytime/jev-crash-course) - Metin yazmak yerine kararlar veren bir model olan Jev.
...
<sub>Oluşturan · `render.py` · 2026-09-27T01:21:54+08:00</sub>
