...
> [!NOTE]
> **Canlı dizin** · Son eşitleme: `2026-09-23T17:45:55+08:00` (UTC+8)
> · Kayıt: **778** · Bu turda yeni: **111** · Uygulama dilleri: **23**
...
<sub>Örüntü olarak yazamayacağınız sorular için grep. Birkaçını örneklemek yerine her işlevi okur. Jev, TypeSafe AI&#x27;ın System One modeli tarafından desteklenir.</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
- [Ajan araçları: MCP, kancalar, geçitler ve kodlama ajanları](#ajan-araçları-mcp-kancalar-geçitler-ve-kodlama-ajanları) — **239**
- [Yönlendirme, koruma kuralları ve onaylar](#yönlendirme-koruma-kuralları-ve-onaylar) — **55**
...
- [Uygulamalar, oyunlar, robotik ve etkileşimli demolar](#uygulamalar-oyunlar-robotik-ve-etkileşimli-demolar) — **48**
- [Yazılar, tartışmalar ve kardeş listeler](#yazılar-tartışmalar-ve-kardeş-listeler) — **96**
- [Diğer projeler](#diğer-projeler) — **84**
...
<sub>🔧 Kodda kullanıldığı tespit edildi: `src/typesafe_sdk/__init__.py`, `src/typesafe_sdk/_core/retry.py`, `src/typesafe_sdk/_core/config.py`</sub>
...
TypeSafe AI'ın Jev'i için özel bir kodlama harness'i: bir LLM önerilerde bulunur, Jev dar soruları yanıtlar, kararı kod verir ve her adım bir makbuz bırakır.
...
ConvAI Innovations' OSS Laya sistemi tek modelini saran bir Elixir kitaplığı
...
Örüntü olarak yazamayacağınız sorular için grep. Birkaçını örneklemek yerine her işlevi okur. Jev, TypeSafe AI'ın System One modeli tarafından desteklenir.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/clouatre-labs--decisions-judge-mcp/c8c00f2b58774857.gif" width="100%" alt="clouatre-labs/decisions-judge-mcp animation"><br><sub>hareketli kayıt</sub></td>
</tr></table>
...
Tüm robotlarınız için tek bir CLI. Onları bağlayın, yönetin ve birlikte çalışmalarını sağlayın; her birinde beyin olarak bir LLM (Claude, OpenAI, Gemini, Grok veya Ollama ya da vLLM üzerinden yerel) ve daha ucuz ve hızlı adımlar için bir karar LLM'ı (Jev, Laya ve Kev) bulunur. Microduck, Open Duck Mini, LeRobot, XLeRobot, AlohaMini, ToddlerBot, Jetson veya herhangi bir ROS'u destekler.
...
Apple'ın Core AI teknolojisiyle iPhone ve Mac üzerinde sohbet, görüntü ve konuşma modellerini çalıştırmak için Swift SDK. Model indirme ve önbelleğe alma, FoundationModels entegrasyonu ve belgelenmiş işletim sistemi, SDK ve model gereksinimleriyle çalıştırılabilir örnekler.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/john-rocky--coreai-kit/c98c7bb8cb04e76e.gif" width="100%" alt="john-rocky/coreai-kit animation"><br><sub>hareketli kayıt</sub></td>
</tr></table>
...
jev-seo: kodlama ajanları için Rust SEO ve GEO CLI ile MCP sunucusu: 50 kural denetimi, canlı taramalar, GEO puanları, sıralama değişimi, CI kapıları. MIT, abonelik yok.
...
Salt okunur işlem günlüğü ve inceleme düzeneği: Jev tür belirtilmiş yargılar, aracı entegrasyonu ve yeniden üretilebilir bir finans kıyaslaması. Emir yok, tavsiye yok.
...
Metin dosyaları için Jev destekli, kural tabanlı değerlendirici. Her kuralı her satıra paralel olarak uygular. Gözden kaçırma yok, atlanan satır yok.
...
Hızlı, kendi kendine barındırılan semantik kararlar için SDK öncelikli, bağımsız olarak sürdürülen SemIf fork'u.
...
<details>
<summary><b>Bu kategoride daha fazla</b> <sub>· 108</sub></summary>
...
- [AkashPriyadarshii/jev-curate](https://github.com/AkashPriyadarshii/jev-curate) - TypeSafe Jev için yüksek aktarım hızlı sentetik ve ön eğitim veri kümesi…
...
- [9pings/notjev](https://github.com/9pings/notjev) - Her OpenAI uyumlu uç noktayla çalışan, modelden bağımsız, Jev benzeri süper…
...
- [bladedevoff/stuntd](https://github.com/bladedevoff/stuntd) - Uygulamanızın tipli LLM kararlarını öğrenen ve bunları Laya başlığıyla…
- [tumf/jev-cli](https://github.com/tumf/jev-cli) - TypeSafe Jev için küçük, bağımlılıksız CLI.
- [talmago/fast_gliner](https://github.com/talmago/fast_gliner) - Python ile yazılmış GLiNER modelleri için çıkarım motoru bağlamaları, Rust.
- [frostney/clean-code-review](https://github.com/frostney/clean-code-review) - Bir çekme isteğindeki her kod dosyası, TypeSafe&#x27;ın Jev&#x27;i tarafından Uncle…
- [Qew7/jev-feels](https://github.com/Qew7/jev-feels) - Jev tarafından desteklenen sıradan Ruby olarak anlamsal kararlar #feels?
...
- [tontoko/jev-browser](https://github.com/tontoko/jev-browser) - Tek bir temellendirilmiş Jev/Playwright çekirdeği: tür belirtilmiş SDK, kalıcı…
...
- [vercel-labs/jev-ai-sdk-form-router](https://github.com/vercel-labs/jev-ai-sdk-form-router) - Form gönderimlerini Jev ve yapay zekâ SDK ile doğru kişilere yönlendirin.
- [ansidium/jev-codex-bridge](https://github.com/ansidium/jev-codex-bridge) - Codex Desktop ve CLI için model ve akıl yürütme yönlendirmesi;
- [mountainMath/JevR](https://github.com/mountainMath/JevR) - TypeSafe Jev System One API için R istemcisi.
- [shinpr/jev-reranker](https://github.com/shinpr/jev-reranker) - TypeSafe AI&#x27;in Jev&#x27;siyle JSON arama sonuçlarını yeniden sıralayın, filtreleyin…
...
- [kitfunso/hippo-memory](https://github.com/kitfunso/hippo-memory) - AI ajanları için biyolojik esinli bellek.
...
- [nylon-memory/NylonME](https://github.com/nylon-memory/NylonME) - Yapay zekâ aracıları için bir Bellek Motoru.
...
Karar-modeli sistemlerini bulma, oluşturma, değerlendirme ve iyileştirme için etmen becerisi. Software 3.0 için bileşimsel karar hesabı, değerlendirme donanımları ve sınırlı istem/program tepe tırmanışı. TypeSafe Jev varsayılan barındırılan örnektir. TypeSafe'den bağımsızdır.
...
<td align="center" valign="top"><a href="https://youtu.be/ZC4oge4WsCQ"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/24601--augustus/d2593af47d538d33.jpg" width="100%" alt="video"></a><br><sub><a href="https://youtu.be/ZC4oge4WsCQ">İzleme yeri youtu.be</a> · oynatma kaynak sitede açılır; GitHub bunu satır içi gömemez</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/storm-software--mindctl/69298c40a77b7be5.gif" width="100%" alt="storm-software/mindctl animation"><br><sub>hareketli kayıt</sub></td>
</tr></table>
...
Telefona yüklenen diyalog yardımcı pilotu: WeChat / QQ / X / 飞书 içindeki karşı tarafı anlayıp aday yanıtlar sunar, tek tıklamayla giriş alanına yerleştirir; gönderip göndermemek size kalır. Müdahaleci değildir; yalnızca ekranı okur, hook kullanmaz ve paketi değiştirmez.
...
<details>
<summary><b>Bu kategoride daha fazla</b> <sub>· 217</sub></summary>

- [ChenneyZhuang/laya-browser-agent](https://github.com/ChenneyZhuang/laya-browser-agent) - Yerel, açık kaynaklı Jev alternatifi: kendi makinenizde Laya.
...
- [kydlikebtc/awesome-jev](https://github.com/kydlikebtc/awesome-jev) - Jev için doğrulanmış 805 örnek — TypeSafe AI.
- [Amal-David/awesome-jev](https://github.com/Amal-David/awesome-jev) - Jev demoları, projeleri, SDKs ve becerileri;
- [RomanSlack/jev-drone](https://github.com/RomanSlack/jev-drone) - MuJoCo&#x27;da, döngü içinde 2,5 Hz&#x27;de küçük bir yargı modeli (TypeSafe Jev) bulunan…
...
- [Alex314618-create/JevRev](https://github.com/Alex314618-create/JevRev) - Bir LLM + Jev iş akışı. İçine bir omurga ekleyerek omurgalı beyninizi…
...
- [socai-io/jev-social](https://github.com/socai-io/jev-social) - Jev destekli Instagram, TikTok ve LinkedIn araştırması: tür belirtilmiş…
...
- [PromptEngineer48/laya-vs-jev-arena](https://github.com/PromptEngineer48/laya-vs-jev-arena) - Laya (açık kaynaklı, yerel) ile TypeSafe Jev (API) karşı karşıya: iki AI modeli…
...
- [ThinkFlowLab/system1-agents](https://github.com/ThinkFlowLab/system1-agents) - Aracılar için beyin görevi gören System 1 karar modelleri (Jev, Laya, Cua-S1)…
...
- [jiawei686/jev-ultrafast-mcp](https://github.com/jiawei686/jev-ultrafast-mcp) - Tarayıcı işini devredin: bir karar modelinin ajansınız için sayfayı yönettiği…
...
- [Bodila51/muse-jev-playbook](https://github.com/Bodila51/muse-jev-playbook) - Muse için Jev karar katmanı: pahalı ajan çalışmasından önce hızlı ve ucuz bir…
...
- [rashedInt32/jev-mcp](https://github.com/rashedInt32/jev-mcp) - TypeSafe Jev.
- [ZephyrDeng/ego-jev](https://github.com/ZephyrDeng/ego-jev) - ego-browser için Jev (TypeSafe System One) iç döngüsü — bir LLM turu yerine her…
- [green-dalii/pi-shift-router](https://github.com/green-dalii/pi-shift-router) - Pi kodlama aracısı için tur başına model yönlendirme: küçük bir değerlendirici…
- [ismaelsoilet/jev-harness](https://github.com/ismaelsoilet/jev-harness) - Sıfır bağımlılıklı System One karar düzeneği: önemsiz hatalarda ve çıkmaz…
...
- [jiangkoumo/ego-jev](https://github.com/jiangkoumo/ego-jev) - ego lite tarayıcısını Jev (TypeSafe System One) ile yönetin: girişte tek bir…
...
- [itsmostafa/typesafe-mcp](https://github.com/itsmostafa/typesafe-mcp) - Her şeyi hızlı ve ucuza değerlendirmek için bir mcp bağlayıcısı.
...
Otokorelasyonsuz Sistem 1 karar motoru. Tek bir ileri geçişte, 100'den fazla dilde, her türlü metin üzerinde tür belirtilmiş seçim, puan ve evet/hayır kararları; her istek için doğru kontrol noktasını seçen bir yönlendiriciyle.

<sub>🔧 Kodda kullanıldığı tespit edildi: `research/benchmarks/feishu_zh/run.py`</sub>
...
Jev, TypeSafe'ın System One modeli; herhangi bir OpenRouter LLM'ına, Stockfish'e ve size karşı satranç oynar. Canlı hamleler, Jev'ın hamle olasılıkları, kaydedilmiş oyunlar ve galibiyet oranlarını içeren tek sayfalık web uygulaması.
...
Eğitilmiş politikası olmayan bir Clash Royale botu: Jev (TypeSafe System One) her kararı canlı oyun durumundan verir
...
Yapay zekâ değerlendirmeleri için bir doğrulama katmanı. Yalnızca puanı değil, değerlendirme aracını da kontrol eder: verileri, puanlayıcıyı, çalıştırmaları, sayıları, iddiaları ve kendisini.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/arpit-khandelwal--jev-linkedin-slop-filter/2ba80db1b4af936f.gif" width="100%" alt="Arpit-Khandelwal/jev-linkedin-slop-filter animation"><br><sub>hareketli kayıt</sub></td>
</tr></table>
...
- [jagsan-cyber/reflex-gate](https://github.com/jagsan-cyber/reflex-gate) - Yerel Jev / System One uyumlu ağ geçidi — TypeSafe.
...
Herhangi bir LLM'ı Jev tarzı bir karar modeline dönüştürün: türü belirlenmiş kararlar, gerçek olasılıklar, eğitim yok. (güncellenmeye devam ediyor)
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/nokia-applied-research--anyjev/93e61c3de618cc36.gif" width="100%" alt="nokia-applied-research/AnyJev animation"><br><sub>hareketli kayıt</sub></td>
</tr></table>
...
Jev tarzı karar modelleri için açık bir eğitim ve çıkarım yığını. Modelleri, paylaşılan bir önekten dinamik aday dallarını puanlayacak şekilde eğitin; yüksek kardinaliteli seçim, kalibrasyon ve hızlı toplu çıkarım desteği sunar.
...
Uyarlanabilir karar sistemleri için kalibrasyon farkındalığına sahip pekiştirmeli öğrenme
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/weitianxin--jevany/05825e369317a429.gif" width="100%" alt="weitianxin/JevAny animation"><br><sub>hareketli kayıt</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/ankit-aglawe--tinyjev/bff87199840daa0f.gif" width="100%" alt="ankit-aglawe/tinyjev animation"><br><sub>hareketli kayıt</sub></td>
</tr></table>
...
- [ARCJ137442/jev-2048](https://github.com/ARCJ137442/jev-2048) - Her hamlenin bir Jev (TypeSafe AI System One) Choice olduğu, enstrümante…
...
<table><tr><th align="center" width="50%">🖼 Görsel</th><th align="center" width="50%">🎬 Video</th></tr><tr>
<td align="center" valign="top"><sub>medya yayımlanmamış</sub></td>
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/wfzyx--von/7f8d6b27c0d2e176.gif" width="100%" alt="wfzyx/von animation"><br><sub>hareketli kayıt</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/fbddcz--embodied-jev/297ef7c24f9a67a8.gif" width="100%" alt="FBddcz/embodied-jev animation"><br><sub>hareketli kayıt · <a href="https://raw.githubusercontent.com/FBddcz/embodied-jev/main/docs/media/libero-drawer-comparison.mp4">Videoyu aç</a></sub></td>
</tr></table>
...
TypeSafe'ın Jev API ile uyumlu, yerel ve çevrimdışı bir System One sunucusu. Küçük açık modellerle tür belirtilmiş evet/hayır, kategori ve puan sorularını yanıtlar.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/bl888m/jev-bot/main/assets/demo.gif" width="100%" alt="bl888m/jev-bot animation"><br><sub>hareketli kayıt</sub></td>
</tr></table>
...
<details>
<summary><b>Bu kategoride daha fazla</b> <sub>· 19</sub></summary>
...
- [zhihz/openjev](https://github.com/zhihz/openjev) - Bağlam, sorular ve aday yanıtlardan yerel iki dilli olasılık kararları.
...
İnsanların Jev, TypeSafe'ın System One modeliyle oluşturduklarının en kapsamlı galerisi: senaryolara göre düzenlenmiş 3.400'den fazla proje, demo ve yazı; her birinde özgün bağlantısı, görseli ve açıklaması bulunur.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/darthblanc/tictacjev/main/assets/screenrecording.gif" width="100%" alt="darthblanc/tictacjev animation"><br><sub>hareketli kayıt</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/michaelpersonal--jev-trade-cc/b3ae9a36cc9fcbbf.gif" width="100%" alt="michaelpersonal/jev-trade-cc animation"><br><sub>hareketli kayıt</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/surbhit20/jev-plays-snake/main/jev-plays-snake.gif" width="100%" alt="surbhit20/jev-plays-snake animation"><br><sub>hareketli kayıt</sub></td>
</tr></table>
...
<details>
<summary><b>Bu kategoride daha fazla</b> <sub>· 26</sub></summary>
...
- [heyjunpenn/awesome-jev](https://github.com/heyjunpenn/awesome-jev) - Jev ile oluşturulmuş 832 açık kaynak projesinden oluşan doğrulanmış, topluluk…
...
- [jaibhasin/jev-yt-time-saver](https://github.com/jaibhasin/jev-yt-time-saver) - Dikkat dağıtıcı YouTube videolarını Jev ile kapatan bir Chrome uzantısı.
...
- [Show HN: Will Jev pull the lever in the trolley problem?](https://news.ycombinator.com/item?id=49773756) - Hepinizin beklediği Jev benchmark.
- [Inventor of ChatGPT and RLHF Launches Typesafe.ai](https://news.ycombinator.com/item?id=49763045)
- [Show HN: Agent Chaperone – Screen AI agent tool calls and results with Jev](https://news.ycombinator.com/item?id=49789538) - Herkese merhaba. TypeSafe geçen hafta Jev yayınladı ve bu beni…
...
typesafe.ai kayıt oluşturucu, en üst düzey optimizasyon, sınırsız jev
...
微信（Windows 4.x）yanında çalışan yanıt yardımcısı: pencere ekran görüntüsü + yerel çevrimdışı OCR karşı tarafın mesajlarını okur → Jev amacı belirler → 3 aday yanıt tek tıklamayla doldurulur, gönderme işlemi her zaman manuel
...
微信 mesaj amacı tanıma yüzen penceresi（macOS）：ekranı görüntüler + yerel küçük model amacı ve riski belirler, ardından üsluba göre yanıt adayları oluşturur. Tamamen salt okunur, 微信 içine enjeksiyon yapmaz.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/jev-chat--jev-chat-jarvis-mac/daa9ab5c1715d764.gif" width="100%" alt="jev-chat/jev-chat-jarvis-mac animation"><br><sub>hareketli kayıt</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/zefan-cai--open-jev/f6f2903828782e64.gif" width="100%" alt="Zefan-Cai/Open-Jev animation"><br><sub>hareketli kayıt · <a href="https://zefan-cai.github.io/open-jev/v1-1/replay.mp4">Videoyu aç</a></sub></td>
</tr></table>
...
LLM tarafından yazılmış, göreve özgü Jev koşumları; isteğe bağlı tam yörünge ödül yansıtması ve GEPA evrimiyle.
...
DeepSeek + TypeSafe JEV 微信 yanıt asistanı: Windows kararlı sürümü, Apple Silicon macOS önizleme sürümü; yerel OCR ve insan kontrollü yanıtlar
...
<details>
<summary><b>Bu kategoride daha fazla</b> <sub>· 62</sub></summary>
...
<sub>Oluşturan · `render.py` · 2026-09-23T17:45:55+08:00</sub>
