...
> [!NOTE]
> **Canlı dizin** · Son eşitleme: `2026-09-26T03:12:11+08:00` (UTC+8)
> · Kayıt: **806** · Bu turda yeni: **123** · Uygulama dilleri: **23**
...
- [Yönlendirme, koruma kuralları ve onaylar](#yönlendirme-koruma-kuralları-ve-onaylar) — **61**
...
- [Yazılar, tartışmalar ve kardeş listeler](#yazılar-tartışmalar-ve-kardeş-listeler) — **104**
...
Tüm robotlarınız için tek bir CLI. Onları bağlayın, komut verin ve birlikte çalışmalarını sağlayın; her birinin beyin olarak bir LLM'i (Claude, OpenAI, Gemini, Grok veya Ollama ya da vLLM aracılığıyla yerel) ve çoktan seçmeli sorular için bir karar LLM'sı (Jev, Laya, Kev) olsun. Microduck, Open Duck Mini, LeRobot, XLeRobot, AlohaMini, ToddlerBot, LeRobot veya bir dizüstü bilgisayardan, harici olarak herhangi bir ROS 2 tabanını çalıştırır.
...
- [topherchris420/james_library](https://github.com/topherchris420/james_library) - R.A.I.N. Lab; hızlı yerel yargıyı, bağımsız olasılıksal değerlendirmeyi, çok…
...
- [bladedevoff/stuntd](https://github.com/bladedevoff/stuntd) - Uygulamanızın yazılmış LLM kararlarını öğrenen ve bunları bir Laya başlığıyla…
- [myc0576/SmartMoney-Cub](https://github.com/myc0576/SmartMoney-Cub) - Salt okunur işlem günlüğü ve inceleme düzeneği: Jev türündeki yargılar, aracı…
...
- [6Mikao9/jev-native-agent-with-extended-options](https://github.com/6Mikao9/jev-native-agent-with-extended-options) - Jev-native bir aracı sistemi için araştırma tasarımı: sanallaştırma ve…
...
- [carldaws/hunch](https://github.com/carldaws/hunch) - Ruby ve Rails için olasılıksal kontrol akışı — TypeSafe.
...
- [MiaoWuNYA/rikkahub-sillytavern-android](https://github.com/MiaoWuNYA/rikkahub-sillytavern-android) - Android AI sohbet istemcisi: Tavern kartlarını kayıpsız içe aktarma, kullanımı…
...
✨ Tüm ajanlarınız ve çalışma alanlarınız, sahip olduğunuz her cihazda tek bir yerde. Görevleri masaüstünden, mobilden, tarayıcıdan veya API üzerinden erişilebilen bir panoda takip edin. Kendi sunucunuzda barındırın.
...
<details>
<summary><b>Bu kategoride daha fazla</b> <sub>· 227</sub></summary>
...
- [erkamyaman/jev-enforce](https://github.com/erkamyaman/jev-enforce) - 📏 Claude Code eklentisi, Claude.
...
- [itsmostafa/system-one-connector](https://github.com/itsmostafa/system-one-connector) - Her şeyi hızlı ve ucuza değerlendirmek için System One MCP bağlayıcısı.
...
Açık karar modellerini yerel olarak çalıştırın: Laya, decider, NLI ve GLiClass'ı TypeSafe uyumlu bir API arkasında çekip sunun. Karar modelleri için Ollama.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/ankit-aglawe--tinyjev/dc0d701a10c37f94.gif" width="100%" alt="ankit-aglawe/tinyjev animation"><br><sub>hareketli kayıt</sub></td>
</tr></table>
...
<details>
<summary><b>Bu kategoride daha fazla</b> <sub>· 60</sub></summary>
...
- [anessbelbati/jev-rerank-bench](https://github.com/anessbelbati/jev-rerank-bench) - Bir karar modeli, amaca özel yeniden sıralayıcıları geçebilir mi? TypeSafe Jev…
...
jevos, dizüstü bilgisayarınızda çalışan, evet/hayır kararları için Jev açık kaynaklı bir alternatiftir.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/feder-cr/jev/main/assets/dino_run.gif" width="100%" alt="feder-cr/jev animation"><br><sub>hareketli kayıt</sub></td>
</tr></table>
...
<details>
<summary><b>Bu kategoride daha fazla</b> <sub>· 92</sub></summary>
...
- [Show HN: Doom or Bloom, map your AI worldview with Jev](https://news.ycombinator.com/item?id=49846953) - Birkaç soruyu yanıtlayarak AI dünya görüşünüzü haritalayın ve başkalarıyla…
...
- [HITsz-TMG/JevEmbed](https://github.com/HITsz-TMG/JevEmbed) - JevEmbed ile tanışın — embedding.
- [doeixd/discern](https://github.com/doeixd/discern) - Effect DecisionModel ve Jev için tür güvenli, belirsizlik farkındalıklı…
...
<sub>Oluşturan · `render.py` · 2026-09-26T03:12:11+08:00</sub>
