...
> [!NOTE]
> **Canlı dizin** · Son eşitleme: `2026-09-23T12:34:14+08:00` (UTC+8)
> · Kayıt: **770** · Bu turda yeni: **69** · Uygulama dilleri: **24**
...
<sub>Jev, TypeSafe&#x27;ın System One modeli; herhangi bir OpenRouter LLM&#x27;ına, Stockfish&#x27;e ve size karşı satranç oynar. Canlı hamleler, Jev&#x27;ın hamle olasılıkları, kaydedilmiş…</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
- [Ajan araçları: MCP, kancalar, geçitler ve kodlama ajanları](#ajan-araçları-mcp-kancalar-geçitler-ve-kodlama-ajanları) — **242**
- [Yönlendirme, koruma kuralları ve onaylar](#yönlendirme-koruma-kuralları-ve-onaylar) — **56**
...
- [Uygulamalar, oyunlar, robotik ve etkileşimli demolar](#uygulamalar-oyunlar-robotik-ve-etkileşimli-demolar) — **52**
...
Tüm robotlarınız için tek bir harici CLI. Onları bağlayın, yönetin ve her birinin beyin olarak bir LLM ve daha ucuz, daha hızlı adımlar için bir karar LLM ile birlikte çalışmalarını sağlayın. Microduck, Open Duck Mini, LeRobot, XLeRobot, AlohaMini, ToddlerBot veya herhangi bir ROS tabanı. Claude, OpenAI, Gemini, Grok ya da Ollama veya vLLM üzerinden yerel olarak.
...
%100 ücretsiz ₹0, ajan öncelikli SEO ve GEO CLI paketi ve DuckDuckGo ile Semrush ve OpenSEO'nun yerini alan Rust içindeki MCP sunucusu: TypeSafe Jev System One https://akashpriyadarshii.github.io/jev-seo/
...
jev ile denemeler yapıyorsanız, buradan daha kolay olacaktır
...
<details>
<summary><b>Bu kategoride daha fazla</b> <sub>· 115</sub></summary>
...
- [BeatAPI/awesome-jev](https://github.com/BeatAPI/awesome-jev) - 50+ GitHub yıldız alan JEV ile ilgili projelerden oluşan, kaynakları incelenmiş…
...
- [keltokhy/jgrep](https://github.com/keltokhy/jgrep) - grep, ancak desen bir açıklamadır. Satırları anlama göre TypeSafe.
...
- [evoke-build/evoke](https://github.com/evoke-build/evoke) - Yazılım, refleksle. Söyleyin, doğru küçük program çalışsın: kalibre edilmiş bir…
- [oswarld/notion-skills](https://github.com/oswarld/notion-skills) - Notion.
...
- [ruban-24/switchboard](https://github.com/ruban-24/switchboard) - Claude Code ve Codex için açık kaynaklı, modelden bağımsız bir karar…
...
<details>
<summary><b>Bu kategoride daha fazla</b> <sub>· 220</sub></summary>
...
- [shitianfang/jev-use](https://github.com/shitianfang/jev-use) - Claude Code / Codex / ajan adımlarını metin çıktısı gerektirmeden Jev.
...
- [muratcakmak/jev-guard](https://github.com/muratcakmak/jev-guard) - Claude Code için olasılık puanlı korumalar: kural ihlal eden düzenlemeleri ve…
...
- [weitianxin/JevAny](https://github.com/weitianxin/JevAny) - Karar modelleri için kalibrasyon farkındalıklı RL;
...
- [lucioamor/lovable-skills](https://github.com/lucioamor/lovable-skills) - Uygulama incelemeleri, kararlar, yazma ve jevify çalışma zamanı yapay zekâ…
...
System One Modelleri ile kendi sunucunuzda barındırılan istem izleme
...
Trafiğin uç noktasında tipli yargı erişim denetimi: TypeSafe Jev tarafından desteklenen, nginx/OpenResty için üç katmanlı istem enjeksiyonu ve kötüye kullanım filtresi. Açık durumda başarısız olur, önbelleklenebilir ve yeniden başlatmadan yüklenebilir.
...
Açık System One modelleri: kalibre edilmiş olasılıklara sahip, kendi verilerinizle eğitilebilir tür belirtilmiş kararlar. Metin üretimi yok.
...
<details>
<summary><b>Bu kategoride daha fazla</b> <sub>· 11</sub></summary>
...
- [Kevthetech143/super-jev](https://github.com/Kevthetech143/super-jev) - TypeSafe Jev için küçük ve genişletilebilir bir karardan eyleme geçiş düzeneği.
...
<sub>Oluşturan · `render.py` · 2026-09-23T12:34:14+08:00</sub>
