...
> [!NOTE]
> **Live-Index** · Letzte Synchronisierung: `2026-09-26T03:12:11+08:00` (UTC+8)
> · Einträge: **806** · Neu in diesem Durchlauf: **123** · Implementierungssprachen: **23**
...
- [Routing, Guardrails und Freigaben](#routing-guardrails-und-freigaben) — **61**
...
- [Weitere Projekte](#weitere-projekte) — **87**
...
Entscheidungs-Harness für TypeSafe Jev – Konfidenzschranken, Shadow-Modus, Rezepte und Evaluierungen. Claude CLI 48,9 s → Jev 1,3 s beim gleichen Zeilenfilter-Job.
...
Ein CLI für all deine Roboter. Verbinde sie, erteile ihnen Befehle und lass sie zusammenarbeiten, jeder mit einem LLM als Gehirn (Claude, OpenAI, Gemini, Grok oder lokal über Ollama oder vLLM) und einem Entscheidungs-LLM für Multiple-Choice-Auswahl (Jev, Laya, Kev). Steuert Microduck, Open Duck Mini, LeRobot, XLeRobot, AlohaMini, ToddlerBot oder jede ROS-2-Basis von einem Laptop aus, ohne Bordcomputer.
...
Abdeckung, Sicherheit und Codequalität für Coding-Agents
...
- [topherchris420/james_library](https://github.com/topherchris420/james_library) - R.A.I.N. Lab ist eine experimentelle Architektur für wissenschaftliche Agenten…
...
- [6Mikao9/jev-native-agent-with-extended-options](https://github.com/6Mikao9/jev-native-agent-with-extended-options) - Forschungsentwurf für ein Jev-natives Agentensystem: mehr Optionen ermöglichen…
...
- [carldaws/hunch](https://github.com/carldaws/hunch) - Probabilistischer Kontrollfluss für Ruby und Rails – betrieben von TypeSafe.
...
- [ruban-24/switchboard](https://github.com/ruban-24/switchboard) - Ein Open-Source- und modellagnostischer Entscheidungsrouter für Claude Code und…
...
- [MiaoWuNYA/rikkahub-sillytavern-android](https://github.com/MiaoWuNYA/rikkahub-sillytavern-android) - 安卓-KI-Chat-Client: verlustfreier Import von Tavernenkarten, aggressiver…
...
- [safzanpirani/pi-jev-skill-picker](https://github.com/safzanpirani/pi-jev-skill-picker) - Ranke Pi-Agentenfähigkeiten für die aktuelle Aufgabe mit TypeSafe Jev.
...
- [erkamyaman/jev-enforce](https://github.com/erkamyaman/jev-enforce) - 📏 Claude-Code-Plugin, das Claude dazu bringt, deiner AGENTS.md zu folgen: jede…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/4nt0ineb--jev-from-java/cd4ce3d04107d762.gif" width="100%" alt="4nt0ineB/jev-from-java animation"><br><sub>animierte Aufzeichnung</sub></td>
</tr></table>
...
- [WiktorB2004/llama-index-jev](https://github.com/WiktorB2004/llama-index-jev) - LlamaIndex-Reranker + Router, unterstützt von TypeSafe Jev – typisierte…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/ankit-aglawe--tinyjev/dc0d701a10c37f94.gif" width="100%" alt="ankit-aglawe/tinyjev animation"><br><sub>animierte Aufzeichnung</sub></td>
</tr></table>
...
- [anessbelbati/jev-rerank-bench](https://github.com/anessbelbati/jev-rerank-bench) - Kann ein Entscheidungsmodell dedizierte Reranker schlagen? TypeSafe Jev vs.
...
jevos ist eine Open-Source-Alternative zu Jev für Ja/Nein-Entscheidungen, die auf deinem Laptop läuft.
...
<details>
<summary><b>Mehr in dieser Kategorie</b> <sub>· 92</sub></summary>
...
- [Show HN: Doom or Bloom, map your AI worldview with Jev](https://news.ycombinator.com/item?id=49846953) - Ermittele dein KI-Weltbild, indem du einige Fragen beantwortest, und sieh, wie…
...
Chinesische Übersetzung der offiziellen Nutzungsdokumentation des Jev-Modells (TypeSafe AI) | Inoffizielle chinesische Übersetzung der offiziellen Jev-(TypeSafe AI)-Dokumentation — https://docs.typesafe.ai
...
- [doeixd/discern](https://github.com/doeixd/discern) - Erstelle typsicheres, unsicherheitsbewusstes semantisches Pattern-Matching…
...
<sub>Erzeugt von · `render.py` · 2026-09-26T03:12:11+08:00</sub>
