...
> [!NOTE]
> **Live-Index** · Letzte Synchronisierung: `2026-09-22T04:09:16+08:00` (UTC+8)
> · Einträge: **714** · Neu in diesem Durchlauf: **80** · Implementierungssprachen: **25**
...
- [Routing, Guardrails und Freigaben](#routing-guardrails-und-freigaben) — **71**
...
- [Weitere Projekte](#weitere-projekte) — **72**
...
- [mattt/AnyDecisionModel](https://github.com/mattt/AnyDecisionModel) - Ein Swift-Paket für typisierte Entscheidungen aus Sprachmodellen…
...
Typsichere Decodierung für autoregressive LLMs
...
Antwortassistent neben WeChat（Windows 4.x）：Fenster-Screenshot + lokales Offline-OCR liest Nachrichten der anderen Person → Jev beurteilt die Absicht → 3 Kandidaten per Klick einfügen, Senden immer manuell
...
<sub>Erzeugt von · `render.py` · 2026-09-22T04:09:16+08:00</sub>
