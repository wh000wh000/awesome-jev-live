...
> [!NOTE]
> **Live-Index** · Letzte Synchronisierung: `2026-09-23T00:10:10+08:00` (UTC+8)
> · Einträge: **741** · Neu in diesem Durchlauf: **108** · Implementierungssprachen: **27**
...
- [Agent-Tooling: MCP, Hooks, Gates und Coding-Agents](#agent-tooling-mcp-hooks-gates-und-coding-agents) — **224**
- [Routing, Guardrails und Freigaben](#routing-guardrails-und-freigaben) — **64**
- [Evaluation, Kalibrierung und Benchmarks](#evaluation-kalibrierung-und-benchmarks) — **68**
- [Offene Reproduktionen, Gewichte und Architekturforschung](#offene-reproduktionen-gewichte-und-architekturforschung) — **46**
...
- [Weitere Projekte](#weitere-projekte) — **83**
...
Agenten-Skill zum Platzieren und Bewerten von Entscheidungsmodellen in Software, Geschäft, Organisationen und Alltagsentscheidungen. Klassische Entscheidungsmethoden, Kalibrierung, Routing und explizite Policy. TypeSafe Jev ist das standardmäßig gehostete Beispiel. Unabhängig von TypeSafe.
...
<details>
<summary><b>Mehr in dieser Kategorie</b> <sub>· 202</sub></summary>
...
- [romanmeclazcke/codex-sift](https://github.com/romanmeclazcke/codex-sift) - Route jeden Codex-Turn zum günstigsten Modell, das ihn bewältigen kann…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/fazlerocks--jev-adblock/ba4996f061b8067f.gif" width="100%" alt="fazlerocks/jev-adblock animation"><br><sub>animierte Aufzeichnung</sub></td>
</tr></table>
...
- [ziozzang/hearim](https://github.com/ziozzang/hearim) - hearim (헤아림) — mit Jev kompatibles Multi-Backend-System One-Gateway in Go.
...
OmniJev — multimodale Entscheidungsoberfläche mit endlicher Auswahl und MuJoCo-Workbench für Embodiment: Trajektorien-Replays, Entscheidungsprobes, Benchmark-Panels, 60s-Walkthrough.
...
Erforschung, wie Jev Aufgaben beschleunigen kann, die auf LLM-Entscheidungsfindung angewiesen sind.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/tongyun1--jev-in-the-loop/06851a691352df8c.gif" width="100%" alt="Tongyun1/Jev-in-the-Loop animation"><br><sub>animierte Aufzeichnung</sub></td>
</tr></table>
...
- [mizchi/jev-lint](https://github.com/mizchi/jev-lint) - Text in Code mit jev scorerer linten.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/davertor--jev-slop-guard/5328ae6b3c49cbf6.gif" width="100%" alt="davertor/jev-slop-guard animation"><br><sub>animierte Aufzeichnung</sub></td>
</tr></table>
...
Erstelle typsicheres, unsicherheitsbewusstes semantisches Pattern Matching, Kontrollfluss und intelligente Prozeduren für Effect DecisionModel und Jev
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/doeixd--discern/6e14f29d003c7459.gif" width="100%" alt="doeixd/discern animation"><br><sub>animierte Aufzeichnung</sub></td>
</tr></table>
...
Kann ein Entscheidungsmodell dedizierte Reranker schlagen? TypeSafe Jev vs Cohere Rerank 4 vs ZeroEntropy zerank-2 vs eine Chat-Modell-Baseline: 14 Datensätze, jede rohe API-Antwort, Bootstrap-Bereiche für jede Differenz.
...
- [sabeel111/OpenSourceJev](https://github.com/sabeel111/OpenSourceJev) - Ein LLM-Modell in ein Jev-ähnliches System verwandeln.
...
<sub>Erzeugt von · `render.py` · 2026-09-23T00:10:10+08:00</sub>
