...
> [!NOTE]
> **Live-Index** · Letzte Synchronisierung: `2026-09-21T23:42:10+08:00` (UTC+8)
> · Einträge: **737** · Neu in diesem Durchlauf: **115** · Implementierungssprachen: **25**
...
- [Agent-Tooling: MCP, Hooks, Gates und Coding-Agents](#agent-tooling-mcp-hooks-gates-und-coding-agents) — **192**
- [Routing, Guardrails und Freigaben](#routing-guardrails-und-freigaben) — **78**
- [Evaluation, Kalibrierung und Benchmarks](#evaluation-kalibrierung-und-benchmarks) — **77**
- [Offene Reproduktionen, Gewichte und Architekturforschung](#offene-reproduktionen-gewichte-und-architekturforschung) — **40**
- [Anwendungen, Spiele, Robotik und interaktive Demos](#anwendungen-spiele-robotik-und-interaktive-demos) — **41**
- [Artikel, Diskussionen und verwandte Listen](#artikel-diskussionen-und-verwandte-listen) — **95**
- [Weitere Projekte](#weitere-projekte) — **86**
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/fajarhide--askgrep/fa6a7fa333d2d67f.gif" width="100%" alt="fajarhide/askgrep animation"><br><sub>animierte Aufzeichnung</sub></td>
</tr></table>
...
<details>
<summary><b>Mehr in dieser Kategorie</b> <sub>· 99</sub></summary>
...
- [smkrv/jev-calibrate](https://github.com/smkrv/jev-calibrate) - Kalibrieren Sie Jev-Fragen anhand Ihrer eigenen Labels: Kriterien an gelabelten…
- [BeatAPI/awesome-jev](https://github.com/BeatAPI/awesome-jev) - Wir kuratieren nur quellgeprüfte JEV-bezogene Projekte mit 100+ GitHub Sternen…
...
- [evoke-build/evoke](https://github.com/evoke-build/evoke) - Software, per Reflex. Ein Satz wird zu einem Aufruf eines kleinen Programms…
- [arunav25/jev-mcp](https://github.com/arunav25/jev-mcp) - Verbinde JEV mit MCP-Clients und vergleiche seine Urteile anhand gemeinsamer…
- [chengyongru/fastjev](https://github.com/chengyongru/fastjev) - SDK-first, unabhängig gepflegter SemIf-Fork für schnelle, selbst gehostete…
...
- [Qew7/jev-feels](https://github.com/Qew7/jev-feels) - Semantische Entscheidungen als gewöhnliches Ruby — feels?, decide, score…
...
- [iamvatsalpatel/tiershift](https://github.com/iamvatsalpatel/tiershift) - Verschiebe jeden LLM-Aufruf auf das günstigste Modell, das ihn bewältigen kann.
...
- [zcoder-run/rust-sysone](https://github.com/zcoder-run/rust-sysone) - System One TypeSafe AI Rust Client (inoffiziell).
...
- [neko233-com/laya-go](https://github.com/neko233-com/laya-go) - Laya — offene horizontale System-1-Entscheidungsmodelle: Go-Server + Agent…
...
⚡ Foq — die KOSTENLOSE, lokale Open-Source-Alternative zu Jev. Typisierte System-1-Entscheidungen in ~25 ms — keine Warteliste, keine Cloud, keine Kosten pro Token. foq.fr
...
<details>
<summary><b>Mehr in dieser Kategorie</b> <sub>· 170</sub></summary>
...
- [supercorp-ai/supercov](https://github.com/supercorp-ai/supercov) - Codequalität und Abdeckung für Coding-Agenten.
...
- [socai-io/jev-social](https://github.com/socai-io/jev-social) - Jev-gestützte Recherche auf Instagram, TikTok und LinkedIn: typisierte…
...
- [DanRWilloughby/snifftest](https://github.com/DanRWilloughby/snifftest) - Ein Prosa-Linter, der Hinweise auf KI-generierte Texte aufspürt.
...
- [compozy/yoshi](https://github.com/compozy/yoshi) - Kontextbeschneidungs-Proxy für Claude Code und Codex: Jev beurteilt, welcher…
...
- [OmniJev/PlayJev](https://github.com/OmniJev/PlayJev) - 🚀🚀 Ein JEV-ähnliches multimodales 0.8B-Modell, das GUI-Spiele direkt anhand…
...
- [DECRUX9812/typesafe-skill-router](https://github.com/DECRUX9812/typesafe-skill-router) - TypeSafe (Jev)-Skill-Routing für Hermes Agent: benennt die eine Fähigkeit, die…
...
- [Prophetlab/JevPokerBench](https://github.com/Prophetlab/JevPokerBench) - ProphetLabs Texas Hold.
- [Nyarlathoteppppp/pi-jev-context](https://github.com/Nyarlathoteppppp/pi-jev-context) - Cache-neutrales Kontext-Trimmen für den pi-Coding-Agent, betrieben von TypeSafe…
...
- [FazalAAli/jev-robotics-demo](https://github.com/FazalAAli/jev-robotics-demo) - Jev (TypeSafe System One) vs Claude Opus 5 beim Steuern eines simulierten…
...
- [FFatTiger/new-api-plugin-typesafe](https://github.com/FFatTiger/new-api-plugin-typesafe) - TypeSafe AI System One (Jev) Task-Plugin für QuantumNous/new-api — natives…
...
Automatisches Modell-Routing für Pi unter Verwendung von TypeSafes Jev über Vercel AI Gateway
...
- [kavehmz/typesafe-playground](https://github.com/kavehmz/typesafe-playground) - Interaktive Experimente mit TypeSafe Jev, vom Support-Routing bis zu…
...
- [yzfly/edgejev](https://github.com/yzfly/edgejev) - Offline nutzbare lokale typisierte Entscheidungen: 15,6 ms pro Aufgabe auf…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/fbddcz--embodied-jev/6c478d975fee036f.gif" width="100%" alt="FBddcz/embodied-jev animation"><br><sub>animierte Aufzeichnung · <a href="https://raw.githubusercontent.com/FBddcz/embodied-jev/main/docs/results/metaworld-hierarchy-v2-2026-09-21/figures/hierarchy-grid-fast.mp4">Video öffnen</a></sub></td>
</tr></table>
...
<details>
<summary><b>Mehr in dieser Kategorie</b> <sub>· 18</sub></summary>
...
- [zhihz/openjev](https://github.com/zhihz/openjev) - Lokale zweisprachige Wahrscheinlichkeitsentscheidungen aus Kontext, Fragen und…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/hr98w--jev-visual/e05a42d934ea69ce.gif" width="100%" alt="hr98w/jev-visual animation"><br><sub>animierte Aufzeichnung · <a href="https://github.com/user-attachments/assets/c87c09d8-30d2-4392-b981-d0b5cf1879ae">Video öffnen</a></sub></td>
</tr></table>
...
- [HexyeDEV/JevPR](https://github.com/HexyeDEV/JevPR) - PR-Risiko-Review, automatisiert durch Jev.
...
- [kevin9327/jev-master](https://github.com/kevin9327/jev-master) - Typisierte System One-Entscheidungen mit Jev: Choice + Score + Noul im Code…
...
- [zhengxuyu/litjev](https://github.com/zhengxuyu/litjev) - Verwandle jedes handelsübliche LLM in eine Jev-ähnliche Entscheidungsschicht.
...
- [phyous/tsai-sc](https://github.com/phyous/tsai-sc) - TypeSafe Jev steuert das ursprüngliche StarCraft-Shareware-Spiel über Tastatur…
...
<sub>Erzeugt von · `render.py` · 2026-09-21T23:42:10+08:00</sub>
