...
> [!NOTE]
> **实时索引** · 上次同步: `2026-09-23T20:09:57+08:00` (UTC+8)
> · 条目: **770** · 本轮新增: **76** · 实现语言: **22**
...
- [Agent 工具链：MCP、钩子、门禁与编码 Agent](#agent-工具链mcp钩子门禁与编码-agent) — **231**
- [路由、护栏与审批](#路由护栏与审批) — **57**
...
R.A.I.N. Lab 是一种实验性科学代理架构，将快速本地判断、独立概率评估、多代理审议、证据和授权分离到不同的计算层。🐙（早于 Karpathy 的 AutoResearch）
...
- [agent-chaperone/agent-chaperone](https://github.com/agent-chaperone/agent-chaperone) - 在 AI 代理的工具调用运行之前筛查它们，并在代理读取工具结果之前筛查这些结果。一个 MCP 代理，加上用于客户端内置工具的 hooks 适配器.
...
- [keltokhy/jsort](https://github.com/keltokhy/jsort) - 按含义排序：沿着一个普通英语维度对行排序，基于由 TypeSafe 的 Jev 模型判断的成对比较。
...
- [lucasmartins-ai/lcc](https://github.com/lucasmartins-ai/lcc) - Local Context Compiler (lcc)：在提示上下文到达模型之前清理、去重并压缩它，然后报告每个被丢弃的块、一次处理使哪些缓存 token…
...
- [KiritoKing/midscene-jev-runner](https://github.com/KiritoKing/midscene-jev-runner) - 由社区维护的 Midscene Test JEV runner 集成。
...
<details>
<summary><b>本分类更多条目</b> <sub>· 209</sub></summary>
...
- [socai-io/jev-social](https://github.com/socai-io/jev-social) - Jev × SocAI，用于 Instagram、TikTok 和 LinkedIn 研究——类型化路由、真实浏览器证据、流式帖子卡片、视频捕获和带引用的报告.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/tshmieldev--sharp/016860f6bb08aa6b.gif" width="100%" alt="tshmieldev/sharp animation"><br><sub>动态录屏</sub></td>
</tr></table>
...
- [zeeshan8281/slo-router](https://github.com/zeeshan8281/slo-router) - 具备 SLO 感知的 LLM 推理路由器，支持 Jev 决策、实时队列指标、反事实评估以及可复现的延迟/成本基准测试。
...
一个用于单遍类型化决策的开源高性能 System One Model，带有可嵌入的 C runtime 和 WebAssembly 支持。
...
<sub>生成者 · `render.py` · 2026-09-23T20:09:57+08:00</sub>
