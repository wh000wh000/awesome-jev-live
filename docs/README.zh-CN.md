...
> [!NOTE]
> **实时索引** · 上次同步: `2026-09-22T18:35:35+08:00` (UTC+8)
> · 条目: **743** · 本轮新增: **95** · 实现语言: **23**
...
- [Agent 工具链：MCP、钩子、门禁与编码 Agent](#agent-工具链mcp钩子门禁与编码-agent) — **222**
- [路由、护栏与审批](#路由护栏与审批) — **66**
- [评估、校准与基准测试](#评估校准与基准测试) — **71**
...
完全免费 ₹0、代理优先的 SEO 和 GEO CLI 套件，以及在 Rust 中运行的 MCP 服务器，通过 DuckDuckGo 和 TypeSafe Jev System One https://akashpriyadarshii.github.io/jev-seo/ 取代 Semrush 和 OpenSEO
...
- [nylon-memory/NylonME](https://github.com/nylon-memory/NylonME) - AI 代理的记忆引擎，使用 Jev 可以带来更高的决策准确率。Nylon…
...
<details>
<summary><b>本分类更多条目</b> <sub>· 200</sub></summary>
...
- [chy4pro/jev-for-chrome](https://github.com/chy4pro/jev-for-chrome) - 用于 Chrome 的 Jev：使用 TypeSafe Jev（一种亚秒级决策模型）驱动你正在查看的标签页.
...
- [muratcakmak/jev-guard](https://github.com/muratcakmak/jev-guard) - 针对 Claude Code 的概率评分防护栏：拒绝违反规则的编辑和未经请求的部署，将你的文档注入每个提示，并根据当前轮次自身的证据检查最终答案.
...
<details>
<summary><b>本分类更多条目</b> <sub>· 17</sub></summary>
...
<details>
<summary>🎮 <b><a href="https://x.com/tspy/status/2100864234523685146">Xtags — X 帖子意图标注插件</a></b> · @tspy · 👁️ observed · 4 天</summary>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/beingcognitive--jev-songwriter/0ed98beb60e70743.gif" width="100%" alt="beingcognitive/jev-songwriter animation"><br><sub>动态录屏</sub></td>
</tr></table>
...
- [nssmd/jev-bot](https://github.com/nssmd/jev-bot) - 自托管的 Jev 决策工作台和 Feishu 机器人：自动选择、概率以及实验性的词语/字符写作.
...
<sub>生成者 · `render.py` · 2026-09-22T18:35:35+08:00</sub>
