...
> [!NOTE]
> **实时索引** · 上次同步: `2026-09-26T10:04:24+08:00` (UTC+8)
> · 条目: **815** · 本轮新增: **35** · 实现语言: **23**
...
- [keltokhy/jsort](https://github.com/keltokhy/jsort) - 按含义排序：根据TypeSafe的Jev模型对成对比较的判断，沿着通俗英语维度排列各行。
...
用于System One模型的System One测试框架。在本地运行Jev及其他System One模型，或直接在 HarnessRouter.ai 上运行。
...
- [zhangcy122/OpenJev](https://github.com/zhangcy122/OpenJev) - TypeSafe Jev的开源替代方案。支持 Open LLMs、Laya (ModernBERT) 和…
...
- [fstandhartinger/jevbench](https://github.com/fstandhartinger/jevbench) - JevBench v1——用于Jev类类型化决策模型的基准测试：智能、廉价、快速、可靠、开放.
...
- [imikerussell/beebots](https://github.com/imikerussell/beebots) - OKX 上的三只 AI 交易蜜蜂，每个决策都由Jev做出。默认使用模拟交易。不构成金融建议.
...
<sub>生成者 · `render.py` · 2026-09-26T10:04:24+08:00</sub>
