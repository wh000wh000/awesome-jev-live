...
> [!NOTE]
> **实时索引** · 上次同步: `2026-09-22T11:05:08+08:00` (UTC+8)
> · 条目: **737** · 本轮新增: **54** · 实现语言: **25**
...
- [Agent 工具链：MCP、钩子、门禁与编码 Agent](#agent-工具链mcp钩子门禁与编码-agent) — **209**
- [路由、护栏与审批](#路由护栏与审批) — **71**
- [评估、校准与基准测试](#评估校准与基准测试) — **78**
- [开放复现、权重与架构研究](#开放复现权重与架构研究) — **36**
- [应用、游戏、机器人与交互演示](#应用游戏机器人与交互演示) — **46**
- [文章、讨论与同类列表](#文章讨论与同类列表) — **90**
- [其他项目](#其他项目) — **77**
...
软件，凭反射运行。一句话会变成一个小程序的调用，该程序由 Jev、TypeSafe AI 的分类器选择，并且仅在其足够确定时运行。反射是任何人都可以编写、分享和改进的配方。一个与你交谈的 CLI、一个用于从 git 获取反射的包管理器，以及一个 TypeScript SDK。
...
- [keltokhy/jlink](https://github.com/keltokhy/jlink) - 面向经济学家的记录链接：用通俗英语编写匹配规则，为每对记录获取一个概率，审核它，并引用它。Python、CLI、Stata 和 R.
...
<details>
<summary><b>本分类更多条目</b> <sub>· 187</sub></summary>
...
- [rupeshpoojary9/awesome-open-system-one](https://github.com/rupeshpoojary9/awesome-open-system-one) - 精选的开放System One生态系统列表：开放模型、独立基准、校准和约束解码工具.
...
<details>
<summary><b>本分类更多条目</b> <sub>· 14</sub></summary>
...
- [mmastrac/djev](https://github.com/mmastrac/djev) - DiffusionGemma 上的Jev风格结构化决策：来自vLLM PR 57250 的示例服务器。
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/iron-lyk--omnijev/341b127f269cdd62.gif" width="100%" alt="Iron-LYK/OmniJev animation"><br><sub>动态录屏 · <a href="https://raw.githubusercontent.com/Iron-LYK/OmniJev/main/docs/media/omnijev-stack.mp4">打开视频</a></sub></td>
</tr></table>
...
- [Argos1111/jev_local](https://github.com/Argos1111/jev_local) - 使用本地LLM复现Jev。
...
<sub>生成者 · `render.py` · 2026-09-22T11:05:08+08:00</sub>
