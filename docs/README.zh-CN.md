...
> [!NOTE]
> **实时索引** · 上次同步: `2026-09-19T12:51:10+08:00` (UTC+8)
> · 条目: **452** · 本轮新增: **0** · 实现语言: **25**
...
- [社区客户端、SDK 与适配器](#社区客户端sdk-与适配器) — **72**
- [Agent 工具链：MCP、钩子、门禁与编码 Agent](#agent-工具链mcp钩子门禁与编码-agent) — **138**
- [路由、护栏与审批](#路由护栏与审批) — **50**
- [评估、校准与基准测试](#评估校准与基准测试) — **38**
- [开放复现、权重与架构研究](#开放复现权重与架构研究) — **19**
- [应用、游戏、机器人与交互演示](#应用游戏机器人与交互演示) — **43**
- [文章、讨论与同类列表](#文章讨论与同类列表) — **37**
- [其他项目](#其他项目) — **49**
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/jimmyhealer--jev-semantic-explorer/f9d2833c758298d8.gif" width="100%" alt="jimmyhealer/jev-semantic-explorer animation"><br><sub>动态录屏</sub></td>
</tr></table>
...
<sub>生成者 · `render.py` · 2026-09-19T12:51:10+08:00</sub>
