...
> [!NOTE]
> **实时索引** · 上次同步: `2026-09-20T12:04:41+08:00` (UTC+8)
> · 条目: **592** · 本轮新增: **69** · 实现语言: **22**
...
- [heyman333/jev-router](https://github.com/heyman333/jev-router) - 根据 jev 判断提示并选择合适模型的 Claude Code / Codex 技能。0 个依赖，能力值标明公开基准来源.
...
- [makefunstuff/jev-lsp](https://github.com/makefunstuff/jev-lsp) - 由 Jev 支持的 lsp 服务器，使用 jev inference api 在编辑器中工作时引导代码工具或检测问题.
...
- [rioriost/rspamd-jev](https://github.com/rioriost/rspamd-jev) - 用于 Rspamd 的 TypeSafe Jev 影子评估插件，可选 GPT 提供商比较。
...
- [maraichr/jev-triage](https://github.com/maraichr/jev-triage) - 使用通过 OpenRouter 的 TypeSafe Jev 的跨境 B2B 案件分诊原型。
- [mcgalleg/grokbot-jev-jobs](https://github.com/mcgalleg/grokbot-jev-jobs) - 使用 TypeSafe 的 jev 通过 Vercel AI Gateway，根据我的简历为公开职位发布评分。每日 Vercel cron.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/Chunky83/jev-workbench/main/docs/assets/jev-welcome.gif" width="100%" alt="Chunky83/jev-workbench animation"><br><sub>动态录屏</sub></td>
</tr></table>
...
<details>
<summary><b>本分类更多条目</b> <sub>· 6</sub></summary>
...
- [kazuhideoki/jev-search](https://github.com/kazuhideoki/jev-search) - 使用 TypeSafe Jev 和 fzf 的递归语义文件搜索。
...
由 TypeSafe AI 的 System One 模型驱动的 OpenAPI 兼容性检查，JEV——将结构差异比较与语义契约分析相结合。
...
- [keltokhy/jsort](https://github.com/keltokhy/jsort) - 按含义排序：沿着一个普通英语维度排列各行，基于由 TypeSafe 的 Jev 模型判断的成对比较。
...
<sub>生成者 · `render.py` · 2026-09-20T12:04:41+08:00</sub>
