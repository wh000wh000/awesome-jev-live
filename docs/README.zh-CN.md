...
> [!NOTE]
> **实时索引** · 上次同步: `2026-09-23T07:10:14+08:00` (UTC+8)
> · 条目: **756** · 本轮新增: **71** · 实现语言: **25**
...
- [应用、游戏、机器人与交互演示](#应用游戏机器人与交互演示) — **39**
...
R.A.I.N. Lab 是一种实验性科学代理架构，将快速本地判断、独立概率评估、多代理审议、证据和授权划分为不同的计算层。🐙（早于 Karpathy 的 AutoResearch）
...
<details>
<summary><b>本分类更多条目</b> <sub>· 218</sub></summary>
...
<sub>生成者 · `render.py` · 2026-09-23T07:10:14+08:00</sub>
