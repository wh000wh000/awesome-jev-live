...
> [!NOTE]
> **Живий індекс** · Остання синхронізація: `2026-09-23T07:10:14+08:00` (UTC+8)
> · Записи: **756** · Нові за цей цикл: **71** · Мови реалізації: **25**
...
<sub>Один CLI для всіх ваших роботів. Підключайте їх, керуйте ними й дозволяйте їм працювати разом, кожен з LLM як мозком і рішенням LLM для дешевших і швидших кроків.…</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
- [Інструменти для агентів: MCP, хуки, шлюзи та агенти-програмісти](#інструменти-для-агентів-mcp-хуки-шлюзи-та-агенти-програмісти) — **240**
...
- [Застосунки, ігри, робототехніка та інтерактивні демо](#застосунки-ігри-робототехніка-та-інтерактивні-демо) — **39**
...
Один CLI для всіх ваших роботів. Підключайте їх, керуйте ними й дозволяйте їм працювати разом, кожен з LLM як мозком і рішенням LLM для дешевших і швидших кроків. Microduck, Open Duck Mini, LeRobot, XLeRobot, AlohaMini, ToddlerBot або будь-яка база ROS. Claude, OpenAI, Gemini, Grok або локально через Ollama чи vLLM.

<sub>🔧 Виявлено використання в коді: `docs/adr/0043-decision-llms-are-a-wire-format-and-a-data-row.md`</sub>
...
R.A.I.N. Lab — це експериментальна архітектура наукового агента, яка розділяє швидке локальне оцінювання, незалежну ймовірнісну оцінку, обговорення між кількома агентами, докази та авторизацію на окремі обчислювальні рівні.🐙(Створено раніше за AutoResearch Karpathy)
...
- [keltokhy/jsort](https://github.com/keltokhy/jsort) - сортування за значенням: упорядковує рядки вздовж виміру, сформульованого…
...
- [evoke-build/evoke](https://github.com/evoke-build/evoke) - Програмне забезпечення, рефлекторно. Скажіть — і запуститься потрібна невелика…
- [Qew7/jev-feels](https://github.com/Qew7/jev-feels) - Семантичні рішення як звичайні Ruby: #feels?, #decide, #score, валідації Rails…
- [oswarld/notion-skills](https://github.com/oswarld/notion-skills) - Навичка для корейськомовних користувачів Notion.
...
- [keltokhy/jlink](https://github.com/keltokhy/jlink) - Зіставлення записів для економістів: сформулюйте правило зіставлення простою…
...
<details>
<summary><b>Більше в цій категорії</b> <sub>· 218</sub></summary>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/hfnissum-byte--hunkpick/21c4c5bad7854d6e.gif" width="100%" alt="hfnissum-byte/Hunkpick animation"><br><sub>анімований запис</sub></td>
</tr></table>
...
Відкриті System One-моделі: типізовані рішення з каліброваними ймовірностями, які можна навчати на власних даних. Без генерації тексту.
...
- [fstandhartinger/jevbench](https://github.com/fstandhartinger/jevbench) - JevBench v1 — бенчмарк для типізованих моделей прийняття рішень класу Jev…
...
- [backmeupplz/jev_antispam_bot](https://github.com/backmeupplz/jev_antispam_bot) - Мінімальний Telegram-бот grammY для захисту від спаму на основі TypeSafe Jev.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/surbhit20/jev-plays-snake/main/jev-plays-snake.gif" width="100%" alt="surbhit20/jev-plays-snake animation"><br><sub>анімований запис</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/yinsongxu--llm2jev/9b0b042b0dfa87b7.gif" width="100%" alt="Yinsongxu/LLM2Jev animation"><br><sub>анімований запис · <a href="https://raw.githubusercontent.com/Yinsongxu/LLM2Jev/main/assets/mujoco.mp4">Відкрити відео</a></sub></td>
</tr></table>
...
<details>
<summary><b>Більше в цій категорії</b> <sub>· 59</sub></summary>
...
- [phyous/tsai-sc](https://github.com/phyous/tsai-sc) - TypeSafe Jev керує оригінальною умовно-безкоштовною версією StarCraft за…
...
<sub>Згенеровано за допомогою · `render.py` · 2026-09-23T07:10:14+08:00</sub>
