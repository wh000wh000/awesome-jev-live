...
> [!NOTE]
> **Живий індекс** · Остання синхронізація: `2026-09-22T21:36:57+08:00` (UTC+8)
> · Записи: **739** · Нові за цей цикл: **80** · Мови реалізації: **25**
...
<sub>Jev, модель System One від TypeSafe, грає в шахи проти будь-якого LLM з OpenRouter, Stockfish і вас. Односторінковий вебзастосунок із ходами в реальному часі,…</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
- [Офіційні SDK та інструменти для розробників](#офіційні-sdk-та-інструменти-для-розробників) — **8**
- [Клієнти, SDK та адаптери спільноти](#клієнти-sdk-та-адаптери-спільноти) — **115**
- [Інструменти для агентів: MCP, хуки, шлюзи та агенти-програмісти](#інструменти-для-агентів-mcp-хуки-шлюзи-та-агенти-програмісти) — **218**
- [Маршрутизація, запобіжники та затвердження](#маршрутизація-запобіжники-та-затвердження) — **68**
- [Оцінювання, калібрування та бенчмарки](#оцінювання-калібрування-та-бенчмарки) — **66**
- [Відкриті відтворення, ваги та дослідження архітектури](#відкриті-відтворення-ваги-та-дослідження-архітектури) — **38**
- [Застосунки, ігри, робототехніка та інтерактивні демо](#застосунки-ігри-робототехніка-та-інтерактивні-демо) — **48**
- [Тексти, обговорення та споріднені списки](#тексти-обговорення-та-споріднені-списки) — **91**
- [Інші проєкти](#інші-проєкти) — **87**
...
- [lucasmartins-ai/lcc](https://github.com/lucasmartins-ai/lcc) - Local Context Compiler (lcc): очищає, дедуплікує та стискає контекст промпту…
...
<details>
<summary><b>Більше в цій категорії</b> <sub>· 196</sub></summary>
...
Контроль допуску на основі типізованих суджень на межі мережі: тришаровий фільтр ін’єкцій у промпти та зловживань для nginx/OpenResty на основі TypeSafe Jev. Із режимом fail-open, кешуванням і гарячим перезавантаженням.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/arpit-khandelwal--jev-linkedin-slop-filter/2ba80db1b4af936f.gif" width="100%" alt="Arpit-Khandelwal/jev-linkedin-slop-filter animation"><br><sub>анімований запис</sub></td>
</tr></table>
...
- [ziozzang/hearim](https://github.com/ziozzang/hearim) - hearim (헤아림) — сумісний із Jev мультибекендний шлюз System One у Go.
...
<details>
<summary><b>Більше в цій категорії</b> <sub>· 16</sub></summary>
...
- [mattt/AnyDecisionModel](https://github.com/mattt/AnyDecisionModel) - Пакет Swift для типізованих рішень мовних моделей.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/0x7067--jev-browse/ef0e8f6126e6228e.gif" width="100%" alt="0x7067/jev-browse animation"><br><sub>анімований запис · <a href="https://raw.githubusercontent.com/0x7067/jev-browse/main/docs/demo.mp4">Відкрити відео</a></sub></td>
</tr></table>
...
<details>
<summary><b>Більше в цій категорії</b> <sub>· 26</sub></summary>
...
<details>
<summary><b>Більше в цій категорії</b> <sub>· 65</sub></summary>
...
- [yushen100/wechat-jev-assistant](https://github.com/yushen100/wechat-jev-assistant) - Windows помічник для аналізу діалогів у 微信: локальне читання, знеособлення…
...
- [kerryrm/systemANE](https://github.com/kerryrm/systemANE) - Використання Neural Engine від Apple як безкоштовного та швидкого «System One»…
...
<sub>Згенеровано за допомогою · `render.py` · 2026-09-22T21:36:57+08:00</sub>
