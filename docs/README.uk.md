...
> [!NOTE]
> **Живий індекс** · Остання синхронізація: `2026-09-22T18:35:35+08:00` (UTC+8)
> · Записи: **743** · Нові за цей цикл: **95** · Мови реалізації: **23**
...
- [Інструменти для агентів: MCP, хуки, шлюзи та агенти-програмісти](#інструменти-для-агентів-mcp-хуки-шлюзи-та-агенти-програмісти) — **222**
- [Маршрутизація, запобіжники та затвердження](#маршрутизація-запобіжники-та-затвердження) — **66**
- [Оцінювання, калібрування та бенчмарки](#оцінювання-калібрування-та-бенчмарки) — **71**
...
Повністю безкоштовний ₹0 набір CLI для SEO та GEO з пріоритетом агентів і MCP сервер у Rust, що замінює Semrush і OpenSEO через DuckDuckGo та TypeSafe Jev System One https://akashpriyadarshii.github.io/jev-seo/
...
<details>
<summary><b>Більше в цій категорії</b> <sub>· 93</sub></summary>
...
- [ruban-24/switchboard](https://github.com/ruban-24/switchboard) - Маршрутизатор ухвалення рішень із відкритим кодом, незалежний від моделі, для…
...
<details>
<summary><b>Більше в цій категорії</b> <sub>· 200</sub></summary>
...
- [chy4pro/jev-for-chrome](https://github.com/chy4pro/jev-for-chrome) - Jev для Chrome: керує відкритою вами вкладкою за допомогою TypeSafe Jev, моделі…
...
- [muratcakmak/jev-guard](https://github.com/muratcakmak/jev-guard) - Захисні обмеження для Claude Code з оцінюванням імовірності: забороняють…
...
- [raihankhan-rk/diffjury](https://github.com/raihankhan-rk/diffjury) - DiffJury — маршрутизатор ризиків PR для TypeSafe Jev і наставник із перевірки…
...
<details>
<summary><b>Більше в цій категорії</b> <sub>· 17</sub></summary>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/beingcognitive--jev-songwriter/0ed98beb60e70743.gif" width="100%" alt="beingcognitive/jev-songwriter animation"><br><sub>анімований запис</sub></td>
</tr></table>
...
- [nssmd/jev-bot](https://github.com/nssmd/jev-bot) - Автономний робочий простір для ухвалення рішень Jev і бот Feishu: автоматичний…
...
- [tanxarx/awesome-jev](https://github.com/tanxarx/awesome-jev) - Усе найкраще, що стосується Jev.
...
<details>
<summary><b>Більше в цій категорії</b> <sub>· 66</sub></summary>
...
- [QuicqDev/Jev-vs-ML](https://github.com/QuicqDev/Jev-vs-ML) - Jev проти ML.
...
<sub>Згенеровано за допомогою · `render.py` · 2026-09-22T18:35:35+08:00</sub>
