...
> [!NOTE]
> **Живий індекс** · Остання синхронізація: `2026-09-25T18:10:37+08:00` (UTC+8)
> · Записи: **799** · Нові за цей цикл: **298** · Мови реалізації: **24**
...
<sub>Swift SDK для запуску моделей чату, бачення та мовлення на iPhone і Mac за допомогою Apple&#x27;s Core AI. Завантаження моделей і кешування, інтеграція з FoundationModels…</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
- [Клієнти, SDK та адаптери спільноти](#клієнти-sdk-та-адаптери-спільноти) — **129**
- [Інструменти для агентів: MCP, хуки, шлюзи та агенти-програмісти](#інструменти-для-агентів-mcp-хуки-шлюзи-та-агенти-програмісти) — **249**
- [Маршрутизація, запобіжники та затвердження](#маршрутизація-запобіжники-та-затвердження) — **58**
...
<sub>🔧 Виявлено використання в коді: `src/typesafe_sdk/__init__.py`</sub>
...
<sub>🔧 Виявлено використання в коді: `Sources/CoreAIOps/CoreAI+SystemOne.swift`</sub>
...
Агентний фреймворк GraphRAG, незалежний від бази даних, зі змінними моделями System One (локальна Laya / хмарна Jev). Підключуваний інтелектуальний рівень із повним 4-фазним конвеєром і власним обходом A* для будь-якої графової бази даних.
...
Понад 200 готових рецептів Jev: малі калібровані рішення AI, які маршрутизують, оцінюють, допускають, порівнюють і позначають текст для агентів, RAG, підтримки, перевірки коду та музики. Імпортуйте з JavaScript або TypeScript чи викликайте CLI за допомогою JSON з будь-якої мови.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/agencyenterprise--jev-recipes/0f08086836b893d8.gif" width="100%" alt="agencyenterprise/jev-recipes animation"><br><sub>анімований запис</sub></td>
</tr></table>
...
Спільнотний Java SDK для Jev, моделі System One від TypeSafe: типізовані запитання на вході, типізовані відповіді з каліброваними ймовірностями на виході. Java 17+, Spring Boot starter (неофіційний)
...
Один CLI для всіх ваших роботів. Підключайте їх, віддавайте їм команди й дозвольте працювати разом — кожен із LLM як мозком (Claude, OpenAI, Gemini, Grok або локально через Ollama чи vLLM) і рішенням LLM для множинного вибору (Jev, Laya, Kev). Керує Microduck, Open Duck Mini, LeRobot, XLeRobot, AlohaMini, ToddlerBot, будь-якою базою ROS 2 із ноутбука, поза бортом.
...
<details>
<summary><b>Більше в цій категорії</b> <sub>· 111</sub></summary>
...
- [tacticocc/Jevbridge](https://github.com/tacticocc/Jevbridge) - Адаптер ACP і MCP, що поєднує TypeSafe Jev з будь-яким LLM — керування…
...
- [chengyongru/fastjev](https://github.com/chengyongru/fastjev) - SemIf-форк із пріоритетом SDK, який незалежно підтримується для швидких…
- [Ray-Hughes/jevalyn](https://github.com/Ray-Hughes/jevalyn) - Шар рішень для вашого Rails-застосунку.
- [CheshiAI/Cheshi](https://github.com/CheshiAI/Cheshi) - Пам.
...
Експерименти з пошуковою системою на колекціях TREC. Наразі зосереджено на реалізаціях переранжування без навчальних прикладів із використанням моделі JEV від typesafe.ai
...
Локальна альтернативна система Jev з відкритим кодом: рішення браузерного агента з Laya (модель System One) на власному комп’ютері. Без хмари, без ключа API. Сумісна з Playwright/CDP і MCP.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/mansicer--jev-plays/c4f1ec41afcb4ae9.gif" width="100%" alt="mansicer/jev-plays animation"><br><sub>анімований запис</sub></td>
</tr></table>
...
- [supercorp-ai/supercov](https://github.com/supercorp-ai/supercov) - Покриття, безпека та якість коду для агентів програмування.
...
- [angel291592/Intent-Router](https://github.com/angel291592/Intent-Router) - Компілятор намірів для AI-агентів — перетворює нечіткі запити на типізовані…
- [socai-io/jev-social](https://github.com/socai-io/jev-social) - Навичка агента з відкритим кодом і локальна демонстрація: Jev × socai для…
...
- [OmniJev/PlayJev](https://github.com/OmniJev/PlayJev) - 🚀🚀 Мультимодальна модель на 0.8B параметрів, подібна до JEV, яка грає в…
...
- [PyModel/jev-judge-mcp](https://github.com/PyModel/jev-judge-mcp) - Інструменти типізованих суджень для агентів MCP.
...
- [khordoo/jev-reflex-autonomy-lab](https://github.com/khordoo/jev-reflex-autonomy-lab) - Симуляція автономності рою дронів у реальному часі з використанням Jev для…
...
- [bgivenb/flick-computer-use](https://github.com/bgivenb/flick-computer-use) - Швидка робота з браузером і комп.
...
- [24601/Augustus](https://github.com/24601/Augustus) - Навичка агента для пошуку, створення, оцінювання та вдосконалення систем…
...
- [AskTheWay/dsh-jev-interceptor](https://github.com/AskTheWay/dsh-jev-interceptor) - ⚡ Мілісекундне судження System-1 для кожного виклику інструмента в DeepSeek…
...
- [itsmostafa/typesafe-mcp](https://github.com/itsmostafa/typesafe-mcp) - Конектор mcp для швидкого й дешевого оцінювання будь-чого.
...
Шлюз оцінювання ризиків у реальному часі для депозитів і виведення коштів на біржі — Jev (TypeSafe System One) виконує лише оцінювання; винесення рішення залишається за детермінованим кодом.
...
Контроль допуску на основі типізованих суджень на межі трафіку: тришаровий фільтр ін’єкцій у промпти та зловживань для nginx/OpenResty на основі TypeSafe Jev. Режим fail-open, кешування, гаряче перезавантаження.
...
Малюйте на полотні tldraw за допомогою голосу та вказівного пальця. Jev (TypeSafe System One) визначає дію, ціль і місце приблизно за 350 мс на кожне вимовлене слово.
...
- [ollaya-dev/ollaya](https://github.com/ollaya-dev/ollaya) - Запускайте відкриті моделі прийняття рішень локально: завантажуйте й…
...
JevK5: альтернатива з відкритими вагами для TypeSafe Jev. Типізовані рішення з імовірностями за один прямий прохід; ваги та код Apache-2.0.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/allebee--jevk5/1f9cd6cb325d4bd4.gif" width="100%" alt="allebee/jevk5 animation"><br><sub>анімований запис · <a href="https://raw.githubusercontent.com/allebee/jevk5/main/docs/demo/jevk5-nvidia-demo.mp4">Відкрити відео</a></sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/weitianxin--jevany/711125367b6758ff.gif" width="100%" alt="weitianxin/JevAny animation"><br><sub>анімований запис</sub></td>
</tr></table>
...
Крихітна модель на кшталт jev, яка за один прямий прохід відповідає на запитання Choice, Score і Noul та повертає калібровані ймовірності. MLX або PyTorch, повністю офлайн, сумісна з System One.
...
- [Eliot5566/JEV-Paper-Radar](https://github.com/Eliot5566/JEV-Paper-Radar) - Дозвольте Jev щоранку читати кожну нову статтю з arXiv і показувати ті кілька…
...
Типізовані рішення з неструктурованого стану: один прямий прохід, нуль згенерованого тексту. Локальний, детермінований, сумісний із Jev. Не пов’язаний із typesafe.ai.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/antonellof--laya-vs-dijkstra/b61bc3a8e3d368be.gif" width="100%" alt="antonellof/laya-vs-dijkstra animation"><br><sub>анімований запис</sub></td>
</tr></table>
...
Семантичні ifs із відкритих моделей на домашній 3090. Незалежний проєкт; не пов’язаний із Jev або TypeSafe.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/theoleecj--semif-openjev/0504149cd9ef3cad.gif" width="100%" alt="TheoLeeCJ/SemIf-OpenJev animation"><br><sub>анімований запис</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/zadescoxp--jev-trades/2abea899d779de55.gif" width="100%" alt="zadescoxp/Jev-Trades animation"><br><sub>анімований запис</sub></td>
</tr></table>
...
- [NanmiCoder/jev-arena](https://github.com/NanmiCoder/jev-arena) - Вступ і практичне тестування моделі Jev: перетворює природну мову на типізовані…
...
<details>
<summary>📰 <b><a href="https://typesafe.ai/team">TypeSafe додав сторінку Team + у навігацію додано вхід `Enterprise` (сигнал productization/commercialization)</a></b> · ✅ official · 6 天</summary>
...
<details>
<summary><b>Більше в цій категорії</b> <sub>· 89</sub></summary>
...
Сімейство моделей прийняття рішень на кшталт Jev, створених на основі Qwen3.5/3.8, які можна навчати й запускати самостійно
...
Навчайте мультимодальну модель на кшталт Jev самостійно. System One Model, тепер із підтримкою зору.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/liuziyu77--valen/d4fa3bf5c399a28d.gif" width="100%" alt="Liuziyu77/Valen animation"><br><sub>анімований запис</sub></td>
</tr></table>
...
Локальна заміна Jev, моделі System One від TypeSafe, сумісна з API
...
JevChat-Windows: помічник для відповідей, закріплений поруч із вікном чату. Знімок вікна + локальний офлайн OCR читає повідомлення співрозмовника → Jev визначає намір → 3 варіанти вставляються одним натисканням, надсилання завжди виконується вручну
...
Помічник у плаваючому вікні чату (macOS): сприйняття екрана + локальна мала модель визначають намір і ризик та генерують варіанти відповідей за шаблонами. Лише читання.
...
- [1Panel-dev/laya-server](https://github.com/1Panel-dev/laya-server) - Самостійно розгортуваний API і вебінтерфейс для структурованих моделей…
...
- [alvarobartt/sys1](https://github.com/alvarobartt/sys1) - Сумісний із System One API для відкритих моделей прийняття рішень, написаний на…
...
- [HITsz-TMG/JevEmbed](https://github.com/HITsz-TMG/JevEmbed) - Знайомтеся з JevEmbed — перетворюйте вбудовування на рішення.
...
<sub>Згенеровано за допомогою · `render.py` · 2026-09-25T18:10:37+08:00</sub>
