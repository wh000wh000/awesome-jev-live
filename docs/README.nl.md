...
> [!NOTE]
> **Live-index** · Laatste synchronisatie: `2026-09-23T20:09:57+08:00` (UTC+8)
> · Vermeldingen: **770** · Nieuw in deze ronde: **76** · Implementatietalen: **22**
...
<sub>grep naar de vragen die je niet als patroon kunt schrijven. Leest elke functie in plaats van er een paar te samplen. Aangedreven door Jev, het System One-model van…</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
- [Community-clients, SDK's en adapters](#community-clients-sdks-en-adapters) — **132**
- [Agent-tooling: MCP, hooks, gates en coding agents](#agent-tooling-mcp-hooks-gates-en-coding-agents) — **231**
- [Routing, guardrails en goedkeuringen](#routing-guardrails-en-goedkeuringen) — **57**
- [Evaluatie, kalibratie en benchmarks](#evaluatie-kalibratie-en-benchmarks) — **76**
- [Open reproducties, gewichten en architectuuronderzoek](#open-reproducties-gewichten-en-architectuuronderzoek) — **44**
- [Toepassingen, games, robotica en interactieve demo's](#toepassingen-games-robotica-en-interactieve-demos) — **47**
- [Artikelen, discussies en zusterlijsten](#artikelen-discussies-en-zusterlijsten) — **97**
- [Overige projecten](#overige-projecten) — **80**
...
<sub>🔧 Aangetroffen in code: `src/typesafe_sdk/__init__.py`, `src/typesafe_sdk/_core/retry.py`, `src/typesafe_sdk/_core/config.py`</sub>
...
Een aangepaste codeerharnas voor TypeSafe AI's Jev: een LLM doet een voorstel, Jev beantwoordt gerichte vragen, code neemt de beslissing en elke stap laat een ontvangstbewijs achter.
...
Een Elixir-bibliotheek rond het éénmodel van ConvAI Innovations' OSS Laya-systeem
...
grep naar de vragen die je niet als patroon kunt schrijven. Leest elke functie in plaats van er een paar te samplen. Aangedreven door Jev, het System One-model van TypeSafe AI.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/clouatre-labs--decisions-judge-mcp/c8c00f2b58774857.gif" width="100%" alt="clouatre-labs/decisions-judge-mcp animation"><br><sub>geanimeerde opname</sub></td>
</tr></table>
...
Eén offboard CLI voor al je robots. Verbind ze, geef ze opdrachten en laat ze samenwerken, elk met een LLM als brein (Claude, OpenAI, Gemini, Grok of lokaal via Ollama of vLLM) en een beslis-LLM voor goedkopere en snellere stappen (Jev, Laya en Kev). Ondersteunt Microduck, Open Duck Mini, LeRobot, XLeRobot, AlohaMini, ToddlerBot, Jetson of elke ROS.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/rokbenko--quackd/2060eda6dcb35de6.gif" width="100%" alt="rokbenko/quackd animation"><br><sub>geanimeerde opname</sub></td>
</tr></table>
...
R.A.I.N. Lab is een experimentele architectuur voor wetenschappelijke agents die snel lokaal oordeel, onafhankelijke probabilistische evaluatie, multi-agentberaad, bewijs en autorisatie scheidt in afzonderlijke computationele lagen.🐙(Gaat vooraf aan Karpathy's AutoResearch)
...
jev-seo: Rust SEO en GEO CLI plus MCP-server voor codeeragenten: audits met 50 regels, live crawls, GEO-scores, rangschommelingen, CI-gates. MIT, zonder abonnement.
...
Handelsdagboek en review-harnas met alleen-lezen: getypeerde oordelen van Jev, agentintegratie en een reproduceerbare financiële benchmark. Geen orders, geen advies.
...
<details>
<summary><b>Meer in deze categorie</b> <sub>· 110</sub></summary>
...
- [agent-chaperone/agent-chaperone](https://github.com/agent-chaperone/agent-chaperone) - Controleert de toolaanroepen van een AI-agent voordat ze worden uitgevoerd en…
...
- [9pings/notjev](https://github.com/9pings/notjev) - SuperJev-achtige snelle server, modelonafhankelijk en werkend met elk…
- [keltokhy/jsort](https://github.com/keltokhy/jsort) - sorteren op betekenis: orden regels langs een dimensie in gewoon Engels, op…
...
- [talmago/fast_gliner](https://github.com/talmago/fast_gliner) - Python-bindings voor de Inference-engine voor GLiNER-modellen, geschreven in…
- [frostney/clean-code-review](https://github.com/frostney/clean-code-review) - Elk codebestand in een pull request wordt beoordeeld aan de hand van Uncle…
...
- [lucasmartins-ai/lcc](https://github.com/lucasmartins-ai/lcc) - Local Context Compiler (lcc): ruim promptcontext op, verwijder duplicaten en…
...
- [KiritoKing/midscene-jev-runner](https://github.com/KiritoKing/midscene-jev-runner) - Door de community onderhouden JEV-runnerintegratie voor Midscene Test.
...
- [vercel-labs/jev-ai-sdk-form-router](https://github.com/vercel-labs/jev-ai-sdk-form-router) - Stuur formulierinzendingen naar de juiste mensen met Jev en AI SDK.
- [ansidium/jev-codex-bridge](https://github.com/ansidium/jev-codex-bridge) - Routering van modellen en redeneringen voor Codex Desktop en CLI, met een…
...
- [kitfunso/hippo-memory](https://github.com/kitfunso/hippo-memory) - Biologisch geïnspireerd geheugen voor AI-agents.
...
- [nylon-memory/NylonME](https://github.com/nylon-memory/NylonME) - Een Memory Engine voor AI-agents. Werken met Jev kan een hogere…
...
Agentvaardigheid voor het vinden, bouwen, evalueren en verbeteren van beslismodelsystemen. Compositorische besliskunde, evaluatieharnassen en begrensd hill-climbing van prompts/programma's voor Software 3.0. TypeSafe Jev is het standaardgehoste voorbeeld. Onafhankelijk van TypeSafe.
...
<td align="center" valign="top"><a href="https://youtu.be/ZC4oge4WsCQ"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/24601--augustus/d2593af47d538d33.jpg" width="100%" alt="video"></a><br><sub><a href="https://youtu.be/ZC4oge4WsCQ">Bekijk op youtu.be</a> · afspelen opent op de hostsite; GitHub kan het niet inline insluiten</sub></td>
</tr></table>
...
<details>
<summary><b>Meer in deze categorie</b> <sub>· 209</sub></summary>

- [ChenneyZhuang/laya-browser-agent](https://github.com/ChenneyZhuang/laya-browser-agent) - Lokaal, opensource-alternatief voor Jev: beslissingen van een browseragent met…
...
- [kydlikebtc/awesome-jev](https://github.com/kydlikebtc/awesome-jev) - 805 geverifieerde voorbeelden van Jev — het System One-beslissingsmodel van…
...
- [socai-io/jev-social](https://github.com/socai-io/jev-social) - Jev × SocAI voor onderzoek op Instagram, TikTok en LinkedIn—getypeerde…
...
- [PromptEngineer48/laya-vs-jev-arena](https://github.com/PromptEngineer48/laya-vs-jev-arena) - Laya (open source, lokaal) versus TypeSafe Jev (API): twee AI-modellen strijden…
...
- [ThinkFlowLab/system1-agents](https://github.com/ThinkFlowLab/system1-agents) - System 1-beslismodellen (Jev, Laya, Cua-S1) als brein voor agents…
...
- [jiawei686/jev-ultrafast-mcp](https://github.com/jiawei686/jev-ultrafast-mcp) - Draag browserwerk over: een MCP-server waarop een beslissingsmodel de pagina…
...
- [rashedInt32/jev-mcp](https://github.com/rashedInt32/jev-mcp) - MCP-server die TypeSafe Jev beschikbaar maakt als getypeerde, gekalibreerde…
- [ZephyrDeng/ego-jev](https://github.com/ZephyrDeng/ego-jev) - Jev (TypeSafe System One) inner loop voor ego-browser — één getypte beslissing…
- [green-dalii/pi-shift-router](https://github.com/green-dalii/pi-shift-router) - Modelrouting per beurt voor de Pi-codeeragent: een kleine beoordelaar kiest…
...
- [jiangkoumo/ego-jev](https://github.com/jiangkoumo/ego-jev) - Bestuur de ego lite-browser met Jev (TypeSafe System One): één geïndexeerde…
...
- [itsmostafa/typesafe-mcp](https://github.com/itsmostafa/typesafe-mcp) - Een mcp-connector om alles snel en goedkoop te evalueren.
...
Niet-autoregressieve System 1-beslissingsengine. Getypeerde keuze-, score- en ja/nee-beslissingen over willekeurige tekst in één forward pass, in meer dan 100 talen, met een router die per verzoek het juiste checkpoint selecteert.

<sub>🔧 Aangetroffen in code: `research/benchmarks/feishu_zh/run.py`</sub>
...
Jev, het System One-model van TypeSafe, speelt schaak tegen elke OpenRouter LLM, Stockfish en jou. Webapp op één pagina met live zetten, zetwaarschijnlijkheden van Jev, opgeslagen partijen en winstpercentages.
...
Een Clash Royale-bot zonder getraind beleid: Jev (TypeSafe System One) neemt elke beslissing op basis van de actuele spelstatus
...
Filter je X.com-feed met Jev of een willekeurige LLM
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/tshmieldev--sharp/016860f6bb08aa6b.gif" width="100%" alt="tshmieldev/sharp animation"><br><sub>geanimeerde opname</sub></td>
</tr></table>
...
Een verificatielaag voor AI-evaluaties. Controleert het instrument, niet alleen de score: gegevens, beoordelaar, runs, cijfers, claims en zichzelf.
...
- [zeeshan8281/slo-router](https://github.com/zeeshan8281/slo-router) - SLO-bewuste LLM-inferentierouter met Jev-beslissingen, live…
...
- [Trystan-SA/laya-candle](https://github.com/Trystan-SA/laya-candle) - JEV-achtige Rust-port met Laya, 100% lokaal, geen Python.
...
Maak van elke LLM een beslismodel in Jev-stijl: getypeerde beslissingen, echte waarschijnlijkheden, geen training. (continu bijgewerkt)
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/nokia-applied-research--anyjev/93e61c3de618cc36.gif" width="100%" alt="nokia-applied-research/AnyJev animation"><br><sub>geanimeerde opname</sub></td>
</tr></table>
...
Een open trainings- en inferentiestack voor beslismodellen in de stijl van Jev. Train modellen om dynamische kandidaatvertakkingen vanuit een gedeeld prefix te scoren, met ondersteuning voor keuzes met hoge kardinaliteit, kalibratie en snelle gebatchte inferentie.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/weitianxin--jevany/05825e369317a429.gif" width="100%" alt="weitianxin/JevAny animation"><br><sub>geanimeerde opname</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/ankit-aglawe--tinyjev/bff87199840daa0f.gif" width="100%" alt="ankit-aglawe/tinyjev animation"><br><sub>geanimeerde opname</sub></td>
</tr></table>
...
- [ARCJ137442/jev-2048](https://github.com/ARCJ137442/jev-2048) - Een geïnstrumenteerd 2048-weblab waarin elke zet een Jev.
...
- [fstandhartinger/jevbench](https://github.com/fstandhartinger/jevbench) - JevBench v1 - een benchmark voor getypeerde beslismodellen van de klasse Jev…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/fbddcz--embodied-jev/297ef7c24f9a67a8.gif" width="100%" alt="FBddcz/embodied-jev animation"><br><sub>geanimeerde opname · <a href="https://raw.githubusercontent.com/FBddcz/embodied-jev/main/docs/media/libero-drawer-comparison.mp4">Video openen</a></sub></td>
</tr></table>
...
Een lokale, offline System One-server die compatibel is met TypeSafe's Jev API. Deze beantwoordt getypeerde ja/nee-, categorie- en scorevragen met kleine open modellen.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/bl888m/jev-bot/main/assets/demo.gif" width="100%" alt="bl888m/jev-bot animation"><br><sub>geanimeerde opname</sub></td>
</tr></table>
...
De meest complete galerij van wat mensen bouwen met Jev, het TypeSafe System One-model: meer dan 3.400 projecten, demo's en uitwerkingen per scenario, elk met de oorspronkelijke link, afbeelding en beschrijving.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/darthblanc/tictacjev/main/assets/screenrecording.gif" width="100%" alt="darthblanc/tictacjev animation"><br><sub>geanimeerde opname</sub></td>
</tr></table>
...
- [heyjunpenn/awesome-jev](https://github.com/heyjunpenn/awesome-jev) - Een geverifieerde, door de community onderhouden catalogus van 832…
...
<details>
<summary>📰 <b><a href="https://typesafe.ai/team">TypeSafe voegt Team-pagina toe + navigatie voegt `Enterprise`-ingang toe (signaal van productisering/commercialisering)</a></b> · ✅ official · 4 天</summary>
...
<details>
<summary><b>Meer in deze categorie</b> <sub>· 85</sub></summary>
...
- [Show HN: Will Jev pull the lever in the trolley problem?](https://news.ycombinator.com/item?id=49773756) - De Jev-benchmark waarop jullie allemaal hebben gewacht: zal Jev de hendel…
...
Een open-source System One Model met hoge prestaties voor getypeerde beslissingen in één doorgang, met een inbedbare C-runtime en WebAssembly-ondersteuning.
...
Antwoordassistent naast WeChat（Windows 4.x）：vensterscreenshot + lokaal offline OCR leest berichten van de andere partij → Jev bepaalt de intentie → 3 kandidaatantwoorden met één klik invullen; verzenden gebeurt altijd handmatig
...
Zwevend venster voor intentieherkenning van WeChat-berichten（macOS）：bekijkt het scherm + een lokaal klein model bepaalt de intentie en het risico, en genereert vervolgens antwoordkandidaten op basis van gesprekssjablonen. Volledig alleen-lezen, injecteert niets in WeChat.
...
<sub>Gegenereerd door · `render.py` · 2026-09-23T20:09:57+08:00</sub>
