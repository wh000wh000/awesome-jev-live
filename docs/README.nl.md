...
> [!NOTE]
> **Live-index** · Laatste synchronisatie: `2026-09-19T12:51:10+08:00` (UTC+8)
> · Vermeldingen: **452** · Nieuw in deze ronde: **0** · Implementatietalen: **25**
...
- [Community-clients, SDK's en adapters](#community-clients-sdks-en-adapters) — **72**
- [Agent-tooling: MCP, hooks, gates en coding agents](#agent-tooling-mcp-hooks-gates-en-coding-agents) — **138**
- [Routing, guardrails en goedkeuringen](#routing-guardrails-en-goedkeuringen) — **50**
...
- [Artikelen, discussies en zusterlijsten](#artikelen-discussies-en-zusterlijsten) — **37**
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/jimmyhealer--jev-semantic-explorer/f9d2833c758298d8.gif" width="100%" alt="jimmyhealer/jev-semantic-explorer animation"><br><sub>geanimeerde opname</sub></td>
</tr></table>
...
<sub>Gegenereerd door · `render.py` · 2026-09-19T12:51:10+08:00</sub>
