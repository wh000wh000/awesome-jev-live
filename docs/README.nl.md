...
> [!NOTE]
> **Live-index** · Laatste synchronisatie: `2026-09-26T03:12:11+08:00` (UTC+8)
> · Vermeldingen: **806** · Nieuw in deze ronde: **123** · Implementatietalen: **23**
...
- [Routing, guardrails en goedkeuringen](#routing-guardrails-en-goedkeuringen) — **61**
...
Een database-agnostisch Agentic GraphRAG-framework dat gebruikmaakt van verwisselbare System One-modellen (lokale Laya / cloud-Jev). Een plug-and-play-intelligentielaag met een complete pipeline in 4 fasen, continue evaluatie en aangepaste A*-traversal voor elke grafiekdatabase.
...
Beslissingsharnas voor TypeSafe Jev — betrouwbaarheidsdrempels, schaduwmodus, recepten en evaluaties. Claude CLI 48,9 s → Jev 1,3 s voor dezelfde rijfiltertaak.
...
Dekking, beveiliging en codekwaliteit voor codeeragents
...
- [topherchris420/james_library](https://github.com/topherchris420/james_library) - R.A.I.N. Lab is een experimentele architectuur voor wetenschappelijke agents…
...
- [6Mikao9/jev-native-agent-with-extended-options](https://github.com/6Mikao9/jev-native-agent-with-extended-options) - Onderzoeksontwerp voor een Jev-native agentsysteem: maak meer opties mogelijk…
...
- [carldaws/hunch](https://github.com/carldaws/hunch) - Probabilistische control flow voor Ruby en Rails — mogelijk gemaakt door…
...
- [ruban-24/switchboard](https://github.com/ruban-24/switchboard) - Een open-source, modelagnostische beslisrouter voor Claude Code en Codex.
...
- [MiaoWuNYA/rikkahub-sillytavern-android](https://github.com/MiaoWuNYA/rikkahub-sillytavern-android) - Android AI-chatclient: verliesvrije import van SillyTavern-kaarten, krachtige…
...
- [erkamyaman/jev-enforce](https://github.com/erkamyaman/jev-enforce) - 📏 Claude Code-plugin die Claude je AGENTS.md laat volgen: elk antwoord en elke…
...
Voer open beslissingsmodellen lokaal uit: haal Laya, decider, NLI en GLiClass op en serveer ze achter een TypeSafe-compatibele API. Ollama voor beslissingsmodellen.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/4nt0ineb--jev-from-java/cd4ce3d04107d762.gif" width="100%" alt="4nt0ineB/jev-from-java animation"><br><sub>geanimeerde opname</sub></td>
</tr></table>
...
- [WiktorB2004/llama-index-jev](https://github.com/WiktorB2004/llama-index-jev) - LlamaIndex-reranker + router, aangedreven door TypeSafe Jev — getypeerde…
...
<details>
<summary><b>Meer in deze categorie</b> <sub>· 60</sub></summary>
...
- [anessbelbati/jev-rerank-bench](https://github.com/anessbelbati/jev-rerank-bench) - Kan een beslismodel gespecialiseerde rerankers verslaan? TypeSafe Jev versus…
...
jevos is een open-sourcealternatief voor Jev voor ja/nee-beslissingen dat op je laptop draait.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/feder-cr/jev/main/assets/dino_run.gif" width="100%" alt="feder-cr/jev animation"><br><sub>geanimeerde opname</sub></td>
</tr></table>
...
<details>
<summary>📰 <b><a href="https://typesafe.ai/team">TypeSafe voegt Team-pagina toe + navigatie voegt `Enterprise`-ingang toe (signaal van productisering/commercialisering)</a></b> · ✅ official · 7 天</summary>
...
<details>
<summary><b>Meer in deze categorie</b> <sub>· 92</sub></summary>
...
- [Show HN: Doom or Bloom, map your AI worldview with Jev](https://news.ycombinator.com/item?id=49846953) - Breng je AI-wereldbeeld in kaart door een paar vragen te beantwoorden en zie…
...
Chinese vertaling van de officiële gebruiksdocumentatie van het Jev-model (TypeSafe AI) | Onofficiële Chinese vertaling van de officiële Jev-documentatie (TypeSafe AI) — https://docs.typesafe.ai
...
- [doeixd/discern](https://github.com/doeixd/discern) - Maak typeveilige, onzekerheidsbewuste semantische patroonmatching, control flow…
...
<sub>Gegenereerd door · `render.py` · 2026-09-26T03:12:11+08:00</sub>
