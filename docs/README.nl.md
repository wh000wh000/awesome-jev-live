...
> [!NOTE]
> **Live-index** · Laatste synchronisatie: `2026-09-22T16:07:34+08:00` (UTC+8)
> · Vermeldingen: **741** · Nieuw in deze ronde: **86** · Implementatietalen: **25**
...
- [Community-clients, SDK's en adapters](#community-clients-sdks-en-adapters) — **119**
- [Agent-tooling: MCP, hooks, gates en coding agents](#agent-tooling-mcp-hooks-gates-en-coding-agents) — **223**
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/chenycl--jev-browser-skill/6f1223bb1aa99b1b.gif" width="100%" alt="ChenYCL/jev-browser-skill animation"><br><sub>geanimeerde opname · <a href="https://raw.githubusercontent.com/ChenYCL/jev-browser-skill/main/assets/demo-wikipedia.mp4">Video openen</a></sub></td>
</tr></table>
...
Jev-aangedreven, regelgebaseerde beoordelaar voor tekstbestanden. Voert elke regel parallel uit tegen elke regel tekst. Geen vluchtig doorlezen, geen gemiste regels.
...
SDK-first, onafhankelijk onderhouden SemIf-fork voor snelle, zelfgehoste semantische beslissingen.
...
<details>
<summary><b>Meer in deze categorie</b> <sub>· 97</sub></summary>
...
- [BeatAPI/awesome-jev](https://github.com/BeatAPI/awesome-jev) - Een op broncode beoordeelde galerij van JEV-gerelateerde projecten met 50+…
...
- [AkashPriyadarshii/jev-seo](https://github.com/AkashPriyadarshii/jev-seo) - 100% gratis ₹0 agent-first SEO &amp; GEO CLI-suite en MCP-server in Rust ter…
...
- [doronp/jevc](https://github.com/doronp/jevc) - Compileer proza voor agentbeleid naar deterministische oordeelprogramma.
...
<details>
<summary><b>Meer in deze categorie</b> <sub>· 201</sub></summary>
...
- [poiuyjie/jev_project_context](https://github.com/poiuyjie/jev_project_context) - Vaardigheid voor langetermijngeheugen van experimenten, gebaseerd op bewijs…
...
- [ziqi-jin/agent-to-trust](https://github.com/ziqi-jin/agent-to-trust) - Vertrouw een Agent niet. Test het. Open-source laboratorium voor agentkrediet…
...
- [malevrigns/agent-jev](https://github.com/malevrigns/agent-jev) - AgentJev-0.6B - een snel &#x27;System One&#x27;-beslismodel voor AI Agents: voer elke…
- [ronadin2002/jev-cua](https://github.com/ronadin2002/jev-cua) - Spraak- en tekstbesturing voor macOS. Eén zwevende balk, live selectie van…
...
- [jon-devlapaz/tink-route](https://github.com/jon-devlapaz/tink-route) - Dynamische, op vertrouwen gebaseerde routing van Agent Skills met TypeSafe Jev…
...
- [cskwork/pi-jev-router](https://github.com/cskwork/pi-jev-router) - Automatische modelroutering voor Pi met TypeSafe.
...
- [kavehmz/typesafe-playground](https://github.com/kavehmz/typesafe-playground) - Interactieve experimenten met TypeSafe Jev, van supportroutering tot…
...
OmniJev — multimodale beslisinterface met eindige keuzes en MuJoCo-embodied workbench: trajectreplays, beslisprobes, benchmarkpanelen, walkthrough van 60s.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/shapsider--omnijev/fab2a3d9229ff025.gif" width="100%" alt="shapsider/OmniJev animation"><br><sub>geanimeerde opname · <a href="https://raw.githubusercontent.com/shapsider/OmniJev/main/docs/media/omnijev-intro-60s.mp4">Video openen</a></sub></td>
</tr></table>
...
- [nibzard/decision-model-benchmark](https://github.com/nibzard/decision-model-benchmark) - Onafhankelijke, reproduceerbare benchmark: een beslismodel (jev), acht beperkte…
...
Native MLX runtime voor Laya-getypte beslismodellen — korte beslissingen van 7–14 ms op M3 Max. Geen tekstgeneratie, PyTorch of cloud-API.
...
- [vtavakkoli/simple-jev](https://github.com/vtavakkoli/simple-jev) - Maak van elk open model een classifier/jev-eindpunt.
...
- [heyjunpenn/awesome-jev](https://github.com/heyjunpenn/awesome-jev) - Een geverifieerde, door de community onderhouden catalogus van 640 open-source…
...
Chinese vertaling van de officiële gebruiksdocumentatie voor het Jev-model (TypeSafe AI) | Onofficiële Chinese vertaling van de officiële Jev (TypeSafe AI)-documentatie — https://docs.typesafe.ai
...
TypeLLM: LLMs met typeveilige generatie
...
- [keltokhy/jsort](https://github.com/keltokhy/jsort) - sorteer op betekenis: orden regels langs een dimensie in eenvoudig Engels, op…
...
<sub>Gegenereerd door · `render.py` · 2026-09-22T16:07:34+08:00</sub>
