...
> [!NOTE]
> **Live-index** · Laatste synchronisatie: `2026-09-25T18:10:37+08:00` (UTC+8)
> · Vermeldingen: **799** · Nieuw in deze ronde: **298** · Implementatietalen: **24**
...
- [Agent-tooling: MCP, hooks, gates en coding agents](#agent-tooling-mcp-hooks-gates-en-coding-agents) — **249**
- [Routing, guardrails en goedkeuringen](#routing-guardrails-en-goedkeuringen) — **58**
...
- [Artikelen, discussies en zusterlijsten](#artikelen-discussies-en-zusterlijsten) — **102**
- [Overige projecten](#overige-projecten) — **82**
...
<sub>🔧 Aangetroffen in code: `src/typesafe_sdk/__init__.py`</sub>
...
Een databaseagnostisch Agentic GraphRAG-framework met verwisselbare System One-modellen (lokaal Laya / cloud Jev). Een plug-and-play-intelligentielaag met een complete pipeline in 4 fasen en aangepaste A*-traversal voor elke grafiekdatabase.
...
Meer dan 200 plug-and-play-Jev-recepten: kleine, gekalibreerde AI-beslissingen die tekst routeren, beoordelen, afschermen, vergelijken en labelen voor agents, RAG, ondersteuning, code-review en muziek. Importeer uit JavaScript of TypeScript, of roep de CLI aan met JSON vanuit elke taal.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/agencyenterprise--jev-recipes/0f08086836b893d8.gif" width="100%" alt="agencyenterprise/jev-recipes animation"><br><sub>geanimeerde opname</sub></td>
</tr></table>
...
Community-Java SDK voor Jev, het System One-model van TypeSafe: getypeerde vragen erin, getypeerde antwoorden met gekalibreerde waarschijnlijkheden eruit. Java 17+, Spring Boot-starter (onofficieel)
...
Eén CLI voor al je robots. Verbind ze, geef ze opdrachten en laat ze samenwerken, elk met een LLM als brein (Claude, OpenAI, Gemini, Grok of lokaal via Ollama of vLLM) en een beslissings-LLM voor meerkeuze (Jev, Laya, Kev). Stuurt Microduck, Open Duck Mini, LeRobot, XLeRobot, AlohaMini, ToddlerBot of elke ROS 2-basis aan vanaf een laptop, offboard.
...
CLI die voor een taak Cursor, Claude Code, Codex of OpenCode + model/inspanning kiest en die vervolgens start. Aangedreven door Jev en Herdr
...
<details>
<summary><b>Meer in deze categorie</b> <sub>· 111</sub></summary>
...
- [chengyongru/fastjev](https://github.com/chengyongru/fastjev) - SDK-first, onafhankelijk onderhouden SemIf-fork voor snelle, zelf gehoste…
...
- [CheshiAI/Cheshi](https://github.com/CheshiAI/Cheshi) - Gespreksgeheugen aangedreven door Jev: vind eerdere sessies en bekijk…
...
- [utk2103/jev-studio](https://github.com/utk2103/jev-studio) - als je met jev experimenteert, gaat het vanaf hier gemakkelijker.
...
Lokaal, opensource-alternatief voor Jev: beslissingen van een browseragent met Laya (System One-model) op je eigen machine. Geen cloud, geen API-sleutel. Playwright/CDP, MCP-vriendelijk.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/mansicer--jev-plays/c4f1ec41afcb4ae9.gif" width="100%" alt="mansicer/jev-plays animation"><br><sub>geanimeerde opname</sub></td>
</tr></table>
...
<details>
<summary><b>Meer in deze categorie</b> <sub>· 231</sub></summary>
...
- [walidboulanouar/awesome-jev-use-cases](https://github.com/walidboulanouar/awesome-jev-use-cases) - Geweldige lijst met TypeSafe AI Jev-gebruiksscenario&#x27;s: 74 demo&#x27;s gerangschikt…
...
- [supercorp-ai/supercov](https://github.com/supercorp-ai/supercov) - Dekking, beveiliging en codekwaliteit voor codeeragents.
...
- [angel291592/Intent-Router](https://github.com/angel291592/Intent-Router) - Intentiecompiler voor AI-agents — zet vage verzoeken om in getypeerde…
- [socai-io/jev-social](https://github.com/socai-io/jev-social) - Opensource Agent Skill en lokale demo: Jev × socai voor onderzoek op Instagram…
...
- [OmniJev/PlayJev](https://github.com/OmniJev/PlayJev) - 🚀🚀 Een 0.8B JEV-achtig multimodaal model dat GUI-games rechtstreeks vanuit…
- [jonathanavis96/jev-kit](https://github.com/jonathanavis96/jev-kit) - Alles wat je nodig hebt om TypeSafe.
- [PyModel/jev-judge-mcp](https://github.com/PyModel/jev-judge-mcp) - Tools voor getypeerde beoordelingen voor MCP-agents.
...
- [khordoo/jev-reflex-autonomy-lab](https://github.com/khordoo/jev-reflex-autonomy-lab) - Realtime simulatie van autonome zwermen drones met Jev voor snelle…
...
- [bgivenb/flick-computer-use](https://github.com/bgivenb/flick-computer-use) - Snel browser- en macOS-computergebruik voor MCP-agents.
...
- [24601/Augustus](https://github.com/24601/Augustus) - Agentvaardigheid voor het vinden, bouwen, evalueren en verbeteren van…
...
- [AskTheWay/dsh-jev-interceptor](https://github.com/AskTheWay/dsh-jev-interceptor) - ⚡ Milliseconde-Systeem-1-beoordeling voor elke toolaanroep in DeepSeek Harness…
...
Realtime risicotriagegateway voor stortingen en opnames bij exchanges — Jev (TypeSafe System One) handelt alleen triage af; beoordeling blijft in deterministische code.
...
Toelatingscontrole met getypeerde beoordelingen aan de verkeersrand: drielaags filter tegen promptinjectie en misbruik voor nginx/OpenResty, aangedreven door TypeSafe Jev. Fail-open, gecachet en hot-reloadable.
...
Teken op een tldraw-canvas met je stem en een wijzende vinger. Jev (TypeSafe System One) bepaalt actie, doel en plaats in ~350 ms per gesproken woord.
...
JevK5: open-weightsalternatief voor TypeSafe Jev. Getypeerde beslissingen met waarschijnlijkheden in één forward pass; Apache-2.0-gewichten en code.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/allebee--jevk5/1f9cd6cb325d4bd4.gif" width="100%" alt="allebee/jevk5 animation"><br><sub>geanimeerde opname · <a href="https://raw.githubusercontent.com/allebee/jevk5/main/docs/demo/jevk5-nvidia-demo.mp4">Video openen</a></sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/weitianxin--jevany/711125367b6758ff.gif" width="100%" alt="weitianxin/JevAny animation"><br><sub>geanimeerde opname</sub></td>
</tr></table>
...
- [Eliot5566/JEV-Paper-Radar](https://github.com/Eliot5566/JEV-Paper-Radar) - Laat Jev elke nieuwe arXiv-paper elke ochtend lezen en de paar papers die je…
...
Getypeerde beslissingen uit ongestructureerde toestand: één forward pass, nul gegenereerde tekst. Lokaal, deterministisch, Jev-compatibel. Niet gelieerd aan typesafe.ai.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/antonellof--laya-vs-dijkstra/b61bc3a8e3d368be.gif" width="100%" alt="antonellof/laya-vs-dijkstra animation"><br><sub>geanimeerde opname</sub></td>
</tr></table>
...
Semantische ifs van open modellen, op een 3090 thuis. Onafhankelijk; niet gelieerd aan Jev of TypeSafe.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/theoleecj--semif-openjev/0504149cd9ef3cad.gif" width="100%" alt="TheoLeeCJ/SemIf-OpenJev animation"><br><sub>geanimeerde opname</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/zadescoxp--jev-trades/2abea899d779de55.gif" width="100%" alt="zadescoxp/Jev-Trades animation"><br><sub>geanimeerde opname</sub></td>
</tr></table>
...
<details>
<summary>📰 <b><a href="https://typesafe.ai/team">TypeSafe voegt Team-pagina toe + navigatie voegt `Enterprise`-ingang toe (signaal van productisering/commercialisering)</a></b> · ✅ official · 6 天</summary>
...
Een Jev-achtige familie van beslissingsmodellen, gebouwd boven op Qwen3.5/3.8, die je zelf kunt trainen en uitvoeren
...
Train zelf een multimodaal model in Jev-stijl. System One Model, nu met vision.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/liuziyu77--valen/d4fa3bf5c399a28d.gif" width="100%" alt="Liuziyu77/Valen animation"><br><sub>geanimeerde opname</sub></td>
</tr></table>
...
Een lokale, API-compatibele vervanging voor Jev, het System One-model van TypeSafe
...
- [alvarobartt/sys1](https://github.com/alvarobartt/sys1) - System One-compatibele API voor open beslissingsmodellen, geschreven in Rust.
...
- [Kevthetech143/super-jev](https://github.com/Kevthetech143/super-jev) - Een kleine, uitbreidbare harness voor beslissing-naar-actie voor TypeSafe Jev.
...
<sub>Gegenereerd door · `render.py` · 2026-09-25T18:10:37+08:00</sub>
