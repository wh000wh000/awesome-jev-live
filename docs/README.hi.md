...
> [!NOTE]
> **लाइव सूचकांक** · अंतिम सिंक: `2026-09-26T03:12:11+08:00` (UTC+8)
> · प्रविष्टियाँ: **806** · इस चक्र में नई: **123** · कार्यान्वयन भाषाएँ: **23**
...
- [एजेंट उपकरण: MCP, हुक, गेट और कोडिंग एजेंट](#एजट-उपकरण-mcp-हक-गट-और-कडग-एजट) — **245**
- [रूटिंग, गार्डरेल और अनुमोदन](#रटग-गरडरल-और-अनमदन) — **61**
...
swappable System One models (local Laya / cloud Jev) का उपयोग करने वाला database-agnostic Agentic GraphRAG framework। किसी भी graph database के लिए complete 4-phase pipeline, continuous evaluation और custom A* traversal वाली plug-and-play intelligence layer।
...
TypeSafe Jev के लिए निर्णय हार्नेस — विश्वास गेट, शैडो मोड, रेसिपी और मूल्यांकन। उसी पंक्ति-फ़िल्टर कार्य पर Claude CLI 48.9s → Jev 1.3s।
...
Jev, TypeSafe के System One model के लिए community Java SDK: typed questions in, calibrated probabilities वाले typed answers out। Java 17+, Spring Boot starter (unofficial)
...
coding agents के लिए coverage, security और code quality
...
- [topherchris420/james_library](https://github.com/topherchris420/james_library) - R.A.I.N. Lab एक प्रायोगिक वैज्ञानिक-एजेंट आर्किटेक्चर है, जो तेज़ स्थानीय…
...
- [6Mikao9/jev-native-agent-with-extended-options](https://github.com/6Mikao9/jev-native-agent-with-extended-options) - Jev-native एजेंट सिस्टम के लिए अनुसंधान डिज़ाइन: वर्चुअलाइजेशन और पेजिंग के साथ…
...
- [CheshiAI/Cheshi](https://github.com/CheshiAI/Cheshi) - Jev-powered conversation memory: पिछली sessions खोजें और original sources के…
- [carldaws/hunch](https://github.com/carldaws/hunch) - Ruby और Rails के लिए संभाव्य नियंत्रण प्रवाह — TypeSafe के Jev द्वारा संचालित.
- [evoke-build/evoke](https://github.com/evoke-build/evoke) - Software, reflex के ज़रिए। इसे कहें और सही छोटा program चल जाता है: calibrated…
...
- [ruban-24/switchboard](https://github.com/ruban-24/switchboard) - Claude Code और Codex के लिए एक ओपन-सोर्स, मॉडल-अज्ञेयवादी निर्णय राउटर।.
...
- [MiaoWuNYA/rikkahub-sillytavern-android](https://github.com/MiaoWuNYA/rikkahub-sillytavern-android) - Android AI चैट क्लाइंट: SillyTavern कार्ड का बिना क्षति आयात, कैश का आक्रामक…
...
<details>
<summary><b>इस श्रेणी में और</b> <sub>· 227</sub></summary>
...
- [safzanpirani/pi-jev-skill-picker](https://github.com/safzanpirani/pi-jev-skill-picker) - वर्तमान कार्य के लिए Pi Agent Skills को TypeSafe Jev के साथ रैंक करें.
...
- [PyModel/jev-judge-mcp](https://github.com/PyModel/jev-judge-mcp) - MCP agents के लिए typed judgment tools। TypeSafe के Jev model का उपयोग verify…
...
- [bgivenb/flick-computer-use](https://github.com/bgivenb/flick-computer-use) - MCP agents के लिए तेज़ browser और macOS computer use। Local execution, TypeSafe…
...
- [erkamyaman/jev-enforce](https://github.com/erkamyaman/jev-enforce) - 📏 Claude Code प्लगइन, जो Claude को आपके AGENTS.md का पालन करवाता है: हर उत्तर…
...
- [itsmostafa/system-one-connector](https://github.com/itsmostafa/system-one-connector) - किसी भी चीज़ का तेज़ी और कम लागत में मूल्यांकन करने वाला System One MCP…
...
traffic edge पर typed-judgment admission control: nginx/OpenResty के लिए three-layer prompt-injection और abuse filter, TypeSafe Jev द्वारा संचालित। Fail-open, cached, hot-reloadable।
...
exchange deposits और withdrawals के लिए real-time risk triage gateway — Jev (TypeSafe System One) केवल triage संभालता है; adjudication deterministic code में ही रहता है।
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/4nt0ineb--jev-from-java/cd4ce3d04107d762.gif" width="100%" alt="4nt0ineB/jev-from-java animation"><br><sub>एनिमेटेड रिकॉर्डिंग</sub></td>
</tr></table>
...
- [WiktorB2004/llama-index-jev](https://github.com/WiktorB2004/llama-index-jev) - TypeSafe Jev द्वारा संचालित LlamaIndex reranker + router - typed…
...
- [anessbelbati/jev-rerank-bench](https://github.com/anessbelbati/jev-rerank-bench) - क्या कोई निर्णय मॉडल समर्पित रीरैंकर्स से बेहतर प्रदर्शन कर सकता है? TypeSafe…
...
unstructured state से typed decisions: एक forward pass, zero generated text। Local, deterministic, Jev-compatible। typesafe.ai से संबद्ध नहीं।
...
घर पर 3090 पर open models से Semantic ifs। स्वतंत्र; Jev या TypeSafe से संबद्ध नहीं।
...
jevos, Jev का एक ओपन-सोर्स विकल्प है, जो हाँ/नहीं के निर्णयों के लिए आपके लैपटॉप पर चलता है।
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/feder-cr/jev/main/assets/dino_run.gif" width="100%" alt="feder-cr/jev animation"><br><sub>एनिमेटेड रिकॉर्डिंग</sub></td>
</tr></table>
...
- [Ryu0118/jev-sim-use](https://github.com/Ryu0118/jev-sim-use) - 📱 sim-use के साथ Jev की speed पर किसी भी screen तक पहुँचें.
...
<details>
<summary><b>इस श्रेणी में और</b> <sub>· 92</sub></summary>
...
- [Show HN: Doom or Bloom, map your AI worldview with Jev](https://news.ycombinator.com/item?id=49846953) - कुछ प्रश्नों के उत्तर देकर अपने AI विश्वदृष्टिकोण का मानचित्र बनाएँ और देखें कि…
...
Jev जैसा decision models का परिवार, जो Qwen3.5/3.8 पर आधारित है और जिसे आप स्वयं train और run कर सकते हैं
...
अपने दम पर Jev जैसा multimodal model train करें। System One Model, अब vision के साथ।
...
- [HITsz-TMG/JevEmbed](https://github.com/HITsz-TMG/JevEmbed) - JevEmbed से मिलिए — एम्बेडिंग्स को निर्णयों में बदलें। अपनी पसंद के एम्बेडिंग…
- [doeixd/discern](https://github.com/doeixd/discern) - Effect DecisionModel और Jev के लिए Type-Safe, Uncertainty-aware सिमैंटिक पैटर्न…
...
- [codejunkie99/keel](https://github.com/codejunkie99/keel) - स्थानीय Laya और वैकल्पिक Jev निर्णय चयन के साथ Local-first macOS कोडिंग…
...
<sub>इनके द्वारा निर्मित · `render.py` · 2026-09-26T03:12:11+08:00</sub>
