...
> [!NOTE]
> **लाइव सूचकांक** · अंतिम सिंक: `2026-09-21T21:15:25+08:00` (UTC+8)
> · प्रविष्टियाँ: **716** · इस चक्र में नई: **105** · कार्यान्वयन भाषाएँ: **26**
...
<sub>Vercel AI Gateway के माध्यम से Pi के लिए TypeSafe के Jev का उपयोग करके स्वचालित मॉडल रूटिंग</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
- [समुदाय के क्लाइंट, SDK और अडैप्टर](#समदय-क-कलइट-sdk-और-अडपटर) — **119**
- [एजेंट उपकरण: MCP, हुक, गेट और कोडिंग एजेंट](#एजट-उपकरण-mcp-हक-गट-और-कडग-एजट) — **203**
- [रूटिंग, गार्डरेल और अनुमोदन](#रटग-गरडरल-और-अनमदन) — **77**
- [मूल्यांकन, कैलिब्रेशन और बेंचमार्क](#मलयकन-कलबरशन-और-बचमरक) — **72**
- [खुले पुनरुत्पादन, वेट और आर्किटेक्चर शोध](#खल-पनरतपदन-वट-और-आरकटकचर-शध) — **39**
...
- [BeatAPI/awesome-jev](https://github.com/BeatAPI/awesome-jev) - हम केवल source-reviewed JEV-related projects को curate करते हैं जिनमें 100+…
...
- [frostney/clean-code-review](https://github.com/frostney/clean-code-review) - pull request में हर code file, TypeSafe के Jev द्वारा Uncle Bob के Clean Code…
- [lucasmartins-ai/lcc](https://github.com/lucasmartins-ai/lcc) - Local Context Compiler (lcc): model तक पहुँचने से पहले prompt context को clean…
...
- [evoke-build/evoke](https://github.com/evoke-build/evoke) - Software, by reflex. एक वाक्य एक छोटे program की call बन जाता है, जिसे Jev…
...
- [lukstei/slop-grader](https://github.com/lukstei/slop-grader) - text files के लिए Jev-powered, rule-based slop grader.
...
<details>
<summary><b>इस श्रेणी में और</b> <sub>· 181</sub></summary>
...
- [savka777/jev-use](https://github.com/savka777/jev-use) - इसे कहें, और आपका Mac इसे कर देता है। Jev पर एक computer-use harness जो…
...
- [chy4pro/jev-for-chrome](https://github.com/chy4pro/jev-for-chrome) - Chrome के लिए Jev: TypeSafe Jev के साथ आपके देखे जा रहे टैब को संचालित करता है…
- [shitianfang/jev-use](https://github.com/shitianfang/jev-use) - Claude Code / Codex / pi plugin जो text output की आवश्यकता न रखने वाले agent…
...
- [nozomi-koborinai/jev-spec](https://github.com/nozomi-koborinai/jev-spec) - ⚡ हर commit पर spec drift पकड़ें: TypeSafe AI के Jev मॉडल के साथ अपने कोड को…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/fbddcz--embodied-jev/f54e7ac23f2c730a.gif" width="100%" alt="FBddcz/embodied-jev animation"><br><sub>एनिमेटेड रिकॉर्डिंग · <a href="https://raw.githubusercontent.com/FBddcz/embodied-jev/main/docs/results/metaworld-hierarchy-v2-2026-09-21/figures/hierarchy-grid.mp4">वीडियो खोलें</a></sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/4esv/jev-joust/main/runs/jev-vs-jev-20260921-070232.gif" width="100%" alt="4esv/jev-joust animation"><br><sub>एनिमेटेड रिकॉर्डिंग</sub></td>
</tr></table>
...
- [Kevthetech143/super-jev](https://github.com/Kevthetech143/super-jev) - TypeSafe Jev के लिए एक छोटा, extensible decision-to-action harness.
...
<sub>इनके द्वारा निर्मित · `render.py` · 2026-09-21T21:15:25+08:00</sub>
