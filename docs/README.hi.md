...
> [!NOTE]
> **लाइव सूचकांक** · अंतिम सिंक: `2026-09-21T15:27:37+08:00` (UTC+8)
> · प्रविष्टियाँ: **702** · इस चक्र में नई: **59** · कार्यान्वयन भाषाएँ: **26**
...
- [एजेंट उपकरण: MCP, हुक, गेट और कोडिंग एजेंट](#एजट-उपकरण-mcp-हक-गट-और-कडग-एजट) — **190**
- [रूटिंग, गार्डरेल और अनुमोदन](#रटग-गरडरल-और-अनमदन) — **64**
- [मूल्यांकन, कैलिब्रेशन और बेंचमार्क](#मलयकन-कलबरशन-और-बचमरक) — **79**
- [खुले पुनरुत्पादन, वेट और आर्किटेक्चर शोध](#खल-पनरतपदन-वट-और-आरकटकचर-शध) — **33**
- [अनुप्रयोग, गेम, रोबोटिक्स और इंटरैक्टिव डेमो](#अनपरयग-गम-रबटकस-और-इटरकटव-डम) — **54**
- [लेखन, चर्चाएँ और समान सूचियाँ](#लखन-चरचए-और-समन-सचय) — **89**
- [अन्य प्रोजेक्ट](#अनय-परजकट) — **69**
...
- [carlosedm10/agi-jev-containment](https://github.com/carlosedm10/agi-jev-containment) - AGI JEV Detection — स्थानीय AI एजेंट मॉनिटर: श्रृंखला-स्तरीय.
...
- [nico-martin/open-jev](https://github.com/nico-martin/open-jev) - open-jev टाइप किए गए निर्णयों के लिए ब्राउज़र-केंद्रित TypeScript लाइब्रेरी है.
...
- [kushals256/jevcache](https://github.com/kushals256/jevcache) - जब TypeSafe Jev समान आशय बताता है, तब महंगी LLM कॉल छोड़ें। OpenAI-संगत स्थानीय.
...
Chrome के लिए Jev: TypeSafe Jev के साथ आपके देखे जा रहे टैब को संचालित करता है, जो एक सब-सेकंड निर्णय मॉडल है। browser-use/jev-ultrafast का सामुदायिक पोर्ट, TypeSafe से संबद्ध नहीं है।
...
<details>
<summary><b>इस श्रेणी में और</b> <sub>· 156</sub></summary>
...
- [miniLV/Jev-Auto-Router](https://github.com/miniLV/Jev-Auto-Router) - Jev ऑटो राउटर (Jev राउटर): TypeSafe Jev और स्थानीय Responses प्रॉक्सी के माध्यम.
...
- [teempai/jev-in-codex](https://github.com/teempai/jev-in-codex) - Jev-संचालित टूल और कौशल चयन, संदर्भ खोज और MCP के माध्यम से Codex के लिए आउटपुट.
...
- [daniel-farina/nitro](https://github.com/daniel-farina/nitro) - प्रति टर्न एक बार टूल चयन के लिए TypeSafe Jev रूटिंग के साथ Grok Build: समान.
...
- [RenaGao/jev-dataops](https://github.com/RenaGao/jev-dataops) - स्ट्रीमिंग डेटा चयन, गुणवत्ता मूल्यांकन, स्वचालित LoRA प्रशिक्षण और रोके गए.
...
<details>
<summary><b>इस श्रेणी में और</b> <sub>· 15</sub></summary>
...
<td align="center" valign="top"><a href="https://www.youtube.com/@j-AI99"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/evoworkai--jev-playground/a2aeedef9dc4507e.png" width="100%" alt="video"></a><br><sub><a href="https://www.youtube.com/@j-AI99">यहाँ देखें youtube.com</a> · प्लेबैक होस्ट साइट पर खुलता है; GitHub इसे इनलाइन एम्बेड नहीं कर सकता</sub></td>
</tr></table>
...
<sub>इनके द्वारा निर्मित · `render.py` · 2026-09-21T15:27:37+08:00</sub>
