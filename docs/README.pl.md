...
> [!NOTE]
> **Indeks na żywo** · Ostatnia synchronizacja: `2026-09-26T03:12:11+08:00` (UTC+8)
> · Wpisy: **806** · Nowe w tym cyklu: **123** · Języki implementacji: **23**
...
- [Klienty, zestawy SDK i adaptery społeczności](#klienty-zestawy-sdk-i-adaptery-społeczności) — **127**
- [Narzędzia dla agentów: MCP, hooki, bramki i agenty kodujące](#narzędzia-dla-agentów-mcp-hooki-bramki-i-agenty-kodujące) — **245**
- [Routing, zabezpieczenia i zatwierdzenia](#routing-zabezpieczenia-i-zatwierdzenia) — **61**
...
- [Inne projekty](#inne-projekty) — **87**
...
Środowisko decyzyjne dla TypeSafe Jev — bramki pewności, tryb cienia, receptury i ewaluacje. Claude CLI 48,9 s → Jev 1,3 s dla tego samego zadania filtrowania wierszy.
...
Jeden CLI dla wszystkich robotów. Połącz je, wydawaj im polecenia i pozwól im współpracować, zapewniając każdemu LLM jako mózg (Claude, OpenAI, Gemini, Grok lub lokalnie przez Ollama albo vLLM) oraz decyzyjny LLM do wyboru spośród wielu opcji (Jev, Laya, Kev). Steruje Microduck, Open Duck Mini, LeRobot, XLeRobot, AlohaMini, ToddlerBot, a także dowolną platformą ROS 2 z laptopa, poza robotem.
...
Pokrycie, bezpieczeństwo i jakość kodu dla agentów programistycznych
...
- [topherchris420/james_library](https://github.com/topherchris420/james_library) - R.A.I.N. Lab to eksperymentalna architektura agenta naukowego, która rozdziela…
...
- [bladedevoff/stuntd](https://github.com/bladedevoff/stuntd) - Lokalny serwer proxy, który uczy się wpisywanych w aplikacji decyzji LLM i…
- [myc0576/SmartMoney-Cub](https://github.com/myc0576/SmartMoney-Cub) - Dziennik transakcyjny tylko do odczytu i środowisko do przeglądów: typowane…
...
- [6Mikao9/jev-native-agent-with-extended-options](https://github.com/6Mikao9/jev-native-agent-with-extended-options) - Projekt badawczy systemu agenta natywnego dla Jev: umożliwienie większej liczby…
...
- [carldaws/hunch](https://github.com/carldaws/hunch) - Probabilistyczny przepływ sterowania dla Ruby i Rails — oparty na Jev od…
...
- [ruban-24/switchboard](https://github.com/ruban-24/switchboard) - Otwarty router decyzyjny niezależny od modelu dla Claude Code i Codex.
...
- [MiaoWuNYA/rikkahub-sillytavern-android](https://github.com/MiaoWuNYA/rikkahub-sillytavern-android) - Klient czatu AI na Androida: bezstratny import kart z tawerny, agresywna…
...
✨ Wszyscy agenci i obszary robocze w jednym miejscu, na każdym posiadanym urządzeniu. Śledź zadania na tablicy dostępnej z komputera, telefonu, przeglądarki lub API. Hostowane samodzielnie.
...
<details>
<summary><b>Więcej w tej kategorii</b> <sub>· 227</sub></summary>
...
- [safzanpirani/pi-jev-skill-picker](https://github.com/safzanpirani/pi-jev-skill-picker) - Uszereguj umiejętności agenta Rank Pi dla bieżącego zadania za pomocą TypeSafe…
...
- [erkamyaman/jev-enforce](https://github.com/erkamyaman/jev-enforce) - 📏 Wtyczka Claude Code, która sprawia, że Claude przestrzega Twojego AGENTS.md…
...
- [itsmostafa/system-one-connector](https://github.com/itsmostafa/system-one-connector) - Łącznik System One MCP do szybkiej i taniej oceny czegokolwiek.
...
Uruchamiaj otwarte modele decyzyjne lokalnie: pobieraj i udostępniaj Laya, decider, NLI i GLiClass za pośrednictwem API zgodnego z TypeSafe. Ollama dla modeli decyzyjnych.
...
<details>
<summary><b>Więcej w tej kategorii</b> <sub>· 60</sub></summary>
...
- [anessbelbati/jev-rerank-bench](https://github.com/anessbelbati/jev-rerank-bench) - Czy model decyzyjny może pokonać dedykowane rerankery? TypeSafe Jev kontra…
...
jevos to open-source’owa alternatywa dla Jev do decyzji tak/nie, działająca na laptopie.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/feder-cr/jev/main/assets/dino_run.gif" width="100%" alt="feder-cr/jev animation"><br><sub>nagranie animowane</sub></td>
</tr></table>
...
- [amithgc/local-jev](https://github.com/amithgc/local-jev) - Lokalny, działający offline serwer System One zgodny z Jev API firmy TypeSafe.
...
<details>
<summary>📰 <b><a href="https://typesafe.ai/team">TypeSafe dodało stronę Team + nawigacja dodała wejście `Enterprise` (sygnał produktizacji/komercjalizacji)</a></b> · ✅ official · 7 天</summary>
...
<details>
<summary><b>Więcej w tej kategorii</b> <sub>· 92</sub></summary>
...
- [Show HN: Doom or Bloom, map your AI worldview with Jev](https://news.ycombinator.com/item?id=49846953) - Poznaj swój światopogląd dotyczący AI, odpowiadając na kilka pytań, i zobacz…
...
- [HITsz-TMG/JevEmbed](https://github.com/HITsz-TMG/JevEmbed) - Poznaj JevEmbed — przekształcaj embeddingi w decyzje.
- [doeixd/discern](https://github.com/doeixd/discern) - Twórz bezpieczne typowo, uwzględniające niepewność dopasowywanie wzorców…
...
- [codejunkie99/keel](https://github.com/codejunkie99/keel) - Lokalne przede wszystkim środowisko programistyczne macOS z lokalnym Laya i…
...
<sub>Wygenerowano przez · `render.py` · 2026-09-26T03:12:11+08:00</sub>
