...
> [!NOTE]
> **Indeks na żywo** · Ostatnia synchronizacja: `2026-09-22T11:05:08+08:00` (UTC+8)
> · Wpisy: **737** · Nowe w tym cyklu: **54** · Języki implementacji: **25**
...
- [Klienty, zestawy SDK i adaptery społeczności](#klienty-zestawy-sdk-i-adaptery-społeczności) — **125**
- [Narzędzia dla agentów: MCP, hooki, bramki i agenty kodujące](#narzędzia-dla-agentów-mcp-hooki-bramki-i-agenty-kodujące) — **209**
...
- [Otwarte reprodukcje, wagi i badania nad architekturą](#otwarte-reprodukcje-wagi-i-badania-nad-architekturą) — **36**
- [Aplikacje, gry, robotyka i interaktywne dema](#aplikacje-gry-robotyka-i-interaktywne-dema) — **46**
- [Teksty, dyskusje i pokrewne listy](#teksty-dyskusje-i-pokrewne-listy) — **90**
- [Inne projekty](#inne-projekty) — **77**
...
Oprogramowanie odruchowo. Zdanie staje się wywołaniem małego programu, wybranego przez Jev, klasyfikator TypeSafe AI i uruchamianego tylko wtedy, gdy ma wystarczającą pewność. Odruchy to receptury, które każdy może pisać, udostępniać i ulepszać. CLI, z którym rozmawiasz, menedżer pakietów odruchów z gita oraz TypeScript SDK.
...
<details>
<summary><b>Więcej w tej kategorii</b> <sub>· 103</sub></summary>
...
- [AkashPriyadarshii/jev-seo](https://github.com/AkashPriyadarshii/jev-seo) - 100% darmowy, ₹0, agent-first pakiet SEO &amp; GEO CLI oraz serwer MCP w Rust…
...
- [lukstei/slop-grader](https://github.com/lukstei/slop-grader) - Oparty na Jev, oparty na regułach grader plików tekstowych.
- [chengyongru/fastjev](https://github.com/chengyongru/fastjev) - Nastawiony przede wszystkim na SDK, niezależnie utrzymywany fork SemIf do…
- [Qew7/jev-feels](https://github.com/Qew7/jev-feels) - Decyzje semantyczne jako zwykłe Ruby — feels?, decide, score, walidacje Rails i…
- [arunav25/jev-mcp](https://github.com/arunav25/jev-mcp) - Połącz JEV z klientami MCP i porównuj jego oceny z ocenami ogólnego…
- [lucasmartins-ai/lcc](https://github.com/lucasmartins-ai/lcc) - Local Context Compiler (lcc): czyści, deduplikuje i kompresuje kontekst…
...
- [keltokhy/jlink](https://github.com/keltokhy/jlink) - Łączenie rekordów dla ekonomistów: napisz regułę dopasowania prostym…
...
- [iamvatsalpatel/tiershift](https://github.com/iamvatsalpatel/tiershift) - Przekieruj każde wywołanie LLM do najtańszego modelu, który potrafi je…
...
- [kitfunso/hippo-memory](https://github.com/kitfunso/hippo-memory) - Biologicznie inspirowana pamięć dla agentów AI.
...
Umiejętność agenta dla klasy modeli decyzyjnych (klasyfikatory, kodery/dekodery, wyspecjalizowane głowice AR, System One). TypeSafe Jev jest dominującym przykładem. Algebra kompozycji, projektowanie pytań, bramki walidacji. MIT.
...
<details>
<summary><b>Więcej w tej kategorii</b> <sub>· 187</sub></summary>
...
- [savka777/jev-use](https://github.com/savka777/jev-use) - Powiedz to, a Twój Mac to zrobi. Uprząż do korzystania z komputera na Jev…
...
- [socai-io/jev-social](https://github.com/socai-io/jev-social) - Badania Instagram, TikTok i LinkedIn napędzane przez Jev: typowany routing…
...
- [compozy/yoshi](https://github.com/compozy/yoshi) - Proxy przycinające kontekst dla Claude Code i Codex: Jev ocenia, która historia…
...
- [OmniJev/PlayJev](https://github.com/OmniJev/PlayJev) - 🚀🚀 Multimodalny model 0.8B podobny do JEV, grający w gry GUI bezpośrednio na…
...
- [blakestone-x/jev-mcp](https://github.com/blakestone-x/jev-mcp) - Serwer MCP dla TypeSafe Jev: typowane klasyfikowanie, ocenianie, sprawdzanie…
...
- [khordoo/jev-reflex-autonomy-lab](https://github.com/khordoo/jev-reflex-autonomy-lab) - Laboratorium autonomii wielu dronów demonstrujące refleksyjne decyzje TypeSafe…
- [DECRUX9812/typesafe-skill-router](https://github.com/DECRUX9812/typesafe-skill-router) - Routing umiejętności TypeSafe (Jev) dla Hermes Agent: wskazuje jedną…
...
- [libingzheren/Jev-Mem](https://github.com/libingzheren/Jev-Mem) - Jev-Mem: Pamięć agentowa kontrolowana przez System-One.
...
- [Nyarlathoteppppp/pi-jev-context](https://github.com/Nyarlathoteppppp/pi-jev-context) - Najpierw wydajność modelu. Oszczędności tokenów na drugim miejscu.
- [alexgreensh/eval-genius](https://github.com/alexgreensh/eval-genius) - Naucz swojego agenta pracy z ewaluacjami: KIEDY naprawdę potrzebujesz ewaluacji…
- [nozomi-koborinai/jev-spec](https://github.com/nozomi-koborinai/jev-spec) - ⚡ Wykrywaj rozjazd specyfikacji przy każdym commicie: sprawdzaj swój kod…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/hfnissum-byte/Hunkpick/main/demo/hunkpick.gif" width="100%" alt="hfnissum-byte/Hunkpick animation"><br><sub>nagranie animowane</sub></td>
</tr></table>
...
Automatyczne routowanie modeli dla Pi przy użyciu Jev od TypeSafe przez Vercel AI Gateway
...
Zmień dowolne LLM w model decyzyjny w stylu Jev: typowane decyzje, rzeczywiste prawdopodobieństwa, bez trenowania.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/nokia-applied-research--anyjev/4184f4406ec59fe6.gif" width="100%" alt="nokia-applied-research/AnyJev animation"><br><sub>nagranie animowane</sub></td>
</tr></table>
...
- [yzfly/edgejev](https://github.com/yzfly/edgejev) - Lokalne typowane decyzje dostępne offline: 15,6 ms na jedno zadanie na…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/rythmn1111--doom-war/c0cd335c6615f8e3.gif" width="100%" alt="rythmn1111/doom-war animation"><br><sub>nagranie animowane</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/fbddcz--embodied-jev/6c478d975fee036f.gif" width="100%" alt="FBddcz/embodied-jev animation"><br><sub>nagranie animowane · <a href="https://raw.githubusercontent.com/FBddcz/embodied-jev/main/docs/results/metaworld-hierarchy-v2-2026-09-21/figures/hierarchy-grid-fast.mp4">Otwórz wideo</a></sub></td>
</tr></table>
...
<details>
<summary><b>Więcej w tej kategorii</b> <sub>· 14</sub></summary>
...
- [mmastrac/djev](https://github.com/mmastrac/djev) - Ustrukturyzowane decyzje w stylu Jev na DiffusionGemma: przykładowy serwer z…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/iron-lyk--omnijev/341b127f269cdd62.gif" width="100%" alt="Iron-LYK/OmniJev animation"><br><sub>nagranie animowane · <a href="https://raw.githubusercontent.com/Iron-LYK/OmniJev/main/docs/media/omnijev-stack.mp4">Otwórz wideo</a></sub></td>
</tr></table>
...
<td align="center" valign="top"><a href="https://youtu.be/rLLO-umS140"><img src="https://img.youtube.com/vi/rLLO-umS140/hqdefault.jpg" width="100%" alt="video"></a><br><sub><a href="https://youtu.be/rLLO-umS140">Obejrzyj na youtu.be</a> · odtwarzanie otwiera się w witrynie hosta; GitHub nie może osadzić go bezpośrednio</sub></td>
</tr></table>
...
<details>
<summary><b>Więcej w tej kategorii</b> <sub>· 24</sub></summary>
...
<details>
<summary>📰 <b><a href="https://typesafe.ai/team">TypeSafe dodało stronę Team + nawigacja dodała wejście `Enterprise` (sygnał produktizacji/komercjalizacji)</a></b> · ✅ official · 3 天</summary>
...
Typobezpieczne dekodowanie dla autoregresyjnego LLMs
...
- [Argos1111/jev_local](https://github.com/Argos1111/jev_local) - Replikowanie Jev za pomocą lokalnego LLM.
...
- [kevin9327/jev-master](https://github.com/kevin9327/jev-master) - Typowane decyzje System One z Jev: Choice + Score + Noul złożone w kodzie.
...
- [phyous/tsai-sc](https://github.com/phyous/tsai-sc) - TypeSafe Jev steruje oryginalnym shareware StarCraft za pomocą klawiatury i…
...
<sub>Wygenerowano przez · `render.py` · 2026-09-22T11:05:08+08:00</sub>
