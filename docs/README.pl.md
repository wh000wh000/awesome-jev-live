...
> [!NOTE]
> **Indeks na żywo** · Ostatnia synchronizacja: `2026-09-23T17:45:55+08:00` (UTC+8)
> · Wpisy: **778** · Nowe w tym cyklu: **111** · Języki implementacji: **23**
...
<sub>grep dla pytań, których nie można zapisać jako wzorca. Odczytuje każdą funkcję zamiast próbkować kilka. Napędzane przez model System One firmy TypeSafe AI, oparty na Jev.</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
- [Narzędzia dla agentów: MCP, hooki, bramki i agenty kodujące](#narzędzia-dla-agentów-mcp-hooki-bramki-i-agenty-kodujące) — **239**
- [Routing, zabezpieczenia i zatwierdzenia](#routing-zabezpieczenia-i-zatwierdzenia) — **55**
...
- [Aplikacje, gry, robotyka i interaktywne dema](#aplikacje-gry-robotyka-i-interaktywne-dema) — **48**
- [Teksty, dyskusje i pokrewne listy](#teksty-dyskusje-i-pokrewne-listy) — **96**
- [Inne projekty](#inne-projekty) — **84**
...
<sub>🔧 Znaleziono użycie w kodzie: `src/typesafe_sdk/__init__.py`, `src/typesafe_sdk/_core/retry.py`, `src/typesafe_sdk/_core/config.py`</sub>
...
Niestandardowy harness programistyczny dla Jev należącego do TypeSafe AI: LLM proponuje, Jev odpowiada na wąskie pytania, kod podejmuje decyzje, a każdy krok pozostawia potwierdzenie.
...
Biblioteka Elixir opakowująca jednomodelowy system OSS Laya firmy ConvAI Innovations
...
grep dla pytań, których nie można zapisać jako wzorca. Odczytuje każdą funkcję zamiast próbkować kilka. Napędzane przez model System One firmy TypeSafe AI, oparty na Jev.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/fajarhide--askgrep/fa6a7fa333d2d67f.gif" width="100%" alt="fajarhide/askgrep animation"><br><sub>nagranie animowane</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/clouatre-labs--decisions-judge-mcp/c8c00f2b58774857.gif" width="100%" alt="clouatre-labs/decisions-judge-mcp animation"><br><sub>nagranie animowane</sub></td>
</tr></table>
...
Jedno offboard CLI dla wszystkich Twoich robotów. Połącz je, steruj nimi i pozwól im współpracować, przy czym każdy ma LLM jako mózg (Claude, OpenAI, Gemini, Grok lub lokalnie przez Ollama albo vLLM) oraz decyzyjny LLM do tańszych i szybszych kroków (Jev, Laya i Kev). Obsługuje Microduck, Open Duck Mini, LeRobot, XLeRobot, AlohaMini, ToddlerBot, Jetson oraz dowolny ROS.
...
Swift SDK do uruchamiania modeli czatu, wizji i mowy na iPhone oraz Mac z użyciem Apple’s Core AI. Pobieranie i buforowanie modeli, integracja z FoundationModels oraz przykłady do uruchomienia z udokumentowanymi wymaganiami dotyczącymi systemu operacyjnego, SDK i modeli.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/john-rocky--coreai-kit/c98c7bb8cb04e76e.gif" width="100%" alt="john-rocky/coreai-kit animation"><br><sub>nagranie animowane</sub></td>
</tr></table>
...
jev-seo: Rust SEO i GEO CLI oraz serwer MCP dla agentów programistycznych: audyty obejmujące 50 reguł, aktywne crawlowanie, wyniki GEO, zmiany pozycji i bramki CI. MIT, bez abonamentu.
...
Dziennik transakcji i narzędzie do przeglądu działające tylko do odczytu: typowane oceny Jev, integracja z agentem oraz powtarzalny benchmark finansowy. Bez zleceń i bez porad.
...
Oparty na Jev, oparty na regułach grader plików tekstowych. Uruchamia każdą regułę równolegle dla każdej linii. Bez pobieżnego przeglądania i pominiętych linii.
...
Nastawiony przede wszystkim na SDK, niezależnie utrzymywany fork SemIf do szybkich, samodzielnie hostowanych decyzji semantycznych.
...
<details>
<summary><b>Więcej w tej kategorii</b> <sub>· 108</sub></summary>
...
- [smkrv/jev-calibrate](https://github.com/smkrv/jev-calibrate) - Kalibruj pytania Jev względem własnych etykiet: dostrój kryteria na oznaczonych…
- [dannote/jev](https://github.com/dannote/jev) - TypeSafe Jev dla OTP: odpowiadaj na Jev z GenServer i dopasowuj wzorzec do jego…
- [9pings/notjev](https://github.com/9pings/notjev) - Superszybki serwer podobny do Jev, niezależny od modelu, działający z dowolnym…
...
- [bladedevoff/stuntd](https://github.com/bladedevoff/stuntd) - Lokalny serwer proxy, który uczy się typowanych decyzji LLM Twojej aplikacji i…
- [tumf/jev-cli](https://github.com/tumf/jev-cli) - Mały, pozbawiony zależności CLI dla TypeSafe Jev.
- [talmago/fast_gliner](https://github.com/talmago/fast_gliner) - Powiązania Python z silnikiem wnioskowania dla modeli GLiNER napisanych w Rust.
- [frostney/clean-code-review](https://github.com/frostney/clean-code-review) - Każdy plik kodu w żądaniu pull jest oceniany pod kątem zgodności z Clean Code…
- [Qew7/jev-feels](https://github.com/Qew7/jev-feels) - Decyzje semantyczne jako zwykłe Ruby #feels?, #decide, #score, walidacje Rails…
...
- [tontoko/jev-browser](https://github.com/tontoko/jev-browser) - Jeden osadzony rdzeń Jev/Playwright: typowane SDK, trwałe CLI i serwer MCP z…
...
- [vercel-labs/jev-ai-sdk-form-router](https://github.com/vercel-labs/jev-ai-sdk-form-router) - Kieruj zgłoszenia z formularzy do właściwych osób za pomocą Jev i AI SDK.
- [ansidium/jev-codex-bridge](https://github.com/ansidium/jev-codex-bridge) - Kierowanie modelami i rozumowaniem dla Codex Desktop i CLI, z usługą Windows i…
- [mountainMath/JevR](https://github.com/mountainMath/JevR) - Klient R dla TypeSafe Jev System One API.
- [shinpr/jev-reranker](https://github.com/shinpr/jev-reranker) - Ponownie szereguj, filtruj i kompresuj wyniki wyszukiwania JSON z…
...
- [nylon-memory/NylonME](https://github.com/nylon-memory/NylonME) - Silnik pamięci dla agentów AI. Praca z Jev może zwiększyć dokładność decyzji.
...
- [zcoder-run/rust-sysone](https://github.com/zcoder-run/rust-sysone) - Klient System One TypeSafe AI Rust (nieoficjalny).
...
<sub>🔧 Znaleziono użycie w kodzie: `src/request.ts`</sub>
...
Awesome Jev: oparty na źródłach przewodnik terenowy po modelu System One TypeSafe, z SDKs, demonstracjami na żywo, narzędziami agentów i niezależnymi ewaluacjami.
...
Umiejętność agenta do znajdowania, budowania, oceniania i ulepszania systemów modeli decyzyjnych. Kompozycyjny rachunek decyzyjny, uprzęże ewaluacyjne oraz ograniczone wspinanie się po zboczu dla promptów/programów w Software 3.0. TypeSafe Jev to domyślny hostowany przykład. Niezależne od TypeSafe.
...
<td align="center" valign="top"><a href="https://youtu.be/ZC4oge4WsCQ"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/24601--augustus/d2593af47d538d33.jpg" width="100%" alt="video"></a><br><sub><a href="https://youtu.be/ZC4oge4WsCQ">Obejrzyj na youtu.be</a> · odtwarzanie otwiera się w witrynie hosta; GitHub nie może osadzić go bezpośrednio</sub></td>
</tr></table>
...
⚡ Foq — BEZPŁATNA, lokalna i otwartoźródłowa alternatywa dla Jev. Typowane decyzje System 1 w około 25 ms — bez listy oczekujących, chmury i kosztu za token. foq.fr
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/storm-software--mindctl/69298c40a77b7be5.gif" width="100%" alt="storm-software/mindctl animation"><br><sub>nagranie animowane</sub></td>
</tr></table>
...
Najszybszy i najtańszy agent internetowy
...
Konwersacyjny drugi pilot na telefonie: w WeChat / QQ / X / Feishu rozumie rozmówcę, proponuje możliwe odpowiedzi i jednym kliknięciem wstawia je do pola tekstowego — to ty decydujesz, czy wysłać. Nieinwazyjny, tylko odczytuje ekran, bez hooków i bez modyfikowania pakietów.
...
<details>
<summary><b>Więcej w tej kategorii</b> <sub>· 217</sub></summary>

- [ChenneyZhuang/laya-browser-agent](https://github.com/ChenneyZhuang/laya-browser-agent) - Lokalna alternatywa Jev o otwartym kodzie źródłowym: decyzje agenta…
...
- [kydlikebtc/awesome-jev](https://github.com/kydlikebtc/awesome-jev) - 805 zweryfikowanych przykładów Jev — modelu decyzji System One należącego do…
- [Amal-David/awesome-jev](https://github.com/Amal-David/awesome-jev) - Dema Jev, projekty, SDKs i umiejętności, z linkami do źródeł oraz…
- [RomanSlack/jev-drone](https://github.com/RomanSlack/jev-drone) - Autonomiczny dron sterowany wyłącznie kamerą w MuJoCo z małym modelem oceny…
...
- [supercorp-ai/supercov](https://github.com/supercorp-ai/supercov) - Jakość kodu i pokrycie dla agentów kodujących.
- [Alex314618-create/JevRev](https://github.com/Alex314618-create/JevRev) - Przepływ pracy LLM + Jev. Wzmocnij swój kręgowieczy mózg kręgosłupem wewnątrz.
...
- [socai-io/jev-social](https://github.com/socai-io/jev-social) - Badania na Instagramie, TikToku i LinkedIn oparte na Jev: typowane routowanie…
...
- [DanRWilloughby/snifftest](https://github.com/DanRWilloughby/snifftest) - Linter prozy, który wywęsza oznaki pisania przez AI.
...
- [PromptEngineer48/laya-vs-jev-arena](https://github.com/PromptEngineer48/laya-vs-jev-arena) - Laya (open source, lokalny) kontra TypeSafe Jev (API): dwa modele AI ścigają…
...
- [jiawei686/jev-ultrafast-mcp](https://github.com/jiawei686/jev-ultrafast-mcp) - Przekaż pracę przeglądarki: serwer MCP, w którym model decyzyjny steruje stroną…
...
- [Bodila51/muse-jev-playbook](https://github.com/Bodila51/muse-jev-playbook) - Warstwa decyzyjna Jev dla Muse: szybka i tania bramka TypeSafe AI przed…
...
- [ZephyrDeng/ego-jev](https://github.com/ZephyrDeng/ego-jev) - Wewnętrzna pętla Jev (TypeSafe System One) dla ego-browser — jedna wpisywana…
- [green-dalii/pi-shift-router](https://github.com/green-dalii/pi-shift-router) - Routing modeli dla każdej tury agenta kodującego Pi: mały sędzia wybiera tanią…
- [ismaelsoilet/jev-harness](https://github.com/ismaelsoilet/jev-harness) - Pozbawiony zależności harness decyzyjny System One: 5 bramek semantycznych…
...
- [FazalAAli/jev-robotics-demo](https://github.com/FazalAAli/jev-robotics-demo) - Jev (TypeSafe System One) kontra Claude Opus 5 sterujący symulowanym ramieniem…
...
- [jiangkoumo/ego-jev](https://github.com/jiangkoumo/ego-jev) - Steruj przeglądarką ego lite za pomocą Jev (TypeSafe System One): jedna…
...
- [itsmostafa/typesafe-mcp](https://github.com/itsmostafa/typesafe-mcp) - Złącze mcp do szybkiej i taniej ewaluacji czegokolwiek.
...
- [FFatTiger/new-api-plugin-typesafe](https://github.com/FFatTiger/new-api-plugin-typesafe) - Wtyczka zadań TypeSafe AI System One (Jev) dla QuantumNous/new-api — natywne…
...
Nieautoregresyjny silnik decyzyjny System 1. Typowane wybory, oceny oraz decyzje tak/nie dla dowolnego tekstu w jednym przebiegu w przód, w ponad 100 językach, z routerem wybierającym właściwy checkpoint dla każdego żądania.

<sub>🔧 Znaleziono użycie w kodzie: `research/benchmarks/feishu_zh/run.py`</sub>
...
Jev, model System One należący do TypeSafe, gra w szachy przeciwko dowolnemu LLM OpenRouter, Stockfishowi i tobie. Jednostronicowa aplikacja internetowa z ruchami na żywo, prawdopodobieństwami ruchów Jev, zapisanymi partiami i współczynnikami zwycięstw.
...
Bot Clash Royale bez wytrenowanej polityki: Jev (TypeSafe System One) podejmuje każdą decyzję na podstawie bieżącego stanu gry
...
Produkcyjne uprzęże do przypadków użycia TypeSafe Jev (System One) z logiką decyzyjną opartą na progach pewności
...
Przekształć dowolne LLM w model decyzyjny w stylu Jev: decyzje typowane, rzeczywiste prawdopodobieństwa, bez trenowania. (ciągła aktualizacja)
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/nokia-applied-research--anyjev/93e61c3de618cc36.gif" width="100%" alt="nokia-applied-research/AnyJev animation"><br><sub>nagranie animowane</sub></td>
</tr></table>
...
Otwarty stos do trenowania i wnioskowania dla modeli decyzyjnych w stylu Jev. Trenuj modele do oceniania dynamicznych gałęzi kandydatów ze wspólnego prefiksu, z obsługą wyboru o dużej liczbie kategorii, kalibracji i szybkiego wnioskowania wsadowego.
...
Uczenie ze wzmocnieniem uwzględniające kalibrację dla adaptacyjnych systemów decyzyjnych
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/weitianxin--jevany/05825e369317a429.gif" width="100%" alt="weitianxin/JevAny animation"><br><sub>nagranie animowane</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/ankit-aglawe--tinyjev/bff87199840daa0f.gif" width="100%" alt="ankit-aglawe/tinyjev animation"><br><sub>nagranie animowane</sub></td>
</tr></table>
...
- [RenaGao/jev-dataops](https://github.com/RenaGao/jev-dataops) - Oparty na JEV i open source warsztat do strumieniowego wyboru danych, oceny…
...
- [ARCJ137442/jev-2048](https://github.com/ARCJ137442/jev-2048) - Instrumentowane laboratorium webowe 2048, w którym każdy ruch jest Jev…
...
- [rupeshpoojary9/awesome-open-system-one](https://github.com/rupeshpoojary9/awesome-open-system-one) - Kuratorowana lista otwartego ekosystemu System One: otwarte modele, niezależne…
...
<table><tr><th align="center" width="50%">🖼 Obraz</th><th align="center" width="50%">🎬 Wideo</th></tr><tr>
<td align="center" valign="top"><sub>brak opublikowanych multimediów</sub></td>
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/wfzyx--von/7f8d6b27c0d2e176.gif" width="100%" alt="wfzyx/von animation"><br><sub>nagranie animowane</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/fbddcz--embodied-jev/297ef7c24f9a67a8.gif" width="100%" alt="FBddcz/embodied-jev animation"><br><sub>nagranie animowane · <a href="https://raw.githubusercontent.com/FBddcz/embodied-jev/main/docs/media/libero-drawer-comparison.mp4">Otwórz wideo</a></sub></td>
</tr></table>
...
Lokalny, działający offline serwer System One zgodny z Jev API firmy TypeSafe. Odpowiada na typowane pytania typu tak/nie, pytania o kategorię i ocenę, korzystając z małych modeli open source.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/bl888m/jev-bot/main/assets/demo.gif" width="100%" alt="bl888m/jev-bot animation"><br><sub>nagranie animowane</sub></td>
</tr></table>
...
<details>
<summary><b>Więcej w tej kategorii</b> <sub>· 19</sub></summary>
...
- [zhihz/openjev](https://github.com/zhihz/openjev) - Lokalne dwujęzyczne decyzje prawdopodobieństwa na podstawie kontekstu, pytań i…
...
Najpełniejsza galeria tego, co ludzie tworzą za pomocą modelu System One należącego do TypeSafe i Jev: ponad 3400 projektów, demonstracji i opisów według scenariuszy, każdy z oryginalnym linkiem, obrazem i opisem.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/darthblanc/tictacjev/main/assets/screenrecording.gif" width="100%" alt="darthblanc/tictacjev animation"><br><sub>nagranie animowane</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/michaelpersonal--jev-trade-cc/b3ae9a36cc9fcbbf.gif" width="100%" alt="michaelpersonal/jev-trade-cc animation"><br><sub>nagranie animowane</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/hr98w--jev-visual/e05a42d934ea69ce.gif" width="100%" alt="hr98w/jev-visual animation"><br><sub>nagranie animowane · <a href="https://github.com/user-attachments/assets/c87c09d8-30d2-4392-b981-d0b5cf1879ae">Otwórz wideo</a></sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/surbhit20/jev-plays-snake/main/jev-plays-snake.gif" width="100%" alt="surbhit20/jev-plays-snake animation"><br><sub>nagranie animowane</sub></td>
</tr></table>
...
<details>
<summary><b>Więcej w tej kategorii</b> <sub>· 26</sub></summary>
...
- [heyjunpenn/awesome-jev](https://github.com/heyjunpenn/awesome-jev) - Zweryfikowany, utrzymywany przez społeczność katalog 832 projektów open source…
...
- [jaibhasin/jev-yt-time-saver](https://github.com/jaibhasin/jev-yt-time-saver) - Rozszerzenie Chrome, które zasłania rozpraszające filmy na YouTube za pomocą…
...
<details>
<summary>📰 <b><a href="https://typesafe.ai/team">TypeSafe dodało stronę Team + nawigacja dodała wejście `Enterprise` (sygnał produktizacji/komercjalizacji)</a></b> · ✅ official · 4 天</summary>
...
- [AiPersonacademy/Awesome-jev-use](https://github.com/AiPersonacademy/Awesome-jev-use) - Starannie wyselekcjonowana lista świetnych aplikacji, bibliotek i zasobów Jev /…
...
Generator rejestracji typesafe.ai, ekstremalna optymalizacja, nieograniczone jev
...
Asystent odpowiedzi działający obok 微信 (Windows 4.x): zrzut ekranu okna + lokalny, działający offline OCR odczytuje wiadomość drugiej osoby → Jev rozpoznaje intencję → 3 propozycje można wstawić jednym kliknięciem, a wysyłanie zawsze odbywa się ręcznie
...
Pływające okno rozpoznawania intencji wiadomości 微信 (macOS): analiza ekranu + lokalny mały model oceniający intencję i ryzyko, a następnie generujący propozycje odpowiedzi na podstawie stylu wypowiedzi. Wyłącznie do odczytu, bez wstrzykiwania do 微信.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/zefan-cai--open-jev/f6f2903828782e64.gif" width="100%" alt="Zefan-Cai/Open-Jev animation"><br><sub>nagranie animowane · <a href="https://zefan-cai.github.io/open-jev/v1-1/replay.mp4">Otwórz wideo</a></sub></td>
</tr></table>
...
Opracowane przez LLM harnessy Jev do konkretnych zadań, z opcjonalną refleksją nad nagrodą za pełną trajektorię i ewolucją GEPA.
...
Asystent odpowiedzi 微信 oparty na DeepSeek + TypeSafe JEV: oficjalna wersja Windows, wersja preview dla Apple Silicon macOS; lokalne OCR i odpowiedzi kontrolowane przez człowieka
...
- [iapp-technology/openthai-systemone](https://github.com/iapp-technology/openthai-systemone) - OpenThai-SystemOne: otwarty tajski + angielski model decyzyjny System One…
- [hawkymisc/typed-decision-bert](https://github.com/hawkymisc/typed-decision-bert) - Nieoficjalny PoC: silnik decyzyjny z enkoderem w stylu BERT za HTTP API…
...
<sub>Wygenerowano przez · `render.py` · 2026-09-23T17:45:55+08:00</sub>
