...
> [!NOTE]
> **Indeks na żywo** · Ostatnia synchronizacja: `2026-09-23T20:09:57+08:00` (UTC+8)
> · Wpisy: **770** · Nowe w tym cyklu: **76** · Języki implementacji: **22**
...
- [Narzędzia dla agentów: MCP, hooki, bramki i agenty kodujące](#narzędzia-dla-agentów-mcp-hooki-bramki-i-agenty-kodujące) — **231**
- [Routing, zabezpieczenia i zatwierdzenia](#routing-zabezpieczenia-i-zatwierdzenia) — **57**
- [Ewaluacja, kalibracja i benchmarki](#ewaluacja-kalibracja-i-benchmarki) — **76**
- [Otwarte reprodukcje, wagi i badania nad architekturą](#otwarte-reprodukcje-wagi-i-badania-nad-architekturą) — **44**
...
- [Inne projekty](#inne-projekty) — **80**
...
R.A.I.N. Lab to eksperymentalna architektura agenta naukowego, która rozdziela szybki lokalny osąd, niezależną ocenę probabilistyczną, deliberację wieloagentową, dowody i autoryzację na odrębne warstwy obliczeniowe.🐙(Poprzedza AutoResearch Karpathy’ego)
...
<details>
<summary><b>Więcej w tej kategorii</b> <sub>· 110</sub></summary>
...
- [agent-chaperone/agent-chaperone](https://github.com/agent-chaperone/agent-chaperone) - Sprawdza wywołania narzędzi agenta AI przed ich wykonaniem oraz wyniki…
...
- [keltokhy/jsort](https://github.com/keltokhy/jsort) - sortuj według znaczenia: uporządkuj wiersze wzdłuż wymiaru opisanego prostym…
...
- [lucasmartins-ai/lcc](https://github.com/lucasmartins-ai/lcc) - Local Context Compiler (lcc): oczyść, usuń duplikaty i skompaktuj kontekst…
...
- [KiritoKing/midscene-jev-runner](https://github.com/KiritoKing/midscene-jev-runner) - Utrzymywana przez społeczność integracja uruchamiacza JEV z Midscene Test.
...
<details>
<summary><b>Więcej w tej kategorii</b> <sub>· 209</sub></summary>
...
- [socai-io/jev-social](https://github.com/socai-io/jev-social) - Jev × SocAI do badań na Instagramie, TikToku i LinkedIn — typowane…
...
Filtruj swój kanał X.com za pomocą Jev lub dowolnego LLM
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/tshmieldev--sharp/016860f6bb08aa6b.gif" width="100%" alt="tshmieldev/sharp animation"><br><sub>nagranie animowane</sub></td>
</tr></table>
...
- [zeeshan8281/slo-router](https://github.com/zeeshan8281/slo-router) - Router wnioskowania LLM uwzględniający SLO, z decyzjami Jev, metrykami kolejki…
...
Pozwól Jev czytać każdego ranka każdą nową pracę z arXiv i wybierać te nieliczne, które warto przeczytać. Zainteresowania opisane prostym językiem angielskim, skalibrowane prawdopodobieństwa, około 0,06 USD dziennie — sklonuj i uruchom.
...
Wydajny projekt open source System One Model do jednokrotnego wykonywania typowanych decyzji, z osadzalnym środowiskiem uruchomieniowym C i obsługą WebAssembly.
...
TypeLLM: LLMs z generowaniem bezpiecznym typowo
...
Samodzielnie hostowany API i interfejs internetowy dla ustrukturyzowanych modeli decyzyjnych Laya, zgodny z formatem TypeSafe Jev API.
...
<sub>Wygenerowano przez · `render.py` · 2026-09-23T20:09:57+08:00</sub>
