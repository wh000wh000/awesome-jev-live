...
> [!NOTE]
> **Indeks na żywo** · Ostatnia synchronizacja: `2026-09-23T12:34:14+08:00` (UTC+8)
> · Wpisy: **770** · Nowe w tym cyklu: **69** · Języki implementacji: **24**
...
<sub>Jev, model System One należący do TypeSafe, gra w szachy przeciwko dowolnemu LLM OpenRouter, Stockfishowi i tobie. Jednostronicowa aplikacja internetowa z ruchami na…</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
- [Klienty, zestawy SDK i adaptery społeczności](#klienty-zestawy-sdk-i-adaptery-społeczności) — **137**
- [Narzędzia dla agentów: MCP, hooki, bramki i agenty kodujące](#narzędzia-dla-agentów-mcp-hooki-bramki-i-agenty-kodujące) — **242**
- [Routing, zabezpieczenia i zatwierdzenia](#routing-zabezpieczenia-i-zatwierdzenia) — **56**
...
- [Inne projekty](#inne-projekty) — **74**
...
Jeden zewnętrzny CLI dla wszystkich Twoich robotów. Połącz je, steruj nimi i pozwól im współpracować, z LLM jako mózgiem oraz LLM decyzyjnym zapewniającym tańsze i szybsze kroki. Microduck, Open Duck Mini, LeRobot, XLeRobot, AlohaMini, ToddlerBot lub dowolna baza ROS. Claude, OpenAI, Gemini, Grok lub lokalnie przez Ollama albo vLLM.
...
<details>
<summary><b>Więcej w tej kategorii</b> <sub>· 115</sub></summary>
...
- [BeatAPI/awesome-jev](https://github.com/BeatAPI/awesome-jev) - Przejrzana pod kątem źródeł galeria projektów związanych z JEV, z ponad 50…
...
- [evoke-build/evoke](https://github.com/evoke-build/evoke) - Oprogramowanie na zawołanie. Powiedz, a uruchomi się właściwy mały program…
- [oswarld/notion-skills](https://github.com/oswarld/notion-skills) - Umiejętność dla koreańskich użytkowników Notion, która robi wszystko zgrabnie…
...
- [compozy/yoshi](https://github.com/compozy/yoshi) - Proxy przycinające kontekst dla Claude Code i Codex: Jev ocenia, która część…
...
- [shitianfang/jev-use](https://github.com/shitianfang/jev-use) - Wtyczka Claude Code / Codex / pi, która przekazuje Jev kroki agenta…
...
- [weitianxin/JevAny](https://github.com/weitianxin/JevAny) - RL uwzględniające kalibrację dla modeli decyzyjnych, rozwijane w kierunku…
...
- [lucioamor/lovable-skills](https://github.com/lucioamor/lovable-skills) - Wielokrotnego użytku umiejętności Lovable do przeglądów aplikacji, podejmowania…
...
Samodzielnie hostowane monitorowanie promptów z modelami System One
...
Kontrola dopuszczania oparta na typowanych ocenach na brzegu ruchu: trójwarstwowy filtr zapobiegania wstrzykiwaniu promptów i nadużyciom dla nginx/OpenResty, zasilany przez TypeSafe Jev. Fail-open, z pamięcią podręczną i możliwością przeładowania na gorąco.
...
Otwarte modele System One: typowane decyzje ze skalibrowanymi prawdopodobieństwami, które można trenować na własnych danych. Bez generowania tekstu.
...
<details>
<summary><b>Więcej w tej kategorii</b> <sub>· 11</sub></summary>
...
- [Kevthetech143/super-jev](https://github.com/Kevthetech143/super-jev) - Mały, rozszerzalny mechanizm łączący decyzję z działaniem dla TypeSafe Jev.
...
<sub>Wygenerowano przez · `render.py` · 2026-09-23T12:34:14+08:00</sub>
