...
> [!NOTE]
> **Indeks na żywo** · Ostatnia synchronizacja: `2026-09-25T18:10:37+08:00` (UTC+8)
> · Wpisy: **799** · Nowe w tym cyklu: **298** · Języki implementacji: **24**
...
- [Narzędzia dla agentów: MCP, hooki, bramki i agenty kodujące](#narzędzia-dla-agentów-mcp-hooki-bramki-i-agenty-kodujące) — **249**
- [Routing, zabezpieczenia i zatwierdzenia](#routing-zabezpieczenia-i-zatwierdzenia) — **58**
- [Ewaluacja, kalibracja i benchmarki](#ewaluacja-kalibracja-i-benchmarki) — **81**
- [Otwarte reprodukcje, wagi i badania nad architekturą](#otwarte-reprodukcje-wagi-i-badania-nad-architekturą) — **38**
- [Aplikacje, gry, robotyka i interaktywne dema](#aplikacje-gry-robotyka-i-interaktywne-dema) — **54**
- [Teksty, dyskusje i pokrewne listy](#teksty-dyskusje-i-pokrewne-listy) — **102**
- [Inne projekty](#inne-projekty) — **82**
...
<sub>🔧 Znaleziono użycie w kodzie: `src/typesafe_sdk/__init__.py`</sub>
...
<sub>🔧 Znaleziono użycie w kodzie: `Sources/CoreAIOps/CoreAI+SystemOne.swift`</sub>
...
Niezależny od bazy danych framework Agentic GraphRAG wykorzystujący wymienne modele System One (lokalny Laya / chmurowy Jev). Gotowa do użycia warstwa inteligencji z kompletnym potokiem 4-fazowym i niestandardowym przechodzeniem A* dla dowolnej grafowej bazy danych.
...
Ponad 200 gotowych do użycia przepisów Jev: małe, skalibrowane decyzje AI, które przekierowują, oceniają, kontrolują, porównują i etykietują tekst dla agentów, RAG, wsparcia, przeglądu kodu i muzyki. Importuj z JavaScript lub TypeScript albo wywołuj CLI za pomocą JSON z dowolnego języka.
...
Społecznościowy Java SDK dla Jev, modelu System One firmy TypeSafe: typowane pytania na wejściu, typowane odpowiedzi ze skalibrowanymi prawdopodobieństwami na wyjściu. Java 17+, starter Spring Boot (nieoficjalny)
...
Jedno CLI dla wszystkich Twoich robotów. Łącz je, wydawaj im polecenia i pozwól im współpracować, zapewniając każdemu LLM jako mózg (Claude, OpenAI, Gemini, Grok lub lokalny przez Ollama albo vLLM) oraz decyzyjny LLM do pytań wielokrotnego wyboru (Jev, Laya, Kev). Steruje Microduck, Open Duck Mini, LeRobot, XLeRobot, AlohaMini, ToddlerBot, a także dowolną bazą ROS 2 z laptopa, poza robotem.
...
CLI, który wybiera Cursor, Claude Code, Codex lub OpenCode + model/poziom wysiłku dla zadania, a następnie go uruchamia. Działa dzięki Jev i Herdr
...
<details>
<summary><b>Więcej w tej kategorii</b> <sub>· 111</sub></summary>
...
- [shaharia-lab/jev-cli](https://github.com/shaharia-lab/jev-cli) - Narzędzie wiersza poleceń dla modelu Jev firmy TypeSafe AI.
...
- [chengyongru/fastjev](https://github.com/chengyongru/fastjev) - Fork SemIf stawiający na SDK, niezależnie utrzymywany na potrzeby szybkich…
- [Ray-Hughes/jevalyn](https://github.com/Ray-Hughes/jevalyn) - Warstwa decyzyjna dla Twojej aplikacji Rails.
- [CheshiAI/Cheshi](https://github.com/CheshiAI/Cheshi) - Pamięć rozmów oparta na Jev: znajdź poprzednie sesje i ponownie przeanalizuj…
- [evoke-build/evoke](https://github.com/evoke-build/evoke) - Oprogramowanie, odruchowo. Powiedz, czego potrzebujesz, a uruchomi się właściwy…
- [utk2103/jev-studio](https://github.com/utk2103/jev-studio) - Jeśli eksperymentujesz z jev, stąd będzie łatwiej.
...
Eksperymenty z wyszukiwarką na zbiorach TREC. Obecnie skupione na implementacjach ponownego rangowania zero-shot z wykorzystaniem modelu JEV firmy typesafe.ai
...
Lokalna alternatywa Jev o otwartym kodzie źródłowym: decyzje agenta przeglądarki z Laya (model System One) na własnym komputerze. Bez chmury i bez klucza API. Przyjazne dla Playwright/CDP i MCP.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/mansicer--jev-plays/c4f1ec41afcb4ae9.gif" width="100%" alt="mansicer/jev-plays animation"><br><sub>nagranie animowane</sub></td>
</tr></table>
...
<details>
<summary><b>Więcej w tej kategorii</b> <sub>· 231</sub></summary>
...
- [jev-chat/jev-chat-jarvis](https://github.com/jev-chat/jev-chat-jarvis) - Konwersacyjny drugi pilot w telefonie: rozumie rozmówcę w QQ / X / 飞书…
- [reticlehq/reticle](https://github.com/reticlehq/reticle) - Agenci AI potrafią generować kod, ale nadal mają trudności ze zrozumieniem…
...
- [supercorp-ai/supercov](https://github.com/supercorp-ai/supercov) - Pokrycie, bezpieczeństwo i jakość kodu dla agentów programistycznych.
...
- [angel291592/Intent-Router](https://github.com/angel291592/Intent-Router) - Kompilator intencji dla agentów AI — przekształca niejasne żądania w typowane…
- [socai-io/jev-social](https://github.com/socai-io/jev-social) - Umiejętność agenta open source i lokalna demonstracja: Jev × socai do badań na…
...
- [OmniJev/PlayJev](https://github.com/OmniJev/PlayJev) - 🚀🚀 Multimodalny model JEV-podobny 0.8B, grający w gry GUI bezpośrednio na…
...
- [khordoo/jev-reflex-autonomy-lab](https://github.com/khordoo/jev-reflex-autonomy-lab) - Symulacja autonomii roju dronów w czasie rzeczywistym, wykorzystująca Jev do…
...
- [24601/Augustus](https://github.com/24601/Augustus) - Umiejętność agenta do znajdowania, budowania, oceniania i ulepszania systemów…
...
- [itsmostafa/typesafe-mcp](https://github.com/itsmostafa/typesafe-mcp) - Łącznik mcp do szybkiej i taniej oceny wszystkiego.
...
Brama triage ryzyka w czasie rzeczywistym dla wpłat i wypłat na giełdzie — Jev (TypeSafe System One) zajmuje się wyłącznie triage; rozstrzyganie pozostaje w kodzie deterministycznym.
...
Kontrola dostępu oparta na typowanych ocenach na krawędzi ruchu: trójwarstwowy filtr prompt injection i nadużyć dla nginx/OpenResty, oparty na TypeSafe Jev. Fail-open, z pamięcią podręczną i możliwością hot-reloadu.
...
Rysuj na płótnie tldraw za pomocą głosu i wskazującego palca. Jev (TypeSafe System One) decyduje o działaniu, celu i miejscu w ~350 ms na wypowiedziane słowo.
...
JevK5: alternatywa z otwartymi wagami dla TypeSafe Jev. Typowane decyzje z prawdopodobieństwami w jednym przejściu w przód; wagi i kod Apache-2.0.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/allebee--jevk5/1f9cd6cb325d4bd4.gif" width="100%" alt="allebee/jevk5 animation"><br><sub>nagranie animowane · <a href="https://raw.githubusercontent.com/allebee/jevk5/main/docs/demo/jevk5-nvidia-demo.mp4">Otwórz wideo</a></sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/weitianxin--jevany/711125367b6758ff.gif" width="100%" alt="weitianxin/JevAny animation"><br><sub>nagranie animowane</sub></td>
</tr></table>
...
Typowane decyzje z nieustrukturyzowanego stanu: jedno przejście w przód, zero generowanego tekstu. Lokalny, deterministyczny, zgodny z Jev. Niepowiązany z typesafe.ai.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/antonellof--laya-vs-dijkstra/b61bc3a8e3d368be.gif" width="100%" alt="antonellof/laya-vs-dijkstra animation"><br><sub>nagranie animowane</sub></td>
</tr></table>
...
Semantyczne instrukcje if z otwartych modeli, uruchamiane na domowym 3090. Niezależny; niepowiązany z Jev ani TypeSafe.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/theoleecj--semif-openjev/0504149cd9ef3cad.gif" width="100%" alt="TheoLeeCJ/SemIf-OpenJev animation"><br><sub>nagranie animowane</sub></td>
</tr></table>
...
- [ShuhanSun/jev-oas-sentinel](https://github.com/ShuhanSun/jev-oas-sentinel) - Wykrywaj przełomowe zachowanie API ukryte w opisie OpenAPI za pomocą…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/zadescoxp--jev-trades/2abea899d779de55.gif" width="100%" alt="zadescoxp/Jev-Trades animation"><br><sub>nagranie animowane</sub></td>
</tr></table>
...
- [heyjunpenn/awesome-jev](https://github.com/heyjunpenn/awesome-jev) - Zweryfikowany, utrzymywany przez społeczność katalog 916 projektów open source…
...
<details>
<summary>📰 <b><a href="https://typesafe.ai/team">TypeSafe dodało stronę Team + nawigacja dodała wejście `Enterprise` (sygnał produktizacji/komercjalizacji)</a></b> · ✅ official · 6 天</summary>
...
<details>
<summary><b>Więcej w tej kategorii</b> <sub>· 89</sub></summary>
...
Rodzina modeli decyzyjnych podobnych do Jev, zbudowanych na Qwen3.5/3.8, które możesz samodzielnie trenować i uruchamiać
...
Samodzielnie wytrenuj multimodalny model podobny do Jev. System One Model, teraz z obsługą wizji.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/liuziyu77--valen/d4fa3bf5c399a28d.gif" width="100%" alt="Liuziyu77/Valen animation"><br><sub>nagranie animowane</sub></td>
</tr></table>
...
JevChat-Windows: pomocnik odpowiedzi przypięty obok okna czatu. Zrzut okna + lokalny, działający offline OCR odczytuje wiadomość rozmówcy → Jev rozpoznaje intencję → 3 proponowane odpowiedzi można wstawić jednym kliknięciem; wysyłanie zawsze ręczne
...
- [HITsz-TMG/JevEmbed](https://github.com/HITsz-TMG/JevEmbed) - Poznaj JevEmbed — zamieniaj osadzenia w decyzje.
- [Kevthetech143/super-jev](https://github.com/Kevthetech143/super-jev) - Mały, rozszerzalny uprząż do przechodzenia od decyzji do działania dla TypeSafe…
...
<sub>Wygenerowano przez · `render.py` · 2026-09-25T18:10:37+08:00</sub>
