...
> [!NOTE]
> **라이브 인덱스** · 최근 동기화: `2026-09-27T01:21:54+08:00` (UTC+8)
> · 항목: **811** · 이번 회차 신규: **103** · 구현 언어: **25**
...
- [커뮤니티 클라이언트, SDK, 어댑터](#커뮤니티-클라이언트-sdk-어댑터) — **134**
...
- [wojciechwiesner/jit-context](https://github.com/wojciechwiesner/jit-context) - Architectural Moat: JIT-JEV Context OS — AI 에이전트를 위한 인식론적 런타임 및 JEV System 1…
...
- [safzanpirani/pi-jev-skill-picker](https://github.com/safzanpirani/pi-jev-skill-picker) - TypeSafe Jev을(를) 사용해 현재 작업에 적합한 Pi Agent Skills 순위 지정.
...
모든 LLM을(를) Jev 스타일의 의사결정 모델로 변환: 타입이 지정된 결정, 실제 확률, 학습 불필요. (계속 업데이트하며 모든 이슈와 PR 요청을 환영합니다)
...
<sub>생성 도구 · `render.py` · 2026-09-27T01:21:54+08:00</sub>
