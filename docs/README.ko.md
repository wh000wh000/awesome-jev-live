...
> [!NOTE]
> **라이브 인덱스** · 최근 동기화: `2026-09-26T18:44:26+08:00` (UTC+8)
> · 항목: **806** · 이번 회차 신규: **98** · 구현 언어: **25**
...
- [topherchris420/james_library](https://github.com/topherchris420/james_library) - R.A.I.N. Lab은 빠른 로컬 판단, 독립적인 확률 평가, 다중 에이전트 숙의, 증거, 권한 부여를 서로 다른 계산 계층으로 분리하는…
...
- [6Mikao9/jev-native-agent-with-extended-options](https://github.com/6Mikao9/jev-native-agent-with-extended-options) - Jev 네이티브 에이전트 시스템을 위한 연구 설계: 가상화와 페이징으로 jev가 제공한 것보다 더 많은 옵션을 활성화하고, 도구 통합, Jev…
...
- [MiaoWuNYA/rikkahub-sillytavern-android](https://github.com/MiaoWuNYA/rikkahub-sillytavern-android) - Android AI 채팅 클라이언트: Tavern 카드를 무손실로 가져오고, 캐시를 적극적으로 최적화해 사용량을 줄이며, Jev 의사결정…
...
- [jesset/pi-verdict](https://github.com/jesset/pi-verdict) - Claude Code의 자동 모드 스타일을 따르는 Pi용 최소 권한 게이트.
...
- [Ryu0118/jev-sim-use](https://github.com/Ryu0118/jev-sim-use) - 📱 Jev 속도로 sim-use를 사용해 모든 화면에 접근하세요.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/123skywalker/Neriv/main/demo.gif" width="100%" alt="123skywalker/Neriv animation"><br><sub>움직이는 화면 녹화</sub></td>
</tr></table>
...
- [shengjidaguai-china/goutoujunshi-jev-chat](https://github.com/shengjidaguai-china/goutoujunshi-jev-chat) - 狗头军师 Chat: Mac 微信 화면 읽기, 관계 분석 및 답변 초안 플로팅 창.
...
- [HITsz-TMG/JevEmbed](https://github.com/HITsz-TMG/JevEmbed) - JevEmbed를 만나보세요 — 임베딩을 의사결정으로 전환합니다. 원하는 임베딩 모델로 선택하고, 점수를 매기고, 판단하세요.
...
- [Abhinavexists/lev](https://github.com/Abhinavexists/lev) - 공개 System One 의사결정 모델.
...
<sub>생성 도구 · `render.py` · 2026-09-26T18:44:26+08:00</sub>
