...
> [!NOTE]
> **라이브 인덱스** · 최근 동기화: `2026-09-21T15:27:37+08:00` (UTC+8)
> · 항목: **702** · 이번 회차 신규: **59** · 구현 언어: **26**
...
<sub>AI 평가를 위한 검증 계층. 점수만이 아니라 도구 자체를 검사합니다: 데이터, 채점기, 실행, 수치, 주장 및 자기 자신.</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
- [에이전트 도구: MCP, 훅, 게이트, 코딩 에이전트](#에이전트-도구-mcp-훅-게이트-코딩-에이전트) — **190**
- [라우팅, 가드레일, 승인](#라우팅-가드레일-승인) — **64**
- [평가, 캘리브레이션, 벤치마크](#평가-캘리브레이션-벤치마크) — **79**
- [공개 재현, 가중치, 아키텍처 연구](#공개-재현-가중치-아키텍처-연구) — **33**
- [애플리케이션, 게임, 로보틱스, 인터랙티브 데모](#애플리케이션-게임-로보틱스-인터랙티브-데모) — **54**
- [글, 토론, 유사 목록](#글-토론-유사-목록) — **89**
- [기타 프로젝트](#기타-프로젝트) — **69**
...
작업에 대해 Cursor, Claude Code, Codex 또는 OpenCode + model/effort를 선택한 다음 실행하는 CLI. Jev 및 Herdr로 구동
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/christiantracy--jev-terrarium-dinosaurs/470c26c8cd6fd09b.gif" width="100%" alt="ChristianTracy/jev-terrarium-dinosaurs animation"><br><sub>움직이는 화면 녹화</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/dtduc-git--jev-table/cf24db495e9a350c.gif" width="100%" alt="dtduc-git/jev-table animation"><br><sub>움직이는 화면 녹화</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/jammaru--jev-affected/a133b121a40d7830.gif" width="100%" alt="jammaru/jev-affected animation"><br><sub>움직이는 화면 녹화 · <a href="https://raw.githubusercontent.com/jammaru/jev-affected/main/assets/demo.mp4">동영상 열기</a></sub></td>
</tr></table>
...
- [carlosedm10/agi-jev-containment](https://github.com/carlosedm10/agi-jev-containment) - AGI JEV Detection — 로컬 AI 에이전트 모니터: 체인 수준 악성 에이전트 탐지(TypeSafe Jev + Sentinel).
...
- [nico-martin/open-jev](https://github.com/nico-martin/open-jev) - open-jev는 타입이 지정된 의사결정을 위한 브라우저 중심 TypeScript 라이브러리입니다. 텍스트 하나(상태)와 타입이 지정된 질문.
...
- [kushals256/jevcache](https://github.com/kushals256/jevcache) - TypeSafe Jev가 같은 의도라고 판단하면 비용이 많이 드는 LLM 호출을 건너뜁니다. OpenAI 호환 로컬 캐시 프록시 — npx.
...
Chrome용 Jev: 초 단위 미만의 의사결정 모델인 TypeSafe Jev로 보고 있는 탭을 구동합니다. browser-use/jev-ultrafast의 커뮤니티 포트이며, TypeSafe와(과) 제휴하지 않았습니다.
...
<details>
<summary><b>이 분류의 나머지</b> <sub>· 156</sub></summary>
...
- [safzanpirani/pi-jev-skill-picker](https://github.com/safzanpirani/pi-jev-skill-picker) - TypeSafe Jev로 현재 작업에 대한 Pi Agent Skills 순위 매기기.
...
- [jackbarunz/jev-tool-router](https://github.com/jackbarunz/jev-tool-router) - Codex를 위한 Jev 기반 MCP 도구 라우팅.
- [libingzheren/Jev-Mem](https://github.com/libingzheren/Jev-Mem) - Jev-Mem: System-One 제어 에이전트 메모리.
- [nozomi-koborinai/jev-spec](https://github.com/nozomi-koborinai/jev-spec) - ⚡ TypeSafe AI Jev로 구동되는 AI Code 및 Specs를 위한 사양 주도 의미론적 검증 엔진.
...
- [miniLV/Jev-Auto-Router](https://github.com/miniLV/Jev-Auto-Router) - Jev Auto Router(Jev Router): TypeSafe Jev 및 로컬 Responses 프록시를 통해 Codex에 대해 호출별.
...
- [teempai/jev-in-codex](https://github.com/teempai/jev-in-codex) - MCP를 통한 Codex용 Jev 기반 도구 및 스킬 선택, 컨텍스트 검색, 출력 분류.
...
<sub>🔧 코드에서 사용 확인: `doc/research/tweets-and-community.md`</sub>
...
오픈 소스 로컬 Jev 대안: 증명 가능하게 보정된 신뢰도(ECE 0.170→0.071)를 갖춘 System One 결정 레이어. 타입 지정 결정, 오프라인 실행, API 키 없음, 대기자 명단 없음.
...
- [daniel-farina/nitro](https://github.com/daniel-farina/nitro) - 턴당 한 번 TypeSafe Jev 라우팅 도구 선택으로 Grok Build: 동일한 작업에서 22~40% 더 저렴.
...
- [RenaGao/jev-dataops](https://github.com/RenaGao/jev-dataops) - 스트리밍 데이터 선택, 품질 평가, 자동 LoRA 학습 및 홀드아웃 모델 평가를 위한 오픈 소스 JEV 기반 워크벤치.
...
<details>
<summary><b>이 분류의 나머지</b> <sub>· 15</sub></summary>
...
- [mizchi/jev-lint](https://github.com/mizchi/jev-lint) - jev scorerer로 코드 내 텍스트 린트.
...
<td align="center" valign="top"><a href="https://www.youtube.com/@j-AI99"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/evoworkai--jev-playground/a2aeedef9dc4507e.png" width="100%" alt="video"></a><br><sub><a href="https://www.youtube.com/@j-AI99">시청 위치 youtube.com</a> · 재생은 호스트 사이트에서 열립니다. GitHub에서는 인라인으로 삽입할 수 없습니다</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/qingbolan--llm2jev-releases/7a89d65110d9f076.gif" width="100%" alt="Qingbolan/llm2jev-releases animation"><br><sub>움직이는 화면 녹화 · <a href="https://github.com/Qingbolan/llm2jev-releases/raw/refs/tags/v0.2.0/docs/assets/local-inference.mp4">동영상 열기</a></sub></td>
</tr></table>
...
<sub>생성 도구 · `render.py` · 2026-09-21T15:27:37+08:00</sub>
