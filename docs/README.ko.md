...
> [!NOTE]
> **라이브 인덱스** · 최근 동기화: `2026-09-19T13:20:52+08:00` (UTC+8)
> · 항목: **467** · 이번 회차 신규: **29** · 구현 언어: **26**
...
- [커뮤니티 클라이언트, SDK, 어댑터](#커뮤니티-클라이언트-sdk-어댑터) — **75**
- [에이전트 도구: MCP, 훅, 게이트, 코딩 에이전트](#에이전트-도구-mcp-훅-게이트-코딩-에이전트) — **150**
- [라우팅, 가드레일, 승인](#라우팅-가드레일-승인) — **48**
- [평가, 캘리브레이션, 벤치마크](#평가-캘리브레이션-벤치마크) — **39**
- [공개 재현, 가중치, 아키텍처 연구](#공개-재현-가중치-아키텍처-연구) — **18**
...
| 언어     | Python                                          |
| 라이선스 | MIT                                             |
| 소유자   | authrain-cloud-abdullahformuli                  |
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/authrain-cloud-abdullahformuli--jev-ultrafast/dcdb919ac3afb514.gif" width="100%" alt="authrain-cloud-abdullahformuli/jev-ultrafast animation"><br><sub>움직이는 화면 녹화 · <a href="https://raw.githubusercontent.com/authrain-cloud-abdullahformuli/jev-ultrafast/main/docs/demo.mp4">동영상 열기</a></sub></td>
</tr></table>
...
<details>
<summary><b>이 분류의 나머지</b> <sub>· 116</sub></summary>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/nikotaronosuke--jev-voice-decision/aaa9beaaf083ea64.gif" width="100%" alt="nikotaronosuke/jev-voice-decision animation"><br><sub>움직이는 화면 녹화</sub></td>
</tr></table>
...
<details>
<summary><b>이 분류의 나머지</b> <sub>· 2</sub></summary>
...
| 티어     | 커뮤니티                                        |
| 근거     | `observed`                                      |
| 소유자   | [yishan](https://x.com/tspy) · @tspy · x.com    |
...
<sub>생성 도구 · `render.py` · 2026-09-19T13:20:52+08:00</sub>
