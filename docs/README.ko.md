...
> [!NOTE]
> **라이브 인덱스** · 최근 동기화: `2026-09-19T12:51:10+08:00` (UTC+8)
> · 항목: **452** · 이번 회차 신규: **0** · 구현 언어: **25**
...
- [커뮤니티 클라이언트, SDK, 어댑터](#커뮤니티-클라이언트-sdk-어댑터) — **72**
- [에이전트 도구: MCP, 훅, 게이트, 코딩 에이전트](#에이전트-도구-mcp-훅-게이트-코딩-에이전트) — **138**
- [라우팅, 가드레일, 승인](#라우팅-가드레일-승인) — **50**
- [평가, 캘리브레이션, 벤치마크](#평가-캘리브레이션-벤치마크) — **38**
- [공개 재현, 가중치, 아키텍처 연구](#공개-재현-가중치-아키텍처-연구) — **19**
- [애플리케이션, 게임, 로보틱스, 인터랙티브 데모](#애플리케이션-게임-로보틱스-인터랙티브-데모) — **43**
- [글, 토론, 유사 목록](#글-토론-유사-목록) — **37**
- [기타 프로젝트](#기타-프로젝트) — **49**
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/jimmyhealer--jev-semantic-explorer/f9d2833c758298d8.gif" width="100%" alt="jimmyhealer/jev-semantic-explorer animation"><br><sub>움직이는 화면 녹화</sub></td>
</tr></table>
...
<sub>생성 도구 · `render.py` · 2026-09-19T12:51:10+08:00</sub>
