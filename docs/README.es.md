...
> [!NOTE]
> **Índice en vivo** · Última sincronización: `2026-09-25T20:30:47+08:00` (UTC+8)
> · Entradas: **786** · Nuevas en este ciclo: **52** · Lenguajes de implementación: **22**
...
<sub>Swift SDK para ejecutar modelos de chat, visión y voz en iPhone y Mac con Core AI de Apple. Descarga y almacenamiento en caché de modelos, integración con…</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
- [Herramientas para agentes: MCP, hooks, gates y agentes de programación](#herramientas-para-agentes-mcp-hooks-gates-y-agentes-de-programación) — **249**
- [Enrutamiento, guardarraíles y aprobaciones](#enrutamiento-guardarraíles-y-aprobaciones) — **59**
...
<sub>🔧 Usado en código: `src/typesafe_sdk/__init__.py`</sub>
...
<sub>🔧 Usado en código: `Sources/CoreAIOps/CoreAI+SystemOne.swift`</sub>
...
Un framework Agentic GraphRAG independiente de la base de datos que utiliza modelos System One intercambiables (Laya local / Jev en la nube). Una capa de inteligencia plug-and-play con una canalización completa de 4 fases, evaluación continua y recorrido A* personalizado para cualquier base de datos de grafos.
...
Más de 200 recetas Jev listas para usar: decisiones de IA pequeñas y calibradas que enrutan, califican, filtran, comparan y etiquetan texto para agentes, RAG, soporte, revisión de código y música. Importa desde JavaScript o TypeScript, o llama al CLI con JSON desde cualquier lenguaje.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/agencyenterprise--jev-recipes/0f08086836b893d8.gif" width="100%" alt="agencyenterprise/jev-recipes animation"><br><sub>grabación animada</sub></td>
</tr></table>
...
Java SDK comunitario para Jev, el modelo System One de TypeSafe: preguntas tipadas de entrada y respuestas tipadas con probabilidades calibradas de salida. Java 17+, starter de Spring Boot (no oficial)
...
Un CLI para todos tus robots. Conéctalos, dales órdenes y deja que trabajen juntos, cada uno con un LLM como cerebro (Claude, OpenAI, Gemini, Grok o local mediante Ollama o vLLM) y un LLM de decisión para opciones múltiples (Jev, Laya, Kev). Controla Microduck, Open Duck Mini, LeRobot, XLeRobot, AlohaMini, ToddlerBot, cualquier base ROS 2, desde un portátil y de forma externa.
...
- [CheshiAI/Cheshi](https://github.com/CheshiAI/Cheshi) - Memoria conversacional impulsada por Jev: encuentra sesiones anteriores y…
...
Alternativa local y de código abierto a Jev: decisiones de agente de navegador con Laya (modelo System One) en tu propia máquina. Sin nube ni clave de API. Compatible con Playwright/CDP y MCP.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/mansicer--jev-plays/c4f1ec41afcb4ae9.gif" width="100%" alt="mansicer/jev-plays animation"><br><sub>grabación animada</sub></td>
</tr></table>
...
- [supercorp-ai/supercov](https://github.com/supercorp-ai/supercov) - Cobertura, seguridad y calidad del código para agentes de programación.
...
- [socai-io/jev-social](https://github.com/socai-io/jev-social) - Jev × socai convierte una pregunta de investigación social en evidencia real de…
...
- [OmniJev/PlayJev](https://github.com/OmniJev/PlayJev) - 🚀🚀 Un modelo multimodal similar a JEV de 0.8B que juega a juegos de GUI…
...
- [khordoo/jev-reflex-autonomy-lab](https://github.com/khordoo/jev-reflex-autonomy-lab) - Simulación de autonomía de enjambres de drones en tiempo real usando Jev para…
...
- [24601/Augustus](https://github.com/24601/Augustus) - Habilidad de agente para encontrar, construir, evaluar y mejorar sistemas de…
...
- [green-dalii/pi-shift-router](https://github.com/green-dalii/pi-shift-router) - Enrutamiento del modelo por turno para el agente de programación Pi: un juez…
- [inso1337/revl](https://github.com/inso1337/revl) - Un lenguaje para la composabilidad espaciotemporal segura y universal…
- [AskTheWay/dsh-jev-interceptor](https://github.com/AskTheWay/dsh-jev-interceptor) - ⚡ Juicio del Sistema 1 en milisegundos para cada llamada de herramienta en…
...
- [itsmostafa/typesafe-mcp](https://github.com/itsmostafa/typesafe-mcp) - Un conector mcp para evaluar cualquier cosa de forma rápida y económica.
...
Pasarela de triaje de riesgos en tiempo real para depósitos y retiros de exchanges: Jev (TypeSafe System One) solo gestiona el triaje; la adjudicación permanece en código determinista.
...
Dibuja en un lienzo de tldraw con tu voz y un dedo señalador. Jev (TypeSafe System One) decide la acción, el objetivo y el lugar en ~350 ms por palabra hablada.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/4nt0ineb--jev-from-java/cd4ce3d04107d762.gif" width="100%" alt="4nt0ineB/jev-from-java animation"><br><sub>grabación animada</sub></td>
</tr></table>
...
- [WiktorB2004/llama-index-jev](https://github.com/WiktorB2004/llama-index-jev) - Reordenador + enrutador de LlamaIndex impulsado por TypeSafe Jev: puntuaciones…
...
Un modelo diminuto similar a jev que responde preguntas de Choice, Score y Noul en una sola pasada hacia delante y devuelve probabilidades calibradas. MLX o PyTorch, completamente sin conexión y compatible con System One.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/weitianxin--jevany/711125367b6758ff.gif" width="100%" alt="weitianxin/JevAny animation"><br><sub>grabación animada</sub></td>
</tr></table>
...
- [wondertwins/jev-benchmark](https://github.com/wondertwins/jev-benchmark) - Benchmarks y un playground para el modelo Jev de TypeSafe (System One): ajedrez…
...
Decisiones tipadas a partir de estados no estructurados: una sola pasada hacia delante, cero texto generado. Local, determinista y compatible con Jev. No está afiliado a typesafe.ai.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/antonellof--laya-vs-dijkstra/b61bc3a8e3d368be.gif" width="100%" alt="antonellof/laya-vs-dijkstra animation"><br><sub>grabación animada</sub></td>
</tr></table>
...
Semántica de ifs a partir de modelos abiertos, en una 3090 doméstica. Independiente; no está afiliado a Jev ni a TypeSafe.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/theoleecj--semif-openjev/0504149cd9ef3cad.gif" width="100%" alt="TheoLeeCJ/SemIf-OpenJev animation"><br><sub>grabación animada</sub></td>
</tr></table>
...
- [bnsd55/jevmlx](https://github.com/bnsd55/jevmlx) - Decisiones paralelas restringidas al estilo de Jev para cualquier modelo MLX en…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/zadescoxp--jev-trades/2abea899d779de55.gif" width="100%" alt="zadescoxp/Jev-Trades animation"><br><sub>grabación animada</sub></td>
</tr></table>
...
- [Ryu0118/jev-sim-use](https://github.com/Ryu0118/jev-sim-use) - 📱 Llega a cualquier pantalla con sim-use a velocidad de Jev.
...
Familia de modelos de decisión similares a Jev, construidos sobre Qwen3.5/3.8 que puedes entrenar y ejecutar por tu cuenta
...
Entrena por tu cuenta un modelo multimodal similar a Jev. System One Model, ahora con visión.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/liuziyu77--valen/d4fa3bf5c399a28d.gif" width="100%" alt="Liuziyu77/Valen animation"><br><sub>grabación animada</sub></td>
</tr></table>
...
Un reemplazo local y compatible con API para el modelo System One de Jev, TypeSafe
...
Traducción al español de la documentación oficial de uso del modelo Jev (TypeSafe AI) | Traducción no oficial al chino de la documentación oficial de Jev (TypeSafe AI) — https://docs.typesafe.ai
...
JevChat-Windows: asistencia para responder junto a la ventana de chat. Captura de la ventana + OCR local sin conexión para leer los mensajes de la otra persona → Jev determina la intención → 3 respuestas candidatas que se introducen con un toque; el envío siempre es manual
...
<sub>Generado por · `render.py` · 2026-09-25T20:30:47+08:00</sub>
