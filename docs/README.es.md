...
> [!NOTE]
> **Índice en vivo** · Última sincronización: `2026-09-22T11:05:08+08:00` (UTC+8)
> · Entradas: **737** · Nuevas en este ciclo: **54** · Lenguajes de implementación: **25**
...
- [Herramientas para agentes: MCP, hooks, gates y agentes de programación](#herramientas-para-agentes-mcp-hooks-gates-y-agentes-de-programación) — **209**
...
- [Reproducciones abiertas, pesos e investigación de arquitectura](#reproducciones-abiertas-pesos-e-investigación-de-arquitectura) — **36**
- [Aplicaciones, juegos, robótica y demos interactivas](#aplicaciones-juegos-robótica-y-demos-interactivas) — **46**
- [Artículos, discusiones y listas hermanas](#artículos-discusiones-y-listas-hermanas) — **90**
- [Otros proyectos](#otros-proyectos) — **77**
...
Software, por reflejo. Una frase se convierte en una llamada a un pequeño programa, elegido por Jev, el clasificador de TypeSafe AI, y ejecutado solo cuando tiene suficiente certeza. Los reflejos son recetas que cualquiera puede escribir, compartir y mejorar. Un CLI con el que hablas, un gestor de paquetes para reflejos de git y un TypeScript SDK.
...
- [keltokhy/jlink](https://github.com/keltokhy/jlink) - Vinculación de registros para economistas: escribe la regla de coincidencia en…
...
Copiloto conversacional instalado en el teléfono: entiende a la otra persona en WeChat / QQ / X / 飞书, propone respuestas, las introduce en el campo de texto con un toque; tú decides si enviarlas. No es invasivo: solo lee la pantalla, no usa hooks ni modifica paquetes.
...
<details>
<summary><b>Más en esta categoría</b> <sub>· 187</sub></summary>
...
- [savka777/jev-use](https://github.com/savka777/jev-use) - Dilo, y tu Mac lo hace. Un arnés de uso de computadora en Jev que lee la…
...
- [blakestone-x/jev-mcp](https://github.com/blakestone-x/jev-mcp) - Servidor MCP para TypeSafe Jev: clasifica, puntúa, comprueba, empareja y filtra…
...
- [khordoo/jev-reflex-autonomy-lab](https://github.com/khordoo/jev-reflex-autonomy-lab) - Laboratorio de autonomía multidron que demuestra decisiones reflejas de…
...
- [PerryLink/jevcore](https://github.com/PerryLink/jevcore) - TypeSafe Jev para DeepSeek Harness, el Model Context Protocol y Node simple…
...
- [Nyarlathoteppppp/pi-jev-context](https://github.com/Nyarlathoteppppp/pi-jev-context) - El rendimiento del modelo primero. El ahorro de tokens, segundo.
- [alexgreensh/eval-genius](https://github.com/alexgreensh/eval-genius) - Enseña a tu agente a trabajar con evaluaciones: CUÁNDO realmente necesitas una…
- [nozomi-koborinai/jev-spec](https://github.com/nozomi-koborinai/jev-spec) - ⚡ Detecta desviaciones de especificación en cada commit: comprueba tu código…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/hfnissum-byte/Hunkpick/main/demo/hunkpick.gif" width="100%" alt="hfnissum-byte/Hunkpick animation"><br><sub>grabación animada</sub></td>
</tr></table>
...
- [jagsan-cyber/reflex-gate](https://github.com/jagsan-cyber/reflex-gate) - Pasarela local compatible con Jev / System One — no es el Jev de TypeSafe.
...
Convierte cualquier LLM en un modelo de decisión al estilo Jev: decisiones tipadas, probabilidades reales, sin entrenamiento.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/nokia-applied-research--anyjev/4184f4406ec59fe6.gif" width="100%" alt="nokia-applied-research/AnyJev animation"><br><sub>grabación animada</sub></td>
</tr></table>
...
- [rupeshpoojary9/awesome-open-system-one](https://github.com/rupeshpoojary9/awesome-open-system-one) - Lista seleccionada del ecosistema abierto de System One: modelos abiertos…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/rythmn1111--doom-war/c0cd335c6615f8e3.gif" width="100%" alt="rythmn1111/doom-war animation"><br><sub>grabación animada</sub></td>
</tr></table>
...
<details>
<summary><b>Más en esta categoría</b> <sub>· 14</sub></summary>
...
- [mmastrac/djev](https://github.com/mmastrac/djev) - Decisiones estructuradas al estilo de Jev en DiffusionGemma: el servidor de…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/michaelpersonal--jev-trade-cc/b3ae9a36cc9fcbbf.gif" width="100%" alt="michaelpersonal/jev-trade-cc animation"><br><sub>grabación animada</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/iron-lyk--omnijev/341b127f269cdd62.gif" width="100%" alt="Iron-LYK/OmniJev animation"><br><sub>grabación animada · <a href="https://raw.githubusercontent.com/Iron-LYK/OmniJev/main/docs/media/omnijev-stack.mp4">Abrir vídeo</a></sub></td>
</tr></table>
...
<td align="center" valign="top"><a href="https://youtu.be/rLLO-umS140"><img src="https://img.youtube.com/vi/rLLO-umS140/hqdefault.jpg" width="100%" alt="video"></a><br><sub><a href="https://youtu.be/rLLO-umS140">Ver en youtu.be</a> · la reproducción se abre en el sitio de origen; GitHub no puede incrustarla</sub></td>
</tr></table>
...
generador de claves de typesafe.ai, optimización extrema, jev ilimitado
...
Decodificación con seguridad de tipos para LLMs autorregresivo
...
- [Argos1111/jev_local](https://github.com/Argos1111/jev_local) - Replicación de Jev con un LLM local.
...
<sub>Generado por · `render.py` · 2026-09-22T11:05:08+08:00</sub>
