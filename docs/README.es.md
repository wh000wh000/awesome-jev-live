...
> [!NOTE]
> **Índice en vivo** · Última sincronización: `2026-09-27T01:21:54+08:00` (UTC+8)
> · Entradas: **811** · Nuevas en este ciclo: **103** · Lenguajes de implementación: **25**
...
- [Clientes, SDK y adaptadores de la comunidad](#clientes-sdk-y-adaptadores-de-la-comunidad) — **134**
...
- [Reproducciones abiertas, pesos e investigación de arquitectura](#reproducciones-abiertas-pesos-e-investigación-de-arquitectura) — **42**
...
Kit gratuito de SEO y GEO para Rust, impulsado por TypeSafe Jev: auditorías con 58 reglas, rastreos de sitios, comprobaciones de citas de IA, variación de posiciones, controles de CI y MCP de 15 herramientas. Coste cero.
...
- [nexibeo/jev-cookbook](https://github.com/nexibeo/jev-cookbook) - Recetas prácticas y probadas para el modelo de decisiones TypeSafe de Jev en…
...
- [wojciechwiesner/jit-context](https://github.com/wojciechwiesner/jit-context) - Barrera arquitectónica: JIT-JEV Context OS — entorno de ejecución epistémico y…
...
- [jackie-cqz/dsh-jev-plugin](https://github.com/jackie-cqz/dsh-jev-plugin) - Plugin DeepSeek Harness para TypeSafe Jev: decisiones tipadas, barreras…
...
Convierte cualquier LLM en un modelo de decisiones al estilo de Jev: decisiones tipadas, probabilidades reales y sin entrenamiento. (seguimos actualizándolo, se agradece cualquier incidencia y solicitud de PR)
...
- [AIAnytime/jev-crash-course](https://github.com/AIAnytime/jev-crash-course) - Todos los proyectos para aprender Jev, un modelo que toma decisiones en lugar…
...
<sub>Generado por · `render.py` · 2026-09-27T01:21:54+08:00</sub>
