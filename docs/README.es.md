...
> [!NOTE]
> **Índice en vivo** · Última sincronización: `2026-09-26T03:12:11+08:00` (UTC+8)
> · Entradas: **806** · Nuevas en este ciclo: **123** · Lenguajes de implementación: **23**
...
- [Herramientas para agentes: MCP, hooks, gates y agentes de programación](#herramientas-para-agentes-mcp-hooks-gates-y-agentes-de-programación) — **245**
- [Enrutamiento, guardarraíles y aprobaciones](#enrutamiento-guardarraíles-y-aprobaciones) — **61**
- [Evaluación, calibración y benchmarks](#evaluación-calibración-y-benchmarks) — **78**
- [Reproducciones abiertas, pesos e investigación de arquitectura](#reproducciones-abiertas-pesos-e-investigación-de-arquitectura) — **45**
- [Aplicaciones, juegos, robótica y demos interactivas](#aplicaciones-juegos-robótica-y-demos-interactivas) — **53**
- [Artículos, discusiones y listas hermanas](#artículos-discusiones-y-listas-hermanas) — **104**
...
Entorno de decisiones para TypeSafe Jev: umbrales de confianza, modo sombra, recetas y evaluaciones. Claude CLI 48,9 s → Jev 1,3 s en el mismo trabajo de filtrado de filas.
...
Un CLI para todos tus robots. Conéctalos, dales órdenes y deja que trabajen juntos, cada uno con un LLM como cerebro (Claude, OpenAI, Gemini, Grok o localmente mediante Ollama o vLLM) y una LLM de decisiones para opciones múltiples (Jev, Laya, Kev). Controla Microduck, Open Duck Mini, LeRobot, XLeRobot, AlohaMini, ToddlerBot, o cualquier base de ROS 2 desde un portátil, de forma externa.
...
Cobertura, seguridad y calidad del código para agentes de programación
...
- [topherchris420/james_library](https://github.com/topherchris420/james_library) - R.A.I.N. Lab es una arquitectura experimental de agentes científicos que separa…
...
- [myc0576/SmartMoney-Cub](https://github.com/myc0576/SmartMoney-Cub) - Diario de operaciones y entorno de revisión de solo lectura: juicios escritos…
...
- [6Mikao9/jev-native-agent-with-extended-options](https://github.com/6Mikao9/jev-native-agent-with-extended-options) - Diseño de investigación para un sistema de agentes nativo de Jev: permite más…
...
- [carldaws/hunch](https://github.com/carldaws/hunch) - Flujo de control probabilístico para Ruby y Rails, impulsado por TypeSafe.
...
- [MiaoWuNYA/rikkahub-sillytavern-android](https://github.com/MiaoWuNYA/rikkahub-sillytavern-android) - Cliente de chat de IA para Android: importación sin pérdidas de tarjetas de 酒馆…
...
<details>
<summary><b>Más en esta categoría</b> <sub>· 227</sub></summary>
...
- [safzanpirani/pi-jev-skill-picker](https://github.com/safzanpirani/pi-jev-skill-picker) - Clasifica las habilidades de Pi Agent para la tarea actual con TypeSafe Jev.
...
- [erkamyaman/jev-enforce](https://github.com/erkamyaman/jev-enforce) - 📏 Complemento de Claude Code que hace que Claude siga tu AGENTS.md: cada…
...
Ejecuta modelos de decisión abiertos localmente: descarga y sirve Laya, decider, NLI y GLiClass detrás de un API compatible con TypeSafe. Ollama para modelos de decisión.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/ankit-aglawe--tinyjev/dc0d701a10c37f94.gif" width="100%" alt="ankit-aglawe/tinyjev animation"><br><sub>grabación animada</sub></td>
</tr></table>
...
- [anessbelbati/jev-rerank-bench](https://github.com/anessbelbati/jev-rerank-bench) - ¿Puede un modelo de decisiones superar a los rerankers especializados? TypeSafe…
...
jevos es una alternativa de código abierto a Jev para decisiones de sí/no que se ejecuta en tu portátil.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/feder-cr/jev/main/assets/dino_run.gif" width="100%" alt="feder-cr/jev animation"><br><sub>grabación animada</sub></td>
</tr></table>
...
<details>
<summary><b>Más en esta categoría</b> <sub>· 92</sub></summary>
...
- [Show HN: Doom or Bloom, map your AI worldview with Jev](https://news.ycombinator.com/item?id=49846953) - Traza tu visión del mundo sobre la IA respondiendo a unas pocas preguntas y…
...
- [doeixd/discern](https://github.com/doeixd/discern) - Crea coincidencia de patrones semánticos con seguridad de tipos y consciente de…
...
<sub>Generado por · `render.py` · 2026-09-26T03:12:11+08:00</sub>
