...
> [!NOTE]
> **Índice en vivo** · Última sincronización: `2026-09-23T20:09:57+08:00` (UTC+8)
> · Entradas: **770** · Nuevas en este ciclo: **76** · Lenguajes de implementación: **22**
...
<sub>grep para las preguntas que no puedes escribir como un patrón. Lee todas las funciones en lugar de muestrear unas pocas. Impulsado por Jev, TypeSafe AI con su modelo…</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
- [Herramientas para agentes: MCP, hooks, gates y agentes de programación](#herramientas-para-agentes-mcp-hooks-gates-y-agentes-de-programación) — **231**
- [Enrutamiento, guardarraíles y aprobaciones](#enrutamiento-guardarraíles-y-aprobaciones) — **57**
...
- [Artículos, discusiones y listas hermanas](#artículos-discusiones-y-listas-hermanas) — **97**
- [Otros proyectos](#otros-proyectos) — **80**
...
<sub>🔧 Usado en código: `src/typesafe_sdk/__init__.py`, `src/typesafe_sdk/_core/retry.py`, `src/typesafe_sdk/_core/config.py`</sub>
...
Un arnés de programación personalizado para Jev de TypeSafe AI: un LLM propone, Jev responde preguntas concretas, el código decide y cada paso deja un comprobante.
...
Una biblioteca Elixir que envuelve el modelo uno del sistema OSS Laya de ConvAI Innovations
...
grep para las preguntas que no puedes escribir como un patrón. Lee todas las funciones en lugar de muestrear unas pocas. Impulsado por Jev, TypeSafe AI con su modelo System One.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/clouatre-labs--decisions-judge-mcp/c8c00f2b58774857.gif" width="100%" alt="clouatre-labs/decisions-judge-mcp animation"><br><sub>grabación animada</sub></td>
</tr></table>
...
Un único centro de control CLI para todos tus robots. Conéctalos, dales órdenes y deja que trabajen juntos, cada uno con un LLM como cerebro (Claude, OpenAI, Gemini, Grok o local mediante Ollama o vLLM) y una LLM de decisiones para pasos más baratos y rápidos (Jev, Laya y Kev). Compatible con Microduck, Open Duck Mini, LeRobot, XLeRobot, AlohaMini, ToddlerBot, Jetson o cualquier ROS.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/rokbenko--quackd/2060eda6dcb35de6.gif" width="100%" alt="rokbenko/quackd animation"><br><sub>grabación animada</sub></td>
</tr></table>
...
Swift SDK para ejecutar modelos de chat, visión y voz en iPhone y Mac con Core AI de Apple. Descarga y almacenamiento en caché de modelos, integración con FoundationModels y ejemplos ejecutables con requisitos documentados de OS, SDK y modelos.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/john-rocky--coreai-kit/c98c7bb8cb04e76e.gif" width="100%" alt="john-rocky/coreai-kit animation"><br><sub>grabación animada</sub></td>
</tr></table>
...
R.A.I.N. Lab es una arquitectura experimental de agente científico que separa el juicio local rápido, la evaluación probabilística independiente, la deliberación multiagente, la evidencia y la autorización en capas computacionales distintas.🐙(Anterior a AutoResearch de Karpathy)
...
jev-seo: Rust SEO y GEO CLI, además de un servidor MCP para agentes de programación: auditorías de 50 reglas, rastreos en directo, puntuaciones GEO, cambios en el posicionamiento y barreras de CI. MIT, sin suscripción.
...
Diario de trading y arnés de revisión de solo lectura: juicios tipados de Jev, integración de agentes y un benchmark financiero reproducible. Sin órdenes, sin consejos.
...
<details>
<summary><b>Más en esta categoría</b> <sub>· 110</sub></summary>
...
- [agent-chaperone/agent-chaperone](https://github.com/agent-chaperone/agent-chaperone) - Examina las llamadas a herramientas de un agente de AI antes de que se ejecuten…
...
- [9pings/notjev](https://github.com/9pings/notjev) - Servidor tipo Jev superrápido, agnóstico al modelo, que funciona con cualquier…
- [keltokhy/jsort](https://github.com/keltokhy/jsort) - ordena por significado: ordena líneas a lo largo de una dimensión en inglés…
- [bladedevoff/stuntd](https://github.com/bladedevoff/stuntd) - Proxy local que aprende las decisiones LLM tipadas de tu aplicación y las…
- [talmago/fast_gliner](https://github.com/talmago/fast_gliner) - Bindings de Python para el motor de inferencia de modelos GLiNER escritos en…
...
- [lucasmartins-ai/lcc](https://github.com/lucasmartins-ai/lcc) - Local Context Compiler (lcc): limpia, elimina duplicados y compacta el contexto…
...
- [tontoko/jev-browser](https://github.com/tontoko/jev-browser) - Un núcleo único fundamentado de Jev/Playwright: SDK tipados, CLI persistentes y…
...
- [KiritoKing/midscene-jev-runner](https://github.com/KiritoKing/midscene-jev-runner) - Integración de ejecutor JEV mantenida por la comunidad para Midscene Test.
...
- [vercel-labs/jev-ai-sdk-form-router](https://github.com/vercel-labs/jev-ai-sdk-form-router) - Dirige los envíos de formularios a las personas adecuadas con Jev y AI SDK.
...
- [kitfunso/hippo-memory](https://github.com/kitfunso/hippo-memory) - Memoria inspirada en la biología para agentes de AI.
...
- [nylon-memory/NylonME](https://github.com/nylon-memory/NylonME) - Un motor de memoria para agentes de IA.
...
Habilidad de agente para encontrar, construir, evaluar y mejorar sistemas de modelos de decisión. Cálculo composicional de decisiones, arneses de evaluación y escalada acotada de prompts/programas para Software 3.0. TypeSafe Jev es el ejemplar alojado predeterminado. Independiente de TypeSafe.
...
<td align="center" valign="top"><a href="https://youtu.be/ZC4oge4WsCQ"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/24601--augustus/d2593af47d538d33.jpg" width="100%" alt="video"></a><br><sub><a href="https://youtu.be/ZC4oge4WsCQ">Ver en youtu.be</a> · la reproducción se abre en el sitio de origen; GitHub no puede incrustarla</sub></td>
</tr></table>
...
<details>
<summary><b>Más en esta categoría</b> <sub>· 209</sub></summary>

- [ChenneyZhuang/laya-browser-agent](https://github.com/ChenneyZhuang/laya-browser-agent) - Alternativa local y de código abierto a Jev: decisiones de agente de navegador…
...
- [kydlikebtc/awesome-jev](https://github.com/kydlikebtc/awesome-jev) - 805 ejemplos verificados de Jev — el modelo de decisión System One de TypeSafe…
- [Amal-David/awesome-jev](https://github.com/Amal-David/awesome-jev) - Demos, proyectos, SDKs y habilidades de Jev, con enlaces al código fuente y una…
...
- [socai-io/jev-social](https://github.com/socai-io/jev-social) - Jev × SocAI para investigación en Instagram, TikTok y LinkedIn—enrutamiento…
...
- [PromptEngineer48/laya-vs-jev-arena](https://github.com/PromptEngineer48/laya-vs-jev-arena) - Laya (de código abierto, local) frente a TypeSafe Jev (API): dos modelos de IA…
...
- [ZephyrDeng/ego-jev](https://github.com/ZephyrDeng/ego-jev) - Bucle interno de Jev (TypeSafe System One) para ego-browser: una decisión…
- [green-dalii/pi-shift-router](https://github.com/green-dalii/pi-shift-router) - Enrutamiento de modelos por turno para el agente de programación Pi: un juez…
- [ismaelsoilet/jev-harness](https://github.com/ismaelsoilet/jev-harness) - Arnés de decisión System One sin dependencias: 5 puertas semánticas que ahorran…
...
- [jiangkoumo/ego-jev](https://github.com/jiangkoumo/ego-jev) - Controla el navegador ego lite con Jev (TypeSafe System One): una tabla de…
...
- [itsmostafa/typesafe-mcp](https://github.com/itsmostafa/typesafe-mcp) - Un conector mcp para evaluar cualquier cosa de forma rápida y barata.
...
Motor de decisiones System 1 no autorregresivo. Decisiones tipadas de elección, puntuación y sí/no sobre cualquier texto en una sola pasada hacia adelante, en más de 100 idiomas, con un router que elige el checkpoint adecuado para cada solicitud.

<sub>🔧 Usado en código: `research/benchmarks/feishu_zh/run.py`</sub>
...
Jev, el modelo System One de TypeSafe, juega al ajedrez contra cualquier LLM de OpenRouter, Stockfish y tú. Aplicación web de una sola página con movimientos en directo, probabilidades de movimiento de Jev, partidas guardadas y porcentajes de victorias.
...
Un bot de Clash Royale sin una política entrenada: Jev (TypeSafe System One) toma cada decisión a partir del estado actual del juego
...
Filtra tu feed de X.com con Jev o cualquier LLM
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/tshmieldev--sharp/016860f6bb08aa6b.gif" width="100%" alt="tshmieldev/sharp animation"><br><sub>grabación animada</sub></td>
</tr></table>
...
- [zeeshan8281/slo-router](https://github.com/zeeshan8281/slo-router) - Router de inferencia LLM consciente de SLO con decisiones Jev, métricas de cola…
...
- [Trystan-SA/laya-candle](https://github.com/Trystan-SA/laya-candle) - Port similar a JEV de Rust usando Laya, 100% local, sin Python.
...
Convierte cualquier LLM en un modelo de decisiones al estilo de Jev: decisiones tipadas, probabilidades reales, sin entrenamiento. (se sigue actualizando)
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/nokia-applied-research--anyjev/93e61c3de618cc36.gif" width="100%" alt="nokia-applied-research/AnyJev animation"><br><sub>grabación animada</sub></td>
</tr></table>
...
Una pila abierta de entrenamiento e inferencia para modelos de decisión al estilo de Jev. Entrena modelos para puntuar ramas candidatas dinámicas a partir de un prefijo compartido, con compatibilidad para elecciones de alta cardinalidad, calibración e inferencia por lotes rápida.
...
Aprendizaje por refuerzo consciente de la calibración para sistemas de decisión adaptativos
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/weitianxin--jevany/05825e369317a429.gif" width="100%" alt="weitianxin/JevAny animation"><br><sub>grabación animada</sub></td>
</tr></table>
...
Deja que Jev lea cada nuevo artículo de arXiv cada mañana y destaque los pocos que deberías leer. Intereses en inglés sencillo, probabilidades calibradas, ~$0.06/día, haz fork y listo.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/ankit-aglawe--tinyjev/bff87199840daa0f.gif" width="100%" alt="ankit-aglawe/tinyjev animation"><br><sub>grabación animada</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/dtunai--cu-jev/7447e43e6802a342.gif" width="100%" alt="dtunai/cu-Jev animation"><br><sub>grabación animada · <a href="https://raw.githubusercontent.com/dtunai/cu-Jev/main/assets/starfighter.mp4">Abrir vídeo</a></sub></td>
</tr></table>
...
- [ARCJ137442/jev-2048](https://github.com/ARCJ137442/jev-2048) - Un laboratorio web instrumentado de 2048 en el que cada movimiento es un Jev…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/fbddcz--embodied-jev/297ef7c24f9a67a8.gif" width="100%" alt="FBddcz/embodied-jev animation"><br><sub>grabación animada · <a href="https://raw.githubusercontent.com/FBddcz/embodied-jev/main/docs/media/libero-drawer-comparison.mp4">Abrir vídeo</a></sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/bl888m/jev-bot/main/assets/demo.gif" width="100%" alt="bl888m/jev-bot animation"><br><sub>grabación animada</sub></td>
</tr></table>
...
<details>
<summary><b>Más en esta categoría</b> <sub>· 22</sub></summary>
...
La galería más completa de lo que la gente crea con Jev, el modelo System One de TypeSafe: más de 3.400 proyectos, demostraciones y artículos organizados por escenario, cada uno con su enlace original, imagen y descripción.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/darthblanc/tictacjev/main/assets/screenrecording.gif" width="100%" alt="darthblanc/tictacjev animation"><br><sub>grabación animada</sub></td>
</tr></table>
...
- [heyjunpenn/awesome-jev](https://github.com/heyjunpenn/awesome-jev) - Un catálogo verificado y mantenido por la comunidad de 832 proyectos de código…
...
- [jaibhasin/jev-yt-time-saver](https://github.com/jaibhasin/jev-yt-time-saver) - Una extensión de Chrome que cubre los vídeos de YouTube que distraen con Jev.
...
<details>
<summary><b>Más en esta categoría</b> <sub>· 85</sub></summary>
...
- [Show HN: Will Jev pull the lever in the trolley problem?](https://news.ycombinator.com/item?id=49773756) - El benchmark Jev que todos estabais esperando: ¿tirará Jev de la palanca en el…
...
Un System One Model de código abierto y alto rendimiento para decisiones tipadas de una sola pasada, con un runtime C incrustable y soporte para WebAssembly.
...
Asistente de respuestas acoplado a WeChat (Windows 4.x): captura de la ventana + OCR local sin conexión lee los mensajes de la otra persona → Jev determina la intención → 3 respuestas candidatas se introducen con un clic; el envío siempre es manual
...
Ventana flotante para reconocer la intención de los mensajes de WeChat (macOS): observa la pantalla + un modelo pequeño local determina la intención y el riesgo, y luego genera respuestas candidatas según las pautas. Solo lectura, no inyecta nada en WeChat.
...
TypeLLM: LLMs con generación con seguridad de tipos
...
<sub>Generado por · `render.py` · 2026-09-23T20:09:57+08:00</sub>
