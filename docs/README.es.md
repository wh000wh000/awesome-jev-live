...
> [!NOTE]
> **Índice en vivo** · Última sincronización: `2026-09-22T16:07:34+08:00` (UTC+8)
> · Entradas: **741** · Nuevas en este ciclo: **86** · Lenguajes de implementación: **25**
...
- [Clientes, SDK y adaptadores de la comunidad](#clientes-sdk-y-adaptadores-de-la-comunidad) — **119**
- [Herramientas para agentes: MCP, hooks, gates y agentes de programación](#herramientas-para-agentes-mcp-hooks-gates-y-agentes-de-programación) — **223**
...
- [Reproducciones abiertas, pesos e investigación de arquitectura](#reproducciones-abiertas-pesos-e-investigación-de-arquitectura) — **37**
...
- [Otros proyectos](#otros-proyectos) — **86**
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/chenycl--jev-browser-skill/6f1223bb1aa99b1b.gif" width="100%" alt="ChenYCL/jev-browser-skill animation"><br><sub>grabación animada · <a href="https://raw.githubusercontent.com/ChenYCL/jev-browser-skill/main/assets/demo-wikipedia.mp4">Abrir vídeo</a></sub></td>
</tr></table>
...
Evaluador basado en reglas para archivos de texto impulsado por Jev. Ejecuta cada regla contra cada línea en paralelo. Sin lectura superficial ni líneas omitidas.
...
Fork de SemIf mantenido de forma independiente y centrado en SDK para decisiones semánticas rápidas y autoalojadas.
...
<details>
<summary><b>Más en esta categoría</b> <sub>· 97</sub></summary>
...
- [BeatAPI/awesome-jev](https://github.com/BeatAPI/awesome-jev) - Una galería de proyectos relacionados con JEV revisada según sus fuentes, con…
...
- [AkashPriyadarshii/jev-seo](https://github.com/AkashPriyadarshii/jev-seo) - Suite de SEO y GEO 100 % gratuita ₹0, centrada en agentes, y servidor CLI en…
...
- [doronp/jevc](https://github.com/doronp/jevc) - Compilar la prosa de políticas del agente en programas de veredictos…
...
<details>
<summary><b>Más en esta categoría</b> <sub>· 201</sub></summary>
...
- [poiuyjie/jev_project_context](https://github.com/poiuyjie/jev_project_context) - Memoria experimental a largo plazo basada en evidencia para agentes de…
...
- [ziqi-jin/agent-to-trust](https://github.com/ziqi-jin/agent-to-trust) - No confíes en un agente. Ponlo a prueba.
...
- [ronadin2002/jev-cua](https://github.com/ronadin2002/jev-cua) - Control por voz y texto de macOS. Una sola barra flotante, selección de…
...
- [jon-devlapaz/tink-route](https://github.com/jon-devlapaz/tink-route) - Enrutamiento dinámico de Agent Skill consciente de la confianza con TypeSafe…
...
- [cskwork/pi-jev-router](https://github.com/cskwork/pi-jev-router) - Enrutamiento automático de modelos para Pi usando Jev de TypeSafe a través de…
...
OmniJev — interfaz de decisiones multimodal de opciones finitas y banco de trabajo corporizado de MuJoCo: reproducciones de trayectorias, sondas de decisiones, paneles de referencia, recorrido guiado de 60 s.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/shapsider--omnijev/fab2a3d9229ff025.gif" width="100%" alt="shapsider/OmniJev animation"><br><sub>grabación animada · <a href="https://raw.githubusercontent.com/shapsider/OmniJev/main/docs/media/omnijev-intro-60s.mp4">Abrir vídeo</a></sub></td>
</tr></table>
...
- [nibzard/decision-model-benchmark](https://github.com/nibzard/decision-model-benchmark) - Referencia independiente y reproducible: un modelo de decisión (jev), ocho LLMs…
...
Entorno de ejecución nativo de MLX para modelos de decisión tipados de Laya — decisiones breves de 7–14 ms en M3 Max. Sin generación de texto, PyTorch ni API en la nube.
...
- [vtavakkoli/simple-jev](https://github.com/vtavakkoli/simple-jev) - Convierte cualquier modelo abierto en un endpoint de clasificación/jev.
- [yo4e/JevPip](https://github.com/yo4e/JevPip) - GMOのFX/BTC市場データに対応したローカル市場研究ターミナル。ライブチャート、ペーパートレード、バックテスト、安全監督、TypeSafe Jev連携.
- [zhihz/openjev](https://github.com/zhihz/openjev) - Decisiones de probabilidad bilingües locales a partir del contexto, las…
...
- [heyjunpenn/awesome-jev](https://github.com/heyjunpenn/awesome-jev) - Un catálogo verificado y mantenido por la comunidad de 640 proyectos de código…
...
Traducción al chino de la documentación oficial de uso del modelo Jev (TypeSafe AI) | Traducción no oficial al chino de la documentación oficial de Jev (TypeSafe AI) — https://docs.typesafe.ai
...
Arneses LLM-creados específicos para tareas de Jev, con reflexión opcional de recompensas sobre la trayectoria completa y evolución GEPA.
...
TypeLLM: LLMs con generación segura en cuanto a tipos
...
- [keltokhy/jsort](https://github.com/keltokhy/jsort) - ordenar por significado: ordenar líneas a lo largo de una dimensión en inglés…
...
<sub>Generado por · `render.py` · 2026-09-22T16:07:34+08:00</sub>
