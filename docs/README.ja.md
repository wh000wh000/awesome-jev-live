...
> [!NOTE]
> **ライブインデックス** · 最終同期: `2026-09-23T15:10:28+08:00` (UTC+8)
> · エントリ数: **704** · 今回の追加: **47** · 実装言語: **22**
...
- [エージェントツール：MCP、フック、ゲート、コーディングエージェント](#エージェントツールmcpフックゲートコーディングエージェント) — **224**
- [ルーティング、ガードレール、承認](#ルーティングガードレール承認) — **54**
- [評価、キャリブレーション、ベンチマーク](#評価キャリブレーションベンチマーク) — **70**
...
- [tumf/jev-cli](https://github.com/tumf/jev-cli) - TypeSafe Jev向けの小型で依存関係のないCLI。
...
- [d-date/swift-jev](https://github.com/d-date/swift-jev) - TypeSafe AIのJev向けSwiftクライアント — テキストではなく型付き判定。
...
<details>
<summary><b>このカテゴリのその他</b> <sub>· 202</sub></summary>
...
- [Alex314618-create/JevRev](https://github.com/Alex314618-create/JevRev) - LLM + Jevのワークフロー。背骨を内蔵して、脊椎動物の脳を強化します.
...
- [Bodila51/muse-jev-playbook](https://github.com/Bodila51/muse-jev-playbook) - Muse向けJev意思決定レイヤー：高コストなエージェント処理の前段に置く、高速で安価なTypeSafe AIゲート…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/storm-software--mindctl/69298c40a77b7be5.gif" width="100%" alt="storm-software/mindctl animation"><br><sub>アニメーション記録</sub></td>
</tr></table>
...
Vercel AI Gateway経由で、TypeSafeのJevを使用するPi向け自動モデルルーティング
...
<details>
<summary><b>このカテゴリのその他</b> <sub>· 19</sub></summary>
...
- [heyjunpenn/awesome-jev](https://github.com/heyjunpenn/awesome-jev) - Jevで構築された657件のオープンソースプロジェクトを収録した、検証済みでコミュニティが維持するカタログ.
...
- [Nisaka520/JevBystander](https://github.com/Nisaka520/JevBystander) - Androidアクセシビリティ版WeChat判読：画面読み上げのみ、Toastは3件（意図／感情／焦り／提案）のみ表示し、返信文の生成や送信は行いません・サード…
...
<sub>生成ツール · `render.py` · 2026-09-23T15:10:28+08:00</sub>
