...
> [!NOTE]
> **ライブインデックス** · 最終同期: `2026-09-26T18:44:26+08:00` (UTC+8)
> · エントリ数: **806** · 今回の追加: **98** · 実装言語: **25**
...
- [エージェントツール：MCP、フック、ゲート、コーディングエージェント](#エージェントツールmcpフックゲートコーディングエージェント) — **244**
...
- [記事、ディスカッション、類似リスト](#記事ディスカッション類似リスト) — **105**
- [その他のプロジェクト](#その他のプロジェクト) — **90**
...
- [6Mikao9/jev-native-agent-with-extended-options](https://github.com/6Mikao9/jev-native-agent-with-extended-options) - Jev ネイティブなエージェントシステムの研究設計：仮想化とページングにより jev が提供する以上の選択肢を可能にし、ツール統合、Jev…
...
- [MiaoWuNYA/rikkahub-sillytavern-android](https://github.com/MiaoWuNYA/rikkahub-sillytavern-android) - Android AI チャット端末：SillyTavern カードのロスレスインポート、キャッシュによる使用量の大幅節約、Jev…
...
- [jesset/pi-verdict](https://github.com/jesset/pi-verdict) - Claude Code の auto mode 風の、Pi 向け最小限の permission gate。
...
- [Ryu0118/jev-sim-use](https://github.com/Ryu0118/jev-sim-use) - 📱 Jev 速度の sim-use であらゆる画面に到達。
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/123skywalker/Neriv/main/demo.gif" width="100%" alt="123skywalker/Neriv animation"><br><sub>アニメーション記録</sub></td>
</tr></table>
...
- [shengjidaguai-china/goutoujunshi-jev-chat](https://github.com/shengjidaguai-china/goutoujunshi-jev-chat) - 狗头军师 Chat：Mac WeChat のスクリーンリーダー、関係分析、返信下書きのフローティングウィンドウ。
...
- [HITsz-TMG/JevEmbed](https://github.com/HITsz-TMG/JevEmbed) - JevEmbed を紹介 — 埋め込みを意思決定に変換します。好みの埋め込みモデルで選択、スコアリング、判定を行えます.
...
- [Abhinavexists/lev](https://github.com/Abhinavexists/lev) - オープンな System One 意思決定モデル。
...
<sub>生成ツール · `render.py` · 2026-09-26T18:44:26+08:00</sub>
