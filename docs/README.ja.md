...
> [!NOTE]
> **ライブインデックス** · 最終同期: `2026-09-23T00:10:10+08:00` (UTC+8)
> · エントリ数: **741** · 今回の追加: **108** · 実装言語: **27**
...
- [評価、キャリブレーション、ベンチマーク](#評価キャリブレーションベンチマーク) — **68**
- [公開再現、重み、アーキテクチャ研究](#公開再現重みアーキテクチャ研究) — **46**
- [アプリケーション、ゲーム、ロボティクス、インタラクティブデモ](#アプリケーションゲームロボティクスインタラクティブデモ) — **44**
- [記事、ディスカッション、類似リスト](#記事ディスカッション類似リスト) — **94**
- [その他のプロジェクト](#その他のプロジェクト) — **83**
...
ソフトウェア、ビジネス、組織、日常の意思決定に意思決定モデルを配置し、評価するためのエージェントスキル。古典的な意思決定手法、キャリブレーション、ルーティング、明示的なポリシーに対応。TypeSafe Jevがデフォルトのホスト型実例です。TypeSafeから独立しています。
...
- [khordoo/jev-reflex-autonomy-lab](https://github.com/khordoo/jev-reflex-autonomy-lab) - TypeSafe Jev反射的意思決定を実演する、オプションでSystem 2の戦略ガイダンスも備えたマルチドローン自律性ラボ.
...
- [Prophetlab/JevPokerBench](https://github.com/Prophetlab/JevPokerBench) - 意思決定モデル向けのProphetLabによるTexas…
...
- [romanmeclazcke/codex-sift](https://github.com/romanmeclazcke/codex-sift) - 各Codexターンを、それを処理できる最も安価なモデルにルーティングし、TypeSafe Jevで評価します.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/fazlerocks--jev-adblock/ba4996f061b8067f.gif" width="100%" alt="fazlerocks/jev-adblock animation"><br><sub>アニメーション記録</sub></td>
</tr></table>
...
OmniJev — マルチモーダルな有限選択意思決定インターフェース兼MuJoCo具現化ワークベンチ：軌跡リプレイ、意思決定プローブ、ベンチマークパネル、60秒のウォークスルー。
...
JevがLLMの意思決定に依存するタスクをどのように高速化できるかを研究。
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/tongyun1--jev-in-the-loop/06851a691352df8c.gif" width="100%" alt="Tongyun1/Jev-in-the-Loop animation"><br><sub>アニメーション記録</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/davertor--jev-slop-guard/5328ae6b3c49cbf6.gif" width="100%" alt="davertor/jev-slop-guard animation"><br><sub>アニメーション記録</sub></td>
</tr></table>
...
Effect DecisionModelとJev向けに、型安全で不確実性を考慮したセマンティックパターンマッチング、制御フロー、スマートプロシージャを構築。
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/doeixd--discern/6e14f29d003c7459.gif" width="100%" alt="doeixd/discern animation"><br><sub>アニメーション記録</sub></td>
</tr></table>
...
意思決定モデルは専用の再ランキングモデルに勝てるか？TypeSafe Jev対Cohere Rerank 4対ZeroEntropy zerank-2対チャットモデルのベースライン：14データセット、すべての生のAPIレスポンス、すべての差分に対するブートストラップ範囲。
...
- [sabeel111/OpenSourceJev](https://github.com/sabeel111/OpenSourceJev) - LLMモデルをJevのようなSystemに変換.
...
- [kerryrm/systemANE](https://github.com/kerryrm/systemANE) - AppleのNeural Engineを、高速かつ無料のローカル「System One」Decision Engine（macOS 27）として使用…
...
<sub>生成ツール · `render.py` · 2026-09-23T00:10:10+08:00</sub>
