...
> [!NOTE]
> **ライブインデックス** · 最終同期: `2026-09-26T10:04:24+08:00` (UTC+8)
> · エントリ数: **815** · 今回の追加: **35** · 実装言語: **23**
...
- [エージェントツール：MCP、フック、ゲート、コーディングエージェント](#エージェントツールmcpフックゲートコーディングエージェント) — **239**
...
- [keltokhy/jsort](https://github.com/keltokhy/jsort) - 意味で並べ替え：TypeSafeのJevモデルによるペア比較の判定に基づき、平易な英語の次元に沿って行を並べます.
...
- [rashedInt32/jev-mcp](https://github.com/rashedInt32/jev-mcp) - TypeSafe Jevを型付きかつ較正済みの判断ツール（分類、スコアリング、チェック、一括質問）として公開するMCPサーバー.
...
System Oneモデル向けのSystem Oneハーネス。Jevやその他のSystem OneモデルをローカルまたはHarnessRouter.aiから直接実行できます。
...
- [zhangcy122/OpenJev](https://github.com/zhangcy122/OpenJev) - TypeSafe Jevのオープンソース代替。型付き確率的意思決定API（Choice、Noul、Score）で、Open LLMs、Laya…
...
- [fstandhartinger/jevbench](https://github.com/fstandhartinger/jevbench) - JevBench v1 - Jevクラスの型付き意思決定モデル向けベンチマーク：スマート、低コスト、高速、信頼性が高く、オープン.
...
- [imikerussell/beebots](https://github.com/imikerussell/beebots) - OKX上で動作する3体のAIトレーディングビー。すべての意思決定はJevが行います。デフォルトではペーパートレーディングです。金融上の助言ではありません.
...
<sub>生成ツール · `render.py` · 2026-09-26T10:04:24+08:00</sub>
