...
> [!NOTE]
> **ライブインデックス** · 最終同期: `2026-09-19T12:51:10+08:00` (UTC+8)
> · エントリ数: **452** · 今回の追加: **0** · 実装言語: **25**
...
- [コミュニティ製のクライアント、SDK、アダプタ](#コミュニティ製のクライアントsdkアダプタ) — **72**
- [エージェントツール：MCP、フック、ゲート、コーディングエージェント](#エージェントツールmcpフックゲートコーディングエージェント) — **138**
- [ルーティング、ガードレール、承認](#ルーティングガードレール承認) — **50**
...
- [記事、ディスカッション、類似リスト](#記事ディスカッション類似リスト) — **37**
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/jimmyhealer--jev-semantic-explorer/f9d2833c758298d8.gif" width="100%" alt="jimmyhealer/jev-semantic-explorer animation"><br><sub>アニメーション記録</sub></td>
</tr></table>
...
<details>
<summary><b>このカテゴリのその他</b> <sub>· 104</sub></summary>
...
<sub>生成ツール · `render.py` · 2026-09-19T12:51:10+08:00</sub>
