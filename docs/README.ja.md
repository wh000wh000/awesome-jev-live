...
> [!NOTE]
> **ライブインデックス** · 最終同期: `2026-09-25T18:10:37+08:00` (UTC+8)
> · エントリ数: **799** · 今回の追加: **298** · 実装言語: **24**
...
<sub>Swift SDK：iPhoneおよびAppleのCore AIを搭載したMac上でチャット、ビジョン、音声モデルを実行するためのもの。モデルのダウンロードとキャッシュ、FoundationModelsとの統合、OS、SDK、モデル要件を記載した実行可能なサンプル。</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
- [コミュニティ製のクライアント、SDK、アダプタ](#コミュニティ製のクライアントsdkアダプタ) — **129**
- [エージェントツール：MCP、フック、ゲート、コーディングエージェント](#エージェントツールmcpフックゲートコーディングエージェント) — **249**
- [ルーティング、ガードレール、承認](#ルーティングガードレール承認) — **58**
...
- [記事、ディスカッション、類似リスト](#記事ディスカッション類似リスト) — **102**
...
<sub>🔧 コード内での使用を確認: `src/typesafe_sdk/__init__.py`</sub>
...
<sub>🔧 コード内での使用を確認: `Sources/CoreAIOps/CoreAI+SystemOne.swift`</sub>
...
差し替え可能な System One モデル（ローカル Laya / クラウド Jev）を使用する、データベース非依存の Agentic GraphRAG フレームワーク。完全な 4 フェーズパイプラインと任意のグラフデータベース向けカスタム A* トラバーサルを備えた、プラグアンドプレイのインテリジェンスレイヤー。
...
200+ のプラグアンドプレイ Jev レシピ：エージェント、RAG、サポート、コードレビュー、音楽向けに、テキストをルーティング、採点、ゲート、比較、ラベル付けする小さな較正済み AI 意思決定。JavaScript または TypeScript からインポートするか、任意の言語から JSON で CLI を呼び出します。
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/agencyenterprise--jev-recipes/0f08086836b893d8.gif" width="100%" alt="agencyenterprise/jev-recipes animation"><br><sub>アニメーション記録</sub></td>
</tr></table>
...
Jev、TypeSafe の System One モデル向けコミュニティ Java SDK：型付き質問を入力し、較正済み確率付きの型付き回答を出力。Java 17+、Spring Boot starter（非公式）
...
すべてのロボットに 1 つの CLI。それらを接続し、指令を出し、連携して動作させます。各ロボットは頭脳として LLM（Claude、OpenAI、Gemini、Grok、または Ollama や vLLM 経由のローカル）と、多肢選択用の意思決定 LLM（Jev、Laya、Kev）を備えます。ラップトップからオフボードで、Microduck、Open Duck Mini、LeRobot、XLeRobot、AlohaMini、ToddlerBot、または任意の ROS 2 ベースを駆動します。
...
タスクに対して Cursor、Claude Code、Codex、または OpenCode + モデル/労力を選び、それを起動する CLI。Jev と Herdr によって駆動。
...
<details>
<summary><b>このカテゴリのその他</b> <sub>· 111</sub></summary>
...
- [chengyongru/fastjev](https://github.com/chengyongru/fastjev) - 高速でセルフホスト可能なセマンティック意思決定のための、SDK ファーストで独立管理の SemIf フォーク.
- [Ray-Hughes/jevalyn](https://github.com/Ray-Hughes/jevalyn) - Railsアプリの判断レイヤー。TypeSafeのJev System One…
- [CheshiAI/Cheshi](https://github.com/CheshiAI/Cheshi) - Jev 搭載の会話メモリ：過去のセッションを見つけ、元のソースとともに意思決定を再訪。OpenAI Codex のための macOS ワークスペース.
...
- [utk2103/jev-studio](https://github.com/utk2103/jev-studio) - jev を試しているなら、ここからの方が簡単です。
...
TREC コレクションでの検索エンジン実験。現在は typesafe.ai の JEV モデルを用いたゼロショット再ランキング実装に注力
...
ローカルで動作するオープンソースのJev代替：自分のマシン上でLaya（System Oneモデル）を使ったブラウザーエージェントの意思決定。クラウド不要、APIキー不要。Playwright／CDP対応で、MCPフレンドリー。
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/mansicer--jev-plays/c4f1ec41afcb4ae9.gif" width="100%" alt="mansicer/jev-plays animation"><br><sub>アニメーション記録</sub></td>
</tr></table>
...
<details>
<summary><b>このカテゴリのその他</b> <sub>· 231</sub></summary>
...
- [browser-use/jev-ultrafast](https://github.com/browser-use/jev-ultrafast) - 最速かつ最安のWebエージェント。
...
- [angel291592/Intent-Router](https://github.com/angel291592/Intent-Router) - AI エージェント向けの意図コンパイラ — 曖昧なリクエストを型付き IntentSpec コントラクトへ収束させる。
- [socai-io/jev-social](https://github.com/socai-io/jev-social) - オープンソースの Agent Skill とローカルデモ：Instagram、TikTok、LinkedIn リサーチ向けの Jev ×…
...
- [OmniJev/PlayJev](https://github.com/OmniJev/PlayJev) - 🚀🚀 生のピクセルから直接 GUI ゲームをプレイする 0.8B JEV 風マルチモーダルモデル.
- [jonathanavis96/jev-kit](https://github.com/jonathanavis96/jev-kit) - TypeSafe の Jev を Claude Code…
- [PyModel/jev-judge-mcp](https://github.com/PyModel/jev-judge-mcp) - MCP エージェント向けの型付き判断ツール。TypeSafe の Jev モデルを…
...
- [khordoo/jev-reflex-autonomy-lab](https://github.com/khordoo/jev-reflex-autonomy-lab) - 高速な System 1 反射的意思決定と衝突回避のために Jev を使用し、戦略的ガイダンスのための任意の System 2…
...
- [AskTheWay/dsh-jev-interceptor](https://github.com/AskTheWay/dsh-jev-interceptor) - ⚡ DeepSeek Harness のすべてのツール呼び出しに対するミリ秒 System-1 判断 — Jev…
...
- [itsmostafa/typesafe-mcp](https://github.com/itsmostafa/typesafe-mcp) - 何でも高速かつ低コストで評価するための mcp コネクタ。AI エージェントに typesafe ai の jev モデルと laya…
...
トラフィックエッジでの型付き判断によるアドミッション制御：nginx/OpenResty 向けの 3 層プロンプトインジェクションおよび不正利用フィルター。TypeSafe Jev によって駆動。フェイルオープン、キャッシュ対応、ホットリロード可能。
...
音声と指差しでtldrawキャンバスに描画します。Jev（TypeSafe System One）が、発話された1語あたり約350 msでアクション、対象、場所を決定します。
...
JevK5：TypeSafe Jev のオープンウェイト代替。1 回のフォワードパスで確率付きの型付き意思決定。Apache-2.0 の重みとコード。
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/allebee--jevk5/1f9cd6cb325d4bd4.gif" width="100%" alt="allebee/jevk5 animation"><br><sub>アニメーション記録 · <a href="https://raw.githubusercontent.com/allebee/jevk5/main/docs/demo/jevk5-nvidia-demo.mp4">動画を開く</a></sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/weitianxin--jevany/711125367b6758ff.gif" width="100%" alt="weitianxin/JevAny animation"><br><sub>アニメーション記録</sub></td>
</tr></table>
...
- [Eliot5566/JEV-Paper-Radar](https://github.com/Eliot5566/JEV-Paper-Radar) - 毎朝、Jevに新着arXiv論文をすべて読ませ、読むべき少数の論文を浮かび上がらせます.
...
非構造化状態からの型付き意思決定：1 回のフォワードパス、生成テキストなし。ローカル、決定論的、Jev 互換。typesafe.ai とは提携していません。
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/antonellof--laya-vs-dijkstra/b61bc3a8e3d368be.gif" width="100%" alt="antonellof/laya-vs-dijkstra animation"><br><sub>アニメーション記録</sub></td>
</tr></table>
...
オープンモデルによる Semantic ifs を、自宅の 3090 で。独立しており、Jev または TypeSafe とは提携していません。
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/theoleecj--semif-openjev/0504149cd9ef3cad.gif" width="100%" alt="TheoLeeCJ/SemIf-OpenJev animation"><br><sub>アニメーション記録</sub></td>
</tr></table>
...
<details>
<summary><b>このカテゴリのその他</b> <sub>· 20</sub></summary>
...
<details>
<summary>📰 <b><a href="https://typesafe.ai/team">TypeSafeにTeamページを追加 + ナビゲーションに`Enterprise`の入口を追加（プロダクト化・商業化のシグナル）</a></b> · ✅ official · 6 天</summary>
...
Qwen3.5/3.8 の上に構築され、自分でトレーニングして実行できる Jev 風の意思決定モデルファミリー
...
Jev 風のマルチモーダルモデルを自分でトレーニング。System One Model、今度はビジョン対応。
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/liuziyu77--valen/d4fa3bf5c399a28d.gif" width="100%" alt="Liuziyu77/Valen animation"><br><sub>アニメーション記録</sub></td>
</tr></table>
...
チャット用フローティングウィンドウアシスタント（macOS）：画面認識 + ローカル小型モデルで意図とリスクを判定し、話法に沿って返信候補を生成。完全に読み取り専用。
...
ローカル言語モデルを Jev スタイルの構造化意思決定モデルに変換。プリフィルだけでテキストと画像から結果を取得—トークン単位のデコードは不要。
...
- [alvarobartt/sys1](https://github.com/alvarobartt/sys1) - Rust で書かれた、オープン意思決定モデル向けの System One 互換 API.
- [2951461586/Jev-Register-Tool](https://github.com/2951461586/Jev-Register-Tool) - TypeSafe（Jev / System One）申請 → 確認メール → 承認 → 登録 → API…
- [HITsz-TMG/JevEmbed](https://github.com/HITsz-TMG/JevEmbed) - JevEmbed を紹介 — 埋め込みを意思決定に変換。選択、スコア付け、判定を、選んだ埋め込みモデルで行います.
- [Kevthetech143/super-jev](https://github.com/Kevthetech143/super-jev) - TypeSafe Jev 向けの、小さく拡張可能な意思決定からアクションへのハーネス。
...
<sub>生成ツール · `render.py` · 2026-09-25T18:10:37+08:00</sub>
