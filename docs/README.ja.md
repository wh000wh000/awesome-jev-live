...
> [!NOTE]
> **ライブインデックス** · 最終同期: `2026-09-22T21:36:57+08:00` (UTC+8)
> · エントリ数: **739** · 今回の追加: **80** · 実装言語: **25**
...
- [エージェントツール：MCP、フック、ゲート、コーディングエージェント](#エージェントツールmcpフックゲートコーディングエージェント) — **218**
- [ルーティング、ガードレール、承認](#ルーティングガードレール承認) — **68**
- [評価、キャリブレーション、ベンチマーク](#評価キャリブレーションベンチマーク) — **66**
- [公開再現、重み、アーキテクチャ研究](#公開再現重みアーキテクチャ研究) — **38**
- [アプリケーション、ゲーム、ロボティクス、インタラクティブデモ](#アプリケーションゲームロボティクスインタラクティブデモ) — **48**
- [記事、ディスカッション、類似リスト](#記事ディスカッション類似リスト) — **91**
- [その他のプロジェクト](#その他のプロジェクト) — **87**
...
<details>
<summary><b>このカテゴリのその他</b> <sub>· 196</sub></summary>
...
- [kydlikebtc/awesome-jev](https://github.com/kydlikebtc/awesome-jev) - Jevの検証済み事例148件 — TypeSafe AIのSystem One意思決定モデル — を、それを紹介したブログではなく、各事例が下す判断ごとに分類.
...
- [chy4pro/jev-for-chrome](https://github.com/chy4pro/jev-for-chrome) - Chrome向けのJev：サブ秒判断モデルである TypeSafe Jev を使って、現在表示しているタブを操作します.
...
- [ziozzang/hearim](https://github.com/ziozzang/hearim) - hearim（헤아림） — Goで動作するJev互換のマルチバックエンドSystem Oneゲートウェイ。
...
<details>
<summary><b>このカテゴリのその他</b> <sub>· 16</sub></summary>
...
- [mattt/AnyDecisionModel](https://github.com/mattt/AnyDecisionModel) - 言語モデルからの型付き判断（確率、選択肢、スコア）を扱うSwiftパッケージ。ローカルMLXモデルとTypeSafe Jev APIに対応しています.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/0x7067--jev-browse/ef0e8f6126e6228e.gif" width="100%" alt="0x7067/jev-browse animation"><br><sub>アニメーション記録 · <a href="https://raw.githubusercontent.com/0x7067/jev-browse/main/docs/demo.mp4">動画を開く</a></sub></td>
</tr></table>
...
- [kerryrm/systemANE](https://github.com/kerryrm/systemANE) - AppleのNeural Engineを無料かつ高速な「System One」意思決定エンジン（macOS 27）として使用 — 「ねえ、家にもJevがあるよ」。
...
<sub>生成ツール · `render.py` · 2026-09-22T21:36:57+08:00</sub>
