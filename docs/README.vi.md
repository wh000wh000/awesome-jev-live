...
> [!NOTE]
> **Chỉ mục trực tiếp** · Đồng bộ lần cuối: `2026-09-23T17:45:55+08:00` (UTC+8)
> · Mục: **778** · Mới trong lượt này: **111** · Ngôn ngữ triển khai: **23**
...
<sub>grep cho những câu hỏi mà bạn không thể viết dưới dạng mẫu. Đọc mọi hàm thay vì lấy mẫu một vài hàm. Được hỗ trợ bởi Jev, mô hình System One của TypeSafe AI.</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
- [Công cụ cho agent: MCP, hook, cổng chặn và agent viết mã](#công-cụ-cho-agent-mcp-hook-cổng-chặn-và-agent-viết-mã) — **239**
- [Định tuyến, rào chắn và phê duyệt](#định-tuyến-rào-chắn-và-phê-duyệt) — **55**
- [Đánh giá, hiệu chỉnh và benchmark](#đánh-giá-hiệu-chỉnh-và-benchmark) — **78**
- [Bản tái tạo mở, trọng số và nghiên cứu kiến trúc](#bản-tái-tạo-mở-trọng-số-và-nghiên-cứu-kiến-trúc) — **41**
...
<sub>🔧 Được tìm thấy trong mã nguồn: `src/typesafe_sdk/__init__.py`, `src/typesafe_sdk/_core/retry.py`, `src/typesafe_sdk/_core/config.py`</sub>
...
Một harness lập trình tùy chỉnh cho Jev của TypeSafe AI: một LLM đề xuất, Jev trả lời các câu hỏi cụ thể, mã quyết định, và mỗi bước đều để lại biên nhận.
...
Một thư viện Elixir bao bọc một mô hình của hệ thống Laya OSS của ConvAI Innovations
...
grep cho những câu hỏi mà bạn không thể viết dưới dạng mẫu. Đọc mọi hàm thay vì lấy mẫu một vài hàm. Được hỗ trợ bởi Jev, mô hình System One của TypeSafe AI.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/clouatre-labs--decisions-judge-mcp/c8c00f2b58774857.gif" width="100%" alt="clouatre-labs/decisions-judge-mcp animation"><br><sub>bản ghi động</sub></td>
</tr></table>
...
Một offboard CLI cho tất cả robot của bạn. Kết nối chúng, ra lệnh cho chúng và để chúng phối hợp làm việc, mỗi robot có một LLM làm bộ não (Claude, OpenAI, Gemini, Grok hoặc chạy cục bộ qua Ollama hoặc vLLM) và một LLM ra quyết định cho các bước rẻ hơn và nhanh hơn (Jev, Laya và Kev). Hỗ trợ Microduck, Open Duck Mini, LeRobot, XLeRobot, AlohaMini, ToddlerBot, Jetson hoặc bất kỳ ROS nào.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/rokbenko--quackd/2060eda6dcb35de6.gif" width="100%" alt="rokbenko/quackd animation"><br><sub>bản ghi động</sub></td>
</tr></table>
...
Swift SDK để chạy các mô hình trò chuyện, thị giác và giọng nói trên iPhone và Mac với Core AI của Apple. Tải xuống và lưu vào bộ nhớ đệm mô hình, tích hợp FoundationModels, cùng các ví dụ có thể chạy với tài liệu về yêu cầu đối với OS, SDK và mô hình.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/john-rocky--coreai-kit/c98c7bb8cb04e76e.gif" width="100%" alt="john-rocky/coreai-kit animation"><br><sub>bản ghi động</sub></td>
</tr></table>
...
jev-seo: Rust SEO và GEO CLI cùng máy chủ MCP cho các tác nhân lập trình: kiểm tra 50 quy tắc, crawl trực tiếp, điểm GEO, biến động thứ hạng, cổng CI. MIT, không cần đăng ký thuê bao.
...
Nhật ký giao dịch chỉ đọc và bộ khung đánh giá: phán đoán có kiểu Jev, tích hợp agent và một benchmark tài chính có thể tái lập. Không đặt lệnh, không đưa lời khuyên.
...
Bộ chấm điểm dựa trên quy tắc, được hỗ trợ bởi Jev, cho các tệp văn bản. Chạy mọi quy tắc trên mọi dòng song song. Không đọc lướt, không bỏ sót dòng.
...
Fork SemIf ưu tiên SDK, được duy trì độc lập cho các quyết định ngữ nghĩa nhanh, tự lưu trữ.
...
- [9pings/notjev](https://github.com/9pings/notjev) - Máy chủ giống Jev siêu nhanh, không phụ thuộc mô hình, hoạt động với mọi…
...
- [bladedevoff/stuntd](https://github.com/bladedevoff/stuntd) - Proxy cục bộ học các quyết định LLM có kiểu của ứng dụng và trả lời chúng bằng…
- [tumf/jev-cli](https://github.com/tumf/jev-cli) - CLI nhỏ, không phụ thuộc cho TypeSafe Jev.
- [talmago/fast_gliner](https://github.com/talmago/fast_gliner) - Các binding Python tới công cụ Inference cho các mô hình GLiNER được viết bằng…
- [frostney/clean-code-review](https://github.com/frostney/clean-code-review) - Mọi tệp mã trong một pull request, được đánh giá theo Clean Code của Uncle Bob…
- [Qew7/jev-feels](https://github.com/Qew7/jev-feels) - Các quyết định ngữ nghĩa dưới dạng Ruby thông thường #feels?, #decide, #score…
...
- [tontoko/jev-browser](https://github.com/tontoko/jev-browser) - Một lõi Jev/Playwright có tính nền tảng: SDK được định kiểu, CLI bền vững và…
...
- [vercel-labs/jev-ai-sdk-form-router](https://github.com/vercel-labs/jev-ai-sdk-form-router) - Định tuyến các biểu mẫu gửi đến đúng người bằng Jev và AI SDK.
- [ansidium/jev-codex-bridge](https://github.com/ansidium/jev-codex-bridge) - Định tuyến mô hình và suy luận cho Codex Desktop và CLI, với một dịch vụ…
- [mountainMath/JevR](https://github.com/mountainMath/JevR) - R client cho TypeSafe Jev System One API.
- [shinpr/jev-reranker](https://github.com/shinpr/jev-reranker) - Xếp hạng lại, lọc và nén các kết quả tìm kiếm JSON bằng Jev của TypeSafe AI.
...
- [kitfunso/hippo-memory](https://github.com/kitfunso/hippo-memory) - Bộ nhớ lấy cảm hứng từ sinh học cho các tác nhân AI.
...
- [nylon-memory/NylonME](https://github.com/nylon-memory/NylonME) - Một Memory Engine cho AI Agents, làm việc với Jev có thể mang lại độ chính xác…
...
Kỹ năng tác nhân để tìm kiếm, xây dựng, đánh giá và cải thiện các hệ thống mô hình quyết định. Phép tính quyết định hợp thành, các bộ khung đánh giá và việc leo đồi có giới hạn trên prompt/chương trình cho Software 3.0. TypeSafe Jev là mẫu minh họa được lưu trữ mặc định. Độc lập với TypeSafe.
...
<td align="center" valign="top"><a href="https://youtu.be/ZC4oge4WsCQ"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/24601--augustus/d2593af47d538d33.jpg" width="100%" alt="video"></a><br><sub><a href="https://youtu.be/ZC4oge4WsCQ">Xem trên youtu.be</a> · trình phát mở trên trang gốc; GitHub không thể nhúng trực tiếp</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/storm-software--mindctl/69298c40a77b7be5.gif" width="100%" alt="storm-software/mindctl animation"><br><sub>bản ghi động</sub></td>
</tr></table>
...
Trợ lý hội thoại trên điện thoại: hiểu đối phương trong WeChat / QQ / X / Feishu, đưa ra các câu trả lời gợi ý, điền vào ô nhập liệu bằng một lần nhấn; gửi hay không là do bạn. Không xâm nhập, chỉ đọc màn hình, không hook, không sửa gói.
...
<details>
<summary><b>Thêm trong danh mục này</b> <sub>· 217</sub></summary>

- [ChenneyZhuang/laya-browser-agent](https://github.com/ChenneyZhuang/laya-browser-agent) - Một lựa chọn thay thế Jev cục bộ, mã nguồn mở: các quyết định của tác nhân…
...
- [kydlikebtc/awesome-jev](https://github.com/kydlikebtc/awesome-jev) - 805 ví dụ đã được xác minh về Jev — mô hình ra quyết định System One của…
- [Amal-David/awesome-jev](https://github.com/Amal-David/awesome-jev) - Các bản demo, dự án, SDKs và kỹ năng Jev, cùng liên kết mã nguồn và một thư…
...
- [Alex314618-create/JevRev](https://github.com/Alex314618-create/JevRev) - Một quy trình làm việc LLM + Jev. Tăng cường bộ não động vật có xương sống của…
...
- [PromptEngineer48/laya-vs-jev-arena](https://github.com/PromptEngineer48/laya-vs-jev-arena) - Laya (mã nguồn mở, cục bộ) đấu với TypeSafe Jev (API): hai mô hình AI tranh tài…
...
- [ThinkFlowLab/system1-agents](https://github.com/ThinkFlowLab/system1-agents) - Các mô hình quyết định System 1 (Jev, Laya, Cua-S1) làm bộ não cho các tác tử…
...
- [jiawei686/jev-ultrafast-mcp](https://github.com/jiawei686/jev-ultrafast-mcp) - Bàn giao công việc trên trình duyệt: một máy chủ MCP nơi mô hình ra quyết định…
...
- [Bodila51/muse-jev-playbook](https://github.com/Bodila51/muse-jev-playbook) - Lớp quyết định Jev cho Muse: một cổng TypeSafe AI nhanh và rẻ trước các tác vụ…
...
- [rashedInt32/jev-mcp](https://github.com/rashedInt32/jev-mcp) - Máy chủ MCP cung cấp TypeSafe Jev dưới dạng các công cụ phán đoán có kiểu và…
- [ZephyrDeng/ego-jev](https://github.com/ZephyrDeng/ego-jev) - Vòng lặp bên trong Jev (TypeSafe System One) cho ego-browser — một quyết định…
- [green-dalii/pi-shift-router](https://github.com/green-dalii/pi-shift-router) - Định tuyến mô hình theo từng lượt cho tác tử lập trình Pi: một bộ phán xử nhỏ…
- [ismaelsoilet/jev-harness](https://github.com/ismaelsoilet/jev-harness) - Bộ khung kiểm thử quyết định System One không phụ thuộc: 5 cổng ngữ nghĩa giúp…
...
- [jiangkoumo/ego-jev](https://github.com/jiangkoumo/ego-jev) - Điều khiển trình duyệt ego lite bằng Jev (TypeSafe System One): một bảng phần…
...
- [itsmostafa/typesafe-mcp](https://github.com/itsmostafa/typesafe-mcp) - Một trình kết nối mcp để đánh giá mọi thứ nhanh và rẻ.
...
Công cụ quyết định System 1 phi tự hồi quy. Các quyết định dạng lựa chọn có kiểu, điểm số và có/không trên bất kỳ văn bản nào trong một lượt truyền tiến duy nhất, bằng hơn 100 ngôn ngữ, với một router chọn checkpoint phù hợp cho mỗi yêu cầu.

<sub>🔧 Được tìm thấy trong mã nguồn: `research/benchmarks/feishu_zh/run.py`</sub>
...
Jev, mô hình System One của TypeSafe, chơi cờ với bất kỳ LLM OpenRouter nào, Stockfish và bạn. Ứng dụng web một trang với các nước đi trực tiếp, xác suất nước đi của Jev, các ván cờ đã lưu và tỷ lệ thắng.
...
Một bot Clash Royale không có chính sách được huấn luyện: Jev (TypeSafe System One) đưa ra mọi quyết định từ trạng thái trò chơi trực tiếp
...
Một tầng xác minh cho các đánh giá AI. Kiểm tra công cụ đo, không chỉ điểm số: dữ liệu, bộ chấm điểm, các lần chạy, con số, tuyên bố và chính nó.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/arpit-khandelwal--jev-linkedin-slop-filter/2ba80db1b4af936f.gif" width="100%" alt="Arpit-Khandelwal/jev-linkedin-slop-filter animation"><br><sub>bản ghi động</sub></td>
</tr></table>
...
- [jagsan-cyber/reflex-gate](https://github.com/jagsan-cyber/reflex-gate) - Gateway cục bộ tương thích Jev / System One — không phải Jev của TypeSafe.
...
Biến bất kỳ LLM nào thành một mô hình quyết định kiểu Jev: các quyết định có kiểu, xác suất thực, không cần huấn luyện. (tiếp tục cập nhật)
...
Một ngăn xếp huấn luyện và suy luận mở cho các mô hình quyết định kiểu Jev. Huấn luyện mô hình chấm điểm các nhánh ứng viên động từ một tiền tố chung, hỗ trợ lựa chọn có số lượng lớn, hiệu chỉnh và suy luận theo lô nhanh.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/weitianxin--jevany/05825e369317a429.gif" width="100%" alt="weitianxin/JevAny animation"><br><sub>bản ghi động</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/ankit-aglawe--tinyjev/bff87199840daa0f.gif" width="100%" alt="ankit-aglawe/tinyjev animation"><br><sub>bản ghi động</sub></td>
</tr></table>
...
- [RenaGao/jev-dataops](https://github.com/RenaGao/jev-dataops) - Một bàn làm việc mã nguồn mở được hỗ trợ bởi JEV để lựa chọn dữ liệu phát trực…
...
- [ARCJ137442/jev-2048](https://github.com/ARCJ137442/jev-2048) - Một phòng thí nghiệm web 2048 có ghi nhận, trong đó mỗi nước đi là một Jev…
...
- [rupeshpoojary9/awesome-open-system-one](https://github.com/rupeshpoojary9/awesome-open-system-one) - Danh sách tuyển chọn về hệ sinh thái System One mở: các mô hình mở, benchmark…
...
<table><tr><th align="center" width="50%">🖼 Hình ảnh</th><th align="center" width="50%">🎬 Video</th></tr><tr>
<td align="center" valign="top"><sub>không công bố media</sub></td>
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/wfzyx--von/7f8d6b27c0d2e176.gif" width="100%" alt="wfzyx/von animation"><br><sub>bản ghi động</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/fbddcz--embodied-jev/297ef7c24f9a67a8.gif" width="100%" alt="FBddcz/embodied-jev animation"><br><sub>bản ghi động · <a href="https://raw.githubusercontent.com/FBddcz/embodied-jev/main/docs/media/libero-drawer-comparison.mp4">Mở video</a></sub></td>
</tr></table>
...
Một máy chủ System One cục bộ, ngoại tuyến, tương thích với Jev API của TypeSafe. Nó trả lời các câu hỏi có kiểu về có/không, danh mục và điểm số bằng các mô hình mở nhỏ.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/bl888m/jev-bot/main/assets/demo.gif" width="100%" alt="bl888m/jev-bot animation"><br><sub>bản ghi động</sub></td>
</tr></table>
...
<details>
<summary><b>Thêm trong danh mục này</b> <sub>· 19</sub></summary>
...
Bộ sưu tập đầy đủ nhất về những gì mọi người xây dựng bằng Jev, mô hình System One của TypeSafe: hơn 3.400 dự án, bản demo và bài viết theo từng tình huống, mỗi mục đều có liên kết gốc, hình ảnh và mô tả.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/darthblanc/tictacjev/main/assets/screenrecording.gif" width="100%" alt="darthblanc/tictacjev animation"><br><sub>bản ghi động</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/michaelpersonal--jev-trade-cc/b3ae9a36cc9fcbbf.gif" width="100%" alt="michaelpersonal/jev-trade-cc animation"><br><sub>bản ghi động</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/surbhit20/jev-plays-snake/main/jev-plays-snake.gif" width="100%" alt="surbhit20/jev-plays-snake animation"><br><sub>bản ghi động</sub></td>
</tr></table>
...
- [heyjunpenn/awesome-jev](https://github.com/heyjunpenn/awesome-jev) - Một danh mục đã được xác minh, do cộng đồng duy trì, gồm 832 dự án mã nguồn mở…
...
- [jaibhasin/jev-yt-time-saver](https://github.com/jaibhasin/jev-yt-time-saver) - Một tiện ích mở rộng Chrome dùng Jev để che các video YouTube gây xao nhãng.
...
<details>
<summary>📰 <b><a href="https://typesafe.ai/team">TypeSafe thêm trang Team + điều hướng thêm lối vào `Enterprise` (tín hiệu sản phẩm hóa/thương mại hóa)</a></b> · ✅ official · 4 天</summary>
...
- [Show HN: Will Jev pull the lever in the trolley problem?](https://news.ycombinator.com/item?id=49773756) - Bộ benchmark Jev mà tất cả các bạn đã chờ đợi: Liệu Jev có kéo cần trong bài…
...
Trình đăng ký typesafe.ai, tối ưu hóa tối đa, jev vô hạn
...
Công cụ hỗ trợ trả lời chạy song song với 微信（Windows 4.x）：chụp màn hình cửa sổ + OCR ngoại tuyến cục bộ đọc tin nhắn của đối phương → Jev xác định ý định → điền một lần vào 3 ứng viên, việc gửi luôn được thực hiện thủ công
...
Cửa sổ nổi nhận diện ý định tin nhắn 微信（macOS）：đọc màn hình + mô hình nhỏ cục bộ xác định ý định và rủi ro, sau đó tạo các ứng viên trả lời theo kịch bản. Chỉ đọc, không chèn vào 微信.
...
Trợ lý trả lời WeChat JEV DeepSeek + TypeSafe: phiên bản chính thức Windows, phiên bản xem trước Apple Silicon macOS; OCR cục bộ và trả lời có thể kiểm soát bởi con người
...
<sub>Tạo bởi · `render.py` · 2026-09-23T17:45:55+08:00</sub>
