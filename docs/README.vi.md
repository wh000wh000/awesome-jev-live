...
> [!NOTE]
> **Chỉ mục trực tiếp** · Đồng bộ lần cuối: `2026-09-27T01:21:54+08:00` (UTC+8)
> · Mục: **811** · Mới trong lượt này: **103** · Ngôn ngữ triển khai: **25**
...
- [Client, SDK và adapter do cộng đồng phát triển](#client-sdk-và-adapter-do-cộng-đồng-phát-triển) — **134**
...
- [Bản tái tạo mở, trọng số và nghiên cứu kiến trúc](#bản-tái-tạo-mở-trọng-số-và-nghiên-cứu-kiến-trúc) — **42**
...
- [nexibeo/jev-cookbook](https://github.com/nexibeo/jev-cookbook) - Các công thức thực tiễn, đã được kiểm thử cho mô hình ra quyết định Jev của…
...
- [wojciechwiesner/jit-context](https://github.com/wojciechwiesner/jit-context) - Lợi thế phòng thủ kiến trúc: JIT-JEV Context OS — runtime nhận thức luận và…
...
- [Amal-David/awesome-jev](https://github.com/Amal-David/awesome-jev) - Các bản demo, dự án, SDKs và kỹ năng của Jev, với các liên kết mã nguồn và một…
...
- [safzanpirani/pi-jev-skill-picker](https://github.com/safzanpirani/pi-jev-skill-picker) - Xếp hạng các kỹ năng Pi Agent cho tác vụ hiện tại bằng TypeSafe Jev.
...
- [jackie-cqz/dsh-jev-plugin](https://github.com/jackie-cqz/dsh-jev-plugin) - Plugin DeepSeek Harness cho TypeSafe Jev: các quyết định có kiểu, các rào chắn…
...
Biến mọi LLM thành mô hình ra quyết định theo phong cách Jev: các quyết định có kiểu, xác suất thực, không cần huấn luyện. (tiếp tục cập nhật, hoan nghênh mọi vấn đề và yêu cầu PR)
...
- [AIAnytime/jev-crash-course](https://github.com/AIAnytime/jev-crash-course) - Tất cả dự án để học Jev, một mô hình đưa ra quyết định thay vì viết văn bản.
...
<details>
<summary>📰 <b><a href="https://typesafe.ai/team">TypeSafe thêm trang Team + điều hướng thêm lối vào `Enterprise` (tín hiệu sản phẩm hóa/thương mại hóa)</a></b> · ✅ official · 8 天</summary>
...
<sub>Tạo bởi · `render.py` · 2026-09-27T01:21:54+08:00</sub>
