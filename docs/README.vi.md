...
> [!NOTE]
> **Chỉ mục trực tiếp** · Đồng bộ lần cuối: `2026-09-22T16:07:34+08:00` (UTC+8)
> · Mục: **741** · Mới trong lượt này: **86** · Ngôn ngữ triển khai: **25**
...
- [Client, SDK và adapter do cộng đồng phát triển](#client-sdk-và-adapter-do-cộng-đồng-phát-triển) — **119**
- [Công cụ cho agent: MCP, hook, cổng chặn và agent viết mã](#công-cụ-cho-agent-mcp-hook-cổng-chặn-và-agent-viết-mã) — **223**
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/chenycl--jev-browser-skill/6f1223bb1aa99b1b.gif" width="100%" alt="ChenYCL/jev-browser-skill animation"><br><sub>bản ghi động · <a href="https://raw.githubusercontent.com/ChenYCL/jev-browser-skill/main/assets/demo-wikipedia.mp4">Mở video</a></sub></td>
</tr></table>
...
Phần mềm, theo phản xạ. Một câu trở thành một lệnh gọi của một chương trình nhỏ, được chọn bởi Jev, bộ phân loại của TypeSafe AI, và chỉ chạy khi nó đủ chắc chắn. Phản xạ là các công thức mà bất kỳ ai cũng có thể viết, chia sẻ và cải thiện. Một CLI mà bạn trò chuyện, một trình quản lý gói cho phản xạ từ git, và một TypeScript SDK.
...
- [BeatAPI/awesome-jev](https://github.com/BeatAPI/awesome-jev) - Bộ sưu tập các dự án liên quan đến JEV đã được xem xét nguồn, với hơn 50 sao…
...
- [keltokhy/jgrep](https://github.com/keltokhy/jgrep) - grep, nhưng mẫu là một mô tả. Lọc các dòng theo ý nghĩa bằng mô hình quyết định…
...
- [keltokhy/jlink](https://github.com/keltokhy/jlink) - Liên kết bản ghi cho các nhà kinh tế: viết quy tắc đối sánh bằng plain English…
...
- [doronp/jevc](https://github.com/doronp/jevc) - Biên dịch văn bản chính sách của tác nhân thành các chương trình phán quyết xác…
...
<details>
<summary><b>Thêm trong danh mục này</b> <sub>· 201</sub></summary>
...
- [poiuyjie/jev_project_context](https://github.com/poiuyjie/jev_project_context) - Kỹ năng ghi nhớ thí nghiệm dài hạn ưu tiên bằng chứng dành cho các tác nhân lập…
...
- [ziqi-jin/agent-to-trust](https://github.com/ziqi-jin/agent-to-trust) - Đừng tin một Agent. Hãy kiểm thử nó. Phòng thí nghiệm mã nguồn mở dành cho tín…
...
- [ronadin2002/jev-cua](https://github.com/ronadin2002/jev-cua) - Điều khiển bằng giọng nói và văn bản cho macOS.
...
- [jon-devlapaz/tink-route](https://github.com/jon-devlapaz/tink-route) - Định tuyến Skill của Agent linh động, nhận biết độ tin cậy với TypeSafe Jev và…
...
- [cskwork/pi-jev-router](https://github.com/cskwork/pi-jev-router) - Định tuyến mô hình tự động cho Pi bằng Jev của TypeSafe thông qua Vercel AI…
...
OmniJev — giao diện quyết định lựa chọn hữu hạn đa phương thức và bàn làm việc tác vụ hiện thân MuJoCo: phát lại quỹ đạo, thăm dò quyết định, bảng điều khiển điểm chuẩn, hướng dẫn 60 giây.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/shapsider--omnijev/fab2a3d9229ff025.gif" width="100%" alt="shapsider/OmniJev animation"><br><sub>bản ghi động · <a href="https://raw.githubusercontent.com/shapsider/OmniJev/main/docs/media/omnijev-intro-60s.mp4">Mở video</a></sub></td>
</tr></table>
...
- [nibzard/decision-model-benchmark](https://github.com/nibzard/decision-model-benchmark) - Điểm chuẩn độc lập, có thể tái lập: một mô hình quyết định (jev), tám LLMs bị…
...
Môi trường runtime MLX bản địa cho các mô hình quyết định có kiểu Laya — các quyết định ngắn trong 7–14 ms trên M3 Max. Không tạo văn bản, PyTorch hoặc API đám mây.
...
- [vtavakkoli/simple-jev](https://github.com/vtavakkoli/simple-jev) - Biến mọi mô hình mở thành một endpoint classifier/jev.
...
- [heyjunpenn/awesome-jev](https://github.com/heyjunpenn/awesome-jev) - Danh mục đã được xác minh và do cộng đồng duy trì gồm 640 dự án mã nguồn mở…
...
Bản dịch tiếng Trung của tài liệu chính thức về cách sử dụng mô hình Jev (TypeSafe AI) | Bản dịch tiếng Trung không chính thức của tài liệu Jev (TypeSafe AI) chính thức — https://docs.typesafe.ai
...
TypeLLM: LLMs với khả năng tạo sinh an toàn kiểu
...
- [keltokhy/jsort](https://github.com/keltokhy/jsort) - sắp xếp theo ý nghĩa: sắp thứ tự các dòng theo một chiều plain-English, dựa…
...
<sub>Tạo bởi · `render.py` · 2026-09-22T16:07:34+08:00</sub>
