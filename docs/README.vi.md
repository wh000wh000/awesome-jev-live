...
> [!NOTE]
> **Chỉ mục trực tiếp** · Đồng bộ lần cuối: `2026-09-23T12:34:14+08:00` (UTC+8)
> · Mục: **770** · Mới trong lượt này: **69** · Ngôn ngữ triển khai: **24**
...
<sub>Jev, mô hình System One của TypeSafe, chơi cờ với bất kỳ LLM OpenRouter nào, Stockfish và bạn. Ứng dụng web một trang với các nước đi trực tiếp, xác suất nước đi của…</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
- [Định tuyến, rào chắn và phê duyệt](#định-tuyến-rào-chắn-và-phê-duyệt) — **56**
...
Một CLI offboard cho tất cả robot của bạn. Kết nối chúng, ra lệnh cho chúng và để chúng phối hợp làm việc, mỗi robot có một LLM làm bộ não và một LLM ra quyết định để thực hiện các bước rẻ hơn và nhanh hơn. Microduck, Open Duck Mini, LeRobot, XLeRobot, AlohaMini, ToddlerBot hoặc bất kỳ nền tảng ROS nào. Claude, OpenAI, Gemini, Grok hoặc chạy cục bộ qua Ollama hay vLLM.
...
Bộ công cụ SEO & GEO ưu tiên agent miễn phí 100%, ₹0 và máy chủ MCP trong Rust, thay thế Semrush và OpenSEO thông qua DuckDuckGo cùng TypeSafe Jev System One https://akashpriyadarshii.github.io/jev-seo/ CLI
...
<details>
<summary><b>Thêm trong danh mục này</b> <sub>· 115</sub></summary>
...
- [BeatAPI/awesome-jev](https://github.com/BeatAPI/awesome-jev) - Một thư viện được rà soát nguồn về các dự án liên quan đến JEV với hơn 50…
...
- [keltokhy/jsort](https://github.com/keltokhy/jsort) - sắp xếp theo ý nghĩa: sắp thứ tự các dòng theo một chiều diễn đạt bằng tiếng…
- [tumf/jev-cli](https://github.com/tumf/jev-cli) - CLI nhỏ, không phụ thuộc cho TypeSafe Jev.
- [evoke-build/evoke](https://github.com/evoke-build/evoke) - Phần mềm, theo phản xạ. Nói ra, và chương trình nhỏ phù hợp sẽ chạy: được chọn…
- [oswarld/notion-skills](https://github.com/oswarld/notion-skills) - Kỹ năng gọn gàng, đúng ý dành cho người dùng Notion 한국어.
...
- [ruban-24/switchboard](https://github.com/ruban-24/switchboard) - Bộ định tuyến quyết định mã nguồn mở, không phụ thuộc mô hình cho Claude Code…
...
- [shitianfang/jev-use](https://github.com/shitianfang/jev-use) - Plugin Claude Code / Codex / pi chuyển các bước của tác nhân không cần đầu ra…
...
- [muratcakmak/jev-guard](https://github.com/muratcakmak/jev-guard) - Các rào chắn được chấm điểm theo xác suất cho Claude Code: từ chối các chỉnh…
...
- [weitianxin/JevAny](https://github.com/weitianxin/JevAny) - RL nhận biết hiệu chỉnh cho các mô hình ra quyết định, mở rộng hướng tới các…
...
- [lucioamor/lovable-skills](https://github.com/lucioamor/lovable-skills) - Các kỹ năng Lovable có thể tái sử dụng cho việc đánh giá ứng dụng, ra quyết…
...
Giám sát prompt tự lưu trữ với các mô hình System One
...
Kiểm soát tiếp nhận dựa trên phán đoán có kiểu ở biên lưu lượng: bộ lọc ba lớp chống chèn lời nhắc và lạm dụng cho nginx/OpenResty, được hỗ trợ bởi TypeSafe Jev. Mặc định cho phép khi lỗi, có bộ nhớ đệm và có thể tải lại nóng.
...
- [raihankhan-rk/diffjury](https://github.com/raihankhan-rk/diffjury) - DiffJury — bộ định tuyến rủi ro PR TypeSafe Jev + huấn luyện viên đánh giá mã.
...
Các mô hình System One mã nguồn mở: các quyết định được định kiểu với xác suất đã hiệu chuẩn, có thể huấn luyện trên dữ liệu của riêng bạn. Không sinh văn bản.
...
- [fstandhartinger/jevbench](https://github.com/fstandhartinger/jevbench) - JevBench v1 - một điểm chuẩn cho các mô hình quyết định được định kiểu thuộc…
...
<details>
<summary><b>Thêm trong danh mục này</b> <sub>· 11</sub></summary>
...
- [Kevthetech143/super-jev](https://github.com/Kevthetech143/super-jev) - Một khung nhỏ, có thể mở rộng, chuyển từ quyết định sang hành động cho TypeSafe…
...
<sub>Tạo bởi · `render.py` · 2026-09-23T12:34:14+08:00</sub>
