...
> [!NOTE]
> **Chỉ mục trực tiếp** · Đồng bộ lần cuối: `2026-09-21T18:56:44+08:00` (UTC+8)
> · Mục: **714** · Mới trong lượt này: **87** · Ngôn ngữ triển khai: **25**
...
- [Client, SDK và adapter do cộng đồng phát triển](#client-sdk-và-adapter-do-cộng-đồng-phát-triển) — **109**
- [Công cụ cho agent: MCP, hook, cổng chặn và agent viết mã](#công-cụ-cho-agent-mcp-hook-cổng-chặn-và-agent-viết-mã) — **196**
- [Định tuyến, rào chắn và phê duyệt](#định-tuyến-rào-chắn-và-phê-duyệt) — **77**
- [Đánh giá, hiệu chỉnh và benchmark](#đánh-giá-hiệu-chỉnh-và-benchmark) — **75**
- [Bản tái tạo mở, trọng số và nghiên cứu kiến trúc](#bản-tái-tạo-mở-trọng-số-và-nghiên-cứu-kiến-trúc) — **35**
...
<details>
<summary><b>Thêm trong danh mục này</b> <sub>· 174</sub></summary>
...
- [savka777/jev-use](https://github.com/savka777/jev-use) - Nói ra, và Mac của bạn sẽ thực hiện. Một harness sử dụng máy tính trên Jev đọc…
...
- [chy4pro/jev-for-chrome](https://github.com/chy4pro/jev-for-chrome) - Jev cho Chrome: điều khiển tab bạn đang xem bằng TypeSafe Jev, một mô hình…
...
- [mizchi/jev-test-filter](https://github.com/mizchi/jev-test-filter) - Score mọi kiểm thử theo một git diff với Jev, và xuất ra các đối số bộ lọc mà…
...
<details>
<summary><b>Thêm trong danh mục này</b> <sub>· 75</sub></summary>
...
- [tanxarx/awesome-jev](https://github.com/tanxarx/awesome-jev) - Tất cả những điều awesome liên quan đến Jev.
...
- [Rizzo-AI-Academy/rizzo-flow](https://github.com/Rizzo-AI-Academy/rizzo-flow) - Cách tiếp cận mở, cục bộ đối với Jev: các quyết định có kiểu từ một LLM, không…
...
<sub>Tạo bởi · `render.py` · 2026-09-21T18:56:44+08:00</sub>
