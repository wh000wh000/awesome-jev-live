...
> [!NOTE]
> **Chỉ mục trực tiếp** · Đồng bộ lần cuối: `2026-09-23T09:31:07+08:00` (UTC+8)
> · Mục: **766** · Mới trong lượt này: **61** · Ngôn ngữ triển khai: **26**
...
<sub>Một CLI offboard cho tất cả robot của bạn. Kết nối chúng, ra lệnh cho chúng và để chúng phối hợp làm việc, mỗi robot có một LLM làm bộ não và một LLM ra quyết định để…</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
- [Công cụ cho agent: MCP, hook, cổng chặn và agent viết mã](#công-cụ-cho-agent-mcp-hook-cổng-chặn-và-agent-viết-mã) — **243**
- [Định tuyến, rào chắn và phê duyệt](#định-tuyến-rào-chắn-và-phê-duyệt) — **54**
...
- [Ứng dụng, trò chơi, robot và demo tương tác](#ứng-dụng-trò-chơi-robot-và-demo-tương-tác) — **46**
- [Bài viết, thảo luận và các danh sách cùng chủ đề](#bài-viết-thảo-luận-và-các-danh-sách-cùng-chủ-đề) — **96**
- [Dự án khác](#dự-án-khác) — **77**
...
<sub>🔧 Được tìm thấy trong mã nguồn: `docs/adr/0043-decision-llms-are-a-wire-format-and-a-data-row.md`</sub>
...
- [keltokhy/jlink](https://github.com/keltokhy/jlink) - Liên kết bản ghi cho các nhà kinh tế học: viết quy tắc đối sánh bằng tiếng Anh…
...
<details>
<summary><b>Thêm trong danh mục này</b> <sub>· 221</sub></summary>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/hfnissum-byte--hunkpick/21c4c5bad7854d6e.gif" width="100%" alt="hfnissum-byte/Hunkpick animation"><br><sub>bản ghi động</sub></td>
</tr></table>
...
<details>
<summary><b>Thêm trong danh mục này</b> <sub>· 14</sub></summary>
...
- [backmeupplz/jev_antispam_bot](https://github.com/backmeupplz/jev_antispam_bot) - Bot chống thư rác Telegram grammY tối giản được hỗ trợ bởi TypeSafe Jev.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/yinsongxu--llm2jev/9b0b042b0dfa87b7.gif" width="100%" alt="Yinsongxu/LLM2Jev animation"><br><sub>bản ghi động · <a href="https://raw.githubusercontent.com/Yinsongxu/LLM2Jev/main/assets/mujoco.mp4">Mở video</a></sub></td>
</tr></table>
...
- [Argos1111/jev_local](https://github.com/Argos1111/jev_local) - Tái tạo Jev bằng một LLM cục bộ.
- [yushen100/wechat-jev-assistant](https://github.com/yushen100/wechat-jev-assistant) - Windows 微信 trợ lý phân tích hội thoại: đọc cục bộ, khử thông tin nhận dạng…
...
- [phyous/tsai-sc](https://github.com/phyous/tsai-sc) - TypeSafe Jev điều khiển StarCraft shareware nguyên bản bằng bàn phím và chuột…
...
<sub>Tạo bởi · `render.py` · 2026-09-23T09:31:07+08:00</sub>
