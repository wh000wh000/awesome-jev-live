...
> [!NOTE]
> **Index en direct** · Dernière synchronisation: `2026-09-22T01:56:49+08:00` (UTC+8)
> · Entrées: **732** · Nouvelles ce cycle: **99** · Langages d'implémentation: **24**
...
- [Clients, SDK et adaptateurs communautaires](#clients-sdk-et-adaptateurs-communautaires) — **125**
- [Outillage d'agents : MCP, hooks, portes de contrôle et agents de codage](#outillage-dagents--mcp-hooks-portes-de-contrôle-et-agents-de-codage) — **185**
- [Routage, garde-fous et approbations](#routage-garde-fous-et-approbations) — **73**
...
- [Applications, jeux, robotique et démos interactives](#applications-jeux-robotique-et-démos-interactives) — **44**
- [Articles, discussions et listes sœurs](#articles-discussions-et-listes-sœurs) — **89**
- [Autres projets](#autres-projets) — **93**
...
<details>
<summary><b>Plus dans cette catégorie</b> <sub>· 103</sub></summary>
...
- [AkashPriyadarshii/jev-seo](https://github.com/AkashPriyadarshii/jev-seo) - Suite SEO &amp; GEO CLI orientée agent 100 % gratuite à ₹0 et serveur MCP dans…
...
<sub>🔧 Utilisé dans du code: `src/request.ts`</sub>
...
Compétence d’agent pour la classe de modèles décisionnels (classificateurs, encodeurs/décodeurs, têtes AR spécialisées, System One). TypeSafe Jev est l’exemple dominant. Algèbre de composition, conception de questions, portes de validation. MIT.
...
<details>
<summary><b>Plus dans cette catégorie</b> <sub>· 163</sub></summary>
...
- [Nyarlathoteppppp/pi-jev-context](https://github.com/Nyarlathoteppppp/pi-jev-context) - Performance du modèle d.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/hfnissum-byte/jevmerge/main/demo/jevmerge.gif" width="100%" alt="hfnissum-byte/jevmerge animation"><br><sub>enregistrement animé</sub></td>
</tr></table>
...
<details>
<summary><b>Plus dans cette catégorie</b> <sub>· 51</sub></summary>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/royalpinto007--jev-msw/ebabe386396d5f7e.gif" width="100%" alt="royalpinto007/jev-msw animation"><br><sub>enregistrement animé</sub></td>
</tr></table>
...
Fenêtre flottante de reconnaissance d’intention des messages WeChat（macOS）：analyse l’écran + petit modèle local pour déterminer l’intention et le risque, puis génère des réponses candidates selon le script. Purement en lecture seule, sans injection dans WeChat.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/jev-jarvis--jev-jarvis/daa9ab5c1715d764.gif" width="100%" alt="jev-jarvis/jev-jarvis animation"><br><sub>enregistrement animé</sub></td>
</tr></table>
...
Assistant de réponse greffé à WeChat（Windows 4.x）：capture d’écran de la fenêtre + OCR local hors ligne lit les messages de l’interlocuteur → Jev détermine l’intention → 3 propositions insérées en un clic, l’envoi reste toujours manuel
...
- [musubi-labs/musubi-jev](https://github.com/musubi-labs/musubi-jev) - petite famille de modèles de décision de type Jev, construite au-dessus de…
...
<sub>Généré par · `render.py` · 2026-09-22T01:56:49+08:00</sub>
