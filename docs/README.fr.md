...
> [!NOTE]
> **Index en direct** · Dernière synchronisation: `2026-09-25T18:10:37+08:00` (UTC+8)
> · Entrées: **799** · Nouvelles ce cycle: **298** · Langages d'implémentation: **24**
...
<sub>Swift SDK pour exécuter des modèles de chat, de vision et de parole sur iPhone et Mac avec le Core AI d&#x27;Apple. Téléchargement et mise en cache des modèles,…</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
- [Clients, SDK et adaptateurs communautaires](#clients-sdk-et-adaptateurs-communautaires) — **129**
- [Outillage d'agents : MCP, hooks, portes de contrôle et agents de codage](#outillage-dagents--mcp-hooks-portes-de-contrôle-et-agents-de-codage) — **249**
- [Routage, garde-fous et approbations](#routage-garde-fous-et-approbations) — **58**
...
- [Autres projets](#autres-projets) — **82**
...
<sub>🔧 Utilisé dans du code: `src/typesafe_sdk/__init__.py`</sub>
...
<sub>🔧 Utilisé dans du code: `Sources/CoreAIOps/CoreAI+SystemOne.swift`</sub>
...
Framework Agentic GraphRAG indépendant de la base de données, utilisant des modèles System One interchangeables (Laya local / Jev cloud). Couche d’intelligence prête à l’emploi avec un pipeline complet en 4 phases et un parcours A* personnalisé pour toute base de données graphe.
...
Plus de 200 recettes Jev prêtes à l’emploi : décisions IA petites et calibrées qui acheminent, évaluent, contrôlent, comparent et étiquettent du texte pour les agents, RAG, le support, la revue de code et la musique. Importez depuis JavaScript ou TypeScript, ou appelez le CLI avec JSON depuis n’importe quel langage.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/agencyenterprise--jev-recipes/0f08086836b893d8.gif" width="100%" alt="agencyenterprise/jev-recipes animation"><br><sub>enregistrement animé</sub></td>
</tr></table>
...
Un CLI pour tous vos robots. Connectez-les, commandez-les et laissez-les travailler ensemble, chacun avec un LLM comme cerveau (Claude, OpenAI, Gemini, Grok ou en local via Ollama ou vLLM) et un LLM de décision pour les choix multiples (Jev, Laya, Kev). Pilote Microduck, Open Duck Mini, LeRobot, XLeRobot, AlohaMini, ToddlerBot, ou toute base ROS 2, depuis un ordinateur portable, hors carte.
...
CLI qui sélectionne Cursor, Claude Code, Codex ou OpenCode + le modèle/l’effort pour une tâche, puis le lance. Propulsé par Jev et Herdr
...
<details>
<summary><b>Plus dans cette catégorie</b> <sub>· 111</sub></summary>
...
- [chengyongru/fastjev](https://github.com/chengyongru/fastjev) - Fork SemIf maintenu indépendamment, privilégiant SDK, pour des décisions…
- [Ray-Hughes/jevalyn](https://github.com/Ray-Hughes/jevalyn) - La couche de décision pour votre application Rails.
- [CheshiAI/Cheshi](https://github.com/CheshiAI/Cheshi) - Mémoire conversationnelle propulsée par Jev : retrouvez les sessions passées et…
- [evoke-build/evoke](https://github.com/evoke-build/evoke) - Des logiciels, par réflexe. Dites-le, et le petit programme adéquat s.
- [utk2103/jev-studio](https://github.com/utk2103/jev-studio) - si vous expérimentez avec jev, ce sera plus facile depuis ici.
...
Expérimentation de moteurs de recherche sur les collections TREC. Actuellement axée sur les implémentations de reranking zero-shot avec le modèle JEV de typesafe.ai
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/mansicer--jev-plays/c4f1ec41afcb4ae9.gif" width="100%" alt="mansicer/jev-plays animation"><br><sub>enregistrement animé</sub></td>
</tr></table>
...
<details>
<summary><b>Plus dans cette catégorie</b> <sub>· 231</sub></summary>
...
- [supercorp-ai/supercov](https://github.com/supercorp-ai/supercov) - Couverture, sécurité et qualité du code pour les agents de programmation.
...
- [socai-io/jev-social](https://github.com/socai-io/jev-social) - Compétence Agent open source et démonstration locale : Jev × socai pour la…
...
- [OmniJev/PlayJev](https://github.com/OmniJev/PlayJev) - 🚀🚀 Un modèle multimodal de 0.8B de type JEV qui joue directement à des jeux GUI…
...
- [khordoo/jev-reflex-autonomy-lab](https://github.com/khordoo/jev-reflex-autonomy-lab) - Simulation d.
...
- [bgivenb/flick-computer-use](https://github.com/bgivenb/flick-computer-use) - Utilisation rapide du navigateur et de l.
...
- [24601/Augustus](https://github.com/24601/Augustus) - Compétence d.
...
- [inso1337/revl](https://github.com/inso1337/revl) - Langage pour une composabilité spatiotemporelle sûre et universelle.
- [AskTheWay/dsh-jev-interceptor](https://github.com/AskTheWay/dsh-jev-interceptor) - ⚡ Jugement de Système 1 en quelques millisecondes pour chaque appel d.
...
- [itsmostafa/typesafe-mcp](https://github.com/itsmostafa/typesafe-mcp) - Un connecteur mcp pour tout évaluer rapidement et à moindre coût.
...
Passerelle de triage des risques en temps réel pour les dépôts et retraits sur les plateformes d’échange — Jev (TypeSafe System One) ne gère que le triage ; l’arbitrage reste dans le code déterministe.
...
Contrôle d’admission à jugement typé en périphérie du trafic : filtre en trois couches contre l’injection de prompts et les abus pour nginx/OpenResty, propulsé par TypeSafe Jev. Fonctionnement en cas d’échec ouvert, mise en cache et rechargement à chaud.
...
- [ollaya-dev/ollaya](https://github.com/ollaya-dev/ollaya) - Exécutez localement des modèles de décision ouverts : téléchargez et servez…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/allebee--jevk5/1f9cd6cb325d4bd4.gif" width="100%" alt="allebee/jevk5 animation"><br><sub>enregistrement animé · <a href="https://raw.githubusercontent.com/allebee/jevk5/main/docs/demo/jevk5-nvidia-demo.mp4">Ouvrir la vidéo</a></sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/weitianxin--jevany/711125367b6758ff.gif" width="100%" alt="weitianxin/JevAny animation"><br><sub>enregistrement animé</sub></td>
</tr></table>
...
- [Eliot5566/JEV-Paper-Radar](https://github.com/Eliot5566/JEV-Paper-Radar) - Laissez Jev lire chaque nouveau papier arXiv chaque matin et faire remonter les…
...
Décisions typées à partir d’un état non structuré : un seul passage avant, aucun texte généré. Local, déterministe, compatible avec Jev. Non affilié à typesafe.ai.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/antonellof--laya-vs-dijkstra/b61bc3a8e3d368be.gif" width="100%" alt="antonellof/laya-vs-dijkstra animation"><br><sub>enregistrement animé</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/theoleecj--semif-openjev/0504149cd9ef3cad.gif" width="100%" alt="TheoLeeCJ/SemIf-OpenJev animation"><br><sub>enregistrement animé</sub></td>
</tr></table>
...
<details>
<summary><b>Plus dans cette catégorie</b> <sub>· 20</sub></summary>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/zadescoxp--jev-trades/2abea899d779de55.gif" width="100%" alt="zadescoxp/Jev-Trades animation"><br><sub>enregistrement animé</sub></td>
</tr></table>
...
- [heyjunpenn/awesome-jev](https://github.com/heyjunpenn/awesome-jev) - Un catalogue vérifié, maintenu par la communauté, de 916 projets open source…
...
<details>
<summary><b>Plus dans cette catégorie</b> <sub>· 89</sub></summary>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/liuziyu77--valen/d4fa3bf5c399a28d.gif" width="100%" alt="Liuziyu77/Valen animation"><br><sub>enregistrement animé</sub></td>
</tr></table>
...
Assistant en fenêtre flottante pour les discussions (macOS) : perception de l’écran + petit modèle local pour déterminer l’intention et le risque, puis générer des réponses candidates selon le style de communication. Lecture seule.
...
Transformez les modèles de langage locaux en modèles de décision structurés de type Jev. Obtenez des résultats à partir de textes et d’images avec le seul préremplissage — aucun décodage jeton par jeton requis.
...
- [alvarobartt/sys1](https://github.com/alvarobartt/sys1) - API compatible avec System One pour les modèles de décision ouverts, écrit en…
...
- [Kevthetech143/super-jev](https://github.com/Kevthetech143/super-jev) - Un petit harnais extensible de décision vers action pour TypeSafe Jev.
...
<sub>Généré par · `render.py` · 2026-09-25T18:10:37+08:00</sub>
