...
> [!NOTE]
> **Index en direct** · Dernière synchronisation: `2026-09-22T11:05:08+08:00` (UTC+8)
> · Entrées: **737** · Nouvelles ce cycle: **54** · Langages d'implémentation: **25**
...
- [Outillage d'agents : MCP, hooks, portes de contrôle et agents de codage](#outillage-dagents--mcp-hooks-portes-de-contrôle-et-agents-de-codage) — **209**
...
- [Reproductions ouvertes, poids et recherche sur l'architecture](#reproductions-ouvertes-poids-et-recherche-sur-larchitecture) — **36**
- [Applications, jeux, robotique et démos interactives](#applications-jeux-robotique-et-démos-interactives) — **46**
- [Articles, discussions et listes sœurs](#articles-discussions-et-listes-sœurs) — **90**
- [Autres projets](#autres-projets) — **77**
...
Le logiciel, par réflexe. Une phrase devient l’appel d’un petit programme, choisi par Jev, le classificateur de TypeSafe AI, et exécuté uniquement lorsqu’il est suffisamment sûr. Les réflexes sont des recettes que chacun peut écrire, partager et améliorer. Un CLI auquel vous parlez, un gestionnaire de paquets pour les réflexes depuis git, et un TypeScript SDK.
...
- [lucasmartins-ai/lcc](https://github.com/lucasmartins-ai/lcc) - Compilateur de contexte local (lcc) : nettoie, déduplique et compacte le…
...
- [keltokhy/jlink](https://github.com/keltokhy/jlink) - Appariement d.
...
Copilote conversationnel installé sur le téléphone : comprend l’interlocuteur dans WeChat / QQ / X / 飞书, propose des réponses candidates, les insère d’un clic dans le champ de saisie ; l’envoi dépend de vous. Non intrusif, il lit uniquement l’écran, sans hook ni modification de paquet.
...
<details>
<summary><b>Plus dans cette catégorie</b> <sub>· 187</sub></summary>
...
- [savka777/jev-use](https://github.com/savka777/jev-use) - Dites-le, et votre Mac s.
...
- [blakestone-x/jev-mcp](https://github.com/blakestone-x/jev-mcp) - Serveur MCP pour TypeSafe Jev : classification, scoring, vérification, mise en…
...
- [khordoo/jev-reflex-autonomy-lab](https://github.com/khordoo/jev-reflex-autonomy-lab) - Laboratoire d.
...
- [PerryLink/jevcore](https://github.com/PerryLink/jevcore) - TypeSafe Jev pour DeepSeek Harness, le Model Context Protocol et Node brut…
- [jackbarunz/jev-tool-router](https://github.com/jackbarunz/jev-tool-router) - Routage d.
- [Nyarlathoteppppp/pi-jev-context](https://github.com/Nyarlathoteppppp/pi-jev-context) - Les performances du modèle d.
- [alexgreensh/eval-genius](https://github.com/alexgreensh/eval-genius) - Apprenez à votre agent à travailler avec les évaluations : QUAND vous avez…
- [nozomi-koborinai/jev-spec](https://github.com/nozomi-koborinai/jev-spec) - ⚡ Repérez les divergences de spécification à chaque commit : vérifiez votre…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/hfnissum-byte/Hunkpick/main/demo/hunkpick.gif" width="100%" alt="hfnissum-byte/Hunkpick animation"><br><sub>enregistrement animé</sub></td>
</tr></table>
...
Transformez n’importe quel LLM en modèle de décision de type Jev : décisions typées, probabilités réelles, sans entraînement.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/nokia-applied-research--anyjev/4184f4406ec59fe6.gif" width="100%" alt="nokia-applied-research/AnyJev animation"><br><sub>enregistrement animé</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/rythmn1111--doom-war/c0cd335c6615f8e3.gif" width="100%" alt="rythmn1111/doom-war animation"><br><sub>enregistrement animé</sub></td>
</tr></table>
...
<details>
<summary><b>Plus dans cette catégorie</b> <sub>· 14</sub></summary>
...
- [mmastrac/djev](https://github.com/mmastrac/djev) - Décisions structurées de style Jev sur DiffusionGemma : le serveur d.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/michaelpersonal--jev-trade-cc/b3ae9a36cc9fcbbf.gif" width="100%" alt="michaelpersonal/jev-trade-cc animation"><br><sub>enregistrement animé</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/iron-lyk--omnijev/341b127f269cdd62.gif" width="100%" alt="Iron-LYK/OmniJev animation"><br><sub>enregistrement animé · <a href="https://raw.githubusercontent.com/Iron-LYK/OmniJev/main/docs/media/omnijev-stack.mp4">Ouvrir la vidéo</a></sub></td>
</tr></table>
...
<details>
<summary><b>Plus dans cette catégorie</b> <sub>· 24</sub></summary>
...
- [Argos1111/jev_local](https://github.com/Argos1111/jev_local) - Répliquer Jev avec un LLM local.
...
<sub>Généré par · `render.py` · 2026-09-22T11:05:08+08:00</sub>
