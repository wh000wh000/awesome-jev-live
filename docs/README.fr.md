...
> [!NOTE]
> **Index en direct** · Dernière synchronisation: `2026-09-21T23:42:10+08:00` (UTC+8)
> · Entrées: **737** · Nouvelles ce cycle: **115** · Langages d'implémentation: **25**
...
- [Clients, SDK et adaptateurs communautaires](#clients-sdk-et-adaptateurs-communautaires) — **121**
- [Outillage d'agents : MCP, hooks, portes de contrôle et agents de codage](#outillage-dagents--mcp-hooks-portes-de-contrôle-et-agents-de-codage) — **192**
- [Routage, garde-fous et approbations](#routage-garde-fous-et-approbations) — **78**
- [Évaluation, calibration et benchmarks](#évaluation-calibration-et-benchmarks) — **77**
- [Reproductions ouvertes, poids et recherche sur l'architecture](#reproductions-ouvertes-poids-et-recherche-sur-larchitecture) — **40**
- [Applications, jeux, robotique et démos interactives](#applications-jeux-robotique-et-démos-interactives) — **41**
- [Articles, discussions et listes sœurs](#articles-discussions-et-listes-sœurs) — **95**
- [Autres projets](#autres-projets) — **86**
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/fajarhide--askgrep/fa6a7fa333d2d67f.gif" width="100%" alt="fajarhide/askgrep animation"><br><sub>enregistrement animé</sub></td>
</tr></table>
...
<details>
<summary><b>Plus dans cette catégorie</b> <sub>· 99</sub></summary>
...
- [smkrv/jev-calibrate](https://github.com/smkrv/jev-calibrate) - Calibrez les questions Jev par rapport à vos propres étiquettes : ajustez les…
- [BeatAPI/awesome-jev](https://github.com/BeatAPI/awesome-jev) - Nous ne sélectionnons que des projets liés à JEV dont le code source a été…
...
- [evoke-build/evoke](https://github.com/evoke-build/evoke) - Le logiciel, par réflexe. Une phrase devient l.
...
- [chengyongru/fastjev](https://github.com/chengyongru/fastjev) - Fork SemIf axé sur SDK, maintenu indépendamment, pour des décisions sémantiques…
...
- [lukstei/slop-grader](https://github.com/lukstei/slop-grader) - Correcteur basé sur des règles, propulsé par Jev, pour fichiers texte.
- [Qew7/jev-feels](https://github.com/Qew7/jev-feels) - Décisions sémantiques comme Ruby ordinaires — feels?, decide, score…
...
- [iamvatsalpatel/tiershift](https://github.com/iamvatsalpatel/tiershift) - Basculez chaque appel LLM vers le modèle le moins cher capable de le gérer.
- [mountainMath/JevR](https://github.com/mountainMath/JevR) - Client R pour le TypeSafe Jev System One API.
...
- [kitfunso/hippo-memory](https://github.com/kitfunso/hippo-memory) - Mémoire biologiquement inspirée pour agents IA.
...
- [zcoder-run/rust-sysone](https://github.com/zcoder-run/rust-sysone) - Client System One TypeSafe AI Rust (non officiel).
- [geilt/typesafe-cli](https://github.com/geilt/typesafe-cli) - CLI et compétence d.
- [neko233-com/laya-go](https://github.com/neko233-com/laya-go) - Laya — modèles de décision horizontaux ouverts System 1 : serveur Go + agent…
...
Agent web le plus rapide et le moins cher
...
<details>
<summary><b>Plus dans cette catégorie</b> <sub>· 170</sub></summary>
...
- [cookiespiggy/agentic-rl](https://github.com/cookiespiggy/agentic-rl) - Tutoriel Agentic RL en chinois pour grands débutants (25 chapitres) : des…
...
- [supercorp-ai/supercov](https://github.com/supercorp-ai/supercov) - Qualité et couverture du code pour les agents de programmation.
...
- [socai-io/jev-social](https://github.com/socai-io/jev-social) - Recherche Instagram, TikTok et LinkedIn propulsée par Jev : routage typé…
...
- [DanRWilloughby/snifftest](https://github.com/DanRWilloughby/snifftest) - Un linter de prose qui détecte les indices d&#x27;un texte généré par l&#x27;IA.
...
- [compozy/yoshi](https://github.com/compozy/yoshi) - Proxy d.
...
- [OmniJev/PlayJev](https://github.com/OmniJev/PlayJev) - 🚀🚀 Un modèle multimodal de type JEV 0.8B jouant à des jeux GUI directement à…
...
- [Prophetlab/JevPokerBench](https://github.com/Prophetlab/JevPokerBench) - Le benchmark et terrain de jeu Texas Hold.
- [Nyarlathoteppppp/pi-jev-context](https://github.com/Nyarlathoteppppp/pi-jev-context) - Réduction de contexte neutre vis-à-vis du cache pour l.
...
- [buluoray/JevOnly](https://github.com/buluoray/JevOnly) - Jev pur capable de « taper » et de progresser vers l.
...
- [FFatTiger/new-api-plugin-typesafe](https://github.com/FFatTiger/new-api-plugin-typesafe) - Plugin de tâche TypeSafe AI System One (Jev) pour QuantumNous/new-api…
...
Routage automatique de modèles pour Pi utilisant Jev de TypeSafe via Vercel AI Gateway
...
<details>
<summary><b>Plus dans cette catégorie</b> <sub>· 56</sub></summary>
...
- [rajdhakad9826/jev-router](https://github.com/rajdhakad9826/jev-router) - Routeur LLM soucieux des coûts qui choisit le modèle le moins cher capable de…
...
- [yzfly/edgejev](https://github.com/yzfly/edgejev) - Décisions typées locales utilisables hors ligne : 15,6 ms par question sur CPU…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/fbddcz--embodied-jev/6c478d975fee036f.gif" width="100%" alt="FBddcz/embodied-jev animation"><br><sub>enregistrement animé · <a href="https://raw.githubusercontent.com/FBddcz/embodied-jev/main/docs/results/metaworld-hierarchy-v2-2026-09-21/figures/hierarchy-grid-fast.mp4">Ouvrir la vidéo</a></sub></td>
</tr></table>
...
<details>
<summary><b>Plus dans cette catégorie</b> <sub>· 18</sub></summary>
...
- [zhihz/openjev](https://github.com/zhihz/openjev) - Décisions de probabilité bilingues locales à partir du contexte, des questions…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/hr98w--jev-visual/e05a42d934ea69ce.gif" width="100%" alt="hr98w/jev-visual animation"><br><sub>enregistrement animé · <a href="https://github.com/user-attachments/assets/c87c09d8-30d2-4392-b981-d0b5cf1879ae">Ouvrir la vidéo</a></sub></td>
</tr></table>
...
<details>
<summary><b>Plus dans cette catégorie</b> <sub>· 82</sub></summary>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/yinsongxu--llm2jev/f1121682db48993a.gif" width="100%" alt="Yinsongxu/LLM2Jev animation"><br><sub>enregistrement animé</sub></td>
</tr></table>
...
- [HexyeDEV/JevPR](https://github.com/HexyeDEV/JevPR) - Revue des risques de PR, automatisée par Jev.
...
- [exfly/laya-jev-compatible-server](https://github.com/exfly/laya-jev-compatible-server) - Un serveur HTTP compatible TypeSafe Jev (POST /v1/systemone).
...
- [kevin9327/jev-master](https://github.com/kevin9327/jev-master) - Décisions typées System One avec Jev : Choice + Score + Noul composés dans le…
...
- [zhengxuyu/litjev](https://github.com/zhengxuyu/litjev) - Transformez n.
...
- [phyous/tsai-sc](https://github.com/phyous/tsai-sc) - TypeSafe Jev contrôle le shareware original StarCraft au clavier et à la souris…
...
<sub>Généré par · `render.py` · 2026-09-21T23:42:10+08:00</sub>
