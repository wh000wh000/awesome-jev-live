...
> [!NOTE]
> **Index en direct** · Dernière synchronisation: `2026-09-26T03:12:11+08:00` (UTC+8)
> · Entrées: **806** · Nouvelles ce cycle: **123** · Langages d'implémentation: **23**
...
- [Clients, SDK et adaptateurs communautaires](#clients-sdk-et-adaptateurs-communautaires) — **127**
- [Outillage d'agents : MCP, hooks, portes de contrôle et agents de codage](#outillage-dagents--mcp-hooks-portes-de-contrôle-et-agents-de-codage) — **245**
- [Routage, garde-fous et approbations](#routage-garde-fous-et-approbations) — **61**
- [Évaluation, calibration et benchmarks](#évaluation-calibration-et-benchmarks) — **78**
- [Reproductions ouvertes, poids et recherche sur l'architecture](#reproductions-ouvertes-poids-et-recherche-sur-larchitecture) — **45**
- [Applications, jeux, robotique et démos interactives](#applications-jeux-robotique-et-démos-interactives) — **53**
- [Articles, discussions et listes sœurs](#articles-discussions-et-listes-sœurs) — **104**
...
Environnement de décision pour TypeSafe Jev — seuils de confiance, mode fantôme, recettes et évaluations. Claude CLI 48,9 s → Jev 1,3 s sur la même tâche de filtrage de lignes.
...
<details>
<summary><b>Plus dans cette catégorie</b> <sub>· 109</sub></summary>
...
- [topherchris420/james_library](https://github.com/topherchris420/james_library) - R.A.I.N. Lab est une architecture expérimentale d.
...
- [bladedevoff/stuntd](https://github.com/bladedevoff/stuntd) - Proxy local qui apprend les décisions LLM saisies dans votre application et y…
- [myc0576/SmartMoney-Cub](https://github.com/myc0576/SmartMoney-Cub) - Journal de trading en lecture seule et environnement de revue : jugements Jev…
...
- [6Mikao9/jev-native-agent-with-extended-options](https://github.com/6Mikao9/jev-native-agent-with-extended-options) - Conception de recherche pour un système d.
...
- [carldaws/hunch](https://github.com/carldaws/hunch) - Flux de contrôle probabiliste pour Ruby et Rails — propulsé par le Jev de…
...
- [ruban-24/switchboard](https://github.com/ruban-24/switchboard) - Un routeur de décisions open source et indépendant des modèles pour Claude Code…
...
- [MiaoWuNYA/rikkahub-sillytavern-android](https://github.com/MiaoWuNYA/rikkahub-sillytavern-android) - Client de chat IA Android : importation sans perte des cartes de taverne, cache…
...
✨ Tous vos agents et espaces de travail au même endroit, sur tous vos appareils. Suivez les tâches sur un tableau, accessible depuis un ordinateur, un mobile, un navigateur ou API. Auto-hébergé.
...
<details>
<summary><b>Plus dans cette catégorie</b> <sub>· 227</sub></summary>
...
- [safzanpirani/pi-jev-skill-picker](https://github.com/safzanpirani/pi-jev-skill-picker) - Classez les compétences de l.
...
- [green-dalii/pi-shift-router](https://github.com/green-dalii/pi-shift-router) - Routage de modèle à chaque tour pour l.
...
- [erkamyaman/jev-enforce](https://github.com/erkamyaman/jev-enforce) - 📏 Plugin Claude Code qui oblige Claude à suivre votre AGENTS.md : chaque…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/4nt0ineb--jev-from-java/cd4ce3d04107d762.gif" width="100%" alt="4nt0ineB/jev-from-java animation"><br><sub>enregistrement animé</sub></td>
</tr></table>
...
<details>
<summary><b>Plus dans cette catégorie</b> <sub>· 60</sub></summary>
...
- [anessbelbati/jev-rerank-bench](https://github.com/anessbelbati/jev-rerank-bench) - Un modèle de décision peut-il surpasser les rerankers dédiés ? TypeSafe Jev…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/feder-cr/jev/main/assets/dino_run.gif" width="100%" alt="feder-cr/jev animation"><br><sub>enregistrement animé</sub></td>
</tr></table>
...
- [amithgc/local-jev](https://github.com/amithgc/local-jev) - Un serveur System One local et hors ligne compatible avec Jev API de TypeSafe.
...
- [Ryu0118/jev-sim-use](https://github.com/Ryu0118/jev-sim-use) - 📱 Atteignez n.
...
<details>
<summary><b>Plus dans cette catégorie</b> <sub>· 92</sub></summary>
...
- [Show HN: Doom or Bloom, map your AI worldview with Jev](https://news.ycombinator.com/item?id=49846953) - Cartographiez votre vision du monde de l.
...
Traduction chinoise de la documentation officielle d’utilisation du modèle Jev (TypeSafe AI) | Traduction chinoise non officielle de la documentation officielle Jev (TypeSafe AI) — https://docs.typesafe.ai
...
- [doeixd/discern](https://github.com/doeixd/discern) - Créez une correspondance de motifs sémantiques sûre par rapport aux types et…
...
<sub>Généré par · `render.py` · 2026-09-26T03:12:11+08:00</sub>
