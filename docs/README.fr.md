...
> [!NOTE]
> **Index en direct** · Dernière synchronisation: `2026-09-27T01:21:54+08:00` (UTC+8)
> · Entrées: **811** · Nouvelles ce cycle: **103** · Langages d'implémentation: **25**
...
- [Clients, SDK et adaptateurs communautaires](#clients-sdk-et-adaptateurs-communautaires) — **134**
...
- [Reproductions ouvertes, poids et recherche sur l'architecture](#reproductions-ouvertes-poids-et-recherche-sur-larchitecture) — **42**
...
- [Autres projets](#autres-projets) — **83**
...
Kit SEO et GEO gratuit pour Rust, propulsé par TypeSafe Jev : audits à 58 règles, explorations de sites, vérifications des citations par l’IA, dérive du classement, barrières CI, MCP à 15 outils. Gratuit.
...
- [nexibeo/jev-cookbook](https://github.com/nexibeo/jev-cookbook) - Recettes pratiques et testées pour le modèle de décision de TypeSafe Jev sur…
...
- [9pings/notjev](https://github.com/9pings/notjev) - Jev ultra-rapide de type serveur, indépendant du modèle, fonctionnant avec tout…
...
- [wojciechwiesner/jit-context](https://github.com/wojciechwiesner/jit-context) - Avantage architectural : JIT-JEV Context OS — environnement d.
...
- [Amal-David/awesome-jev](https://github.com/Amal-David/awesome-jev) - Démos, projets, Jev, SDKs et compétences, avec des liens vers les sources et…
...
- [safzanpirani/pi-jev-skill-picker](https://github.com/safzanpirani/pi-jev-skill-picker) - Classez les compétences Pi Agent pour la tâche actuelle avec TypeSafe Jev.
...
- [jackie-cqz/dsh-jev-plugin](https://github.com/jackie-cqz/dsh-jev-plugin) - Plugin DeepSeek Harness pour TypeSafe Jev : décisions typées, garde-fous…
...
- [AIAnytime/jev-crash-course](https://github.com/AIAnytime/jev-crash-course) - Tous les projets pour apprendre Jev, un modèle qui prend des décisions au lieu…
...
<details>
<summary><b>Plus dans cette catégorie</b> <sub>· 90</sub></summary>
...
<sub>Généré par · `render.py` · 2026-09-27T01:21:54+08:00</sub>
