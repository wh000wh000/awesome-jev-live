...
> [!NOTE]
> **Index en direct** · Dernière synchronisation: `2026-09-22T16:07:34+08:00` (UTC+8)
> · Entrées: **741** · Nouvelles ce cycle: **86** · Langages d'implémentation: **25**
...
- [Clients, SDK et adaptateurs communautaires](#clients-sdk-et-adaptateurs-communautaires) — **119**
- [Outillage d'agents : MCP, hooks, portes de contrôle et agents de codage](#outillage-dagents--mcp-hooks-portes-de-contrôle-et-agents-de-codage) — **223**
...
- [Applications, jeux, robotique et démos interactives](#applications-jeux-robotique-et-démos-interactives) — **43**
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/chenycl--jev-browser-skill/6f1223bb1aa99b1b.gif" width="100%" alt="ChenYCL/jev-browser-skill animation"><br><sub>enregistrement animé · <a href="https://raw.githubusercontent.com/ChenYCL/jev-browser-skill/main/assets/demo-wikipedia.mp4">Ouvrir la vidéo</a></sub></td>
</tr></table>
...
Correcteur basé sur des règles, propulsé par Jev, pour fichiers texte. Exécute chaque règle sur chaque ligne en parallèle. Pas de survol, aucune ligne manquée.
...
Fork SemIf axé sur SDK, maintenu indépendamment, pour des décisions sémantiques rapides et auto-hébergées.
...
<details>
<summary><b>Plus dans cette catégorie</b> <sub>· 97</sub></summary>
...
- [BeatAPI/awesome-jev](https://github.com/BeatAPI/awesome-jev) - Une galerie de projets liés à JEV examinés à partir de leurs sources, avec plus…
...
- [AkashPriyadarshii/jev-seo](https://github.com/AkashPriyadarshii/jev-seo) - Suite SEO &amp; GEO 100 % gratuite à ₹0, axée d.
...
- [doronp/jevc](https://github.com/doronp/jevc) - Compiler la prose des politiques d.
...
<details>
<summary><b>Plus dans cette catégorie</b> <sub>· 201</sub></summary>
...
- [poiuyjie/jev_project_context](https://github.com/poiuyjie/jev_project_context) - Compétence de mémoire d&#x27;expériences à long terme, fondée d&#x27;abord sur les…
...
- [ziqi-jin/agent-to-trust](https://github.com/ziqi-jin/agent-to-trust) - Ne faites pas confiance à un Agent. Testez-le.
...
- [ronadin2002/jev-cua](https://github.com/ronadin2002/jev-cua) - Contrôle vocal et textuel pour macOS. Une barre flottante, une sélection en…
...
- [jon-devlapaz/tink-route](https://github.com/jon-devlapaz/tink-route) - Routage dynamique de compétences d.
...
- [cskwork/pi-jev-router](https://github.com/cskwork/pi-jev-router) - Routage automatique de modèles pour Pi utilisant Jev de TypeSafe via Vercel AI…
...
OmniJev — interface de décision multimodale à choix fini et atelier de travail incarné MuJoCo : relectures de trajectoires, sondes de décision, panneaux de référence et présentation de 60 s.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/shapsider--omnijev/fab2a3d9229ff025.gif" width="100%" alt="shapsider/OmniJev animation"><br><sub>enregistrement animé · <a href="https://raw.githubusercontent.com/shapsider/OmniJev/main/docs/media/omnijev-intro-60s.mp4">Ouvrir la vidéo</a></sub></td>
</tr></table>
...
- [nibzard/decision-model-benchmark](https://github.com/nibzard/decision-model-benchmark) - Référence indépendante et reproductible : un modèle de décision (jev), huit…
...
Environnement d’exécution natif MLX pour les modèles de décision typés de Laya — décisions courtes en 7–14 ms sur M3 Max. Aucune génération de texte, aucun PyTorch ni cloud API.
...
- [vtavakkoli/simple-jev](https://github.com/vtavakkoli/simple-jev) - Transformez n.
...
- [heyjunpenn/awesome-jev](https://github.com/heyjunpenn/awesome-jev) - Un catalogue vérifié et maintenu par la communauté de 640 projets open source…
...
Traduction chinoise de la documentation officielle d’utilisation du modèle Jev (TypeSafe AI) | Traduction chinoise non officielle de la documentation officielle de Jev (TypeSafe AI) — https://docs.typesafe.ai
...
Des bancs LLM conçus pour des tâches spécifiques, de type Jev, avec réflexion facultative sur les récompenses de trajectoires complètes et évolution GEPA.
...
TypeLLM : LLMs avec génération sûre du point de vue des types
...
<sub>Généré par · `render.py` · 2026-09-22T16:07:34+08:00</sub>
