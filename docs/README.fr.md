...
> [!NOTE]
> **Index en direct** · Dernière synchronisation: `2026-09-23T20:09:57+08:00` (UTC+8)
> · Entrées: **770** · Nouvelles ce cycle: **76** · Langages d'implémentation: **22**
...
<sub>Utilisez grep pour les questions que vous ne pouvez pas écrire sous forme de motif. Lit chaque fonction au lieu d’en échantillonner quelques-unes. Propulsé par Jev,…</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
- [Clients, SDK et adaptateurs communautaires](#clients-sdk-et-adaptateurs-communautaires) — **132**
- [Outillage d'agents : MCP, hooks, portes de contrôle et agents de codage](#outillage-dagents--mcp-hooks-portes-de-contrôle-et-agents-de-codage) — **231**
- [Routage, garde-fous et approbations](#routage-garde-fous-et-approbations) — **57**
- [Évaluation, calibration et benchmarks](#évaluation-calibration-et-benchmarks) — **76**
- [Reproductions ouvertes, poids et recherche sur l'architecture](#reproductions-ouvertes-poids-et-recherche-sur-larchitecture) — **44**
- [Applications, jeux, robotique et démos interactives](#applications-jeux-robotique-et-démos-interactives) — **47**
- [Articles, discussions et listes sœurs](#articles-discussions-et-listes-sœurs) — **97**
- [Autres projets](#autres-projets) — **80**
...
<sub>🔧 Utilisé dans du code: `src/typesafe_sdk/__init__.py`, `src/typesafe_sdk/_core/retry.py`, `src/typesafe_sdk/_core/config.py`</sub>
...
Un harness de programmation personnalisé pour TypeSafe AI de Jev : un LLM fait des propositions, Jev répond à des questions ciblées, le code décide et chaque étape laisse un reçu.
...
Une bibliothèque Elixir encapsulant le modèle unique du système Laya OSS de ConvAI Innovations
...
Utilisez grep pour les questions que vous ne pouvez pas écrire sous forme de motif. Lit chaque fonction au lieu d’en échantillonner quelques-unes. Propulsé par Jev, le modèle System One de TypeSafe AI.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/clouatre-labs--decisions-judge-mcp/c8c00f2b58774857.gif" width="100%" alt="clouatre-labs/decisions-judge-mcp animation"><br><sub>enregistrement animé</sub></td>
</tr></table>
...
Un seul CLI pour tous vos robots. Connectez-les, commandez-les et laissez-les travailler ensemble, chacun avec un LLM comme cerveau (Claude, OpenAI, Gemini, Grok ou en local via Ollama ou vLLM) et un LLM de décision pour des étapes moins coûteuses et plus rapides (Jev, Laya et Kev). Compatible avec Microduck, Open Duck Mini, LeRobot, XLeRobot, AlohaMini, ToddlerBot, Jetson ou n’importe quel ROS.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/rokbenko--quackd/2060eda6dcb35de6.gif" width="100%" alt="rokbenko/quackd animation"><br><sub>enregistrement animé</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/john-rocky--coreai-kit/c98c7bb8cb04e76e.gif" width="100%" alt="john-rocky/coreai-kit animation"><br><sub>enregistrement animé</sub></td>
</tr></table>
...
R.A.I.N. Lab est une architecture expérimentale d’agent scientifique qui sépare le jugement local rapide, l’évaluation probabiliste indépendante, la délibération multi-agents, les preuves et l’autorisation en couches computationnelles distinctes.🐙(Antérieur à AutoResearch de Karpathy)
...
jev-seo : Rust SEO et GEO CLI, ainsi que MCP serveur pour les agents de programmation : audits de 50 règles, explorations en direct, scores GEO, dérive du classement, contrôles CI. MIT, sans abonnement.
...
Journal de trading en lecture seule et banc d’examen : jugements typés Jev, intégration d’agents et benchmark financier reproductible. Pas d’ordres, pas de conseils.
...
<details>
<summary><b>Plus dans cette catégorie</b> <sub>· 110</sub></summary>
...
- [agent-chaperone/agent-chaperone](https://github.com/agent-chaperone/agent-chaperone) - Filtre les appels d.
...
- [9pings/notjev](https://github.com/9pings/notjev) - Serveur ultra-rapide de type Jev, indépendant du modèle, fonctionnant avec tout…
...
- [bladedevoff/stuntd](https://github.com/bladedevoff/stuntd) - Proxy local qui apprend les décisions LLM typées de votre application et y…
- [talmago/fast_gliner](https://github.com/talmago/fast_gliner) - Bindings Python vers le moteur d.
- [frostney/clean-code-review](https://github.com/frostney/clean-code-review) - Chaque fichier de code dans une pull request, évalué par rapport au Clean Code…
- [Qew7/jev-feels](https://github.com/Qew7/jev-feels) - Décisions sémantiques sous forme de Ruby ordinaires #feels?, #decide, #score…
- [himomohi/aside-jev](https://github.com/himomohi/aside-jev) - Les agents Aside prennent leurs décisions avec TypeSafe Jev.
- [lucasmartins-ai/lcc](https://github.com/lucasmartins-ai/lcc) - Local Context Compiler (lcc) : nettoie, déduplique et compacte le contexte du…
...
- [tontoko/jev-browser](https://github.com/tontoko/jev-browser) - Un cœur Jev/Playwright fondé sur un modèle unique : SDK typé, CLI persistant et…
...
- [KiritoKing/midscene-jev-runner](https://github.com/KiritoKing/midscene-jev-runner) - Intégration du runner JEV maintenue par la communauté pour Midscene Test.
...
- [vercel-labs/jev-ai-sdk-form-router](https://github.com/vercel-labs/jev-ai-sdk-form-router) - Acheminez les soumissions de formulaires vers les bonnes personnes avec Jev et…
...
- [kitfunso/hippo-memory](https://github.com/kitfunso/hippo-memory) - Mémoire inspirée de la biologie pour les agents d.
...
- [nylon-memory/NylonME](https://github.com/nylon-memory/NylonME) - Un moteur de mémoire pour agents IA. Travailler avec Jev peut apporter une plus…
...
Compétence d’agent pour trouver, construire, évaluer et améliorer des systèmes de modèles de décision. Calcul décisionnel compositionnel, bancs d’évaluation et optimisation itérative bornée de prompts/programmes pour Software 3.0. TypeSafe Jev est l’exemple hébergé par défaut. Indépendant de TypeSafe.
...
<td align="center" valign="top"><a href="https://youtu.be/ZC4oge4WsCQ"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/24601--augustus/d2593af47d538d33.jpg" width="100%" alt="video"></a><br><sub><a href="https://youtu.be/ZC4oge4WsCQ">Regarder sur youtu.be</a> · la lecture s'ouvre sur le site hôte ; GitHub ne peut pas l'intégrer directement</sub></td>
</tr></table>
...
<details>
<summary><b>Plus dans cette catégorie</b> <sub>· 209</sub></summary>

- [ChenneyZhuang/laya-browser-agent](https://github.com/ChenneyZhuang/laya-browser-agent) - Alternative Jev locale et open source : décisions d.
...
- [kydlikebtc/awesome-jev](https://github.com/kydlikebtc/awesome-jev) - 805 exemples vérifiés de Jev — le modèle de décision System One de TypeSafe AI…
- [Amal-David/awesome-jev](https://github.com/Amal-David/awesome-jev) - Jev démos, projets, SDKs et compétences, avec des liens vers le code source et…
...
- [socai-io/jev-social](https://github.com/socai-io/jev-social) - Jev × SocAI pour la recherche sur Instagram, TikTok et LinkedIn — routage typé…
...
- [PromptEngineer48/laya-vs-jev-arena](https://github.com/PromptEngineer48/laya-vs-jev-arena) - Laya (open source, local) contre TypeSafe Jev (API) : deux modèles d.
...
- [ThinkFlowLab/system1-agents](https://github.com/ThinkFlowLab/system1-agents) - Modèles de décision System 1 (Jev, Laya, Cua-S1) servant de cerveau aux agents…
...
- [jiawei686/jev-ultrafast-mcp](https://github.com/jiawei686/jev-ultrafast-mcp) - Déléguez le travail du navigateur : un serveur MCP où un modèle de décision…
...
- [rashedInt32/jev-mcp](https://github.com/rashedInt32/jev-mcp) - Serveur MCP exposant TypeSafe Jev sous forme d.
- [ZephyrDeng/ego-jev](https://github.com/ZephyrDeng/ego-jev) - Boucle interne Jev (TypeSafe System One) pour ego-browser — une décision saisie…
- [green-dalii/pi-shift-router](https://github.com/green-dalii/pi-shift-router) - Routage du modèle à chaque tour pour l.
...
- [jiangkoumo/ego-jev](https://github.com/jiangkoumo/ego-jev) - Pilotez le navigateur léger ego avec Jev (TypeSafe System One) : une table…
...
- [itsmostafa/typesafe-mcp](https://github.com/itsmostafa/typesafe-mcp) - Un connecteur mcp pour évaluer n.
...
<sub>🔧 Utilisé dans du code: `research/benchmarks/feishu_zh/run.py`</sub>
...
Jev, le modèle System One de TypeSafe, joue aux échecs contre n’importe quel LLM d’OpenRouter, Stockfish et vous. Application web d’une page avec coups en direct, probabilités de coup de Jev, parties sauvegardées et taux de victoire.
...
Un bot Clash Royale sans politique entraînée : Jev (TypeSafe System One) prend chaque décision à partir de l'état du jeu en direct.
...
Filtrez votre flux X.com avec Jev ou n’importe quel LLM
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/tshmieldev--sharp/016860f6bb08aa6b.gif" width="100%" alt="tshmieldev/sharp animation"><br><sub>enregistrement animé</sub></td>
</tr></table>
...
Une couche de vérification pour les évaluations d’IA. Vérifie l’instrument, pas seulement le score : les données, l’évaluateur, les exécutions, les chiffres, les affirmations et elle-même.
...
- [zeeshan8281/slo-router](https://github.com/zeeshan8281/slo-router) - Routeur d.
...
- [Trystan-SA/laya-candle](https://github.com/Trystan-SA/laya-candle) - Port Rust de type JEV utilisant Laya, 100 % local, sans Python.
...
Transformez n'importe quel LLM en modèle de décision de type Jev : décisions typées, probabilités réelles, aucun entraînement. (mise à jour continue)
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/nokia-applied-research--anyjev/93e61c3de618cc36.gif" width="100%" alt="nokia-applied-research/AnyJev animation"><br><sub>enregistrement animé</sub></td>
</tr></table>
...
Une pile ouverte d’entraînement et d’inférence pour les modèles de décision de type Jev. Entraînez des modèles à évaluer des branches candidates dynamiques à partir d’un préfixe partagé, avec prise en charge des choix à forte cardinalité, du calibrage et de l’inférence par lots rapide.
...
Apprentissage par renforcement tenant compte de l’étalonnage pour systèmes de décision adaptatifs
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/weitianxin--jevany/05825e369317a429.gif" width="100%" alt="weitianxin/JevAny animation"><br><sub>enregistrement animé</sub></td>
</tr></table>
...
Laissez Jev lire chaque nouveau papier arXiv chaque matin et faire remonter les rares que vous devriez lire. Centres d’intérêt en anglais courant, probabilités calibrées, ~$0.06/jour, forkez et lancez-vous.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/ankit-aglawe--tinyjev/bff87199840daa0f.gif" width="100%" alt="ankit-aglawe/tinyjev animation"><br><sub>enregistrement animé</sub></td>
</tr></table>
...
<details>
<summary><b>Plus dans cette catégorie</b> <sub>· 54</sub></summary>
...
- [ARCJ137442/jev-2048](https://github.com/ARCJ137442/jev-2048) - Un laboratoire web instrumenté de 2048 où chaque mouvement est un Jev.
...
- [fstandhartinger/jevbench](https://github.com/fstandhartinger/jevbench) - JevBench v1 - un benchmark pour des modèles de décision typés de classe Jev…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/fbddcz--embodied-jev/297ef7c24f9a67a8.gif" width="100%" alt="FBddcz/embodied-jev animation"><br><sub>enregistrement animé · <a href="https://raw.githubusercontent.com/FBddcz/embodied-jev/main/docs/media/libero-drawer-comparison.mp4">Ouvrir la vidéo</a></sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/bl888m/jev-bot/main/assets/demo.gif" width="100%" alt="bl888m/jev-bot animation"><br><sub>enregistrement animé</sub></td>
</tr></table>
...
La galerie la plus complète de ce que les utilisateurs construisent avec Jev, le modèle System One de TypeSafe : plus de 3 400 projets, démonstrations et articles classés par scénario, chacun avec son lien, son image et sa description d’origine.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/darthblanc/tictacjev/main/assets/screenrecording.gif" width="100%" alt="darthblanc/tictacjev animation"><br><sub>enregistrement animé</sub></td>
</tr></table>
...
<details>
<summary><b>Plus dans cette catégorie</b> <sub>· 25</sub></summary>
...
- [heyjunpenn/awesome-jev](https://github.com/heyjunpenn/awesome-jev) - Un catalogue vérifié, maintenu par la communauté, de 832 projets open-source…
...
- [jaibhasin/jev-yt-time-saver](https://github.com/jaibhasin/jev-yt-time-saver) - Une extension Chrome qui recouvre les vidéos YouTube distrayantes avec Jev.
...
<details>
<summary><b>Plus dans cette catégorie</b> <sub>· 85</sub></summary>
...
Assistant de réponse en accompagnement de 微信（Windows 4.x） : capture d’écran de la fenêtre + OCR local hors ligne lit les messages de l’interlocuteur → Jev détermine l’intention → 3 réponses candidates insérées en un clic, l’envoi reste toujours manuel
...
Fenêtre flottante de reconnaissance de l’intention des messages 微信（macOS） : analyse de l’écran + modèle local léger pour déterminer l’intention et le risque, puis générer des réponses candidates selon des formulations types. En lecture seule uniquement, sans injection dans 微信.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/jev-chat--jev-chat-jarvis-mac/daa9ab5c1715d764.gif" width="100%" alt="jev-chat/jev-chat-jarvis-mac animation"><br><sub>enregistrement animé</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/zefan-cai--open-jev/f6f2903828782e64.gif" width="100%" alt="Zefan-Cai/Open-Jev animation"><br><sub>enregistrement animé · <a href="https://zefan-cai.github.io/open-jev/v1-1/replay.mp4">Ouvrir la vidéo</a></sub></td>
</tr></table>
...
Une interface web et API auto-hébergée pour les modèles de décision structurés de Laya, compatible avec le format TypeSafe Jev API.
...
<details>
<summary><b>Plus dans cette catégorie</b> <sub>· 58</sub></summary>
...
<sub>Généré par · `render.py` · 2026-09-23T20:09:57+08:00</sub>
