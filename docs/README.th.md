...
> [!NOTE]
> **ดัชนีสด** · ซิงค์ล่าสุด: `2026-09-26T03:12:11+08:00` (UTC+8)
> · รายการ: **806** · ใหม่ในรอบนี้: **123** · ภาษาที่ใช้พัฒนา: **23**
...
- [ไคลเอนต์ SDK และอะแดปเตอร์จากชุมชน](#ไคลเอนต-sdk-และอะแดปเตอรจากชมชน) — **127**
- [เครื่องมือสำหรับเอเจนต์: MCP ฮุก เกต และเอเจนต์เขียนโค้ด](#เครองมอสำหรบเอเจนต-mcp-ฮก-เกต-และเอเจนตเขยนโคด) — **245**
- [การจัดเส้นทาง การ์ดเรล และการอนุมัติ](#การจดเสนทาง-การดเรล-และการอนมต) — **61**
- [การประเมิน การคาลิเบรต และเบนช์มาร์ก](#การประเมน-การคาลเบรต-และเบนชมารก) — **78**
- [งานจำลองแบบเปิด เวต และงานวิจัยสถาปัตยกรรม](#งานจำลองแบบเปด-เวต-และงานวจยสถาปตยกรรม) — **45**
...
ชุดเครื่องมือการตัดสินใจสำหรับ TypeSafe Jev — เกตความเชื่อมั่น โหมดเงา สูตร และการประเมิน Claude CLI 48.9 วินาที → Jev 1.3 วินาทีสำหรับงานกรองแถวเดียวกัน
...
CLI หนึ่งตัวสำหรับหุ่นยนต์ทั้งหมดของคุณ เชื่อมต่อ สั่งการ และปล่อยให้พวกมันทำงานร่วมกัน โดยแต่ละตัวมี LLM เป็นสมอง (Claude, OpenAI, Gemini, Grok หรือแบบโลคัลผ่าน Ollama หรือ vLLM) และมี LLM สำหรับการตัดสินใจแบบหลายตัวเลือก (Jev, Laya, Kev) ควบคุม Microduck, Open Duck Mini, LeRobot, XLeRobot, AlohaMini, ToddlerBot, หรือฐาน ROS 2 ใด ๆ จากแล็ปท็อปแบบออฟบอร์ด
...
ความครอบคลุม ความปลอดภัย และคุณภาพโค้ดสำหรับเอเจนต์เขียนโค้ด
...
<details>
<summary><b>เพิ่มเติมในหมวดนี้</b> <sub>· 109</sub></summary>
...
- [topherchris420/james_library](https://github.com/topherchris420/james_library) - R.A.I.N. Lab…
...
- [bladedevoff/stuntd](https://github.com/bladedevoff/stuntd) - พร็อกซีโลคัลที่เรียนรู้การตัดสินใจแบบพิมพ์ LLM…
- [myc0576/SmartMoney-Cub](https://github.com/myc0576/SmartMoney-Cub) - สมุดบันทึกการซื้อขายแบบอ่านอย่างเดียวและชุดเครื่องมือสำหรับทบทวน…
...
- [6Mikao9/jev-native-agent-with-extended-options](https://github.com/6Mikao9/jev-native-agent-with-extended-options) - การออกแบบงานวิจัยสำหรับระบบเอเจนต์แบบเนทีฟ Jev: เปิดใช้ตัวเลือกได้มากกว่าที่…
...
- [carldaws/hunch](https://github.com/carldaws/hunch) - โฟลว์การควบคุมเชิงความน่าจะเป็นสำหรับ Ruby และ Rails — ขับเคลื่อนด้วย Jev ของ…
...
- [ruban-24/switchboard](https://github.com/ruban-24/switchboard) - เราเตอร์การตัดสินใจแบบโอเพนซอร์สที่ไม่ขึ้นกับโมเดลสำหรับ Claude Code และ Codex.
...
- [MiaoWuNYA/rikkahub-sillytavern-android](https://github.com/MiaoWuNYA/rikkahub-sillytavern-android) - 安卓AI聊天端:无损导入酒馆卡，缓存强省用量，Jev 决策，多维记忆，QQbot，AI群聊，酒馆主题，插件系统，强兼容中转站.
...
- [safzanpirani/pi-jev-skill-picker](https://github.com/safzanpirani/pi-jev-skill-picker) - จัดอันดับทักษะของ Pi Agent สำหรับงานปัจจุบันด้วย TypeSafe Jev.
...
- [erkamyaman/jev-enforce](https://github.com/erkamyaman/jev-enforce) - ปลั๊กอิน 📏 Claude Code ที่ทำให้ Claude ปฏิบัติตาม AGENTS.md ของคุณ…
...
รันโมเดลการตัดสินใจแบบเปิดในเครื่อง: ดึงและให้บริการ Laya, decider, NLI และ GLiClass ผ่าน API ที่เข้ากันได้กับ TypeSafe Ollama สำหรับโมเดลการตัดสินใจ
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/ankit-aglawe--tinyjev/dc0d701a10c37f94.gif" width="100%" alt="ankit-aglawe/tinyjev animation"><br><sub>บันทึกแบบเคลื่อนไหว</sub></td>
</tr></table>
...
<details>
<summary><b>เพิ่มเติมในหมวดนี้</b> <sub>· 60</sub></summary>
...
- [anessbelbati/jev-rerank-bench](https://github.com/anessbelbati/jev-rerank-bench) - โมเดลการตัดสินใจสามารถเอาชนะ reranker โดยเฉพาะได้หรือไม่? TypeSafe Jev เทียบกับ…
...
jevos เป็นทางเลือกโอเพนซอร์สสำหรับ Jev เพื่อการตัดสินใจแบบใช่/ไม่ใช่ ซึ่งทำงานบนแล็ปท็อปของคุณ
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/feder-cr/jev/main/assets/dino_run.gif" width="100%" alt="feder-cr/jev animation"><br><sub>บันทึกแบบเคลื่อนไหว</sub></td>
</tr></table>
...
<details>
<summary>📰 <b><a href="https://typesafe.ai/team">TypeSafe เพิ่มหน้า Team + navigation เพิ่มทางเข้า `Enterprise` (สัญญาณ productization/commercialization)</a></b> · ✅ official · 7 天</summary>
...
- [Show HN: Doom or Bloom, map your AI worldview with Jev](https://news.ycombinator.com/item?id=49846953) - ทำแผนที่มุมมองโลกด้าน AI ของคุณด้วยการตอบคำถามไม่กี่ข้อ…
...
- [HITsz-TMG/JevEmbed](https://github.com/HITsz-TMG/JevEmbed) - พบกับ JevEmbed — เปลี่ยน embeddings ให้เป็นการตัดสินใจ เลือก ให้คะแนน…
- [doeixd/discern](https://github.com/doeixd/discern) - สร้างการจับคู่รูปแบบเชิงความหมายที่ปลอดภัยต่อชนิดข้อมูลและตระหนักถึงความไม่แน่นอ…
...
<sub>สร้างโดย · `render.py` · 2026-09-26T03:12:11+08:00</sub>
