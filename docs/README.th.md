...
> [!NOTE]
> **ดัชนีสด** · ซิงค์ล่าสุด: `2026-09-25T18:10:37+08:00` (UTC+8)
> · รายการ: **799** · ใหม่ในรอบนี้: **298** · ภาษาที่ใช้พัฒนา: **24**
...
<sub>Swift SDK สำหรับการรันโมเดลแชต วิชัน และเสียงบน iPhone และ Mac ด้วย Core AI ของ Apple การดาวน์โหลดและแคชโมเดล การผสานรวมกับ FoundationModels…</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
- [ไคลเอนต์ SDK และอะแดปเตอร์จากชุมชน](#ไคลเอนต-sdk-และอะแดปเตอรจากชมชน) — **129**
- [เครื่องมือสำหรับเอเจนต์: MCP ฮุก เกต และเอเจนต์เขียนโค้ด](#เครองมอสำหรบเอเจนต-mcp-ฮก-เกต-และเอเจนตเขยนโคด) — **249**
- [การจัดเส้นทาง การ์ดเรล และการอนุมัติ](#การจดเสนทาง-การดเรล-และการอนมต) — **58**
- [การประเมิน การคาลิเบรต และเบนช์มาร์ก](#การประเมน-การคาลเบรต-และเบนชมารก) — **81**
- [งานจำลองแบบเปิด เวต และงานวิจัยสถาปัตยกรรม](#งานจำลองแบบเปด-เวต-และงานวจยสถาปตยกรรม) — **38**
...
<sub>🔧 พบการใช้งานในโค้ด: `src/typesafe_sdk/__init__.py`</sub>
...
<sub>🔧 พบการใช้งานในโค้ด: `Sources/CoreAIOps/CoreAI+SystemOne.swift`</sub>
...
เฟรมเวิร์ก Agentic GraphRAG ที่ไม่ขึ้นกับฐานข้อมูล โดยใช้โมเดล System One ที่สลับเปลี่ยนได้ (Laya ในเครื่อง / Jev บนคลาวด์) ชั้นปัญญาแบบ plug-and-play ที่มีไปป์ไลน์ครบ 4 ระยะและการท่องกราฟ A* แบบกำหนดเองสำหรับฐานข้อมูลกราฟใด ๆ
...
สูตร Jev แบบ plug-and-play มากกว่า 200 รายการ: การตัดสินใจ AI ขนาดเล็กที่ปรับเทียบแล้วสำหรับ routing ให้เกรด ควบคุม เปรียบเทียบ และติดป้ายกำกับข้อความสำหรับเอเจนต์ RAG การสนับสนุน การตรวจทานโค้ด และดนตรี นำเข้าจาก JavaScript หรือ TypeScript หรือเรียกใช้ CLI ด้วย JSON จากภาษาใดก็ได้
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/agencyenterprise--jev-recipes/0f08086836b893d8.gif" width="100%" alt="agencyenterprise/jev-recipes animation"><br><sub>บันทึกแบบเคลื่อนไหว</sub></td>
</tr></table>
...
Java SDK ของชุมชนสำหรับ Jev โมเดล System One ของ TypeSafe: ป้อนคำถามแบบมีชนิด รับคำตอบแบบมีชนิดพร้อมความน่าจะเป็นที่ปรับเทียบแล้ว Java 17+, Spring Boot starter (ไม่เป็นทางการ)
...
CLI เดียวสำหรับหุ่นยนต์ทั้งหมดของคุณ เชื่อมต่อ สั่งการ และปล่อยให้พวกมันทำงานร่วมกัน โดยแต่ละตัวมี LLM เป็นสมอง (Claude, OpenAI, Gemini, Grok หรือแบบโลคัลผ่าน Ollama หรือ vLLM) และมีการตัดสินใจ LLM สำหรับตัวเลือกแบบหลายตัวเลือก (Jev, Laya, Kev) ควบคุม Microduck, Open Duck Mini, LeRobot, XLeRobot, AlohaMini, ToddlerBot, หรือฐาน ROS 2 ใด ๆ จากแล็ปท็อปแบบ offboard
...
CLI ที่เลือก Cursor, Claude Code, Codex หรือ OpenCode + โมเดล/ระดับความพยายามสำหรับงาน จากนั้นเปิดใช้งาน Powered by Jev and Herdr
...
<details>
<summary><b>เพิ่มเติมในหมวดนี้</b> <sub>· 111</sub></summary>
...
- [shaharia-lab/jev-cli](https://github.com/shaharia-lab/jev-cli) - เครื่องมือบรรทัดคำสั่งสำหรับโมเดล Jev ของ TypeSafe AI ถามคำถามใช่/ไม่ใช่…
...
- [chengyongru/fastjev](https://github.com/chengyongru/fastjev) - SemIf fork ที่ดูแลอย่างอิสระและให้ความสำคัญกับ SDK เป็นอันดับแรก…
...
- [evoke-build/evoke](https://github.com/evoke-build/evoke) - ซอฟต์แวร์ด้วยปฏิกิริยาตอบสนอง เพียงพูด แล้วโปรแกรมขนาดเล็กที่เหมาะสมจะทำงาน…
- [utk2103/jev-studio](https://github.com/utk2103/jev-studio) - หากคุณกำลังทดลองใช้ jev จากที่นี่จะง่ายขึ้น.
...
การทดลองเครื่องมือค้นหาบนคอลเลกชัน TREC ปัจจุบันมุ่งเน้นการใช้งาน zero-shot reranking ด้วยโมเดล JEV ของ typesafe.ai
...
ทางเลือก Jev แบบโอเพนซอร์สที่ทำงานภายในเครื่อง: การตัดสินใจของเอเจนต์เบราว์เซอร์ด้วย Laya (โมเดล System One) บนเครื่องของคุณเอง ไม่มีคลาวด์ ไม่มีคีย์ API รองรับ Playwright/CDP และเป็นมิตรกับ MCP
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/mansicer--jev-plays/c4f1ec41afcb4ae9.gif" width="100%" alt="mansicer/jev-plays animation"><br><sub>บันทึกแบบเคลื่อนไหว</sub></td>
</tr></table>
...
- [browser-use/jev-ultrafast](https://github.com/browser-use/jev-ultrafast) - เว็บเอเจนต์ที่เร็วและถูกที่สุด.
...
- [kydlikebtc/awesome-jev](https://github.com/kydlikebtc/awesome-jev) - ทรัพยากรสาธารณะ 1207 รายการสำหรับ Jev โมเดลการตัดสินใจ System One ของ TypeSafe…
...
- [supercorp-ai/supercov](https://github.com/supercorp-ai/supercov) - ความครอบคลุม ความปลอดภัย และคุณภาพโค้ดสำหรับเอเจนต์เขียนโค้ด.
...
- [angel291592/Intent-Router](https://github.com/angel291592/Intent-Router) - คอมไพเลอร์เจตนาสำหรับเอเจนต์ AI — เปลี่ยนคำขอคลุมเครือให้เป็นสัญญา IntentSpec…
- [socai-io/jev-social](https://github.com/socai-io/jev-social) - Agent Skill แบบโอเพนซอร์สและเดโมในเครื่อง: Jev × socai สำหรับการวิจัย…
...
- [khordoo/jev-reflex-autonomy-lab](https://github.com/khordoo/jev-reflex-autonomy-lab) - การจำลองความเป็นอิสระของฝูงโดรนแบบเรียลไทม์โดยใช้ Jev…
...
- [itsmostafa/typesafe-mcp](https://github.com/itsmostafa/typesafe-mcp) - ตัวเชื่อมต่อ mcp สำหรับประเมินทุกสิ่งอย่างรวดเร็วและประหยัด ให้เอเจนต์ AI…
...
เกตเวย์คัดแยกความเสี่ยงแบบเรียลไทม์สำหรับการฝากและถอนเงินจากตลาดแลกเปลี่ยน — Jev (TypeSafe System One) จัดการเฉพาะการคัดแยก ส่วนการตัดสินยังคงอยู่ในโค้ดแบบกำหนดแน่นอน
...
การควบคุมการรับคำตัดสินแบบมีชนิดที่ขอบทราฟฟิก: ตัวกรอง prompt injection และการใช้งานในทางที่ผิดสามชั้นสำหรับ nginx/OpenResty ขับเคลื่อนด้วย TypeSafe Jev แบบ fail-open แคชได้ และโหลดใหม่ขณะทำงานได้
...
วาดบนผืนผ้าใบ tldraw ด้วยเสียงและนิ้วชี้ Jev (TypeSafe System One) จะตัดสินใจเลือกการกระทำ เป้าหมาย และตำแหน่งในเวลาประมาณ 350 ms ต่อคำที่พูด
...
JevK5: ทางเลือกแบบ open-weight สำหรับ TypeSafe Jev การตัดสินใจแบบมีชนิดพร้อมความน่าจะเป็นในการ forward pass ครั้งเดียว น้ำหนักและโค้ด Apache-2.0
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/allebee--jevk5/1f9cd6cb325d4bd4.gif" width="100%" alt="allebee/jevk5 animation"><br><sub>บันทึกแบบเคลื่อนไหว · <a href="https://raw.githubusercontent.com/allebee/jevk5/main/docs/demo/jevk5-nvidia-demo.mp4">เปิดวิดีโอ</a></sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/weitianxin--jevany/711125367b6758ff.gif" width="100%" alt="weitianxin/JevAny animation"><br><sub>บันทึกแบบเคลื่อนไหว</sub></td>
</tr></table>
...
โมเดลขนาดเล็กคล้าย jev ที่ตอบคำถาม Choice, Score และ Noul ใน forward pass เดียว และส่งคืนความน่าจะเป็นที่ปรับเทียบแล้ว MLX หรือ PyTorch ออฟไลน์อย่างสมบูรณ์ เข้ากันได้กับ System One
...
- [Eliot5566/JEV-Paper-Radar](https://github.com/Eliot5566/JEV-Paper-Radar) - ให้ Jev อ่านเอกสาร arXiv…
...
- [wondertwins/jev-benchmark](https://github.com/wondertwins/jev-benchmark) - Benchmark และ playground สำหรับโมเดล Jev ของ TypeSafe (System One): หมากรุก…
...
- [fstandhartinger/jevbench](https://github.com/fstandhartinger/jevbench) - JevBench v1 - เบนช์มาร์กสำหรับโมเดลการตัดสินใจแบบมีชนิดระดับ Jev: ฉลาด ราคาถูก…
...
การตัดสินใจแบบมีชนิดจากสถานะไร้โครงสร้าง: forward pass ครั้งเดียว ไม่มีข้อความที่สร้างขึ้น ในเครื่อง กำหนดแน่นอน และเข้ากันได้กับ Jev ไม่เกี่ยวข้องกับ typesafe.ai
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/antonellof--laya-vs-dijkstra/b61bc3a8e3d368be.gif" width="100%" alt="antonellof/laya-vs-dijkstra animation"><br><sub>บันทึกแบบเคลื่อนไหว</sub></td>
</tr></table>
...
Semantic ifs จากโมเดลโอเพนซอร์ส บน 3090 ที่บ้าน เป็นอิสระ ไม่เกี่ยวข้องกับ Jev หรือ TypeSafe
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/theoleecj--semif-openjev/0504149cd9ef3cad.gif" width="100%" alt="TheoLeeCJ/SemIf-OpenJev animation"><br><sub>บันทึกแบบเคลื่อนไหว</sub></td>
</tr></table>
...
<details>
<summary><b>เพิ่มเติมในหมวดนี้</b> <sub>· 20</sub></summary>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/zadescoxp--jev-trades/2abea899d779de55.gif" width="100%" alt="zadescoxp/Jev-Trades animation"><br><sub>บันทึกแบบเคลื่อนไหว</sub></td>
</tr></table>
...
<details>
<summary>📰 <b><a href="https://typesafe.ai/team">TypeSafe เพิ่มหน้า Team + navigation เพิ่มทางเข้า `Enterprise` (สัญญาณ productization/commercialization)</a></b> · ✅ official · 6 天</summary>
...
<details>
<summary><b>เพิ่มเติมในหมวดนี้</b> <sub>· 89</sub></summary>
...
ตระกูลโมเดลการตัดสินใจที่คล้าย Jev ซึ่งสร้างบน Qwen3.5/3.8 และคุณสามารถฝึกและรันได้ด้วยตนเอง
...
ฝึกโมเดลมัลติโมดัลที่คล้าย Jev ด้วยตนเอง System One Model พร้อมความสามารถด้านการมองเห็นในตอนนี้
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/liuziyu77--valen/d4fa3bf5c399a28d.gif" width="100%" alt="Liuziyu77/Valen animation"><br><sub>บันทึกแบบเคลื่อนไหว</sub></td>
</tr></table>
...
System One Model ประสิทธิภาพสูงแบบโอเพนซอร์สสำหรับการตัดสินใจแบบมีชนิดในรอบเดียว พร้อมรันไทม์ C ที่ฝังรวมได้และรองรับ WebAssembly
...
ทางเลือกในเครื่องที่เข้ากันได้กับ API สำหรับโมเดล System One ของ Jev, TypeSafe
...
JevChat-Windows: ตัวช่วยเสนอคำตอบที่ติดอยู่ข้างหน้าต่างแชต ภาพหน้าต่าง + OCR แบบออฟไลน์ในเครื่องอ่านทำความเข้าใจข้อความของอีกฝ่าย → Jev ระบุเจตนา → กรอกคำตอบที่เป็นไปได้ 3 รายการด้วยคลิกเดียว การส่งทำด้วยตนเองเสมอ
...
ผู้ช่วยหน้าต่างลอยสำหรับแชต (macOS): รับรู้หน้าจอ + โมเดลขนาดเล็กในเครื่องเพื่อระบุเจตนาและความเสี่ยง จากนั้นสร้างคำตอบที่เป็นไปได้ตามสำนวน อ่านอย่างเดียวเท่านั้น
...
TypeLLM: LLMs พร้อมการสร้างผลลัพธ์ที่ปลอดภัยด้านชนิดข้อมูล
...
- [Kevthetech143/super-jev](https://github.com/Kevthetech143/super-jev) - ฮาร์เนสขนาดเล็กและขยายต่อได้สำหรับเปลี่ยนการตัดสินใจเป็นการกระทำของ TypeSafe Jev.
...
<sub>สร้างโดย · `render.py` · 2026-09-25T18:10:37+08:00</sub>
