...
> [!NOTE]
> **Índice ao vivo** · Última sincronização: `2026-09-23T12:34:14+08:00` (UTC+8)
> · Entradas: **770** · Novas neste ciclo: **69** · Linguagens de implementação: **24**
...
<sub>Jev, modelo System One de TypeSafe, joga xadrez contra qualquer LLM do OpenRouter, Stockfish e você. Aplicativo web de uma página com movimentos ao vivo,…</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
- [Ferramentas para agentes: MCP, hooks, gates e agentes de programação](#ferramentas-para-agentes-mcp-hooks-gates-e-agentes-de-programação) — **242**
- [Roteamento, guardrails e aprovações](#roteamento-guardrails-e-aprovações) — **56**
...
Um CLI externo para todos os seus robôs. Conecte-os, dê comandos a eles e deixe-os trabalhar juntos, cada um com um LLM como cérebro e um LLM de decisão para etapas mais baratas e rápidas. Microduck, Open Duck Mini, LeRobot, XLeRobot, AlohaMini, ToddlerBot ou qualquer base ROS. Claude, OpenAI, Gemini, Grok ou localmente via Ollama ou vLLM.
...
Suíte de SEO e GEO 100% gratuita ₹0, com foco em agentes, e servidor CLI em MCP, substituindo Semrush e OpenSEO por meio do DuckDuckGo e Rust TypeSafe Jev System One https://akashpriyadarshii.github.io/jev-seo/
...
se você está experimentando o jev, será mais fácil a partir daqui
...
<details>
<summary><b>Mais nesta categoria</b> <sub>· 115</sub></summary>
...
- [BeatAPI/awesome-jev](https://github.com/BeatAPI/awesome-jev) - Uma galeria com revisão de código-fonte de projetos relacionados a JEV com mais…
...
- [keltokhy/jsort](https://github.com/keltokhy/jsort) - ordene por significado: organize as linhas ao longo de uma dimensão em inglês…
- [tumf/jev-cli](https://github.com/tumf/jev-cli) - Pequeno CLI sem dependências para TypeSafe Jev.
- [evoke-build/evoke](https://github.com/evoke-build/evoke) - Software, por reflexo. Diga o que precisa, e o pequeno programa certo será…
- [oswarld/notion-skills](https://github.com/oswarld/notion-skills) - Skill bem-feita para usuários de língua coreana do Notion.
...
- [ruban-24/switchboard](https://github.com/ruban-24/switchboard) - Um roteador de decisões de código aberto e independente de modelo para Claude…
...
<details>
<summary><b>Mais nesta categoria</b> <sub>· 220</sub></summary>
...
- [compozy/yoshi](https://github.com/compozy/yoshi) - Proxy de poda de contexto para Claude Code e Codex: Jev julga qual histórico…
...
- [shitianfang/jev-use](https://github.com/shitianfang/jev-use) - Plugin do Claude Code / Codex / pi que encaminha etapas de agentes que não…
...
- [muratcakmak/jev-guard](https://github.com/muratcakmak/jev-guard) - Barreiras de proteção com pontuação de probabilidade para o Claude Code: negue…
...
- [weitianxin/JevAny](https://github.com/weitianxin/JevAny) - RL sensível à calibração para modelos de decisão, expandindo em direção a…
...
- [lucioamor/lovable-skills](https://github.com/lucioamor/lovable-skills) - Habilidades Lovable reutilizáveis para revisões de apps, decisões, escrita e…
...
Monitoramento de prompts auto-hospedado com modelos System One
...
Controle de admissão baseado em julgamentos tipados na borda do tráfego: filtro em três camadas contra injeção de prompt e abuso para nginx/OpenResty, alimentado por TypeSafe Jev. Fail-open, armazenado em cache e recarregável a quente.
...
- [raihankhan-rk/diffjury](https://github.com/raihankhan-rk/diffjury) - DiffJury — roteador de risco de PR + orientador de revisão de código para…
...
Modelos System One abertos: decisões tipadas com probabilidades calibradas, treináveis com seus próprios dados. Sem geração de texto.
...
- [fstandhartinger/jevbench](https://github.com/fstandhartinger/jevbench) - JevBench v1 — um benchmark para modelos de decisão tipados de classe Jev…
...
<details>
<summary><b>Mais nesta categoria</b> <sub>· 11</sub></summary>
...
<details>
<summary><b>Mais nesta categoria</b> <sub>· 30</sub></summary>
...
- [heyjunpenn/awesome-jev](https://github.com/heyjunpenn/awesome-jev) - Um catálogo verificado e mantido pela comunidade com 640 projetos de código…
...
<sub>Gerado por · `render.py` · 2026-09-23T12:34:14+08:00</sub>
