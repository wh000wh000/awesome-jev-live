...
> [!NOTE]
> **Índice ao vivo** · Última sincronização: `2026-09-22T11:05:08+08:00` (UTC+8)
> · Entradas: **737** · Novas neste ciclo: **54** · Linguagens de implementação: **25**
...
- [Ferramentas para agentes: MCP, hooks, gates e agentes de programação](#ferramentas-para-agentes-mcp-hooks-gates-e-agentes-de-programação) — **209**
- [Roteamento, guardrails e aprovações](#roteamento-guardrails-e-aprovações) — **71**
- [Avaliação, calibração e benchmarks](#avaliação-calibração-e-benchmarks) — **78**
- [Reproduções abertas, pesos e pesquisa de arquitetura](#reproduções-abertas-pesos-e-pesquisa-de-arquitetura) — **36**
- [Aplicações, jogos, robótica e demos interativas](#aplicações-jogos-robótica-e-demos-interativas) — **46**
- [Textos, discussões e listas irmãs](#textos-discussões-e-listas-irmãs) — **90**
...
Software, por reflexo. Uma frase se torna uma chamada de um pequeno programa, escolhido por Jev, o classificador da TypeSafe AI, e executado somente quando está confiante o suficiente. Reflexos são receitas que qualquer pessoa pode escrever, compartilhar e melhorar. Um CLI com o qual você conversa, um gerenciador de pacotes para reflexos do git e um TypeScript SDK.
...
- [lucasmartins-ai/lcc](https://github.com/lucasmartins-ai/lcc) - Compilador de Contexto Local (lcc): limpe, deduplicate e compacte o contexto do…
...
- [keltokhy/jlink](https://github.com/keltokhy/jlink) - Record linkage para economistas: escreva a regra de correspondência em inglês…
...
<details>
<summary><b>Mais nesta categoria</b> <sub>· 187</sub></summary>
...
- [savka777/jev-use](https://github.com/savka777/jev-use) - Diga, e seu Mac fará. Um harness de uso de computador em Jev que lê a tela por…
...
- [khordoo/jev-reflex-autonomy-lab](https://github.com/khordoo/jev-reflex-autonomy-lab) - Laboratório de autonomia multi-drone demonstrando decisões reflexas de TypeSafe…
...
- [libingzheren/Jev-Mem](https://github.com/libingzheren/Jev-Mem) - Jev-Mem: memória agêntica controlada por System-One.
...
- [alexgreensh/eval-genius](https://github.com/alexgreensh/eval-genius) - Ensine seu agente a trabalhar com avaliações: QUANDO você realmente precisa de…
- [nozomi-koborinai/jev-spec](https://github.com/nozomi-koborinai/jev-spec) - ⚡ Detecte a deriva da especificação em cada commit: verifique seu código em…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/hfnissum-byte/Hunkpick/main/demo/hunkpick.gif" width="100%" alt="hfnissum-byte/Hunkpick animation"><br><sub>gravação animada</sub></td>
</tr></table>
...
Transforme qualquer LLM em um modelo de decisão no estilo Jev: decisões tipadas, probabilidades reais, sem treinamento.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/nokia-applied-research--anyjev/4184f4406ec59fe6.gif" width="100%" alt="nokia-applied-research/AnyJev animation"><br><sub>gravação animada</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/rythmn1111--doom-war/c0cd335c6615f8e3.gif" width="100%" alt="rythmn1111/doom-war animation"><br><sub>gravação animada</sub></td>
</tr></table>
...
<details>
<summary><b>Mais nesta categoria</b> <sub>· 14</sub></summary>
...
- [mmastrac/djev](https://github.com/mmastrac/djev) - Decisões estruturadas no estilo Jev no DiffusionGemma: o servidor de exemplo do…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/iron-lyk--omnijev/341b127f269cdd62.gif" width="100%" alt="Iron-LYK/OmniJev animation"><br><sub>gravação animada · <a href="https://raw.githubusercontent.com/Iron-LYK/OmniJev/main/docs/media/omnijev-stack.mp4">Abrir vídeo</a></sub></td>
</tr></table>
...
<td align="center" valign="top"><a href="https://youtu.be/rLLO-umS140"><img src="https://img.youtube.com/vi/rLLO-umS140/hqdefault.jpg" width="100%" alt="video"></a><br><sub><a href="https://youtu.be/rLLO-umS140">Assistir em youtu.be</a> · a reprodução abre no site de origem; o GitHub não consegue incorporá-la na página</sub></td>
</tr></table>
...
Decodificação type-safe para LLMs autorregressivo
...
- [Argos1111/jev_local](https://github.com/Argos1111/jev_local) - Replicando Jev com um LLM local.
...
<sub>Gerado por · `render.py` · 2026-09-22T11:05:08+08:00</sub>
