...
> [!NOTE]
> **Índice ao vivo** · Última sincronização: `2026-09-23T17:45:55+08:00` (UTC+8)
> · Entradas: **778** · Novas neste ciclo: **111** · Linguagens de implementação: **23**
...
<sub>grep para perguntas que você não consegue escrever como um padrão. Lê todas as funções em vez de amostrar algumas. Desenvolvido com Jev, modelo System One de TypeSafe AI.</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
- [Clientes, SDKs e adaptadores da comunidade](#clientes-sdks-e-adaptadores-da-comunidade) — **130**
- [Ferramentas para agentes: MCP, hooks, gates e agentes de programação](#ferramentas-para-agentes-mcp-hooks-gates-e-agentes-de-programação) — **239**
- [Roteamento, guardrails e aprovações](#roteamento-guardrails-e-aprovações) — **55**
- [Avaliação, calibração e benchmarks](#avaliação-calibração-e-benchmarks) — **78**
- [Reproduções abertas, pesos e pesquisa de arquitetura](#reproduções-abertas-pesos-e-pesquisa-de-arquitetura) — **41**
...
- [Outros projetos](#outros-projetos) — **84**
...
<sub>🔧 Encontrado em uso no código: `src/typesafe_sdk/__init__.py`, `src/typesafe_sdk/_core/retry.py`, `src/typesafe_sdk/_core/config.py`</sub>
...
Um harness de programação personalizado para o Jev de TypeSafe AI: LLM propõe, Jev responde a perguntas específicas, o código decide e cada etapa deixa um comprovante.
...
Uma biblioteca Elixir que encapsula um modelo do sistema OSS Laya da ConvAI Innovations
...
grep para perguntas que você não consegue escrever como um padrão. Lê todas as funções em vez de amostrar algumas. Desenvolvido com Jev, modelo System One de TypeSafe AI.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/fajarhide--askgrep/fa6a7fa333d2d67f.gif" width="100%" alt="fajarhide/askgrep animation"><br><sub>gravação animada</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/clouatre-labs--decisions-judge-mcp/c8c00f2b58774857.gif" width="100%" alt="clouatre-labs/decisions-judge-mcp animation"><br><sub>gravação animada</sub></td>
</tr></table>
...
Um único offboard CLI para todos os seus robôs. Conecte-os, dê comandos a eles e deixe-os trabalhar juntos, cada um com um LLM como cérebro (Claude, OpenAI, Gemini, Grok ou localmente via Ollama ou vLLM) e uma LLM de decisão para etapas mais baratas e rápidas (Jev, Laya e Kev). Compatível com Microduck, Open Duck Mini, LeRobot, XLeRobot, AlohaMini, ToddlerBot, Jetson ou qualquer ROS.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/rokbenko--quackd/2060eda6dcb35de6.gif" width="100%" alt="rokbenko/quackd animation"><br><sub>gravação animada</sub></td>
</tr></table>
...
Swift SDK para executar modelos de chat, visão e fala em iPhone e Mac com o Core AI da Apple. Download e armazenamento em cache de modelos, integração com FoundationModels e exemplos executáveis com requisitos documentados de SO, SDK e modelo.
...
jev-seo: Rust de SEO e GEO CLI mais servidor MCP para agentes de programação: auditorias de 50 regras, rastreamentos ao vivo, pontuações de GEO, variação de posição e barreiras de CI. MIT, sem assinatura.
...
Diário de negociações somente para leitura e estrutura de revisão: julgamentos tipados de Jev, integração com agentes e um benchmark financeiro reproduzível. Sem ordens, sem aconselhamento.
...
Avaliador baseado em regras, impulsionado por Jev, para arquivos de texto. Executa todas as regras contra todas as linhas em paralelo. Sem leitura superficial, sem linhas perdidas.
...
Fork do SemIf com SDK em primeiro lugar, mantido de forma independente para decisões semânticas rápidas e auto-hospedadas.
...
<details>
<summary><b>Mais nesta categoria</b> <sub>· 108</sub></summary>
...
- [smkrv/jev-calibrate](https://github.com/smkrv/jev-calibrate) - Calibre perguntas Jev em relação aos seus próprios rótulos: ajuste critérios em…
- [dannote/jev](https://github.com/dannote/jev) - TypeSafe Jev para OTP: responda a Jev a partir de um GenServer e faça pattern…
- [9pings/notjev](https://github.com/9pings/notjev) - Servidor tipo Jev super-rápido, agnóstico ao modelo, funcionando com qualquer…
...
- [tumf/jev-cli](https://github.com/tumf/jev-cli) - Pequeno CLI sem dependências para TypeSafe Jev.
- [talmago/fast_gliner](https://github.com/talmago/fast_gliner) - Bindings de Python para o mecanismo de inferência de modelos GLiNER escritos em…
- [frostney/clean-code-review](https://github.com/frostney/clean-code-review) - Cada arquivo de código em um pull request, avaliado em relação ao Clean Code de…
- [Qew7/jev-feels](https://github.com/Qew7/jev-feels) - Decisões semânticas como Ruby comuns: #feels?, #decide, #score, validações do…
...
- [tontoko/jev-browser](https://github.com/tontoko/jev-browser) - Um núcleo fundamentado de Jev/Playwright: SDK tipado, CLI persistente e…
...
- [vercel-labs/jev-ai-sdk-form-router](https://github.com/vercel-labs/jev-ai-sdk-form-router) - Encaminhe envios de formulários para as pessoas certas com Jev e IA SDK.
...
- [mountainMath/JevR](https://github.com/mountainMath/JevR) - Cliente R para o TypeSafe Jev System One API.
- [shinpr/jev-reranker](https://github.com/shinpr/jev-reranker) - Reclassifique, filtre e compacte os resultados de busca de JSON com o Jev do…
...
- [kitfunso/hippo-memory](https://github.com/kitfunso/hippo-memory) - Memória biologicamente inspirada para agentes de IA.
...
- [zcoder-run/rust-sysone](https://github.com/zcoder-run/rust-sysone) - Cliente System One TypeSafe AI Rust (não oficial).
...
<sub>🔧 Encontrado em uso no código: `src/request.ts`</sub>
...
Awesome Jev: um guia de campo respaldado por fontes para o modelo System One de TypeSafe, com SDKs, demos ao vivo, ferramentas de agentes e avaliações independentes.
...
Habilidade de agente para encontrar, criar, avaliar e aprimorar sistemas de modelos de decisão. Cálculo decisório composicional, harnesses de avaliação e hill climbing limitado de prompts/programas para Software 3.0. TypeSafe Jev é o exemplar hospedado padrão. Independente de TypeSafe.
...
<td align="center" valign="top"><a href="https://youtu.be/ZC4oge4WsCQ"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/24601--augustus/d2593af47d538d33.jpg" width="100%" alt="video"></a><br><sub><a href="https://youtu.be/ZC4oge4WsCQ">Assistir em youtu.be</a> · a reprodução abre no site de origem; o GitHub não consegue incorporá-la na página</sub></td>
</tr></table>
...
⚡ Foq — a alternativa GRATUITA, local e open-source a Jev. Decisões tipadas de System 1 em ~25 ms — sem lista de espera, sem nuvem, sem custo por token. foq.fr
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/storm-software--mindctl/69298c40a77b7be5.gif" width="100%" alt="storm-software/mindctl animation"><br><sub>gravação animada</sub></td>
</tr></table>
...
Agente web mais rápido e barato
...
Copiloto de conversa no celular: entende a outra pessoa no WeChat / QQ / X / Feishu, sugere respostas candidatas e preenche a caixa de entrada com um toque; enviar ou não é com você. Não intrusivo, apenas lê a tela, sem hook e sem modificar pacotes.
...
<details>
<summary><b>Mais nesta categoria</b> <sub>· 217</sub></summary>

- [ChenneyZhuang/laya-browser-agent](https://github.com/ChenneyZhuang/laya-browser-agent) - Alternativa local e de código aberto ao Jev: decisões de agente de navegador…
...
- [Heman10x-NGU/openJev-verdict-2.0](https://github.com/Heman10x-NGU/openJev-verdict-2.0) - Mecanismo de decisão não autoregressivo calibrado de 151M, superando TypeSafe…
- [malevrigns/agent-jev](https://github.com/malevrigns/agent-jev) - AgentJev-0.6B — um modelo de decisão &#x27;System One&#x27; rápido para Agentes de IA…
...
- [BillionsBobby/JevRouter](https://github.com/BillionsBobby/JevRouter) - Um roteador leve desenvolvido com Jev para modelos, ferramentas e subagentes.
- [kydlikebtc/awesome-jev](https://github.com/kydlikebtc/awesome-jev) - 805 exemplos verificados de Jev — o modelo de decisão System One de TypeSafe AI…
- [Amal-David/awesome-jev](https://github.com/Amal-David/awesome-jev) - Demos, projetos, SDKs e habilidades de Jev, com links para o código-fonte e uma…
...
- [cookiespiggy/agentic-rl](https://github.com/cookiespiggy/agentic-rl) - Tutorial de Agentic RL em chinês para iniciantes absolutos (25 capítulos): de…
- [supercorp-ai/supercov](https://github.com/supercorp-ai/supercov) - Qualidade e cobertura de código para agentes de programação.
- [Alex314618-create/JevRev](https://github.com/Alex314618-create/JevRev) - Um fluxo de trabalho LLM + Jev. Turbine seu cérebro de vertebrado com uma…
...
- [socai-io/jev-social](https://github.com/socai-io/jev-social) - Pesquisa de Instagram, TikTok e LinkedIn com tecnologia Jev: roteamento tipado…
...
- [DanRWilloughby/snifftest](https://github.com/DanRWilloughby/snifftest) - Um linter de prosa que detecta indícios de texto gerado por IA.
...
- [PromptEngineer48/laya-vs-jev-arena](https://github.com/PromptEngineer48/laya-vs-jev-arena) - Laya (código aberto, local) contra TypeSafe Jev (API): dois modelos de IA…
...
- [ThinkFlowLab/system1-agents](https://github.com/ThinkFlowLab/system1-agents) - Modelos de decisão do Sistema 1 (Jev, Laya, Cua-S1) como cérebro para agentes…
...
- [jiawei686/jev-ultrafast-mcp](https://github.com/jiawei686/jev-ultrafast-mcp) - Delegue o trabalho do navegador: um servidor MCP em que um modelo de decisão…
...
- [Bodila51/muse-jev-playbook](https://github.com/Bodila51/muse-jev-playbook) - Camada de decisão Jev para Muse: uma barreira TypeSafe AI rápida e barata antes…
...
- [ZephyrDeng/ego-jev](https://github.com/ZephyrDeng/ego-jev) - Loop interno de Jev (TypeSafe System One) para ego-browser — uma decisão tipada…
- [green-dalii/pi-shift-router](https://github.com/green-dalii/pi-shift-router) - Roteamento de modelo por turno para o agente de codificação Pi: um pequeno juiz…
- [ismaelsoilet/jev-harness](https://github.com/ismaelsoilet/jev-harness) - Harness de decisões System One sem dependências: 5 barreiras semânticas que…
...
- [FazalAAli/jev-robotics-demo](https://github.com/FazalAAli/jev-robotics-demo) - Jev (TypeSafe System One) vs Claude Opus 5 controlando um braço robótico…
...
- [itsmostafa/typesafe-mcp](https://github.com/itsmostafa/typesafe-mcp) - Um conector mcp para avaliar qualquer coisa de forma rápida e barata.
...
- [FFatTiger/new-api-plugin-typesafe](https://github.com/FFatTiger/new-api-plugin-typesafe) - Plugin de tarefa TypeSafe AI System One (Jev) para QuantumNous/new-api…
...
Mecanismo de decisão não autorregressivo do Sistema 1. Escolhas tipadas, pontuações e decisões de sim/não sobre qualquer texto em uma única passagem direta, em mais de 100 idiomas, com um roteador que seleciona o checkpoint correto para cada solicitação.

<sub>🔧 Encontrado em uso no código: `research/benchmarks/feishu_zh/run.py`</sub>
...
Jev, modelo System One de TypeSafe, joga xadrez contra qualquer LLM do OpenRouter, Stockfish e você. Aplicativo web de uma página com movimentos ao vivo, probabilidades de movimento de Jev, partidas salvas e taxas de vitória.
...
Um bot de Clash Royale sem política treinada: Jev (TypeSafe System One) toma todas as decisões a partir do estado atual do jogo
...
Arneses de casos de uso de TypeSafe Jev (System One) em produção com lógica de decisão controlada por confiança
...
Transforme qualquer LLM em um modelo de decisão no estilo Jev: decisões tipadas, probabilidades reais, sem treinamento. (continua sendo atualizado)
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/nokia-applied-research--anyjev/93e61c3de618cc36.gif" width="100%" alt="nokia-applied-research/AnyJev animation"><br><sub>gravação animada</sub></td>
</tr></table>
...
Uma pilha aberta de treinamento e inferência para modelos de decisão no estilo Jev. Treine modelos para pontuar ramificações candidatas dinâmicas a partir de um prefixo compartilhado, com suporte para escolhas de alta cardinalidade, calibração e inferência em lote rápida.
...
Aprendizado por reforço consciente da calibração para sistemas de decisão adaptativos
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/weitianxin--jevany/05825e369317a429.gif" width="100%" alt="weitianxin/JevAny animation"><br><sub>gravação animada</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/ankit-aglawe--tinyjev/bff87199840daa0f.gif" width="100%" alt="ankit-aglawe/tinyjev animation"><br><sub>gravação animada</sub></td>
</tr></table>
...
<details>
<summary><b>Mais nesta categoria</b> <sub>· 56</sub></summary>
...
- [RenaGao/jev-dataops](https://github.com/RenaGao/jev-dataops) - Uma bancada de trabalho de código aberto baseada em JEV para seleção de dados…
...
- [ARCJ137442/jev-2048](https://github.com/ARCJ137442/jev-2048) - Um laboratório web instrumentado de 2048 em que cada jogada é um Jev.
...
- [rupeshpoojary9/awesome-open-system-one](https://github.com/rupeshpoojary9/awesome-open-system-one) - Lista curada do ecossistema aberto de System One: modelos abertos, benchmarks…
...
<table><tr><th align="center" width="50%">🖼 Imagem</th><th align="center" width="50%">🎬 Vídeo</th></tr><tr>
<td align="center" valign="top"><sub>nenhuma mídia publicada</sub></td>
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/wfzyx--von/7f8d6b27c0d2e176.gif" width="100%" alt="wfzyx/von animation"><br><sub>gravação animada</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/fbddcz--embodied-jev/297ef7c24f9a67a8.gif" width="100%" alt="FBddcz/embodied-jev animation"><br><sub>gravação animada · <a href="https://raw.githubusercontent.com/FBddcz/embodied-jev/main/docs/media/libero-drawer-comparison.mp4">Abrir vídeo</a></sub></td>
</tr></table>
...
<details>
<summary><b>Mais nesta categoria</b> <sub>· 19</sub></summary>
...
- [zhihz/openjev](https://github.com/zhihz/openjev) - Decisões de probabilidade bilíngues locais a partir de contexto, perguntas e…
...
A galeria mais completa do que as pessoas constroem com Jev, o modelo System One de TypeSafe: mais de 3.400 projetos, demonstrações e relatos organizados por cenário, cada um com seu link, imagem e descrição originais.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/darthblanc/tictacjev/main/assets/screenrecording.gif" width="100%" alt="darthblanc/tictacjev animation"><br><sub>gravação animada</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/michaelpersonal--jev-trade-cc/b3ae9a36cc9fcbbf.gif" width="100%" alt="michaelpersonal/jev-trade-cc animation"><br><sub>gravação animada</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/surbhit20/jev-plays-snake/main/jev-plays-snake.gif" width="100%" alt="surbhit20/jev-plays-snake animation"><br><sub>gravação animada</sub></td>
</tr></table>
...
- [heyjunpenn/awesome-jev](https://github.com/heyjunpenn/awesome-jev) - Um catálogo verificado e mantido pela comunidade com 832 projetos de código…
...
- [jaibhasin/jev-yt-time-saver](https://github.com/jaibhasin/jev-yt-time-saver) - Uma extensão de Chrome que cobre vídeos do YouTube que distraem com Jev.
...
- [Show HN: Will Jev pull the lever in the trolley problem?](https://news.ycombinator.com/item?id=49773756) - O benchmark Jev que todos estavam esperando: Jev puxará a alavanca no problema…
...
- [AiPersonacademy/Awesome-jev-use](https://github.com/AiPersonacademy/Awesome-jev-use) - Uma lista curada de aplicações, bibliotecas e recursos incríveis de Jev /…
...
Gerador de chaves do typesafe.ai, otimização extrema, jev ilimitado
...
Assistente de respostas acoplado ao 微信（Windows 4.x）：captura de janela + OCR offline local lê as mensagens da outra pessoa → Jev determina a intenção → 3 respostas candidatas preenchidas com um clique; o envio é sempre manual
...
Janela flutuante de reconhecimento de intenção de mensagens do 微信（macOS）：visualiza a tela + um pequeno modelo local determina a intenção e o risco, depois gera respostas candidatas com base em modelos de texto. Somente leitura, sem injeção no 微信.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/jev-chat--jev-chat-jarvis-mac/daa9ab5c1715d764.gif" width="100%" alt="jev-chat/jev-chat-jarvis-mac animation"><br><sub>gravação animada</sub></td>
</tr></table>
...
Harnesses específicos para tarefas, escritos por LLM, para Jev, com reflexão opcional sobre recompensas de trajetórias completas e evolução do GEPA.
...
Assistente de respostas do 微信 com DeepSeek + TypeSafe JEV: versão oficial Windows, versão de prévia para Apple Silicon macOS; OCR local e respostas controláveis por humanos
...
- [exfly/laya-jev-compatible-server](https://github.com/exfly/laya-jev-compatible-server) - Um servidor HTTP compatível com TypeSafe Jev (POST /v1/systemone).
...
- [jerryjliu/docjev](https://github.com/jerryjliu/docjev) - Um classificador/divisor de documentos muito rápido usando Jev.
...
<sub>Gerado por · `render.py` · 2026-09-23T17:45:55+08:00</sub>
