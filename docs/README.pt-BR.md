...
> [!NOTE]
> **Índice ao vivo** · Última sincronização: `2026-09-25T18:10:37+08:00` (UTC+8)
> · Entradas: **799** · Novas neste ciclo: **298** · Linguagens de implementação: **24**
...
<sub>Swift SDK para executar modelos de chat, visão e fala em iPhone e Mac com o Core AI da Apple. Download e armazenamento em cache de modelos, integração com…</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
- [Ferramentas para agentes: MCP, hooks, gates e agentes de programação](#ferramentas-para-agentes-mcp-hooks-gates-e-agentes-de-programação) — **249**
- [Roteamento, guardrails e aprovações](#roteamento-guardrails-e-aprovações) — **58**
- [Avaliação, calibração e benchmarks](#avaliação-calibração-e-benchmarks) — **81**
- [Reproduções abertas, pesos e pesquisa de arquitetura](#reproduções-abertas-pesos-e-pesquisa-de-arquitetura) — **38**
- [Aplicações, jogos, robótica e demos interativas](#aplicações-jogos-robótica-e-demos-interativas) — **54**
- [Textos, discussões e listas irmãs](#textos-discussões-e-listas-irmãs) — **102**
- [Outros projetos](#outros-projetos) — **82**
...
<sub>🔧 Encontrado em uso no código: `src/typesafe_sdk/__init__.py`</sub>
...
Um framework Agentic GraphRAG independente de banco de dados que usa modelos System One intercambiáveis (Laya local / Jev na nuvem). Uma camada de inteligência plug-and-play com um pipeline completo de 4 fases e travessia A* personalizada para qualquer banco de dados de grafos.
...
Mais de 200 receitas plug-and-play de Jev: pequenas decisões de IA calibradas que roteiam, avaliam, bloqueiam, comparam e rotulam textos para agentes, RAG, suporte, revisão de código e música. Importe de JavaScript ou TypeScript, ou chame o CLI com JSON de qualquer linguagem.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/agencyenterprise--jev-recipes/0f08086836b893d8.gif" width="100%" alt="agencyenterprise/jev-recipes animation"><br><sub>gravação animada</sub></td>
</tr></table>
...
Java SDK da comunidade para Jev, o modelo System One de TypeSafe: perguntas tipadas entram, respostas tipadas com probabilidades calibradas saem. Java 17+, starter do Spring Boot (não oficial)
...
Um único CLI para todos os seus robôs. Conecte-os, comande-os e deixe-os trabalhar juntos, cada um com um LLM como cérebro (Claude, OpenAI, Gemini, Grok ou local via Ollama ou vLLM) e um LLM de decisão para múltipla escolha (Jev, Laya, Kev). Controla Microduck, Open Duck Mini, LeRobot, XLeRobot, AlohaMini, ToddlerBot, ou qualquer base ROS 2, a partir de um laptop, externamente.
...
- [shaharia-lab/jev-cli](https://github.com/shaharia-lab/jev-cli) - Ferramenta de linha de comando para o modelo Jev de TypeSafe AI.
...
- [keltokhy/jsort](https://github.com/keltokhy/jsort) - ordene por significado: organize linhas ao longo de uma dimensão em inglês…
- [chengyongru/fastjev](https://github.com/chengyongru/fastjev) - Fork do SemIf mantido de forma independente, priorizando SDK, para decisões…
...
- [utk2103/jev-studio](https://github.com/utk2103/jev-studio) - se você está experimentando o jev, será mais fácil a partir daqui.
...
Experimentação com mecanismos de busca nas coleções TREC. Atualmente focado em implementações de reranking zero-shot com o modelo JEV da typesafe.ai
...
Alternativa local e de código aberto ao Jev: decisões de agente de navegador com Laya (modelo System One) na sua própria máquina. Sem nuvem, sem chave API. Compatível com Playwright/CDP e MCP.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/mansicer--jev-plays/c4f1ec41afcb4ae9.gif" width="100%" alt="mansicer/jev-plays animation"><br><sub>gravação animada</sub></td>
</tr></table>
...
<details>
<summary><b>Mais nesta categoria</b> <sub>· 231</sub></summary>
...
- [browser-use/jev-ultrafast](https://github.com/browser-use/jev-ultrafast) - Agente web mais rápido e barato.
...
- [angel291592/Intent-Router](https://github.com/angel291592/Intent-Router) - Compilador de intenções para agentes de IA — transforma solicitações vagas em…
- [socai-io/jev-social](https://github.com/socai-io/jev-social) - Skill de agente de código aberto e demonstração local: Jev × socai para…
...
- [OmniJev/PlayJev](https://github.com/OmniJev/PlayJev) - 🚀🚀 Um modelo multimodal de 0.8B semelhante ao JEV, jogando jogos de GUI…
...
- [khordoo/jev-reflex-autonomy-lab](https://github.com/khordoo/jev-reflex-autonomy-lab) - Simulação de autonomia de enxame de drones em tempo real usando Jev para…
...
- [bgivenb/flick-computer-use](https://github.com/bgivenb/flick-computer-use) - Navegador rápido e uso de computador macOS para agentes MCP.
...
- [24601/Augustus](https://github.com/24601/Augustus) - Habilidade de agente para encontrar, criar, avaliar e aprimorar sistemas de…
...
- [AskTheWay/dsh-jev-interceptor](https://github.com/AskTheWay/dsh-jev-interceptor) - ⚡ Julgamento do Sistema 1 em milissegundos para cada chamada de ferramenta no…
...
Gateway de triagem de risco em tempo real para depósitos e saques em exchanges — Jev (TypeSafe System One) cuida apenas da triagem; a adjudicação permanece em código determinístico.
...
Controle de admissão de julgamentos tipados na borda do tráfego: filtro de três camadas contra injeção de prompt e abuso para nginx/OpenResty, desenvolvido com TypeSafe Jev. Fail-open, com cache e recarregamento a quente.
...
Desenhe em uma tela do tldraw com sua voz e um dedo indicador. Jev (TypeSafe System One) decide a ação, o alvo e o local em ~350 ms por palavra falada.
...
- [Trystan-SA/laya-candle](https://github.com/Trystan-SA/laya-candle) - Port JEV-like de Rust usando Laya, 100% local, sem Python.
...
JevK5: alternativa de pesos abertos a TypeSafe Jev. Decisões tipadas com probabilidades em uma única passagem direta; pesos e código Apache-2.0.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/weitianxin--jevany/711125367b6758ff.gif" width="100%" alt="weitianxin/JevAny animation"><br><sub>gravação animada</sub></td>
</tr></table>
...
- [Eliot5566/JEV-Paper-Radar](https://github.com/Eliot5566/JEV-Paper-Radar) - Deixe Jev ler todos os novos artigos do arXiv a cada manhã e destacar os poucos…
...
Decisões tipadas a partir de estado não estruturado: uma única passagem direta, zero texto gerado. Local, determinístico e compatível com Jev. Não afiliado à typesafe.ai.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/antonellof--laya-vs-dijkstra/b61bc3a8e3d368be.gif" width="100%" alt="antonellof/laya-vs-dijkstra animation"><br><sub>gravação animada</sub></td>
</tr></table>
...
Semântica de ifs a partir de modelos abertos, em uma 3090 em casa. Independente; não afiliado a Jev nem a TypeSafe.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/theoleecj--semif-openjev/0504149cd9ef3cad.gif" width="100%" alt="TheoLeeCJ/SemIf-OpenJev animation"><br><sub>gravação animada</sub></td>
</tr></table>
...
<details>
<summary><b>Mais nesta categoria</b> <sub>· 20</sub></summary>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/zadescoxp--jev-trades/2abea899d779de55.gif" width="100%" alt="zadescoxp/Jev-Trades animation"><br><sub>gravação animada</sub></td>
</tr></table>
...
- [heyjunpenn/awesome-jev](https://github.com/heyjunpenn/awesome-jev) - Um catálogo verificado e mantido pela comunidade com 916 projetos de código…
...
Família de modelos de decisão semelhante a Jev, desenvolvida sobre Qwen3.5/3.8, que você pode treinar e executar por conta própria
...
Treine por conta própria um modelo multimodal semelhante a Jev. System One Model, agora com visão.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/liuziyu77--valen/d4fa3bf5c399a28d.gif" width="100%" alt="Liuziyu77/Valen animation"><br><sub>gravação animada</sub></td>
</tr></table>
...
Um System One Model open-source de alto desempenho para decisões tipadas em uma única passada, com runtime C incorporável e suporte a WebAssembly.
...
Uma substituição local e compatível com API para Jev, o modelo System One de TypeSafe
...
Assistente de janela flutuante para conversas (macOS): percepção da tela + modelo pequeno local para determinar intenção e risco, gerando respostas candidatas com base em roteiros. Somente leitura.
...
TypeLLM: LLMs com geração type-safe
...
- [alvarobartt/sys1](https://github.com/alvarobartt/sys1) - API compatível com System One para modelos de decisão abertos, escrito em Rust.
...
<sub>Gerado por · `render.py` · 2026-09-25T18:10:37+08:00</sub>
