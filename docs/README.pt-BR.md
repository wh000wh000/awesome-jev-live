...
> [!NOTE]
> **Índice ao vivo** · Última sincronização: `2026-09-23T15:10:28+08:00` (UTC+8)
> · Entradas: **704** · Novas neste ciclo: **47** · Linguagens de implementação: **22**
...
- [Ferramentas para agentes: MCP, hooks, gates e agentes de programação](#ferramentas-para-agentes-mcp-hooks-gates-e-agentes-de-programação) — **224**
- [Roteamento, guardrails e aprovações](#roteamento-guardrails-e-aprovações) — **54**
- [Avaliação, calibração e benchmarks](#avaliação-calibração-e-benchmarks) — **70**
- [Reproduções abertas, pesos e pesquisa de arquitetura](#reproduções-abertas-pesos-e-pesquisa-de-arquitetura) — **31**
- [Aplicações, jogos, robótica e demos interativas](#aplicações-jogos-robótica-e-demos-interativas) — **41**
- [Textos, discussões e listas irmãs](#textos-discussões-e-listas-irmãs) — **92**
- [Outros projetos](#outros-projetos) — **68**
...
<details>
<summary><b>Mais nesta categoria</b> <sub>· 95</sub></summary>
...
- [d-date/swift-jev](https://github.com/d-date/swift-jev) - Um cliente Swift para o Jev de TypeSafe AI — julgamentos tipados, não texto.
...
<details>
<summary><b>Mais nesta categoria</b> <sub>· 202</sub></summary>
...
Roteamento automático de modelos para Pi usando Jev de TypeSafe por meio do Vercel AI Gateway
...
- [heyjunpenn/awesome-jev](https://github.com/heyjunpenn/awesome-jev) - Um catálogo verificado e mantido pela comunidade de 657 projetos de código…
...
TypeLLM: LLMs com geração com segurança de tipos
...
- [Nisaka520/JevBystander](https://github.com/Nisaka520/JevBystander) - Interpretação do WeChat na versão de acessibilidade do Android: apenas lê a…
...
<sub>Gerado por · `render.py` · 2026-09-23T15:10:28+08:00</sub>
