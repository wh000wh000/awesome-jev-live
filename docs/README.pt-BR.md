...
> [!NOTE]
> **Índice ao vivo** · Última sincronização: `2026-09-23T07:10:14+08:00` (UTC+8)
> · Entradas: **756** · Novas neste ciclo: **71** · Linguagens de implementação: **25**
...
<sub>Um CLI externo para todos os seus robôs. Conecte-os, dê comandos a eles e deixe-os trabalhar juntos, cada um com um LLM como cérebro e um LLM de decisão para etapas…</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
- [Roteamento, guardrails e aprovações](#roteamento-guardrails-e-aprovações) — **57**
...
- [Aplicações, jogos, robótica e demos interativas](#aplicações-jogos-robótica-e-demos-interativas) — **39**
- [Textos, discussões e listas irmãs](#textos-discussões-e-listas-irmãs) — **97**
- [Outros projetos](#outros-projetos) — **81**
...
<sub>🔧 Encontrado em uso no código: `docs/adr/0043-decision-llms-are-a-wire-format-and-a-data-row.md`</sub>
...
R.A.I.N. Lab é uma arquitetura experimental de agente científico que separa julgamento local rápido, avaliação probabilística independente, deliberação multiagente, evidências e autorização em camadas computacionais distintas.🐙(Anterior ao AutoResearch de Karpathy)
...
- [keltokhy/jlink](https://github.com/keltokhy/jlink) - Vinculação de registros para economistas: escreva a regra de correspondência em…
...
<details>
<summary><b>Mais nesta categoria</b> <sub>· 218</sub></summary>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/hfnissum-byte--hunkpick/21c4c5bad7854d6e.gif" width="100%" alt="hfnissum-byte/Hunkpick animation"><br><sub>gravação animada</sub></td>
</tr></table>
...
- [backmeupplz/jev_antispam_bot](https://github.com/backmeupplz/jev_antispam_bot) - Bot anti-spam mínimo para Telegram com grammY, desenvolvido com TypeSafe Jev.
...
- [phyous/tsai-sc](https://github.com/phyous/tsai-sc) - TypeSafe Jev controla o shareware original de StarCraft por meio de teclado e…
...
<sub>Gerado por · `render.py` · 2026-09-23T07:10:14+08:00</sub>
