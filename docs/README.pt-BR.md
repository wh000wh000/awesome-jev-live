...
> [!NOTE]
> **Índice ao vivo** · Última sincronização: `2026-09-20T16:38:49+08:00` (UTC+8)
> · Entradas: **641** · Novas neste ciclo: **44** · Linguagens de implementação: **24**
...
- [Clientes, SDKs e adaptadores da comunidade](#clientes-sdks-e-adaptadores-da-comunidade) — **102**
- [Ferramentas para agentes: MCP, hooks, gates e agentes de programação](#ferramentas-para-agentes-mcp-hooks-gates-e-agentes-de-programação) — **180**
- [Roteamento, guardrails e aprovações](#roteamento-guardrails-e-aprovações) — **67**
- [Avaliação, calibração e benchmarks](#avaliação-calibração-e-benchmarks) — **62**
...
- [Textos, discussões e listas irmãs](#textos-discussões-e-listas-irmãs) — **83**
- [Outros projetos](#outros-projetos) — **56**
...
Uma caixa de ferramentas de decisão Jev para agentes e pessoas: 56 receitas, um CLI do OpenRouter e avaliações pareadas transparentes.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/clueless-creations--jev-ios-ultrafast/24bc4b379cd7fe3a.gif" width="100%" alt="Clueless-Creations/jev-ios-ultrafast animation"><br><sub>gravação animada</sub></td>
</tr></table>
...
<details>
<summary><b>Mais nesta categoria</b> <sub>· 73</sub></summary>
...
Mecanismo de decisão Jev DSH｜plugin de decisão estruturada para Agent Harness. Suporte nativo ao DeepSeek Harness, com suporte a OpenCode e Codex Harness por meio do iPolloWork.
...
<details>
<summary><b>Mais nesta categoria</b> <sub>· 146</sub></summary>
...
- [win4r/jev-security-scan](https://github.com/win4r/jev-security-scan) - 使用 TypeSafe Jev 审查 Skill 与 MCP 可疑行为 | Revise Agent Skills e código MCP com Jev.
...
- [buluoray/JevOnly](https://github.com/buluoray/JevOnly) - Jev puro que consegue &quot;digitar&quot; e conduzir rumo à conclusão de tarefas.
...
- [omkarghugarkar007/actiongate-jev](https://github.com/omkarghugarkar007/actiongate-jev) - Autorização de execução e proteções para chamadas de ferramentas de agentes de.
...
- [maxkilla/hermes-jev-skills](https://github.com/maxkilla/hermes-jev-skills) - Roteamento de modelos baseado em Jev, memória, compactação, seleção de.
...
- [sebastianbugal/jev](https://github.com/sebastianbugal/jev) - Modelo de decisão Jev de TypeSafe no Claude Code. Pergunte em linguagem simples.
...
Decisões tipadas em uma única passagem com probabilidades calibradas (modelo no estilo System One), ajustado a partir do Qwen3.5-2B
...
Decisões restritas paralelas no estilo Jev para qualquer modelo MLX no Apple Silicon. JSON tipados e válidos segundo o esquema em uma única passagem direta.

> 💡 Decisões restritas paralelas no Apple Silicon via MLX. A execução local elimina completamente o argumento do custo por chamada.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/nikotaronosuke--jev-voice-decision/05659dbeb359ceca.gif" width="100%" alt="nikotaronosuke/jev-voice-decision animation"><br><sub>gravação animada</sub></td>
</tr></table>
...
Decisões de IA locais e tipadas para C, C++, C#, Python, Unity e Unreal Engine.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/rmwahid/jev-cordhub/main/docs/demo.gif" width="100%" alt="rmwahid/jev-cordhub animation"><br><sub>gravação animada</sub></td>
</tr></table>
...
- [Frank-ZY-Dou/awesome-jev](https://github.com/Frank-ZY-Dou/awesome-jev) - Exemplos públicos de Jev usados para controle de robôs, modelagem 3D e tarefas.
...
<details>
<summary><b>Mais nesta categoria</b> <sub>· 71</sub></summary>
...
<sub>Gerado por · `render.py` · 2026-09-20T16:38:49+08:00</sub>
