...
> [!NOTE]
> **Índice ao vivo** · Última sincronização: `2026-09-23T02:38:53+08:00` (UTC+8)
> · Entradas: **752** · Novas neste ciclo: **98** · Linguagens de implementação: **26**
...
- [Aplicações, jogos, robótica e demos interativas](#aplicações-jogos-robótica-e-demos-interativas) — **43**
...
- [romanmeclazcke/codex-sift](https://github.com/romanmeclazcke/codex-sift) - Encaminhe cada rodada de Codex para o modelo mais barato capaz de lidar com…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/hangzhi--diffusion-jev-sglang/eca1e5819e042fa5.gif" width="100%" alt="Hangzhi/diffusion-jev-sglang animation"><br><sub>gravação animada</sub></td>
</tr></table>
...
Um modelo de decisão consegue superar rerankers dedicados? TypeSafe Jev vs Cohere Rerank 4 vs ZeroEntropy zerank-2 vs um baseline de modelo de chat: 14 conjuntos de dados, cada resposta bruta API, intervalos bootstrap para cada diferença.
...
<sub>Gerado por · `render.py` · 2026-09-23T02:38:53+08:00</sub>
