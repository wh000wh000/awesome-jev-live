...
> [!NOTE]
> **Живой индекс** · Последняя синхронизация: `2026-09-23T00:10:10+08:00` (UTC+8)
> · Записей: **741** · Новых за цикл: **108** · Языки реализации: **27**
...
- [Клиенты, SDK и адаптеры сообщества](#клиенты-sdk-и-адаптеры-сообщества) — **111**
...
- [Оценка, калибровка и бенчмарки](#оценка-калибровка-и-бенчмарки) — **68**
...
- [Прочие проекты](#прочие-проекты) — **83**
...
- [jonesmelton/verdict](https://github.com/jonesmelton/verdict) - ocaml sdk for typesafe.ai.
...
<details>
<summary>🤖 <b><a href="https://github.com/GhalebDweikat/winnow">GhalebDweikat/winnow</a></b> · ⭐65 · Python · 👁️ observed · 3 天</summary>
...
Навык агента для размещения и оценки моделей принятия решений в программном обеспечении, бизнесе, организациях и повседневных решениях. Классические методы принятия решений, калибровка, маршрутизация и явная политика. TypeSafe Jev — используемый по умолчанию размещённый пример. Независим от TypeSafe.
...
- [Prophetlab/JevPokerBench](https://github.com/Prophetlab/JevPokerBench) - Бенчмарк и площадка ProphetLab для моделей принятия решений в Texas Hold.
...
- [Filipe-Araujo0/tell-me-jev](https://github.com/Filipe-Araujo0/tell-me-jev) - 🧭 Turn noisy tool output into compact, typed next-step JSON for AI coding…
...
- [romanmeclazcke/codex-sift](https://github.com/romanmeclazcke/codex-sift) - Направляйте каждый ход Codex к самой дешёвой модели, способной с ним…
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/fazlerocks--jev-adblock/ba4996f061b8067f.gif" width="100%" alt="fazlerocks/jev-adblock animation"><br><sub>анимированная запись</sub></td>
</tr></table>
...
Solo Tetris where TypeSafe's Jev decision model picks every move live through the Vercel AI Gateway.
...
<table><tr><th align="center" width="50%">🖼 Изображение</th><th align="center" width="50%">🎬 Видео</th></tr><tr>
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/GitNimay/jev-plays-tetris/main/assets/screenshot.png" width="100%" alt="GitNimay/jev-plays-tetris screenshot"></td>
<td align="center" valign="top"><sub>медиа не опубликованы</sub></td>
</tr></table>
...
OmniJev — мультимодальный интерфейс принятия решений с конечным числом вариантов и рабочая среда воплощённого взаимодействия MuJoCo: повторы траекторий, зонды решений, панели бенчмарков, обзор за 60 секунд.
...
Исследование того, как Jev может ускорить задачи, зависящие от принятия решений LLM.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/tongyun1--jev-in-the-loop/06851a691352df8c.gif" width="100%" alt="Tongyun1/Jev-in-the-Loop animation"><br><sub>анимированная запись</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/davertor--jev-slop-guard/5328ae6b3c49cbf6.gif" width="100%" alt="davertor/jev-slop-guard animation"><br><sub>анимированная запись</sub></td>
</tr></table>
...
Создавайте типобезопасное семантическое сопоставление шаблонов с учётом неопределённости, управление потоком и интеллектуальные процедуры для Effect DecisionModel и Jev
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/doeixd--discern/6e14f29d003c7459.gif" width="100%" alt="doeixd/discern animation"><br><sub>анимированная запись</sub></td>
</tr></table>
...
Сможет ли модель принятия решений превзойти специализированные модели переранжирования? TypeSafe Jev против Cohere Rerank 4, ZeroEntropy zerank-2 и базового варианта с чат-моделью: 14 наборов данных, каждый необработанный ответ API, диапазоны бутстрэп-оценок для каждого разрыва.
...
<table><tr><th align="center" width="50%">🖼 Изображение</th><th align="center" width="50%">🎬 Видео</th></tr><tr>
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/anessbelbati--jev-rerank-bench/bea91749f99de5ac.png" width="100%" alt="anessbelbati/jev-rerank-bench screenshot"></td>
<td align="center" valign="top"><sub>медиа не опубликованы</sub></td>
</tr></table>
...
- [sabeel111/OpenSourceJev](https://github.com/sabeel111/OpenSourceJev) - Превращение модели LLM в систему, подобную Jev.
...
- [kerryrm/systemANE](https://github.com/kerryrm/systemANE) - Использование Neural Engine от Apple в качестве быстрого и бесплатного…
...
<sub>Сгенерировано с помощью · `render.py` · 2026-09-23T00:10:10+08:00</sub>
