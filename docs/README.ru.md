...
> [!NOTE]
> **Живой индекс** · Последняя синхронизация: `2026-09-26T03:12:11+08:00` (UTC+8)
> · Записей: **806** · Новых за цикл: **123** · Языки реализации: **23**
...
- [Клиенты, SDK и адаптеры сообщества](#клиенты-sdk-и-адаптеры-сообщества) — **127**
- [Инструменты для агентов: MCP, хуки, гейты и агенты для написания кода](#инструменты-для-агентов-mcp-хуки-гейты-и-агенты-для-написания-кода) — **245**
- [Маршрутизация, защитные правила и согласования](#маршрутизация-защитные-правила-и-согласования) — **61**
- [Оценка, калибровка и бенчмарки](#оценка-калибровка-и-бенчмарки) — **78**
- [Открытые воспроизведения, веса и исследования архитектуры](#открытые-воспроизведения-веса-и-исследования-архитектуры) — **45**
- [Приложения, игры, робототехника и интерактивные демо](#приложения-игры-робототехника-и-интерактивные-демо) — **53**
- [Тексты, обсуждения и смежные списки](#тексты-обсуждения-и-смежные-списки) — **104**
...
Не зависящий от базы данных фреймворк Agentic GraphRAG с возможностью замены моделей System One (локальная Laya / облачная Jev). Подключаемый интеллектуальный слой с полным 4-фазным конвейером, непрерывной оценкой и пользовательским обходом A* для любой графовой базы данных.
...
Один CLI для всех ваших роботов. Подключайте их, управляйте ими и позволяйте им работать вместе: у каждого будет LLM в качестве мозга (Claude, OpenAI, Gemini, Grok или локальная модель через Ollama или vLLM) и LLM принятия решений для выбора из нескольких вариантов (Jev, Laya, Kev). Управляет Microduck, Open Duck Mini, LeRobot, XLeRobot, AlohaMini, ToddlerBot, а также любой платформой ROS 2 с ноутбука, без бортового компьютера.
...
Охват, безопасность и качество кода для агентов программирования
...
<details>
<summary><b>Больше в этой категории</b> <sub>· 109</sub></summary>
...
- [topherchris420/james_library](https://github.com/topherchris420/james_library) - R.A.I.N. Lab — экспериментальная архитектура научного агента, разделяющая…
...
- [6Mikao9/jev-native-agent-with-extended-options](https://github.com/6Mikao9/jev-native-agent-with-extended-options) - Проектирование исследовательской архитектуры агентной системы, нативной для…
...
- [carldaws/hunch](https://github.com/carldaws/hunch) - Вероятностный поток управления для Ruby и Rails — на базе Jev от TypeSafe.
...
- [ruban-24/switchboard](https://github.com/ruban-24/switchboard) - Маршрутизатор решений с открытым исходным кодом и независимостью от модели для…
...
- [MiaoWuNYA/rikkahub-sillytavern-android](https://github.com/MiaoWuNYA/rikkahub-sillytavern-android) - AI-чат для Android: импорт карточек из SillyTavern без потерь, агрессивная…
...
<details>
<summary><b>Больше в этой категории</b> <sub>· 227</sub></summary>
...
- [safzanpirani/pi-jev-skill-picker](https://github.com/safzanpirani/pi-jev-skill-picker) - Ранжируйте навыки Pi Agent для текущей задачи с помощью TypeSafe Jev.
...
- [erkamyaman/jev-enforce](https://github.com/erkamyaman/jev-enforce) - 📏 Плагин Claude Code, заставляющий Claude следовать вашему AGENTS.md: каждый…
...
- [itsmostafa/system-one-connector](https://github.com/itsmostafa/system-one-connector) - Коннектор System One MCP для быстрой и недорогой оценки чего угодно.
...
Запускайте открытые модели принятия решений локально: загружайте и обслуживайте Laya, decider, NLI и GLiClass через API, совместимый с TypeSafe. Ollama для моделей принятия решений.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/4nt0ineb--jev-from-java/cd4ce3d04107d762.gif" width="100%" alt="4nt0ineB/jev-from-java animation"><br><sub>анимированная запись</sub></td>
</tr></table>
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/wh000wh000/awesome-jev-live/main/media/ankit-aglawe--tinyjev/dc0d701a10c37f94.gif" width="100%" alt="ankit-aglawe/tinyjev animation"><br><sub>анимированная запись</sub></td>
</tr></table>
...
<details>
<summary><b>Больше в этой категории</b> <sub>· 60</sub></summary>
...
- [anessbelbati/jev-rerank-bench](https://github.com/anessbelbati/jev-rerank-bench) - Может ли модель решений превзойти специализированные переранжировщики? TypeSafe…
...
jevos — альтернатива Jev с открытым исходным кодом для решений «да/нет», работающая на вашем ноутбуке.
...
<td align="center" valign="top"><img src="https://raw.githubusercontent.com/feder-cr/jev/main/assets/dino_run.gif" width="100%" alt="feder-cr/jev animation"><br><sub>анимированная запись</sub></td>
</tr></table>
...
- [Ryu0118/jev-sim-use](https://github.com/Ryu0118/jev-sim-use) - 📱 Доступ к любому экрану со скоростью sim-use Jev.
...
<details>
<summary>📰 <b><a href="https://typesafe.ai/team">В TypeSafe добавлена страница Team + в навигацию добавлена точка входа `Enterprise` (сигнал продуктового/коммерческого развития)</a></b> · ✅ official · 7 天</summary>
...
<details>
<summary><b>Больше в этой категории</b> <sub>· 92</sub></summary>
...
- [Show HN: Doom or Bloom, map your AI worldview with Jev](https://news.ycombinator.com/item?id=49846953) - Составьте карту своего мировоззрения в области AI, ответив на несколько…
...
Официальная документация по использованию модели Jev (TypeSafe AI) на китайском языке | Неофициальный китайский перевод официальной документации Jev (TypeSafe AI) — https://docs.typesafe.ai
...
- [TianyuCodings/JevHarness](https://github.com/TianyuCodings/JevHarness) - Созданные LLM специализированные для задач Jev-жгуты с необязательной…
...
- [doeixd/discern](https://github.com/doeixd/discern) - Создавайте типобезопасное семантическое сопоставление с учётом…
- [Kevthetech143/super-jev](https://github.com/Kevthetech143/super-jev) - Небольшой расширяемый стенд преобразования решений в действия для TypeSafe Jev.
...
- [codejunkie99/keel](https://github.com/codejunkie99/keel) - Рабочее пространство для программирования macOS с приоритетом локальной работы…
...
<sub>Сгенерировано с помощью · `render.py` · 2026-09-26T03:12:11+08:00</sub>
